<svg
	...
	viewBox="0 0 286 56"
	id="logo_tflite"
	class="s-fahQfAG4a_Lx"
	><g class="s-fahQfAG4a_Lx"
		><g class="s-fahQfAG4a_Lx"
			><defs class="s-fahQfAG4a_Lx"
				><path
					id="SVGID_1_"
					d="M47.5 17.6L25 4.8v52.6l9-5.2V37.4l6.8 3.9-.1-10.1-6.7-3.9v-5.9l13.5 7.9z"
					class="s-fahQfAG4a_Lx"
				></path></defs
			><clipPath id="SVGID_2_" class="s-fahQfAG4a_Lx"
				><use xlink:href="#SVGID_1_" overflow="visible" class="s-fahQfAG4a_Lx"></use></clipPath
			><g clip-path="url(#SVGID_2_)" class="s-fahQfAG4a_Lx"
				><linearGradient
					id="SVGID_3_"
					...
					class="s-fahQfAG4a_Lx"
					><stop offset="0" stop-color="#ff6f00" class="s-fahQfAG4a_Lx"></stop><stop
						offset="1"
						stop-color="#ffa800"
						class="s-fahQfAG4a_Lx"
					></stop></linearGradient
				><path d="M-1.6 4.6h55.2v52.9H-1.6V4.6z" fill="url(#SVGID_3_)" class="s-fahQfAG4a_Lx"
				></path></g
			></g
		></g
	><g class="s-fahQfAG4a_Lx"
		><g class="s-fahQfAG4a_Lx"
			><defs class="s-fahQfAG4a_Lx"
				><path id="SVGID_4_" d="M.5 17.6L23 4.8v52.6l-9-5.2V21.4L.5 29.3z" class="s-fahQfAG4a_Lx"
				></path></defs
			><clipPath id="SVGID_5_" class="s-fahQfAG4a_Lx"
				><use xlink:href="#SVGID_4_" overflow="visible" class="s-fahQfAG4a_Lx"></use></clipPath
			><g clip-path="url(#SVGID_5_)" class="s-fahQfAG4a_Lx"
				><linearGradient
					id="SVGID_6_"
					gradientUnits="userSpaceOnUse"
					x1="-1.9"
					...
					><stop offset="0" stop-color="#ff6f00" class="s-fahQfAG4a_Lx"></stop><stop
						...
						class="s-fahQfAG4a_Lx"
					></stop></linearGradient
				><path d="M-1.9 4.6h55.2v52.9H-1.9V4.6z" fill="url(#SVGID_6_)" class="s-fahQfAG4a_Lx"
				></path></g
			></g
		></g
	><path
		d="M88.2 21.1h-10v27.7h-5.6V21.1h-10v-4.5h25.6v4.5z"
		class="s-fahQfAG4a_Lx"
		style="fill: rgb(66, 80, 102);"
	></path><path
