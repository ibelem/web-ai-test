...
<div class="environment framework">
	<div title="JS ML Framework" class="ort">
		...
		<div class="wasm">
			...
			<span class="version"
				><a href="https://www.npmjs.com/package/onnxruntime-web">{ortDists.public.version}</a></span
			>
		</div>
		<div class="webgpu">
...
<div class="environment">
	...
	<Modal bind:showModal>
		<h2 slot="header" class="updatecpu">Update CPU Model</h2>
