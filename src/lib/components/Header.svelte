...
<header>
	<div id="logo" class={progress}>
		<a href={url} on:click={homeUrl}>
			...
			>
				<path d="M15 90L33 69" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M63 83L44 68" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M77 85L103 79" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M126 40L119 63" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M151 65L127 71" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M161 74L156 109" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M163 62L193 107" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M162 116L188 116" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M148 122L119 143" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M101 114L155 156" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M183 150L155 156" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M194 141L197 129" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M195 155L203 166" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M123 84L149 111" stroke="white" stroke-width="6" stroke-linecap="round" />
				<path d="M67 95L55 127" stroke="white" stroke-width="6" stroke-linecap="round" />
