...
const marqoFashionSigLIPTextComputeBenchmark = () => {
  ...
  return configs.map(([dt, file, size]) => ({
    ...
    isv: '',
    id: `marqo_fashion_sig_lip_text_${dt}`,
    name: `Marqo-FashionSigLIP Text compute-benchmark`,
    description: 'Marqo-FashionSigLIP is a multimodal embedding model that provides up to 57% improvement in MRR and recall over fashion clip.',
    note: '',
    source: 'https://huggingface.co/Marqo/marqo-fashionSigLIP',
    hf: {
...
const marqoFashionSigLIPVisionComputeBenchmark = () => {
  ...
  return configs.map(([dt, file, size]) => ({
    ...
    isv: '',
    id: `marqo_fashion_sig_lip_vision_${dt}`,
    name: `Marqo FashionSigLIP Vision compute-benchmark`,
    description: 'Marqo-FashionSigLIP is a multimodal embedding model that provides up to 57% improvement in MRR and recall over fashion clip.',
    note: '',
    source: 'https://huggingface.co/Marqo/marqo-fashionSigLIP',
    hf: {
...
const sdxlTurboTextEncoder = () => {
  ...
  return configs.map(([dt, file, size]) => ({
    ...
    name: `SDXL-Turbo Text Encoder Demo ${dt}`,
...
const sdxlTurboTextEncoder2 = () => {
  ...
  return configs.map(([dt, file, size]) => ({
    ...
    name: `SDXL-Turbo Text Encoder 2 Demo ${dt}`,
    description: 'A fast generative text-to-image model that can synthesize photorealistic images from a text prompt in a single network evaluation.',
    note: '',
    source: 'https://huggingface.co/stabilityai/sdxl-turbo',
    hf: {
...
const sdxlTurboVAEDecoder = () => {
  ...
  return configs.map(([dt, file, size]) => ({
    ...
    name: `SDXL-Turbo VAE Decoder Demo ${dt}`,
    description: 'A fast generative text-to-image model that can synthesize photorealistic images from a text prompt in a single network evaluation.',
    note: '',
    source: 'https://huggingface.co/stabilityai/sdxl-turbo',
    hf: {
