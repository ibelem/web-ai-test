...
`),R.push(w+`};
`),r=dt(R).apply(null,j),u=`methodCaller<(${n.map(re=>re.name).join(", ")}) => ${p.name}>`,lt(pr(u,r))},p:function(r,n){return n>>>=0,r=de(r>>>0),n=de(n),Re(r[n])},c:function(r){r>>>=0,4<r&&(Oe.get(r).bb+=1)},r:function(){return Re([])},k:function(r){r=de(r>>>0);for(var n=Array(r.length),u=0;u<r.length;u++)n[u]=r[u];return Re(n)},d:function(r){return Re(Cr(r>>>0))},h:function(){return Re({})},g:function(r){r>>>=0;for(var n=de(r);n.length;){var u=n.pop();n.pop()(u)}Ar(r)},f:function(r,n,u){n>>>=0,u>>>=0,r=de(r>>>0),n=de(n),u=de(u),r[n]=u},e:function(r,n){return n>>>=0,r=Sr(r>>>0,"_emval_take_value"),r=r.readValueFromPointer(n),Re(r)},R:function(r,n){r=-9007199254740992>r||9007199254740992<r?NaN:Number(r),n>>>=0,r=new Date(1e3*r),U[n>>>2>>>0]=r.getUTCSeconds(),U[n+4>>>2>>>0]=r.getUTCMinutes(),U[n+8>>>2>>>0]=r.getUTCHours(),U[n+12>>>2>>>0]=r.getUTCDate(),U[n+16>>>2>>>0]=r.getUTCMonth(),U[n+20>>>2>>>0]=r.getUTCFullYear()-1900,U[n+24>>>2>>>0]=r.getUTCDay(),U[n+28>>>2>>>0]=(r.getTime()-Date.UTC(r.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},S:function(r,n){r=-9007199254740992>r||9007199254740992<r?NaN:Number(r),n>>>=0,r=new Date(1e3*r),U[n>>>2>>>0]=r.getSeconds(),U[n+4>>>2>>>0]=r.getMinutes(),U[n+8>>>2>>>0]=r.getHours(),U[n+12>>>2>>>0]=r.getDate(),U[n+16>>>2>>>0]=r.getMonth(),U[n+20>>>2>>>0]=r.getFullYear()-1900,U[n+24>>>2>>>0]=r.getDay(),U[n+28>>>2>>>0]=(Ye(r.getFullYear())?Hr:jr)[r.getMonth()]+r.getDate()-1|0,U[n+36>>>2>>>0]=-(60*r.getTimezoneOffset());var u=new Date(r.getFullYear(),6,1).getTimezoneOffset(),p=new Date(r.getFullYear(),0,1).getTimezoneOffset();U[n+32>>>2>>>0]=(u!=p&&r.getTimezoneOffset()==Math.min(p,u))|0},T:function(r){r>>>=0;var n=new Date(U[r+20>>>2>>>0]+1900,U[r+16>>>2>>>0],U[r+12>>>2>>>0],U[r+8>>>2>>>0],U[r+4>>>2>>>0],U[r>>>2>>>0],0),u=U[r+32>>>2>>>0],p=n.getTimezoneOffset(),w=new Date(n.getFullYear(),6,1).getTimezoneOffset(),E=new Date(n.getFullYear(),0,1).getTimezoneOffset(),F=Math.min(E,w);return 0>u?U[r+32>>>2>>>0]=+(w!=E&&F==p):0<u!=(F==p)&&(w=Math.max(E,w),n.setTime(n.getTime()+6e4*((0<u?F:w)-p))),U[r+24>>>2>>>0]=n.getDay(),U[r+28>>>2>>>0]=(Ye(n.getFullYear())?Hr:jr)[n.getMonth()]+n.getDate()-1|0,U[r>>>2>>>0]=n.getSeconds(),U[r+4>>>2>>>0]=n.getMinutes(),U[r+8>>>2>>>0]=n.getHours(),U[r+12>>>2>>>0]=n.getDate(),U[r+16>>>2>>>0]=n.getMonth(),U[r+20>>>2>>>0]=n.getYear(),r=n.getTime(),isNaN(r)?(U[ht()>>>2>>>0]=61,r=-1):r/=1e3,BigInt(r)},P:function(){return-52},Q:function(){},I:function(r,n,u){function p(j){return(j=j.toTimeString().match(/\(([A-Za-z ]+)\)$/))?j[1]:"GMT"}u>>>=0;var w=new Date().getFullYear(),E=new Date(w,0,1),F=new Date(w,6,1);w=E.getTimezoneOffset();var R=F.getTimezoneOffset();Y[r>>>0>>>2>>>0]=60*Math.max(w,R),U[n>>>0>>>2>>>0]=+(w!=R),r=p(E),n=p(F),r=zr(r),n=zr(n),R<w?(Y[u>>>2>>>0]=r,Y[u+4>>>2>>>0]=n):(Y[u>>>2>>>0]=n,Y[u+4>>>2>>>0]=r)},y:()=>{ur("")},fa:function(r,n,u){r>>>=0,n>>>=0,u>>>=0,Mr.length=0;for(var p;p=J[n++>>>0];){var w=p!=105;w&=p!=112,u+=w&&u%8?4:0,Mr.push(p==112?Y[u>>>2>>>0]:p==106?Ze[u>>>3]:p==105?U[u>>>2>>>0]:ne[u>>>3>>>0]),u+=w?8:4}return ce[r].apply(null,Mr)},C:()=>Date.now(),J:function(){return 4294901760},n:()=>performance.now(),H:function(r){r>>>=0;var n=J.length;if(4294901760<r)return!1;for(var u=1;4>=u;u*=2){var p=n*(1+.2/u);p=Math.min(p,r+100663296);var w=Math;p=Math.max(r,p);e:{w=(w.min.call(w,4294901760,p+(65536-p%65536)%65536)-P.buffer.byteLength+65535)/65536;try{P.grow(w),B();var E=1;break e}catch{}E=void 0}if(E)return!0}return!1},W:function(r,n){r>>>=0,n>>>=0;var u=0;return Gr().forEach((p,w)=>{var E=n+u;for(w=Y[r+4*w>>>2>>>0]=E,E=0;E<p.length;++E)te[w++>>>0>>>0]=p.charCodeAt(E);te[w>>>0>>>0]=0,u+=p.length+1}),0},X:function(r,n){r>>>=0,n>>>=0;var u=Gr();Y[r>>>2>>>0]=u.length;var p=0;return u.forEach(w=>p+=w.length+1),Y[n>>>2>>>0]=p,0},u:()=>52,A:function(){return 52},V:function(){return 70},z:function(r,n,u,p){n>>>=0,u>>>=0,p>>>=0;for(var w=0,E=0;E<u;E++){var F=Y[n>>>2>>>0],R=Y[n+4>>>2>>>0];n+=8;for(var j=0;j<R;j++){var W=J[F+j>>>0],re=pt[r];W===0||W===10?((r===1?q:I)(Ke(re,0)),re.length=0):re.push(W)}w+=R}return Y[p>>>2>>>0]=w,0},ba:qr,m:function(r,n,u,p){return qr(r>>>0,n>>>0,u>>>0,p>>>0)}},H=function(){function r(u){return H=u.exports,H=Qr(),P=H.ga,B(),ke.unshift(H.ha),se--,se==0&&(le!==null&&(clearInterval(le),le=null),pe&&(u=pe,pe=null,u())),H}var n={a:Jr};if(se++,s.instantiateWasm)try{return s.instantiateWasm(n,r)}catch(u){I(`Module.instantiateWasm callback failed with error: ${u}`),c(u)}return me(n,function(u){r(u.instance)}).catch(c),{}}();s._OrtInit=(r,n)=>(s._OrtInit=H.ia)(r,n),s._OrtGetLastError=(r,n)=>(s._OrtGetLastError=H.ja)(r,n),s._OrtCreateSessionOptions=(r,n,u,p,w,E,F,R,j,W)=>(s._OrtCreateSessionOptions=H.ka)(r,n,u,p,w,E,F,R,j,W),s._OrtAppendExecutionProvider=(r,n)=>(s._OrtAppendExecutionProvider=H.la)(r,n),s._OrtAddFreeDimensionOverride=(r,n,u)=>(s._OrtAddFreeDimensionOverride=H.ma)(r,n,u),s._OrtAddSessionConfigEntry=(r,n,u)=>(s._OrtAddSessionConfigEntry=H.na)(r,n,u),s._OrtReleaseSessionOptions=r=>(s._OrtReleaseSessionOptions=H.oa)(r),s._OrtCreateSession=(r,n,u)=>(s._OrtCreateSession=H.pa)(r,n,u),s._OrtReleaseSession=r=>(s._OrtReleaseSession=H.qa)(r),s._OrtGetInputOutputCount=(r,n,u)=>(s._OrtGetInputOutputCount=H.ra)(r,n,u),s._OrtGetInputName=(r,n)=>(s._OrtGetInputName=H.sa)(r,n),s._OrtGetOutputName=(r,n)=>(s._OrtGetOutputName=H.ta)(r,n),s._OrtFree=r=>(s._OrtFree=H.ua)(r),s._OrtCreateTensor=(r,n,u,p,w,E)=>(s._OrtCreateTensor=H.va)(r,n,u,p,w,E),s._OrtGetTensorData=(r,n,u,p,w)=>(s._OrtGetTensorData=H.wa)(r,n,u,p,w),s._OrtReleaseTensor=r=>(s._OrtReleaseTensor=H.xa)(r),s._OrtCreateRunOptions=(r,n,u,p)=>(s._OrtCreateRunOptions=H.ya)(r,n,u,p),s._OrtAddRunConfigEntry=(r,n,u)=>(s._OrtAddRunConfigEntry=H.za)(r,n,u),s._OrtReleaseRunOptions=r=>(s._OrtReleaseRunOptions=H.Aa)(r),s._OrtCreateBinding=r=>(s._OrtCreateBinding=H.Ba)(r),s._OrtBindInput=(r,n,u)=>(s._OrtBindInput=H.Ca)(r,n,u),s._OrtBindOutput=(r,n,u,p)=>(s._OrtBindOutput=H.Da)(r,n,u,p),s._OrtClearBoundOutputs=r=>(s._OrtClearBoundOutputs=H.Ea)(r),s._OrtReleaseBinding=r=>(s._OrtReleaseBinding=H.Fa)(r),s._OrtRunWithBinding=(r,n,u,p,w)=>(s._OrtRunWithBinding=H.Ga)(r,n,u,p,w),s._OrtRun=(r,n,u,p,w,E,F,R)=>(s._OrtRun=H.Ha)(r,n,u,p,w,E,F,R),s._OrtEndProfiling=r=>(s._OrtEndProfiling=H.Ia)(r);var ht=()=>(ht=H.Ja)(),Me=s._malloc=r=>(Me=s._malloc=H.Ka)(r),Ne=s._free=r=>(Ne=s._free=H.La)(r),xe=r=>(xe=H.Ma)(r),Zr=()=>(Zr=H.Oa)(),Kr=r=>(Kr=H.Pa)(r),Te=r=>(Te=H.Qa)(r);function Qr(){var r=H;r=Object.assign({},r);var n=p=>()=>p()>>>0,u=p=>w=>p(w)>>>0;return r.Ja=n(r.Ja),r.Ka=u(r.Ka),r.Ma=u(r.Ma),r.Oa=n(r.Oa),r.Qa=u(r.Qa),r}s.stackAlloc=Te,s.stackSave=Zr,s.stackRestore=Kr,s.UTF8ToString=Qe,s.stringToUTF8=(r,n,u)=>lr(r,J,n,u),s.lengthBytesUTF8=er;var he;pe=function r(){he||Pe(),he||(pe=r)};function Pe(){if(!(0<se)){if(s.preRun)for(typeof s.preRun=="function"&&(s.preRun=[s.preRun]);s.preRun.length;){var r=s.preRun.shift();Ie.unshift(r)}for(;0<Ie.length;)Ie.shift()(s);if(!(0<se||he||(he=!0,s.calledRun=!0,G))){for(;0<ke.length;)ke.shift()(s);for(m(s);0<ye.length;)ye.shift()(s)}}}return Pe(),i.ready}})();typeof Oa=="object"&&typeof nn=="object"?nn.exports=va:typeof define=="function"&&define.amd&&define([],()=>va)});var Ta=Ir(()=>{});var Aa=Ir(()=>{});var _a={};Rr(_a,{cpus:()=>So});var So,Ea=X(()=>{So=void 0});var sn=Ir((Ca,on)=>{"use strict";var Sa=(()=>{var o=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(o=o||__filename),function(i={}){function s(){return B.buffer!=se.buffer&&be(),se}function m(){return B.buffer!=se.buffer&&be(),le}function c(){return B.buffer!=se.buffer&&be(),pe}function y(){return B.buffer!=se.buffer&&be(),ur}function d(){return B.buffer!=se.buffer&&be(),He}function g(){return B.buffer!=se.buffer&&be(),je}function T(){return B.buffer!=se.buffer&&be(),ze}var f=i,_,S;f.ready=new Promise((e,t)=>{_=e,S=t});var A=Object.assign({},f),M="./this.program",L=(e,t)=>{throw t},N=typeof window=="object",q=typeof importScripts=="function",I=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",P=f.ENVIRONMENT_IS_PTHREAD||!1,G="";function te(e){return f.locateFile?f.locateFile(e,G):G+e}var J,_e,Fe;if(I){var U=(en(),hr(Qt)),Y=(tn(),hr(rn));G=q?Y.dirname(G)+"/":__dirname+"/",J=(t,a)=>(t=cr(t)?new URL(t):Y.normalize(t),U.readFileSync(t,a?void 0:"utf8")),Fe=t=>(t=J(t,!0),t.buffer||(t=new Uint8Array(t)),t),_e=(t,a,l,h=!0)=>{t=cr(t)?new URL(t):Y.normalize(t),U.readFile(t,h?void 0:"utf8",(b,C)=>{b?l(b):a(h?C.buffer:C)})},!f.thisProgram&&1<process.argv.length&&(M=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),L=(t,a)=>{throw process.exitCode=t,a},f.inspect=()=>"[Emscripten Module object]";let e;try{e=Ta()}catch(t){throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'),t}global.Worker=e.Worker}else(N||q)&&(q?G=self.location.href:typeof document<"u"&&document.currentScript&&(G=document.currentScript.src),typeof o<"u"&&o&&(G=o),G.indexOf("blob:")!==0?G=G.substr(0,G.replace(/[?#].*/,"").lastIndexOf("/")+1):G="",I||(J=e=>{var t=new XMLHttpRequest;return t.open("GET",e,!1),t.send(null),t.responseText},q&&(Fe=e=>{var t=new XMLHttpRequest;return t.open("GET",e,!1),t.responseType="arraybuffer",t.send(null),new Uint8Array(t.response)}),_e=(e,t,a)=>{var l=new XMLHttpRequest;l.open("GET",e,!0),l.responseType="arraybuffer",l.onload=()=>{l.status==200||l.status==0&&l.response?t(l.response):a()},l.onerror=a,l.send(null)}));I&&typeof performance>"u"&&(global.performance=Aa().performance);var ir=console.log.bind(console),Ze=console.error.bind(console);I&&(ir=(...e)=>U.writeSync(1,e.join(" ")+`
`),Ze=(...e)=>U.writeSync(2,e.join(" ")+`
`));var sr=ir,ne=Ze;Object.assign(f,A),A=null,typeof WebAssembly!="object"&&er("no native wasm support detected");var B,Ie,ke=!1,ye,se,le,pe,ur,He,je,We,Se,Le,ze;function be(){var e=B.buffer;f.HEAP8=se=new Int8Array(e),f.HEAP16=pe=new Int16Array(e),f.HEAPU8=le=new Uint8Array(e),f.HEAPU16=ur=new Uint16Array(e),f.HEAP32=He=new Int32Array(e),f.HEAPU32=je=new Uint32Array(e),f.HEAPF32=We=new Float32Array(e),f.HEAPF64=ze=new Float64Array(e),f.HEAP64=Se=new BigInt64Array(e),f.HEAPU64=Le=new BigUint64Array(e)}var me=16777216;if(P)B=f.wasmMemory;else if(f.wasmMemory)B=f.wasmMemory;else if(B=new WebAssembly.Memory({initial:me/65536,maximum:65536,shared:!0}),!(B.buffer instanceof SharedArrayBuffer))throw ne("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),I&&ne("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");be(),me=B.buffer.byteLength;var ce=[],Ve=[],fr=[],Ge=0,vr=null,Ke=null;function Qe(){if(Ge--,Ge==0&&(vr!==null&&(clearInterval(vr),vr=null),Ke)){var e=Ke;Ke=null,e()}}function er(e){throw e="Aborted("+e+")",ne(e),ke=!0,ye=1,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),S(e),e}var lr=e=>e.startsWith("data:application/octet-stream;base64,"),cr=e=>e.startsWith("file://"),rr;rr="ort-wasm-threaded.wasm",lr(rr)||(rr=te(rr));function Ee(e){if(Fe)return Fe(e);throw"both async and sync fetching of the wasm failed"}function Wr(e){if(N||q){if(typeof fetch=="function"&&!cr(e))return fetch(e,{credentials:"same-origin"}).then(t=>{if(!t.ok)throw"failed to load wasm binary file at '"+e+"'";return t.arrayBuffer()}).catch(()=>Ee(e));if(_e)return new Promise((t,a)=>{_e(e,l=>t(new Uint8Array(l)),a)})}return Promise.resolve().then(()=>Ee(e))}function Or(e,t,a){return Wr(e).then(l=>WebAssembly.instantiate(l,t)).then(l=>l).then(a,l=>{ne(`failed to asynchronously prepare wasm: ${l}`),er(l)})}function kt(e,t){var a=rr;return typeof WebAssembly.instantiateStreaming!="function"||lr(a)||cr(a)||I||typeof fetch!="function"?Or(a,e,t):fetch(a,{credentials:"same-origin"}).then(l=>WebAssembly.instantiateStreaming(l,e).then(t,function(h){return ne(`wasm streaming compile failed: ${h}`),ne("falling back to ArrayBuffer instantiation"),Or(a,e,t)}))}var $e={1379052:(e,t,a,l)=>{if(typeof f>"u"||!f.Hb)return 1;if(e=de(e>>>0),e.startsWith("./")&&(e=e.substring(2)),e=f.Hb.get(e),!e)return 2;if(t>>>=0,a>>>=0,l>>>=0,t+a>e.byteLength)return 3;try{return m().set(e.subarray(t,t+a),l>>>0),0}catch{return 4}}};function Tr(e){this.name="ExitStatus",this.message=`Program terminated with exit(${e})`,this.status=e}var Ce=e=>{e.terminate(),e.onmessage=()=>{}},Lr=e=>{$.ob.length==0&&(st(),$.Bb($.ob[0]));var t=$.ob.pop();if(!t)return 6;$.pb.push(t),$.kb[e.nb]=t,t.nb=e.nb;var a={cmd:"run",start_routine:e.Ob,arg:e.Ib,pthread_ptr:e.nb};return I&&t.unref(),t.postMessage(a,e.Ub),0},tr=0,Oe=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Ar=(e,t,a)=>{t>>>=0;var l=t+a;for(a=t;e[a]&&!(a>=l);)++a;if(16<a-t&&e.buffer&&Oe)return Oe.decode(e.buffer instanceof SharedArrayBuffer?e.slice(t,a):e.subarray(t,a));for(l="";t<a;){var h=e[t++];if(h&128){var b=e[t++]&63;if((h&224)==192)l+=String.fromCharCode((h&31)<<6|b);else{var C=e[t++]&63;h=(h&240)==224?(h&15)<<12|b<<6|C:(h&7)<<18|b<<12|C<<6|e[t++]&63,65536>h?l+=String.fromCharCode(h):(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023))}}else l+=String.fromCharCode(h)}return l},de=(e,t)=>(e>>>=0)?Ar(m(),e,t):"",Re=e=>{var t=Gt();return e=e(),bt(t),e};function K(e,t){var a=arguments.length-2,l=arguments;return Re(()=>{for(var h=2*a,b=Yt(8*h),C=b>>>3,D=0;D<a;D++){var z=l[2+D];typeof z=="bigint"?(Se[C+2*D]=1n,Se[C+2*D+1]=z):(Se[C+2*D]=0n,T()[C+2*D+1>>>0]=z)}return $n(e,h,b,t)})}function ot(e){if(P)return K(0,1,e);ye=e,0<tr||($.Pb(),f.onExit?.(e),ke=!0),L(e,new Tr(e))}var $r=e=>{if(ye=e,P)throw ut(e),"unwind";ot(e)};function it(){for(var e=f.numThreads;e--;)st();ce.unshift(()=>{Ge++,Wt(()=>Qe())})}function st(){var e=te("ort-wasm-threaded.worker.js");e=new Worker(e),$.ob.push(e)}function Wt(e){P?e():Promise.all($.ob.map($.Bb)).then(e)}var $={ob:[],pb:[],Gb:[],kb:{},wb(){P?($.receiveObjectTransfer=$.Nb,$.threadInitTLS=$.Fb,$.setExitStatus=$.Eb):it()},Eb:e=>ye=e,Xb:["$terminateWorker"],Pb:()=>{for(var e of $.pb)Ce(e);for(e of $.ob)Ce(e);$.ob=[],$.pb=[],$.kb=[]},Db:e=>{var t=e.nb;delete $.kb[t],$.ob.push(e),$.pb.splice($.pb.indexOf(e),1),e.nb=0,jt(t)},Nb(){},Fb(){$.Gb.forEach(e=>e())},Bb:e=>new Promise(t=>{e.onmessage=b=>{b=b.data;var C=b.cmd;if(b.targetThread&&b.targetThread!=yt()){var D=$.kb[b.targetThread];D?D.postMessage(b,b.transferList):ne(`Internal error! Worker sent a message "${C}" to target pthread ${b.targetThread}, but that thread no longer exists!`)}else C==="checkMailbox"?ge():C==="spawnThread"?Lr(b):C==="cleanupThread"?$.Db($.kb[b.thread]):C==="killThread"?(b=b.thread,C=$.kb[b],delete $.kb[b],Ce(C),jt(b),$.pb.splice($.pb.indexOf(C),1),C.nb=0):C==="cancelThread"?$.kb[b.thread].postMessage({cmd:"cancel"}):C==="loaded"?(e.loaded=!0,I&&!e.nb&&e.unref(),t(e)):C==="alert"?alert(`Thread ${b.threadId}: ${b.text}`):b.target==="setimmediate"?e.postMessage(b):C==="callHandler"?f[b.handler](...b.args):C&&ne(`worker sent an unknown command ${C}`)},e.onerror=b=>{throw ne(`worker sent an error! ${b.filename}:${b.lineno}: ${b.message}`),b},I&&(e.on("message",b=>e.onmessage({data:b})),e.on("error",b=>e.onerror(b)));var a=[],l=["onExit"],h;for(h of l)f.hasOwnProperty(h)&&a.push(h);e.postMessage({cmd:"load",handlers:a,urlOrBlob:f.mainScriptUrlOrBlob||o,wasmMemory:B,wasmModule:Ie})})};f.PThread=$;var _r=e=>{for(;0<e.length;)e.shift()(f)};f.establishStackSpace=()=>{var e=yt(),t=g()[e+52>>>2>>>0];e=g()[e+56>>>2>>>0],Hn(t,t-e),bt(t)};function ut(e){if(P)return K(1,0,e);$r(e)}var Er=[],Sr;f.invokeEntryPoint=(e,t)=>{var a=Er[e];a||(e>=Er.length&&(Er.length=e+1),Er[e]=a=Sr.get(e)),e=a(t),0<tr?$.Eb(e):zt(e)};function ft(e){this.tb=e-24,this.Mb=function(t){g()[this.tb+4>>>2>>>0]=t},this.yb=function(t){g()[this.tb+8>>>2>>>0]=t},this.wb=function(t,a){this.xb(),this.Mb(t),this.yb(a)},this.xb=function(){g()[this.tb+16>>>2>>>0]=0}}var dr=0,Lt=0;function Cr(e,t,a,l){return P?K(2,1,e,t,a,l):Nr(e,t,a,l)}function Nr(e,t,a,l){if(e>>>=0,t>>>=0,a>>>=0,l>>>=0,typeof SharedArrayBuffer>"u")return ne("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var h=[];return P&&h.length===0?Cr(e,t,a,l):(e={Ob:a,nb:e,Ib:l,Ub:h},P?(e.Wb="spawnThread",postMessage(e,h),0):Lr(e))}function lt(e,t,a){return P?K(3,1,e,t,a):0}function ct(e,t){if(P)return K(4,1,e,t)}var pr=e=>{for(var t=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);127>=l?t++:2047>=l?t+=2:55296<=l&&57343>=l?(t+=4,++a):t+=3}return t},dt=(e,t,a,l)=>{if(a>>>=0,!(0<l))return 0;var h=a;l=a+l-1;for(var b=0;b<e.length;++b){var C=e.charCodeAt(b);if(55296<=C&&57343>=C){var D=e.charCodeAt(++b);C=65536+((C&1023)<<10)|D&1023}if(127>=C){if(a>=l)break;t[a++>>>0]=C}else{if(2047>=C){if(a+1>=l)break;t[a++>>>0]=192|C>>6}else{if(65535>=C){if(a+2>=l)break;t[a++>>>0]=224|C>>12}else{if(a+3>=l)break;t[a++>>>0]=240|C>>18,t[a++>>>0]=128|C>>12&63}t[a++>>>0]=128|C>>6&63}t[a++>>>0]=128|C&63}}return t[a>>>0]=0,a-h},Ye=(e,t,a)=>dt(e,m(),t,a);function Hr(e,t){if(P)return K(5,1,e,t)}function jr(e,t,a){if(P)return K(6,1,e,t,a)}function zr(e,t,a){return P?K(7,1,e,t,a):0}function Mr(e,t){if(P)return K(8,1,e,t)}function Pr(e,t,a){if(P)return K(9,1,e,t,a)}function Gr(e,t,a,l){if(P)return K(10,1,e,t,a,l)}function Ur(e,t,a,l){if(P)return K(11,1,e,t,a,l)}function pt(e,t,a,l){if(P)return K(12,1,e,t,a,l)}function Yr(e){if(P)return K(13,1,e)}function Vr(e,t){if(P)return K(14,1,e,t)}function mt(e,t,a){if(P)return K(15,1,e,t,a)}var qr=e=>{if(e===null)return"null";var t=typeof e;return t==="object"||t==="array"||t==="function"?e.toString():""+e},Xr,ve=e=>{for(var t="";m()[e>>>0];)t+=Xr[m()[e++>>>0]];return t},Jr={},H={},ht={},Me;function Ne(e,t,a={}){var l=t.name;if(!e)throw new Me(`type "${l}" must have a positive integer typeid pointer`);if(H.hasOwnProperty(e)){if(a.Kb)return;throw new Me(`Cannot register type '${l}' twice`)}H[e]=t,delete ht[e],Jr.hasOwnProperty(e)&&(t=Jr[e],delete Jr[e],t.forEach(h=>h()))}function xe(e,t,a={}){if(!("argPackAdvance"in t))throw new TypeError("registerType registeredInstance requires argPackAdvance");Ne(e,t,a)}var Zr=(e,t,a)=>{switch(t){case 1:return a?l=>s()[l>>>0>>>0]:l=>m()[l>>>0>>>0];case 2:return a?l=>c()[l>>>1>>>0]:l=>y()[l>>>1>>>0];case 4:return a?l=>d()[l>>>2>>>0]:l=>g()[l>>>2>>>0];case 8:return a?l=>Se[l>>>3]:l=>Le[l>>>3];default:throw new TypeError(`invalid integer width (${t}): ${e}`)}};function Kr(){this.mb=[void 0],this.Ab=[]}var Te=new Kr;function Qr(e){e>>>=0,e>=Te.tb&&--Te.get(e).Cb===0&&Te.yb(e)}var he=e=>{if(!e)throw new Me("Cannot use deleted val. handle = "+e);return Te.get(e).value},Pe=e=>{switch(e){case void 0:return 1;case null:return 2;case!0:return 3;case!1:return 4;default:return Te.xb({Cb:1,value:e})}};function r(e){return this.fromWireType(d()[e>>>2>>>0])}var n=(e,t)=>{switch(t){case 4:return function(a){var l=this.fromWireType;return B.buffer!=se.buffer&&be(),l.call(this,We[a>>>2>>>0])};case 8:return function(a){return this.fromWireType(T()[a>>>3>>>0])};default:throw new TypeError(`invalid float width (${t}): ${e}`)}};function u(e){return this.fromWireType(g()[e>>>2>>>0])}var p=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,w=(e,t)=>{for(var a=e>>1,l=a+t/2;!(a>=l)&&y()[a>>>0];)++a;if(a<<=1,32<a-e&&p)return p.decode(m().slice(e,a));for(a="",l=0;!(l>=t/2);++l){var h=c()[e+2*l>>>1>>>0];if(h==0)break;a+=String.fromCharCode(h)}return a},E=(e,t,a)=>{if(a??=2147483647,2>a)return 0;a-=2;var l=t;a=a<2*e.length?a/2:e.length;for(var h=0;h<a;++h){var b=e.charCodeAt(h);c()[t>>>1>>>0]=b,t+=2}return c()[t>>>1>>>0]=0,t-l},F=e=>2*e.length,R=(e,t)=>{for(var a=0,l="";!(a>=t/4);){var h=d()[e+4*a>>>2>>>0];if(h==0)break;++a,65536<=h?(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023)):l+=String.fromCharCode(h)}return l},j=(e,t,a)=>{if(t>>>=0,a??=2147483647,4>a)return 0;var l=t;a=l+a-4;for(var h=0;h<e.length;++h){var b=e.charCodeAt(h);if(55296<=b&&57343>=b){var C=e.charCodeAt(++h);b=65536+((b&1023)<<10)|C&1023}if(d()[t>>>2>>>0]=b,t+=4,t+4>a)break}return d()[t>>>2>>>0]=0,t-l},W=e=>{for(var t=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);55296<=l&&57343>=l&&++a,t+=4}return t};function re(e){e>>>=0,typeof Atomics.Vb=="function"&&(Atomics.Vb(d(),e>>>2,e).value.then(ge),e+=128,Atomics.store(d(),e>>>2,1))}f.__emscripten_thread_mailbox_await=re;var ge=()=>{var e=yt();if(e&&(re(e),e=Nn,!ke))try{if(e(),!(0<tr))try{P?zt(ye):$r(ye)}catch(t){t instanceof Tr||t=="unwind"||L(1,t)}}catch(t){t instanceof Tr||t=="unwind"||L(1,t)}};f.checkMailbox=ge;var Ue=[],v=(e,t)=>{var a=H[e];if(a===void 0)throw e=Wn(e),a=ve(e),Xe(e),new Me(t+" has unknown type "+a);return a},V=(e,t,a)=>{var l=[];return e=e.toWireType(l,a),l.length&&(g()[t>>>2>>>0]=Pe(l)),e},Q=[],qe={},Dr=e=>{var t=qe[e];return t===void 0?ve(e):t},bn=()=>typeof globalThis=="object"?globalThis:Function("return this")(),uo=e=>{var t=Q.length;return Q.push(e),t},fo=(e,t)=>{for(var a=Array(e),l=0;l<e;++l)a[l]=v(g()[t+4*l>>>2>>>0],"parameter "+l);return a},vn=(e,t)=>Object.defineProperty(t,"name",{value:e});function lo(e){var t=Function;if(!(t instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof t} which is not a function`);var a=vn(t.name||"unknownFunctionName",function(){});return a.prototype=t.prototype,a=new a,e=t.apply(a,e),e instanceof Object?e:a}var Fr=e=>e%4===0&&(e%100!==0||e%400===0),On=[0,31,60,91,121,152,182,213,244,274,305,335],Tn=[0,31,59,90,120,151,181,212,243,273,304,334];function An(e,t,a,l,h,b,C){return P?K(16,1,e,t,a,l,h,b,C):-52}function _n(e,t,a,l,h,b){if(P)return K(17,1,e,t,a,l,h,b)}var En=e=>{var t=pr(e)+1,a=wt(t);return a&&Ye(e,a,t),a},$t=[],Nt={},Sn=()=>{if(!Ht){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:M||"./this.program"},t;for(t in Nt)Nt[t]===void 0?delete e[t]:e[t]=Nt[t];var a=[];for(t in e)a.push(`${t}=${e[t]}`);Ht=a}return Ht},Ht;function Cn(e,t){if(P)return K(18,1,e,t);e>>>=0,t>>>=0;var a=0;return Sn().forEach((l,h)=>{var b=t+a;for(h=g()[e+4*h>>>2>>>0]=b,b=0;b<l.length;++b)s()[h++>>>0>>>0]=l.charCodeAt(b);s()[h>>>0>>>0]=0,a+=l.length+1}),0}function Mn(e,t){if(P)return K(19,1,e,t);e>>>=0,t>>>=0;var a=Sn();g()[e>>>2>>>0]=a.length;var l=0;return a.forEach(h=>l+=h.length+1),g()[t>>>2>>>0]=l,0}function Pn(e){return P?K(20,1,e):52}function Un(e,t,a,l){return P?K(21,1,e,t,a,l):52}function Dn(e,t,a,l){return P?K(22,1,e,t,a,l):70}var co=[null,[],[]];function Fn(e,t,a,l){if(P)return K(23,1,e,t,a,l);t>>>=0,a>>>=0,l>>>=0;for(var h=0,b=0;b<a;b++){var C=g()[t>>>2>>>0],D=g()[t+4>>>2>>>0];t+=8;for(var z=0;z<D;z++){var x=m()[C+z>>>0],ae=co[e];x===0||x===10?((e===1?sr:ne)(Ar(ae,0)),ae.length=0):ae.push(x)}h+=D}return g()[l>>>2>>>0]=h,0}var In=[31,29,31,30,31,30,31,31,30,31,30,31],Rn=[31,28,31,30,31,30,31,31,30,31,30,31];function po(e){var t=Array(pr(e)+1);return dt(e,t,0,t.length),t}var mo=(e,t)=>{s().set(e,t>>>0)};function xn(e,t,a,l){function h(O,Z,oe){for(O=typeof O=="number"?O.toString():O||"";O.length<Z;)O=oe[0]+O;return O}function b(O,Z){return h(O,Z,"0")}function C(O,Z){function oe(zn){return 0>zn?-1:0<zn?1:0}var mr;return(mr=oe(O.getFullYear()-Z.getFullYear()))===0&&(mr=oe(O.getMonth()-Z.getMonth()))===0&&(mr=oe(O.getDate()-Z.getDate())),mr}function D(O){switch(O.getDay()){case 0:return new Date(O.getFullYear()-1,11,29);case 1:return O;case 2:return new Date(O.getFullYear(),0,3);case 3:return new Date(O.getFullYear(),0,2);case 4:return new Date(O.getFullYear(),0,1);case 5:return new Date(O.getFullYear()-1,11,31);case 6:return new Date(O.getFullYear()-1,11,30)}}function z(O){var Z=O.qb;for(O=new Date(new Date(O.rb+1900,0,1).getTime());0<Z;){var oe=O.getMonth(),mr=(Fr(O.getFullYear())?In:Rn)[oe];if(Z>mr-O.getDate())Z-=mr-O.getDate()+1,O.setDate(1),11>oe?O.setMonth(oe+1):(O.setMonth(0),O.setFullYear(O.getFullYear()+1));else{O.setDate(O.getDate()+Z);break}}return oe=new Date(O.getFullYear()+1,0,4),Z=D(new Date(O.getFullYear(),0,4)),oe=D(oe),0>=C(Z,O)?0>=C(oe,O)?O.getFullYear()+1:O.getFullYear():O.getFullYear()-1}e>>>=0,t>>>=0,a>>>=0,l>>>=0;var x=g()[l+40>>>2>>>0];l={Sb:d()[l>>>2>>>0],Rb:d()[l+4>>>2>>>0],ub:d()[l+8>>>2>>>0],zb:d()[l+12>>>2>>>0],vb:d()[l+16>>>2>>>0],rb:d()[l+20>>>2>>>0],lb:d()[l+24>>>2>>>0],qb:d()[l+28>>>2>>>0],Yb:d()[l+32>>>2>>>0],Qb:d()[l+36>>>2>>>0],Tb:x?de(x):""},a=de(a),x={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ae in x)a=a.replace(new RegExp(ae,"g"),x[ae]);var De="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Je="January February March April May June July August September October November December".split(" ");x={"%a":O=>De[O.lb].substring(0,3),"%A":O=>De[O.lb],"%b":O=>Je[O.vb].substring(0,3),"%B":O=>Je[O.vb],"%C":O=>b((O.rb+1900)/100|0,2),"%d":O=>b(O.zb,2),"%e":O=>h(O.zb,2," "),"%g":O=>z(O).toString().substring(2),"%G":O=>z(O),"%H":O=>b(O.ub,2),"%I":O=>(O=O.ub,O==0?O=12:12<O&&(O-=12),b(O,2)),"%j":O=>{for(var Z=0,oe=0;oe<=O.vb-1;Z+=(Fr(O.rb+1900)?In:Rn)[oe++]);return b(O.zb+Z,3)},"%m":O=>b(O.vb+1,2),"%M":O=>b(O.Rb,2),"%n":()=>`
`,"%p":O=>0<=O.ub&&12>O.ub?"AM":"PM","%S":O=>b(O.Sb,2),"%t":()=>"	","%u":O=>O.lb||7,"%U":O=>b(Math.floor((O.qb+7-O.lb)/7),2),"%V":O=>{var Z=Math.floor((O.qb+7-(O.lb+6)%7)/7);if(2>=(O.lb+371-O.qb-2)%7&&Z++,Z)Z==53&&(oe=(O.lb+371-O.qb)%7,oe==4||oe==3&&Fr(O.rb)||(Z=1));else{Z=52;var oe=(O.lb+7-O.qb-1)%7;(oe==4||oe==5&&Fr(O.rb%400-1))&&Z++}return b(Z,2)},"%w":O=>O.lb,"%W":O=>b(Math.floor((O.qb+7-(O.lb+6)%7)/7),2),"%y":O=>(O.rb+1900).toString().substring(2),"%Y":O=>O.rb+1900,"%z":O=>{O=O.Qb;var Z=0<=O;return O=Math.abs(O)/60,(Z?"+":"-")+("0000"+(O/60*100+O%60)).slice(-4)},"%Z":O=>O.Tb,"%%":()=>"%"},a=a.replace(/%%/g,"\0\0");for(ae in x)a.includes(ae)&&(a=a.replace(new RegExp(ae,"g"),x[ae](l)));return a=a.replace(/\0\0/g,"%"),ae=po(a),ae.length>t?0:(mo(ae,e),ae.length-1)}$.wb();for(var Bn=Array(256),gt=0;256>gt;++gt)Bn[gt]=String.fromCharCode(gt);Xr=Bn,Me=f.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},f.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(Kr.prototype,{get(e){return this.mb[e]},has(e){return this.mb[e]!==void 0},xb(e){var t=this.Ab.pop()||this.mb.length;return this.mb[t]=e,t},yb(e){this.mb[e]=void 0,this.Ab.push(e)}}),Te.mb.push({value:void 0},{value:null},{value:!0},{value:!1}),Te.tb=Te.mb.length,f.count_emval_handles=()=>{for(var e=0,t=Te.tb;t<Te.mb.length;++t)Te.mb[t]!==void 0&&++e;return e};var ho=[ot,ut,Cr,lt,ct,Hr,jr,zr,Mr,Pr,Gr,Ur,pt,Yr,Vr,mt,An,_n,Cn,Mn,Pn,Un,Dn,Fn],go={b:function(e,t,a){throw e>>>=0,new ft(e).wb(t>>>0,a>>>0),dr=e,Lt++,dr},da:function(e){Ln(e>>>0,!q,1,!N,131072,!1),$.Fb()},D:function(e){e>>>=0,P?postMessage({cmd:"cleanupThread",thread:e}):$.Db($.kb[e])},V:Nr,x:lt,ka:ct,R:Hr,T:jr,K:zr,ia:Mr,aa:Pr,ga:Gr,F:Ur,S:pt,P:Yr,ja:Vr,Q:mt,I:function(e,t,a,l,h){e>>>=0,t>>>=0,a>>>=0,t=ve(t);var b=t.indexOf("u")!=-1;b&&(h=(1n<<64n)-1n),xe(e,{name:t,fromWireType:C=>C,toWireType:function(C,D){if(typeof D!="bigint"&&typeof D!="number")throw new TypeError(`Cannot convert "${qr(D)}" to ${this.name}`);if(D<l||D>h)throw new TypeError(`Passing a number "${qr(D)}" from JS side to C/C++ side to an argument of type "${t}", which is outside the valid range [${l}, ${h}]!`);return D},argPackAdvance:8,readValueFromPointer:Zr(t,a,!b),sb:null})},pa:function(e,t,a,l){e>>>=0,t=ve(t>>>0),xe(e,{name:t,fromWireType:function(h){return!!h},toWireType:function(h,b){return b?a:l},argPackAdvance:8,readValueFromPointer:function(h){return this.fromWireType(m()[h>>>0])},sb:null})},oa:function(e,t){e>>>=0,t=ve(t>>>0),xe(e,{name:t,fromWireType:a=>{var l=he(a);return Qr(a),l},toWireType:(a,l)=>Pe(l),argPackAdvance:8,readValueFromPointer:r,sb:null})},H:function(e,t,a){e>>>=0,a>>>=0,t=ve(t>>>0),xe(e,{name:t,fromWireType:l=>l,toWireType:(l,h)=>h,argPackAdvance:8,readValueFromPointer:n(t,a),sb:null})},u:function(e,t,a,l,h){if(e>>>=0,a>>>=0,t=ve(t>>>0),h===-1&&(h=4294967295),h=D=>D,l===0){var b=32-8*a;h=D=>D<<b>>>b}var C=t.includes("unsigned")?function(D,z){return z>>>0}:function(D,z){return z};xe(e,{name:t,fromWireType:h,toWireType:C,argPackAdvance:8,readValueFromPointer:Zr(t,a,l!==0),sb:null})},n:function(e,t,a){function l(b){var C=g()[b>>>2>>>0];return b=g()[b+4>>>2>>>0],new h(s().buffer,b,C)}e>>>=0;var h=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][t];a=ve(a>>>0),xe(e,{name:a,fromWireType:l,argPackAdvance:8,readValueFromPointer:l},{Kb:!0})},J:function(e,t){e>>>=0,t=ve(t>>>0);var a=t==="std::string";xe(e,{name:t,fromWireType:function(l){var h=g()[l>>>2>>>0],b=l+4;if(a)for(var C=b,D=0;D<=h;++D){var z=b+D;if(D==h||m()[z>>>0]==0){if(C=de(C,z-C),x===void 0)var x=C;else x+=String.fromCharCode(0),x+=C;C=z+1}}else{for(x=Array(h),D=0;D<h;++D)x[D]=String.fromCharCode(m()[b+D>>>0]);x=x.join("")}return Xe(l),x},toWireType:function(l,h){h instanceof ArrayBuffer&&(h=new Uint8Array(h));var b=typeof h=="string";if(!(b||h instanceof Uint8Array||h instanceof Uint8ClampedArray||h instanceof Int8Array))throw new Me("Cannot pass non-string to std::string");var C=a&&b?pr(h):h.length,D=wt(4+C+1),z=D+4;if(g()[D>>>2>>>0]=C,a&&b)Ye(h,z,C+1);else if(b)for(b=0;b<C;++b){var x=h.charCodeAt(b);if(255<x)throw Xe(z),new Me("String has UTF-16 code units that do not fit in 8 bits");m()[z+b>>>0]=x}else for(b=0;b<C;++b)m()[z+b>>>0]=h[b];return l!==null&&l.push(Xe,D),D},argPackAdvance:8,readValueFromPointer:u,sb(l){Xe(l)}})},z:function(e,t,a){if(e>>>=0,t>>>=0,a>>>=0,a=ve(a),t===2)var l=w,h=E,b=F,C=()=>y(),D=1;else t===4&&(l=R,h=j,b=W,C=()=>g(),D=2);xe(e,{name:a,fromWireType:z=>{for(var x=g()[z>>>2>>>0],ae=C(),De,Je=z+4,O=0;O<=x;++O){var Z=z+4+O*t;(O==x||ae[Z>>>D]==0)&&(Je=l(Je,Z-Je),De===void 0?De=Je:(De+=String.fromCharCode(0),De+=Je),Je=Z+t)}return Xe(z),De},toWireType:(z,x)=>{if(typeof x!="string")throw new Me(`Cannot pass non-string to C++ string type ${a}`);var ae=b(x),De=wt(4+ae+t);return g()[De>>>2]=ae>>D,h(x,De+4,ae+t),z!==null&&z.push(Xe,De),De},argPackAdvance:8,readValueFromPointer:r,sb(z){Xe(z)}})},qa:function(e,t){e>>>=0,t=ve(t>>>0),xe(e,{Lb:!0,name:t,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>1,N:function(e,t){e>>>=0,e==t>>>0?setTimeout(()=>ge()):P?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=$.kb[e])&&e.postMessage({cmd:"checkMailbox"})},W:function(e,t,a,l){t>>>=0,a/=2,Ue.length=a,l=l>>>0>>>3;for(var h=0;h<a;h++)Ue[h]=Se[l+2*h]?Se[l+2*h+1]:T()[l+2*h+1>>>0];return e=0>e?$e[-e-1]:ho[e],$.Jb=t,t=e.apply(null,Ue),$.Jb=0,t},ca:re,ma:function(e){I&&$.kb[e>>>0].ref()},s:function(e,t,a){return t>>>=0,a>>>=0,e=he(e>>>0),t=v(t,"emval::as"),V(t,a,e)},o:function(e,t,a,l){return a>>>=0,l>>>=0,e=Q[e>>>0],t=he(t>>>0),e(null,t,a,l)},j:function(e,t,a,l,h){return a>>>=0,l>>>=0,h>>>=0,e=Q[e>>>0],t=he(t>>>0),a=Dr(a),e(t,t[a],l,h)},c:Qr,A:function(e,t){return t>>>=0,e=he(e>>>0),t=he(t),e==t},m:function(e){return e>>>=0,e===0?Pe(bn()):(e=Dr(e),Pe(bn()[e]))},i:function(e,t,a){t=fo(e,t>>>0);var l=t.shift();e--;var h=`return function (obj, func, destructorsRef, args) {
