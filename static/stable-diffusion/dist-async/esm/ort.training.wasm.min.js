 ...
 */
var Fr=Object.defineProperty;var Fo=Object.getOwnPropertyDescriptor;var ko=Object.getOwnPropertyNames;var Lo=Object.prototype.hasOwnProperty;var G=(a,n)=>()=>(a&&(n=a(a=0)),n);var dt=(a,n)=>()=>(n||a((n={exports:{}}).exports,n),n.exports),It=(a,n)=>{for(var r in n)Fr(a,r,{get:n[r],enumerable:!0})},Ho=(a,n,r,l)=>{if(n&&typeof n=="object"||typeof n=="function")for(let u of ko(n))!Lo.call(a,u)&&u!==r&&Fr(a,u,{get:()=>n[u],enumerable:!(l=Fo(n,u))||l.enumerable});return a};var pt=a=>Ho(Fr({},"__esModule",{value:!0}),a);var Qt,Ze,xt,er,tr=G(()=>{"use strict";Qt=new Map,Ze=[],xt=(a,n,r)=>{if(n&&typeof n.init=="function"&&typeof n.createInferenceSessionHandler=="function"){let l=Qt.get(a);if(l===void 0)Qt.set(a,{backend:n,priority:r});else{if(l.priority>r)return;if(l.priority===r&&l.backend!==n)throw new Error(`cannot register backend "${a}" using priority ${r}`)}if(r>=0){let u=Ze.indexOf(a);u!==-1&&Ze.splice(u,1);for(let m=0;m<Ze.length;m++)if(Qt.get(Ze[m]).priority<=r){Ze.splice(m,0,a);return}Ze.push(a)}return}throw new TypeError("not a valid backend")},er=async a=>{let n=a.length===0?Ze:a,r=[];for(let l of n){let u=Qt.get(l);if(u){if(u.initialized)return u.backend;if(u.aborted)continue;let m=!!u.initPromise;try{return m||(u.initPromise=u.backend.init(l)),await u.initPromise,u.initialized=!0,u.backend}catch(f){m||r.push({name:l,err:f}),u.aborted=!0}finally{delete u.initPromise}}}throw new Error(`no available backend found. ERR: ${r.map(l=>`[${l.name}] ${l.err}`).join(", ")}`)}});var Jn=G(()=>{"use strict";tr()});var Xn,Kn=G(()=>{"use strict";Xn="1.17.0"});var Zn,Qe,kr=G(()=>{"use strict";Kn();Zn="warning",Qe={wasm:{},webgl:{},webgpu:{},versions:{common:Xn},set logLevel(a){if(a!==void 0){if(typeof a!="string"||["verbose","info","warning","error","fatal"].indexOf(a)===-1)throw new Error(`Unsupported logging level: ${a}`);Zn=a}},get logLevel(){return Zn}};Object.defineProperty(Qe,"logLevel",{enumerable:!0})});var Z,Qn=G(()=>{"use strict";kr();Z=Qe});var ea,ta,ra=G(()=>{"use strict";ea=(a,n)=>{let r=typeof document<"u"?document.createElement("canvas"):new OffscreenCanvas(1,1);r.width=a.dims[3],r.height=a.dims[2];let l=r.getContext("2d");if(l!=null){let u,m;n?.tensorLayout!==void 0&&n.tensorLayout==="NHWC"?(u=a.dims[2],m=a.dims[3]):(u=a.dims[3],m=a.dims[2]);let f=n?.format!==void 0?n.format:"RGB",p=n?.norm,b,s;p===void 0||p.mean===void 0?b=[255,255,255,255]:typeof p.mean=="number"?b=[p.mean,p.mean,p.mean,p.mean]:(b=[p.mean[0],p.mean[1],p.mean[2],0],p.mean[3]!==void 0&&(b[3]=p.mean[3])),p===void 0||p.bias===void 0?s=[0,0,0,0]:typeof p.bias=="number"?s=[p.bias,p.bias,p.bias,p.bias]:(s=[p.bias[0],p.bias[1],p.bias[2],0],p.bias[3]!==void 0&&(s[3]=p.bias[3]));let y=m*u,E=0,O=y,A=y*2,I=-1;f==="RGBA"?(E=0,O=y,A=y*2,I=y*3):f==="RGB"?(E=0,O=y,A=y*2):f==="RBG"&&(E=0,A=y,O=y*2);for(let P=0;P<m;P++)for(let H=0;H<u;H++){let U=(a.data[E++]-s[0])*b[0],C=(a.data[O++]-s[1])*b[1],W=(a.data[A++]-s[2])*b[2],j=I===-1?255:(a.data[I++]-s[3])*b[3];l.fillStyle="rgba("+U+","+C+","+W+","+j+")",l.fillRect(H,P,1,1)}if("toDataURL"in r)return r.toDataURL();throw new Error("toDataURL is not supported")}else throw new Error("Can not access image data")},ta=(a,n)=>{let r=typeof document<"u"?document.createElement("canvas").getContext("2d"):new OffscreenCanvas(1,1).getContext("2d"),l;if(r!=null){let u,m,f;n?.tensorLayout!==void 0&&n.tensorLayout==="NHWC"?(u=a.dims[2],m=a.dims[1],f=a.dims[3]):(u=a.dims[3],m=a.dims[2],f=a.dims[1]);let p=n!==void 0&&n.format!==void 0?n.format:"RGB",b=n?.norm,s,y;b===void 0||b.mean===void 0?s=[255,255,255,255]:typeof b.mean=="number"?s=[b.mean,b.mean,b.mean,b.mean]:(s=[b.mean[0],b.mean[1],b.mean[2],255],b.mean[3]!==void 0&&(s[3]=b.mean[3])),b===void 0||b.bias===void 0?y=[0,0,0,0]:typeof b.bias=="number"?y=[b.bias,b.bias,b.bias,b.bias]:(y=[b.bias[0],b.bias[1],b.bias[2],0],b.bias[3]!==void 0&&(y[3]=b.bias[3]));let E=m*u;if(n!==void 0&&(n.format!==void 0&&f===4&&n.format!=="RGBA"||f===3&&n.format!=="RGB"&&n.format!=="BGR"))throw new Error("Tensor format doesn't match input tensor dims");let O=4,A=0,I=1,P=2,H=3,U=0,C=E,W=E*2,j=-1;p==="RGBA"?(U=0,C=E,W=E*2,j=E*3):p==="RGB"?(U=0,C=E,W=E*2):p==="RBG"&&(U=0,W=E,C=E*2),l=r.createImageData(u,m);for(let X=0;X<m*u;A+=O,I+=O,P+=O,H+=O,X++)l.data[A]=(a.data[U++]-y[0])*s[0],l.data[I]=(a.data[C++]-y[1])*s[1],l.data[P]=(a.data[W++]-y[2])*s[2],l.data[H]=j===-1?255:(a.data[j++]-y[3])*s[3]}else throw new Error("Can not access image data");return l}});var Lr,na,aa,oa,ia,sa=G(()=>{"use strict";rr();Lr=(a,n)=>{if(a===void 0)throw new Error("Image buffer must be defined");if(n.height===void 0||n.width===void 0)throw new Error("Image height and width must be defined");if(n.tensorLayout==="NHWC")throw new Error("NHWC Tensor layout is not supported yet");let{height:r,width:l}=n,u=n.norm??{mean:255,bias:0},m,f;typeof u.mean=="number"?m=[u.mean,u.mean,u.mean,u.mean]:m=[u.mean[0],u.mean[1],u.mean[2],u.mean[3]??255],typeof u.bias=="number"?f=[u.bias,u.bias,u.bias,u.bias]:f=[u.bias[0],u.bias[1],u.bias[2],u.bias[3]??0];let p=n.format!==void 0?n.format:"RGBA",b=n.tensorFormat!==void 0&&n.tensorFormat!==void 0?n.tensorFormat:"RGB",s=r*l,y=b==="RGBA"?new Float32Array(s*4):new Float32Array(s*3),E=4,O=0,A=1,I=2,P=3,H=0,U=s,C=s*2,W=-1;p==="RGB"&&(E=3,O=0,A=1,I=2,P=-1),b==="RGBA"?W=s*3:b==="RBG"?(H=0,C=s,U=s*2):b==="BGR"&&(C=0,U=s,H=s*2);for(let X=0;X<s;X++,O+=E,I+=E,A+=E,P+=E)y[H++]=(a[O]+f[0])/m[0],y[U++]=(a[A]+f[1])/m[1],y[C++]=(a[I]+f[2])/m[2],W!==-1&&P!==-1&&(y[W++]=(a[P]+f[3])/m[3]);return b==="RGBA"?new ye("float32",y,[1,4,r,l]):new ye("float32",y,[1,3,r,l])},na=async(a,n)=>{let r=typeof HTMLImageElement<"u"&&a instanceof HTMLImageElement,l=typeof ImageData<"u"&&a instanceof ImageData,u=typeof ImageBitmap<"u"&&a instanceof ImageBitmap,m=typeof a=="string",f,p=n??{},b=()=>{if(typeof document<"u")return document.createElement("canvas");if(typeof OffscreenCanvas<"u")return new OffscreenCanvas(1,1);throw new Error("Canvas is not supported")},s=y=>y instanceof HTMLCanvasElement||y instanceof OffscreenCanvas?y.getContext("2d"):null;if(r){let y=b();y.width=a.width,y.height=a.height;let E=s(y);if(E!=null){let O=a.height,A=a.width;if(n!==void 0&&n.resizedHeight!==void 0&&n.resizedWidth!==void 0&&(O=n.resizedHeight,A=n.resizedWidth),n!==void 0){if(p=n,n.tensorFormat!==void 0)throw new Error("Image input config format must be RGBA for HTMLImageElement");p.tensorFormat="RGBA",p.height=O,p.width=A}else p.tensorFormat="RGBA",p.height=O,p.width=A;E.drawImage(a,0,0),f=E.getImageData(0,0,A,O).data}else throw new Error("Can not access image data")}else if(l){let y,E;if(n!==void 0&&n.resizedWidth!==void 0&&n.resizedHeight!==void 0?(y=n.resizedHeight,E=n.resizedWidth):(y=a.height,E=a.width),n!==void 0&&(p=n),p.format="RGBA",p.height=y,p.width=E,n!==void 0){let O=b();O.width=E,O.height=y;let A=s(O);if(A!=null)A.putImageData(a,0,0),f=A.getImageData(0,0,E,y).data;else throw new Error("Can not access image data")}else f=a.data}else if(u){if(n===void 0)throw new Error("Please provide image config with format for Imagebitmap");let y=b();y.width=a.width,y.height=a.height;let E=s(y);if(E!=null){let O=a.height,A=a.width;return E.drawImage(a,0,0,A,O),f=E.getImageData(0,0,A,O).data,p.height=O,p.width=A,Lr(f,p)}else throw new Error("Can not access image data")}else{if(m)return new Promise((y,E)=>{let O=b(),A=s(O);if(!a||!A)return E();let I=new Image;I.crossOrigin="Anonymous",I.src=a,I.onload=()=>{O.width=I.width,O.height=I.height,A.drawImage(I,0,0,O.width,O.height);let P=A.getImageData(0,0,O.width,O.height);p.height=O.height,p.width=O.width,y(Lr(P.data,p))}});throw new Error("Input data provided is not supported - aborted tensor creation")}if(f!==void 0)return Lr(f,p);throw new Error("Input data provided is not supported - aborted tensor creation")},aa=(a,n)=>{let{width:r,height:l,download:u,dispose:m}=n,f=[1,l,r,4];return new ye({location:"texture",type:"float32",texture:a,dims:f,download:u,dispose:m})},oa=(a,n)=>{let{dataType:r,dims:l,download:u,dispose:m}=n;return new ye({location:"gpu-buffer",type:r??"float32",gpuBuffer:a,dims:l,download:u,dispose:m})},ia=(a,n,r)=>new ye({location:"cpu-pinned",type:a,data:n,dims:r??[n.length]})});var Ut,nr,ua,fa,la=G(()=>{"use strict";Ut=new Map([["float32",Float32Array],["uint8",Uint8Array],["int8",Int8Array],["uint16",Uint16Array],["float16",Uint16Array],["int16",Int16Array],["int32",Int32Array],["bool",Uint8Array],["float64",Float64Array],["uint32",Uint32Array]]),nr=new Map([[Float32Array,"float32"],[Uint8Array,"uint8"],[Int8Array,"int8"],[Uint16Array,"uint16"],[Int16Array,"int16"],[Int32Array,"int32"],[Float64Array,"float64"],[Uint32Array,"uint32"]]),ua=!1,fa=()=>{if(!ua){ua=!0;let a=typeof BigInt64Array<"u"&&typeof BigInt64Array.from=="function",n=typeof BigUint64Array<"u"&&typeof BigUint64Array.from=="function";a&&(Ut.set("int64",BigInt64Array),nr.set(BigInt64Array,"int64")),n&&(Ut.set("uint64",BigUint64Array),nr.set(BigUint64Array,"uint64"))}}});var ca,da,pa=G(()=>{"use strict";rr();ca=a=>{let n=1;for(let r=0;r<a.length;r++){let l=a[r];if(typeof l!="number"||!Number.isSafeInteger(l))throw new TypeError(`dims[${r}] must be an integer, got: ${l}`);if(l<0)throw new RangeError(`dims[${r}] must be a non-negative integer, got: ${l}`);n*=l}return n},da=(a,n)=>{switch(a.location){case"cpu":return new ye(a.type,a.data,n);case"cpu-pinned":return new ye({location:"cpu-pinned",data:a.data,type:a.type,dims:n});case"texture":return new ye({location:"texture",texture:a.texture,type:a.type,dims:n});case"gpu-buffer":return new ye({location:"gpu-buffer",gpuBuffer:a.gpuBuffer,type:a.type,dims:n});default:throw new Error(`tensorReshape: tensor location ${a.location} is not supported`)}}});var ye,rr=G(()=>{"use strict";ra();sa();la();pa();ye=class{constructor(n,r,l){fa();let u,m;if(typeof n=="object"&&"location"in n)switch(this.dataLocation=n.location,u=n.type,m=n.dims,n.location){case"cpu-pinned":{let p=Ut.get(u);if(!p)throw new TypeError(`unsupported type "${u}" to create tensor from pinned buffer`);if(!(n.data instanceof p))throw new TypeError(`buffer should be of type ${p.name}`);this.cpuData=n.data;break}case"texture":{if(u!=="float32")throw new TypeError(`unsupported type "${u}" to create tensor from texture`);this.gpuTextureData=n.texture,this.downloader=n.download,this.disposer=n.dispose;break}case"gpu-buffer":{if(u!=="float32"&&u!=="float16"&&u!=="int32"&&u!=="int64"&&u!=="uint32"&&u!=="bool")throw new TypeError(`unsupported type "${u}" to create tensor from gpu buffer`);this.gpuBufferData=n.gpuBuffer,this.downloader=n.download,this.disposer=n.dispose;break}default:throw new Error(`Tensor constructor: unsupported location '${this.dataLocation}'`)}else{let p,b;if(typeof n=="string")if(u=n,b=l,n==="string"){if(!Array.isArray(r))throw new TypeError("A string tensor's data must be a string array.");p=r}else{let s=Ut.get(n);if(s===void 0)throw new TypeError(`Unsupported tensor type: ${n}.`);if(Array.isArray(r)){if(n==="float16")throw new TypeError("Creating a float16 tensor from number array is not supported. Please use Uint16Array as data.");n==="uint64"||n==="int64"?p=s.from(r,BigInt):p=s.from(r)}else if(r instanceof s)p=r;else throw new TypeError(`A ${u} tensor's data must be type of ${s}`)}else if(b=r,Array.isArray(n)){if(n.length===0)throw new TypeError("Tensor type cannot be inferred from an empty array.");let s=typeof n[0];if(s==="string")u="string",p=n;else if(s==="boolean")u="bool",p=Uint8Array.from(n);else throw new TypeError(`Invalid element type of data array: ${s}.`)}else{let s=nr.get(n.constructor);if(s===void 0)throw new TypeError(`Unsupported type for tensor data: ${n.constructor}.`);u=s,p=n}if(b===void 0)b=[p.length];else if(!Array.isArray(b))throw new TypeError("A tensor's dims must be a number array");m=b,this.cpuData=p,this.dataLocation="cpu"}let f=ca(m);if(this.cpuData&&f!==this.cpuData.length)throw new Error(`Tensor's size(${f}) does not match data length(${this.cpuData.length}).`);this.type=u,this.dims=m,this.size=f}static async fromImage(n,r){return na(n,r)}static fromTexture(n,r){return aa(n,r)}static fromGpuBuffer(n,r){return oa(n,r)}static fromPinnedBuffer(n,r,l){return ia(n,r,l)}toDataURL(n){return ea(this,n)}toImageData(n){return ta(this,n)}get data(){if(this.ensureValid(),!this.cpuData)throw new Error("The data is not on CPU. Use `getData()` to download GPU data to CPU, or use `texture` or `gpuBuffer` property to access the GPU data directly.");return this.cpuData}get location(){return this.dataLocation}get texture(){if(this.ensureValid(),!this.gpuTextureData)throw new Error("The data is not stored as a WebGL texture.");return this.gpuTextureData}get gpuBuffer(){if(this.ensureValid(),!this.gpuBufferData)throw new Error("The data is not stored as a WebGPU buffer.");return this.gpuBufferData}async getData(n){switch(this.ensureValid(),this.dataLocation){case"cpu":case"cpu-pinned":return this.data;case"texture":case"gpu-buffer":{if(!this.downloader)throw new Error("The current tensor is not created with a specified data downloader.");if(this.isDownloading)throw new Error("The current tensor is being downloaded.");try{this.isDownloading=!0;let r=await this.downloader();return this.downloader=void 0,this.dataLocation="cpu",this.cpuData=r,n&&this.disposer&&(this.disposer(),this.disposer=void 0),r}finally{this.isDownloading=!1}}default:throw new Error(`cannot get data from location: ${this.dataLocation}`)}}dispose(){if(this.isDownloading)throw new Error("The current tensor is being downloaded.");this.disposer&&(this.disposer(),this.disposer=void 0),this.cpuData=void 0,this.gpuTextureData=void 0,this.gpuBufferData=void 0,this.downloader=void 0,this.isDownloading=void 0,this.dataLocation="none"}ensureValid(){if(this.dataLocation==="none")throw new Error("The tensor is disposed.")}reshape(n){if(this.ensureValid(),this.downloader||this.disposer)throw new Error("Cannot reshape a tensor that owns GPU resource.");return da(this,n)}}});var he,ar=G(()=>{"use strict";rr();he=ye});var ma,ha,et,tt,Hr=G(()=>{"use strict";kr();ma=(a,n)=>{Qe.wasm.trace&&console.timeStamp(`${a}::ORT::${n}`)},ha=(a,n)=>{let r=new Error().stack?.split(/\r\n|\r|\n/g)||[],l=!1;for(let u=0;u<r.length;u++){if(l&&!r[u].includes("TRACE_FUNC")){let m=`FUNC_${a}::${r[u].trim().split(" ")[1]}`;n&&(m+=`::${n}`),ma("CPU",m);return}r[u].includes("TRACE_FUNC")&&(l=!0)}},et=a=>{Qe.wasm.trace&&ha("BEGIN",a)},tt=a=>{Qe.wasm.trace&&ha("END",a)}});var or,ga=G(()=>{"use strict";tr();ar();Hr();or=class a{constructor(n){this.handler=n}async run(n,r,l){et();let u={},m={};if(typeof n!="object"||n===null||n instanceof he||Array.isArray(n))throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");let f=!0;if(typeof r=="object"){if(r===null)throw new TypeError("Unexpected argument[1]: cannot be null.");if(r instanceof he)throw new TypeError("'fetches' cannot be a Tensor");if(Array.isArray(r)){if(r.length===0)throw new TypeError("'fetches' cannot be an empty array.");f=!1;for(let s of r){if(typeof s!="string")throw new TypeError("'fetches' must be a string array or an object.");if(this.outputNames.indexOf(s)===-1)throw new RangeError(`'fetches' contains invalid output name: ${s}.`);u[s]=null}if(typeof l=="object"&&l!==null)m=l;else if(typeof l<"u")throw new TypeError("'options' must be an object.")}else{let s=!1,y=Object.getOwnPropertyNames(r);for(let E of this.outputNames)if(y.indexOf(E)!==-1){let O=r[E];(O===null||O instanceof he)&&(s=!0,f=!1,u[E]=O)}if(s){if(typeof l=="object"&&l!==null)m=l;else if(typeof l<"u")throw new TypeError("'options' must be an object.")}else m=r}}else if(typeof r<"u")throw new TypeError("Unexpected argument[1]: must be 'fetches' or 'options'.");for(let s of this.inputNames)if(typeof n[s]>"u")throw new Error(`input '${s}' is missing in 'feeds'.`);if(f)for(let s of this.outputNames)u[s]=null;let p=await this.handler.run(n,u,m),b={};for(let s in p)if(Object.hasOwnProperty.call(p,s)){let y=p[s];y instanceof he?b[s]=y:b[s]=new he(y.type,y.data,y.dims)}return tt(),b}async release(){return this.handler.dispose()}static async create(n,r,l,u){et();let m,f={};if(typeof n=="string"){if(m=n,typeof r=="object"&&r!==null)f=r;else if(typeof r<"u")throw new TypeError("'options' must be an object.")}else if(n instanceof Uint8Array){if(m=n,typeof r=="object"&&r!==null)f=r;else if(typeof r<"u")throw new TypeError("'options' must be an object.")}else if(n instanceof ArrayBuffer||typeof SharedArrayBuffer<"u"&&n instanceof SharedArrayBuffer){let E=n,O=0,A=n.byteLength;if(typeof r=="object"&&r!==null)f=r;else if(typeof r=="number"){if(O=r,!Number.isSafeInteger(O))throw new RangeError("'byteOffset' must be an integer.");if(O<0||O>=E.byteLength)throw new RangeError(`'byteOffset' is out of range [0, ${E.byteLength}).`);if(A=n.byteLength-O,typeof l=="number"){if(A=l,!Number.isSafeInteger(A))throw new RangeError("'byteLength' must be an integer.");if(A<=0||O+A>E.byteLength)throw new RangeError(`'byteLength' is out of range (0, ${E.byteLength-O}].`);if(typeof u=="object"&&u!==null)f=u;else if(typeof u<"u")throw new TypeError("'options' must be an object.")}else if(typeof l<"u")throw new TypeError("'byteLength' must be a number.")}else if(typeof r<"u")throw new TypeError("'options' must be an object.");m=new Uint8Array(E,O,A)}else throw new TypeError("Unexpected argument[0]: must be 'path' or 'buffer'.");let b=(f.executionProviders||[]).map(E=>typeof E=="string"?E:E.name),y=await(await er(b)).createInferenceSessionHandler(m,f);return tt(),new a(y)}startProfiling(){this.handler.startProfiling()}endProfiling(){this.handler.endProfiling()}get inputNames(){return this.handler.inputNames}get outputNames(){return this.handler.outputNames}}});var Wo,ya=G(()=>{"use strict";ga();Wo=or});var ba=G(()=>{"use strict"});var No,ir,wa=G(()=>{"use strict";tr();ar();No="Training backend could not be resolved. Make sure you're using the correct configuration & WebAssembly files.",ir=class a{constructor(n,r,l){this.handler=n,this.hasOptimizerModel=r,this.hasEvalModel=l}get trainingInputNames(){return this.handler.inputNames}get trainingOutputNames(){return this.handler.outputNames}get evalInputNames(){if(this.hasEvalModel)return this.handler.evalInputNames;throw new Error("This training session has no evalModel loaded.")}get evalOutputNames(){if(this.hasEvalModel)return this.handler.evalOutputNames;throw new Error("This training session has no evalModel loaded.")}static async create(n,r){let l=n.evalModel||"",u=n.optimizerModel||"",m=r||{},p=(m.executionProviders||[]).map(s=>typeof s=="string"?s:s.name),b=await er(p);if(b.createTrainingSessionHandler){let s=await b.createTrainingSessionHandler(n.checkpointState,n.trainModel,l,u,m);return new a(s,!!n.optimizerModel,!!n.evalModel)}else throw new Error(No)}typeNarrowingForRunStep(n,r,l,u,m){let f={},p={};if(typeof l!="object"||l===null||l instanceof he||Array.isArray(l))throw new TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");let b=!0;if(typeof u=="object"){if(u===null)throw new TypeError("Unexpected argument[1]: cannot be null.");if(u instanceof he)throw new TypeError("'fetches' cannot be a Tensor");if(Array.isArray(u)){if(u.length===0)throw new TypeError("'fetches' cannot be an empty array.");b=!1;for(let s of u){if(typeof s!="string")throw new TypeError("'fetches' must be a string array or an object.");if(r.indexOf(s)===-1)throw new RangeError(`'fetches' contains invalid output name: ${s}.`);f[s]=null}if(typeof m=="object"&&m!==null)p=m;else if(typeof m<"u")throw new TypeError("'options' must be an object.")}else{let s=!1,y=Object.getOwnPropertyNames(u);for(let E of r)if(y.indexOf(E)!==-1){let O=u[E];(O===null||O instanceof he)&&(s=!0,b=!1,f[E]=O)}if(s){if(typeof m=="object"&&m!==null)p=m;else if(typeof m<"u")throw new TypeError("'options' must be an object.")}else p=u}}else if(typeof u<"u")throw new TypeError("Unexpected argument[1]: must be 'fetches' or 'options'.");for(let s of n)if(typeof l[s]>"u")throw new Error(`input '${s}' is missing in 'feeds'.`);if(b)for(let s of r)f[s]=null;return[f,p]}convertHandlerReturnTypeToMapOfTensors(n){let r={};for(let l in n)if(Object.hasOwnProperty.call(n,l)){let u=n[l];u instanceof he?r[l]=u:r[l]=new he(u.type,u.data,u.dims)}return r}async lazyResetGrad(){await this.handler.lazyResetGrad()}async runTrainStep(n,r,l){let[u,m]=this.typeNarrowingForRunStep(this.trainingInputNames,this.trainingOutputNames,n,r,l),f=await this.handler.runTrainStep(n,u,m);return this.convertHandlerReturnTypeToMapOfTensors(f)}async runOptimizerStep(n){if(this.hasOptimizerModel)await this.handler.runOptimizerStep(n||{});else throw new Error("This TrainingSession has no OptimizerModel loaded.")}async runEvalStep(n,r,l){if(this.hasEvalModel){let[u,m]=this.typeNarrowingForRunStep(this.evalInputNames,this.evalOutputNames,n,r,l),f=await this.handler.runEvalStep(n,u,m);return this.convertHandlerReturnTypeToMapOfTensors(f)}else throw new Error("This TrainingSession has no EvalModel loaded.")}async getParametersSize(n=!0){return this.handler.getParametersSize(n)}async loadParametersBuffer(n,r=!0){let l=await this.getParametersSize(r);if(n.length!==4*l)throw new Error("Size of the buffer passed into loadParametersBuffer must match the number of parameters in the model. Please use getParametersSize method to check.");return this.handler.loadParametersBuffer(n,r)}async getContiguousParameters(n=!0){return this.handler.getContiguousParameters(n)}async release(){return this.handler.dispose()}}});var $o,va=G(()=>{"use strict";wa();$o=ir});var Wr={};It(Wr,{InferenceSession:()=>Wo,TRACE:()=>ma,TRACE_FUNC_BEGIN:()=>et,TRACE_FUNC_END:()=>tt,Tensor:()=>he,TrainingSession:()=>$o,env:()=>Z,registerBackend:()=>xt});var rt=G(()=>{"use strict";Jn();Qn();ya();ar();Hr();ba();va()});var Nr={};It(Nr,{createReadStream:()=>Ta,readFile:()=>zo,readFileSync:()=>Go});var zo,Go,Ta,$r=G(()=>{zo=void 0,Go=void 0,Ta=void 0});var zr={};It(zr,{join:()=>jo});var jo,Gr=G(()=>{jo=void 0});var Aa=dt((Ea,jr)=>{"use strict";var _a=(()=>{var a=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(a=a||__filename),function(n={}){var r=n,l,u;r.ready=new Promise((i,c)=>{l=i,u=c});var m=Object.assign({},r),f="./this.program",p=typeof window=="object",b=typeof importScripts=="function",s=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",y="",E,O,A;if(s){var I=($r(),pt(Nr)),P=(Gr(),pt(zr));y=b?P.dirname(y)+"/":__dirname+"/",E=(i,c)=>(i=oe(i)?new URL(i):P.normalize(i),I.readFileSync(i,c?void 0:"utf8")),A=i=>(i=E(i,!0),i.buffer||(i=new Uint8Array(i)),i),O=(i,c,h,v=!0)=>{i=oe(i)?new URL(i):P.normalize(i),I.readFile(i,v?void 0:"utf8",(M,D)=>{M?h(M):c(v?D.buffer:D)})},!r.thisProgram&&1<process.argv.length&&(f=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),r.inspect=()=>"[Emscripten Module object]"}else(p||b)&&(b?y=self.location.href:typeof document<"u"&&document.currentScript&&(y=document.currentScript.src),a&&(y=a),y.indexOf("blob:")!==0?y=y.substr(0,y.replace(/[?#].*/,"").lastIndexOf("/")+1):y="",E=i=>{var c=new XMLHttpRequest;return c.open("GET",i,!1),c.send(null),c.responseText},b&&(A=i=>{var c=new XMLHttpRequest;return c.open("GET",i,!1),c.responseType="arraybuffer",c.send(null),new Uint8Array(c.response)}),O=(i,c,h)=>{var v=new XMLHttpRequest;v.open("GET",i,!0),v.responseType="arraybuffer",v.onload=()=>{v.status==200||v.status==0&&v.response?c(v.response):h()},v.onerror=h,v.send(null)});var H=console.log.bind(console),U=console.error.bind(console);Object.assign(r,m),m=null,typeof WebAssembly!="object"&&Me("no native wasm support detected");var C,W=!1,j,X,x,q,fe;function Ne(){var i=C.buffer;r.HEAP8=j=new Int8Array(i),r.HEAP16=new Int16Array(i),r.HEAPU8=X=new Uint8Array(i),r.HEAPU16=new Uint16Array(i),r.HEAP32=x=new Int32Array(i),r.HEAPU32=q=new Uint32Array(i),r.HEAPF32=new Float32Array(i),r.HEAPF64=fe=new Float64Array(i)}var $e=[],ze=[],qe=[],ee=0,F=null,be=null;function Me(i){throw i="Aborted("+i+")",U(i),W=!0,i=new WebAssembly.RuntimeError(i+". Build with -sASSERTIONS for more info."),u(i),i}var le=i=>i.startsWith("data:application/octet-stream;base64,"),oe=i=>i.startsWith("file://"),ne;if(ne="ort-training-wasm-simd.wasm",!le(ne)){var ge=ne;ne=r.locateFile?r.locateFile(ge,y):y+ge}function it(i){if(A)return A(i);throw"both async and sync fetching of the wasm failed"}function De(i){if(p||b){if(typeof fetch=="function"&&!oe(i))return fetch(i,{credentials:"same-origin"}).then(c=>{if(!c.ok)throw"failed to load wasm binary file at '"+i+"'";return c.arrayBuffer()}).catch(()=>it(i));if(O)return new Promise((c,h)=>{O(i,v=>c(new Uint8Array(v)),h)})}return Promise.resolve().then(()=>it(i))}function Ge(i,c,h){return De(i).then(v=>WebAssembly.instantiate(v,c)).then(v=>v).then(h,v=>{U(`failed to asynchronously prepare wasm: ${v}`),Me(v)})}function Je(i,c){var h=ne;return typeof WebAssembly.instantiateStreaming!="function"||le(h)||oe(h)||s||typeof fetch!="function"?Ge(h,i,c):fetch(h,{credentials:"same-origin"}).then(v=>WebAssembly.instantiateStreaming(v,i).then(c,function(M){return U(`wasm streaming compile failed: ${M}`),U("falling back to ArrayBuffer instantiation"),Ge(h,i,c)}))}var ce,Re={989232:(i,c,h,v)=>{if(typeof r>"u"||!r.Qa)return 1;if(i=Fe(i>>>0),i.startsWith("./")&&(i=i.substring(2)),i=r.Qa.get(i),!i)return 2;if(c>>>=0,h>>>=0,c+h>i.byteLength)return 3;try{return X.set(i.subarray(c,c+h),v>>>0>>>0),0}catch{return 4}}};function Ie(i){this.Ka=i-24,this.Pa=function(c){q[this.Ka+4>>>2>>>0]=c},this.Oa=function(c){q[this.Ka+8>>>2>>>0]=c},this.Ma=function(c,h){this.Na(),this.Pa(c),this.Oa(h)},this.Na=function(){q[this.Ka+16>>>2>>>0]=0}}var me=0,ue=0,ie=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,xe=(i,c,h)=>{c>>>=0;var v=c+h;for(h=c;i[h]&&!(h>=v);)++h;if(16<h-c&&i.buffer&&ie)return ie.decode(i.subarray(c,h));for(v="";c<h;){var M=i[c++];if(M&128){var D=i[c++]&63;if((M&224)==192)v+=String.fromCharCode((M&31)<<6|D);else{var $=i[c++]&63;M=(M&240)==224?(M&15)<<12|D<<6|$:(M&7)<<18|D<<12|$<<6|i[c++]&63,65536>M?v+=String.fromCharCode(M):(M-=65536,v+=String.fromCharCode(55296|M>>10,56320|M&1023))}}else v+=String.fromCharCode(M)}return v},Fe=(i,c)=>(i>>>=0)?xe(X,i,c):"",_e=i=>{for(var c=0,h=0;h<i.length;++h){var v=i.charCodeAt(h);127>=v?c++:2047>=v?c+=2:55296<=v&&57343>=v?(c+=4,++h):c+=3}return c},Xe=(i,c,h,v)=>{if(h>>>=0,!(0<v))return 0;var M=h;v=h+v-1;for(var D=0;D<i.length;++D){var $=i.charCodeAt(D);if(55296<=$&&57343>=$){var se=i.charCodeAt(++D);$=65536+(($&1023)<<10)|se&1023}if(127>=$){if(h>=v)break;c[h++>>>0]=$}else{if(2047>=$){if(h+1>=v)break;c[h++>>>0]=192|$>>6}else{if(65535>=$){if(h+2>=v)break;c[h++>>>0]=224|$>>12}else{if(h+3>=v)break;c[h++>>>0]=240|$>>18,c[h++>>>0]=128|$>>12&63}c[h++>>>0]=128|$>>6&63}c[h++>>>0]=128|$&63}}return c[h>>>0]=0,h-M},Ee=i=>i%4===0&&(i%100!==0||i%400===0),bt=[0,31,60,91,121,152,182,213,244,274,305,335],st=[0,31,59,90,120,151,181,212,243,273,304,334],wt=i=>{var c=_e(i)+1,h=Et(c);return h&&Xe(i,X,h,c),h},je=[],ke={},vt=()=>{if(!Ot){var i={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:f||"./this.program"},c;for(c in ke)ke[c]===void 0?delete i[c]:i[c]=ke[c];var h=[];for(c in i)h.push(`${c}=${i[c]}`);Ot=h}return Ot},Ot,$t=[null,[],[]],zt=[31,29,31,30,31,30,31,31,30,31,30,31],Tt=[31,28,31,30,31,30,31,31,30,31,30,31];function ut(i){var c=Array(_e(i)+1);return Xe(i,c,0,c.length),c}function ft(i,c,h,v){function M(T,V,K){for(T=typeof T=="number"?T.toString():T||"";T.length<V;)T=K[0]+T;return T}function D(T,V){return M(T,V,"0")}function $(T,V){function K(Rt){return 0>Rt?-1:0<Rt?1:0}var Ue;return(Ue=K(T.getFullYear()-V.getFullYear()))===0&&(Ue=K(T.getMonth()-V.getMonth()))===0&&(Ue=K(T.getDate()-V.getDate())),Ue}function se(T){switch(T.getDay()){case 0:return new Date(T.getFullYear()-1,11,29);case 1:return T;case 2:return new Date(T.getFullYear(),0,3);case 3:return new Date(T.getFullYear(),0,2);case 4:return new Date(T.getFullYear(),0,1);case 5:return new Date(T.getFullYear()-1,11,31);case 6:return new Date(T.getFullYear()-1,11,30)}}function we(T){var V=T.Ga;for(T=new Date(new Date(T.Ha+1900,0,1).getTime());0<V;){var K=T.getMonth(),Ue=(Ee(T.getFullYear())?zt:Tt)[K];if(V>Ue-T.getDate())V-=Ue-T.getDate()+1,T.setDate(1),11>K?T.setMonth(K+1):(T.setMonth(0),T.setFullYear(T.getFullYear()+1));else{T.setDate(T.getDate()+V);break}}return K=new Date(T.getFullYear()+1,0,4),V=se(new Date(T.getFullYear(),0,4)),K=se(K),0>=$(V,T)?0>=$(K,T)?T.getFullYear()+1:T.getFullYear():T.getFullYear()-1}i>>>=0,c>>>=0,h>>>=0,v>>>=0;var de=q[v+40>>>2>>>0];v={Ta:x[v>>>2>>>0],Sa:x[v+4>>>2>>>0],Ia:x[v+8>>>2>>>0],La:x[v+12>>>2>>>0],Ja:x[v+16>>>2>>>0],Ha:x[v+20>>>2>>>0],Ba:x[v+24>>>2>>>0],Ga:x[v+28>>>2>>>0],Va:x[v+32>>>2>>>0],Ra:x[v+36>>>2>>>0],Ua:de?Fe(de):""},h=Fe(h),de={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var pe in de)h=h.replace(new RegExp(pe,"g"),de[pe]);var Ct="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Pt="January February March April May June July August September October November December".split(" ");de={"%a":T=>Ct[T.Ba].substring(0,3),"%A":T=>Ct[T.Ba],"%b":T=>Pt[T.Ja].substring(0,3),"%B":T=>Pt[T.Ja],"%C":T=>D((T.Ha+1900)/100|0,2),"%d":T=>D(T.La,2),"%e":T=>M(T.La,2," "),"%g":T=>we(T).toString().substring(2),"%G":T=>we(T),"%H":T=>D(T.Ia,2),"%I":T=>(T=T.Ia,T==0?T=12:12<T&&(T-=12),D(T,2)),"%j":T=>{for(var V=0,K=0;K<=T.Ja-1;V+=(Ee(T.Ha+1900)?zt:Tt)[K++]);return D(T.La+V,3)},"%m":T=>D(T.Ja+1,2),"%M":T=>D(T.Sa,2),"%n":()=>`
`,"%p":T=>0<=T.Ia&&12>T.Ia?"AM":"PM","%S":T=>D(T.Ta,2),"%t":()=>"	","%u":T=>T.Ba||7,"%U":T=>D(Math.floor((T.Ga+7-T.Ba)/7),2),"%V":T=>{var V=Math.floor((T.Ga+7-(T.Ba+6)%7)/7);if(2>=(T.Ba+371-T.Ga-2)%7&&V++,V)V==53&&(K=(T.Ba+371-T.Ga)%7,K==4||K==3&&Ee(T.Ha)||(V=1));else{V=52;var K=(T.Ba+7-T.Ga-1)%7;(K==4||K==5&&Ee(T.Ha%400-1))&&V++}return D(V,2)},"%w":T=>T.Ba,"%W":T=>D(Math.floor((T.Ga+7-(T.Ba+6)%7)/7),2),"%y":T=>(T.Ha+1900).toString().substring(2),"%Y":T=>T.Ha+1900,"%z":T=>{T=T.Ra;var V=0<=T;return T=Math.abs(T)/60,(V?"+":"-")+("0000"+(T/60*100+T%60)).slice(-4)},"%Z":T=>T.Ua,"%%":()=>"%"},h=h.replace(/%%/g,"\0\0");for(pe in de)h.includes(pe)&&(h=h.replace(new RegExp(pe,"g"),de[pe](v)));return h=h.replace(/\0\0/g,"%"),pe=ut(h),pe.length>c?0:(j.set(pe,i>>>0),pe.length-1)}var Gt={a:function(i,c,h){throw i>>>=0,new Ie(i).Ma(c>>>0,h>>>0),me=i,ue++,me},e:function(){return 0},H:function(){},x:function(){},z:function(){},J:function(){return 0},F:function(){},A:function(){},E:function(){},g:function(){},y:function(){},v:function(){},G:function(){},w:function(){},k:()=>1,n:function(i,c,h){i=c+2097152>>>0<4194305-!!i?(i>>>0)+4294967296*c:NaN,h>>>=0,i=new Date(1e3*i),x[h>>>2>>>0]=i.getUTCSeconds(),x[h+4>>>2>>>0]=i.getUTCMinutes(),x[h+8>>>2>>>0]=i.getUTCHours(),x[h+12>>>2>>>0]=i.getUTCDate(),x[h+16>>>2>>>0]=i.getUTCMonth(),x[h+20>>>2>>>0]=i.getUTCFullYear()-1900,x[h+24>>>2>>>0]=i.getUTCDay(),x[h+28>>>2>>>0]=(i.getTime()-Date.UTC(i.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},o:function(i,c,h){i=c+2097152>>>0<4194305-!!i?(i>>>0)+4294967296*c:NaN,h>>>=0,i=new Date(1e3*i),x[h>>>2>>>0]=i.getSeconds(),x[h+4>>>2>>>0]=i.getMinutes(),x[h+8>>>2>>>0]=i.getHours(),x[h+12>>>2>>>0]=i.getDate(),x[h+16>>>2>>>0]=i.getMonth(),x[h+20>>>2>>>0]=i.getFullYear()-1900,x[h+24>>>2>>>0]=i.getDay(),x[h+28>>>2>>>0]=(Ee(i.getFullYear())?bt:st)[i.getMonth()]+i.getDate()-1|0,x[h+36>>>2>>>0]=-(60*i.getTimezoneOffset()),c=new Date(i.getFullYear(),6,1).getTimezoneOffset();var v=new Date(i.getFullYear(),0,1).getTimezoneOffset();x[h+32>>>2>>>0]=(c!=v&&i.getTimezoneOffset()==Math.min(v,c))|0},p:function(i){i>>>=0;var c=new Date(x[i+20>>>2>>>0]+1900,x[i+16>>>2>>>0],x[i+12>>>2>>>0],x[i+8>>>2>>>0],x[i+4>>>2>>>0],x[i>>>2>>>0],0),h=x[i+32>>>2>>>0],v=c.getTimezoneOffset(),M=new Date(c.getFullYear(),6,1).getTimezoneOffset(),D=new Date(c.getFullYear(),0,1).getTimezoneOffset(),$=Math.min(D,M);return 0>h?x[i+32>>>2>>>0]=+(M!=D&&$==v):0<h!=($==v)&&(M=Math.max(D,M),c.setTime(c.getTime()+6e4*((0<h?$:M)-v))),x[i+24>>>2>>>0]=c.getDay(),x[i+28>>>2>>>0]=(Ee(c.getFullYear())?bt:st)[c.getMonth()]+c.getDate()-1|0,x[i>>>2>>>0]=c.getSeconds(),x[i+4>>>2>>>0]=c.getMinutes(),x[i+8>>>2>>>0]=c.getHours(),x[i+12>>>2>>>0]=c.getDate(),x[i+16>>>2>>>0]=c.getMonth(),x[i+20>>>2>>>0]=c.getYear(),i=c.getTime(),isNaN(i)?(x[_t()>>>2>>>0]=61,i=-1):i/=1e3,Ye((ce=i,1<=+Math.abs(ce)?0<ce?+Math.floor(ce/4294967296)>>>0:~~+Math.ceil((ce-+(~~ce>>>0))/4294967296)>>>0:0)),i>>>0},l:function(){return-52},m:function(){},t:function(i,c,h){function v(we){return(we=we.toTimeString().match(/\(([A-Za-z ]+)\)$/))?we[1]:"GMT"}h>>>=0;var M=new Date().getFullYear(),D=new Date(M,0,1),$=new Date(M,6,1);M=D.getTimezoneOffset();var se=$.getTimezoneOffset();q[i>>>0>>>2>>>0]=60*Math.max(M,se),x[c>>>0>>>2>>>0]=+(M!=se),i=v(D),c=v($),i=wt(i),c=wt(c),se<M?(q[h>>>2>>>0]=i,q[h+4>>>2>>>0]=c):(q[h>>>2>>>0]=c,q[h+4>>>2>>>0]=i)},d:()=>{Me("")},B:function(i,c,h){i>>>=0,c>>>=0,h>>>=0,je.length=0;for(var v;v=X[c++>>>0];){var M=v!=105;M&=v!=112,h+=M&&h%8?4:0,je.push(v==112?q[h>>>2>>>0]:v==105?x[h>>>2>>>0]:fe[h>>>3>>>0]),h+=M?8:4}return Re[i].apply(null,je)},h:()=>Date.now(),u:function(){return 4294901760},b:()=>performance.now(),I:function(i,c,h){return c>>>=0,X.copyWithin(i>>>0>>>0,c>>>0,c+(h>>>0)>>>0)},s:function(i){i>>>=0;var c=X.length;if(4294901760<i)return!1;for(var h=1;4>=h;h*=2){var v=c*(1+.2/h);v=Math.min(v,i+100663296);var M=Math;v=Math.max(i,v);e:{M=(M.min.call(M,4294901760,v+(65536-v%65536)%65536)-C.buffer.byteLength+65535)/65536;try{C.grow(M),Ne();var D=1;break e}catch{}D=void 0}if(D)return!0}return!1},C:function(i,c){i>>>=0,c>>>=0;var h=0;return vt().forEach((v,M)=>{var D=c+h;for(M=q[i+4*M>>>2>>>0]=D,D=0;D<v.length;++D)j[M++>>>0>>>0]=v.charCodeAt(D);j[M>>>0>>>0]=0,h+=v.length+1}),0},D:function(i,c){i>>>=0,c>>>=0;var h=vt();q[i>>>2>>>0]=h.length;var v=0;return h.forEach(M=>v+=M.length+1),q[c>>>2>>>0]=v,0},f:()=>52,j:function(){return 52},q:function(){return 70},i:function(i,c,h,v){c>>>=0,h>>>=0,v>>>=0;for(var M=0,D=0;D<h;D++){var $=q[c>>>2>>>0],se=q[c+4>>>2>>>0];c+=8;for(var we=0;we<se;we++){var de=X[$+we>>>0],pe=$t[i];de===0||de===10?((i===1?H:U)(xe(pe,0)),pe.length=0):pe.push(de)}M+=se}return q[v>>>2>>>0]=M,0},r:ft,c:function(i,c,h,v){return ft(i>>>0,c>>>0,h>>>0,v>>>0)}},B=function(){function i(h){return B=h.exports,B=St(),C=B.K,Ne(),ze.unshift(B.L),ee--,ee==0&&(F!==null&&(clearInterval(F),F=null),be&&(h=be,be=null,h())),B}var c={a:Gt};if(ee++,r.instantiateWasm)try{return r.instantiateWasm(c,i)}catch(h){U(`Module.instantiateWasm callback failed with error: ${h}`),u(h)}return Je(c,function(h){i(h.instance)}).catch(u),{}}();r._OrtInit=(i,c)=>(r._OrtInit=B.M)(i,c),r._OrtGetLastError=(i,c)=>(r._OrtGetLastError=B.N)(i,c),r._OrtCreateSessionOptions=(i,c,h,v,M,D,$,se,we,de)=>(r._OrtCreateSessionOptions=B.O)(i,c,h,v,M,D,$,se,we,de),r._OrtAppendExecutionProvider=(i,c)=>(r._OrtAppendExecutionProvider=B.P)(i,c),r._OrtAddFreeDimensionOverride=(i,c,h)=>(r._OrtAddFreeDimensionOverride=B.Q)(i,c,h),r._OrtAddSessionConfigEntry=(i,c,h)=>(r._OrtAddSessionConfigEntry=B.R)(i,c,h),r._OrtReleaseSessionOptions=i=>(r._OrtReleaseSessionOptions=B.S)(i),r._OrtCreateSession=(i,c,h)=>(r._OrtCreateSession=B.T)(i,c,h),r._OrtReleaseSession=i=>(r._OrtReleaseSession=B.U)(i),r._OrtGetInputOutputCount=(i,c,h)=>(r._OrtGetInputOutputCount=B.V)(i,c,h),r._OrtGetInputName=(i,c)=>(r._OrtGetInputName=B.W)(i,c),r._OrtGetOutputName=(i,c)=>(r._OrtGetOutputName=B.X)(i,c),r._OrtFree=i=>(r._OrtFree=B.Y)(i),r._OrtCreateTensor=(i,c,h,v,M,D)=>(r._OrtCreateTensor=B.Z)(i,c,h,v,M,D),r._OrtGetTensorData=(i,c,h,v,M)=>(r._OrtGetTensorData=B._)(i,c,h,v,M),r._OrtReleaseTensor=i=>(r._OrtReleaseTensor=B.$)(i),r._OrtCreateRunOptions=(i,c,h,v)=>(r._OrtCreateRunOptions=B.aa)(i,c,h,v),r._OrtAddRunConfigEntry=(i,c,h)=>(r._OrtAddRunConfigEntry=B.ba)(i,c,h),r._OrtReleaseRunOptions=i=>(r._OrtReleaseRunOptions=B.ca)(i),r._OrtCreateBinding=i=>(r._OrtCreateBinding=B.da)(i),r._OrtBindInput=(i,c,h)=>(r._OrtBindInput=B.ea)(i,c,h),r._OrtBindOutput=(i,c,h,v)=>(r._OrtBindOutput=B.fa)(i,c,h,v),r._OrtClearBoundOutputs=i=>(r._OrtClearBoundOutputs=B.ga)(i),r._OrtReleaseBinding=i=>(r._OrtReleaseBinding=B.ha)(i),r._OrtRunWithBinding=(i,c,h,v,M)=>(r._OrtRunWithBinding=B.ia)(i,c,h,v,M),r._OrtRun=(i,c,h,v,M,D,$,se)=>(r._OrtRun=B.ja)(i,c,h,v,M,D,$,se),r._OrtEndProfiling=i=>(r._OrtEndProfiling=B.ka)(i),r._OrtTrainingLoadCheckpoint=(i,c)=>(r._OrtTrainingLoadCheckpoint=B.la)(i,c),r._OrtTrainingReleaseCheckpoint=i=>(r._OrtTrainingReleaseCheckpoint=B.ma)(i),r._OrtTrainingCreateSession=(i,c,h,v,M,D,$,se)=>(r._OrtTrainingCreateSession=B.na)(i,c,h,v,M,D,$,se),r._OrtTrainingLazyResetGrad=i=>(r._OrtTrainingLazyResetGrad=B.oa)(i),r._OrtTrainingRunTrainStep=(i,c,h,v,M,D)=>(r._OrtTrainingRunTrainStep=B.pa)(i,c,h,v,M,D),r._OrtTrainingOptimizerStep=(i,c)=>(r._OrtTrainingOptimizerStep=B.qa)(i,c),r._OrtTrainingEvalStep=(i,c,h,v,M,D)=>(r._OrtTrainingEvalStep=B.ra)(i,c,h,v,M,D),r._OrtTrainingGetParametersSize=(i,c,h)=>(r._OrtTrainingGetParametersSize=B.sa)(i,c,h),r._OrtTrainingCopyParametersToBuffer=(i,c,h,v)=>(r._OrtTrainingCopyParametersToBuffer=B.ta)(i,c,h,v),r._OrtTrainingCopyParametersFromBuffer=(i,c,h,v)=>(r._OrtTrainingCopyParametersFromBuffer=B.ua)(i,c,h,v),r._OrtTrainingGetModelInputOutputCount=(i,c,h,v)=>(r._OrtTrainingGetModelInputOutputCount=B.va)(i,c,h,v),r._OrtTrainingGetModelInputOutputName=(i,c,h,v)=>(r._OrtTrainingGetModelInputOutputName=B.wa)(i,c,h,v),r._OrtTrainingReleaseSession=i=>(r._OrtTrainingReleaseSession=B.xa)(i);var _t=()=>(_t=B.ya)(),Et=r._malloc=i=>(Et=r._malloc=B.za)(i);r._free=i=>(r._free=B.Aa)(i);var Ye=i=>(Ye=B.Ca)(i),jt=()=>(jt=B.Da)(),J=i=>(J=B.Ea)(i),At=i=>(At=B.Fa)(i);function St(){var i=B;i=Object.assign({},i);var c=v=>()=>v()>>>0,h=v=>M=>v(M)>>>0;return i.ya=c(i.ya),i.za=h(i.za),i.Da=c(i.Da),i.Fa=h(i.Fa),i}r.stackAlloc=At,r.stackSave=jt,r.stackRestore=J,r.UTF8ToString=Fe,r.stringToUTF8=(i,c,h)=>Xe(i,X,c,h),r.lengthBytesUTF8=_e;var lt;be=function i(){lt||Mt(),lt||(be=i)};function Mt(){if(!(0<ee)){if(r.preRun)for(typeof r.preRun=="function"&&(r.preRun=[r.preRun]);r.preRun.length;){var i=r.preRun.shift();$e.unshift(i)}for(;0<$e.length;)$e.shift()(r);if(!(0<ee||lt||(lt=!0,r.calledRun=!0,W))){for(;0<ze.length;)ze.shift()(r);for(l(r);0<qe.length;)qe.shift()(r)}}}return Mt(),n.ready}})();typeof Ea=="object"&&typeof jr=="object"?jr.exports=_a:typeof define=="function"&&define.amd&&define([],()=>_a)});var Sa=dt(()=>{});var Ma=dt(()=>{});var Ca={};It(Ca,{cpus:()=>Yo});var Yo,Pa=G(()=>{Yo=void 0});var xa=dt((Ia,Yr)=>{"use strict";var Ra=(()=>{var a=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(a=a||__filename),function(n={}){function r(){return F.buffer!=oe.buffer&&me(),oe}function l(){return F.buffer!=oe.buffer&&me(),ne}function u(){return F.buffer!=oe.buffer&&me(),ge}function m(){return F.buffer!=oe.buffer&&me(),it}function f(){return F.buffer!=oe.buffer&&me(),De}function p(){return F.buffer!=oe.buffer&&me(),Ge}function b(){return F.buffer!=oe.buffer&&me(),Ie}var s=n,y,E;s.ready=new Promise((e,t)=>{y=e,E=t});var O=Object.assign({},s),A="./this.program",I=(e,t)=>{throw t},P=typeof window=="object",H=typeof importScripts=="function",U=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",C=s.ENVIRONMENT_IS_PTHREAD||!1,W="";function j(e){return s.locateFile?s.locateFile(e,W):W+e}var X,x,q;if(U){var fe=($r(),pt(Nr)),Ne=(Gr(),pt(zr));W=H?Ne.dirname(W)+"/":__dirname+"/",X=(t,o)=>(t=je(t)?new URL(t):Ne.normalize(t),fe.readFileSync(t,o?void 0:"utf8")),q=t=>(t=X(t,!0),t.buffer||(t=new Uint8Array(t)),t),x=(t,o,d,g=!0)=>{t=je(t)?new URL(t):Ne.normalize(t),fe.readFile(t,g?void 0:"utf8",(w,S)=>{w?d(w):o(g?S.buffer:S)})},!s.thisProgram&&1<process.argv.length&&(A=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),I=(t,o)=>{throw process.exitCode=t,o},s.inspect=()=>"[Emscripten Module object]";let e;try{e=Sa()}catch(t){throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'),t}global.Worker=e.Worker}else(P||H)&&(H?W=self.location.href:typeof document<"u"&&document.currentScript&&(W=document.currentScript.src),typeof a<"u"&&a&&(W=a),W.indexOf("blob:")!==0?W=W.substr(0,W.replace(/[?#].*/,"").lastIndexOf("/")+1):W="",U||(X=e=>{var t=new XMLHttpRequest;return t.open("GET",e,!1),t.send(null),t.responseText},H&&(q=e=>{var t=new XMLHttpRequest;return t.open("GET",e,!1),t.responseType="arraybuffer",t.send(null),new Uint8Array(t.response)}),x=(e,t,o)=>{var d=new XMLHttpRequest;d.open("GET",e,!0),d.responseType="arraybuffer",d.onload=()=>{d.status==200||d.status==0&&d.response?t(d.response):o()},d.onerror=o,d.send(null)}));U&&typeof performance>"u"&&(global.performance=Ma().performance);var $e=console.log.bind(console),ze=console.error.bind(console);U&&($e=(...e)=>fe.writeSync(1,e.join(" ")+`
`),ze=(...e)=>fe.writeSync(2,e.join(" ")+`
`));var qe=$e,ee=ze;Object.assign(s,O),O=null,typeof WebAssembly!="object"&&st("no native wasm support detected");var F,be,Me=!1,le,oe,ne,ge,it,De,Ge,Je,ce,Re,Ie;function me(){var e=F.buffer;s.HEAP8=oe=new Int8Array(e),s.HEAP16=ge=new Int16Array(e),s.HEAPU8=ne=new Uint8Array(e),s.HEAPU16=it=new Uint16Array(e),s.HEAP32=De=new Int32Array(e),s.HEAPU32=Ge=new Uint32Array(e),s.HEAPF32=Je=new Float32Array(e),s.HEAPF64=Ie=new Float64Array(e),s.HEAP64=ce=new BigInt64Array(e),s.HEAPU64=Re=new BigUint64Array(e)}var ue=16777216;if(C)F=s.wasmMemory;else if(s.wasmMemory)F=s.wasmMemory;else if(F=new WebAssembly.Memory({initial:ue/65536,maximum:65536,shared:!0}),!(F.buffer instanceof SharedArrayBuffer))throw ee("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),U&&ee("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");me(),ue=F.buffer.byteLength;var ie=[],xe=[],Fe=[],_e=0,Xe=null,Ee=null;function bt(){if(_e--,_e==0&&(Xe!==null&&(clearInterval(Xe),Xe=null),Ee)){var e=Ee;Ee=null,e()}}function st(e){throw e="Aborted("+e+")",ee(e),Me=!0,le=1,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),E(e),e}var wt=e=>e.startsWith("data:application/octet-stream;base64,"),je=e=>e.startsWith("file://"),ke;ke="ort-wasm-threaded.wasm",wt(ke)||(ke=j(ke));function vt(e){if(q)return q(e);throw"both async and sync fetching of the wasm failed"}function Ot(e){if(P||H){if(typeof fetch=="function"&&!je(e))return fetch(e,{credentials:"same-origin"}).then(t=>{if(!t.ok)throw"failed to load wasm binary file at '"+e+"'";return t.arrayBuffer()}).catch(()=>vt(e));if(x)return new Promise((t,o)=>{x(e,d=>t(new Uint8Array(d)),o)})}return Promise.resolve().then(()=>vt(e))}function $t(e,t,o){return Ot(e).then(d=>WebAssembly.instantiate(d,t)).then(d=>d).then(o,d=>{ee(`failed to asynchronously prepare wasm: ${d}`),st(d)})}function zt(e,t){var o=ke;return typeof WebAssembly.instantiateStreaming!="function"||wt(o)||je(o)||U||typeof fetch!="function"?$t(o,e,t):fetch(o,{credentials:"same-origin"}).then(d=>WebAssembly.instantiateStreaming(d,e).then(t,function(g){return ee(`wasm streaming compile failed: ${g}`),ee("falling back to ArrayBuffer instantiation"),$t(o,e,t)}))}var Tt={891868:(e,t,o,d)=>{if(typeof s>"u"||!s.Hb)return 1;if(e=Ye(e>>>0),e.startsWith("./")&&(e=e.substring(2)),e=s.Hb.get(e),!e)return 2;if(t>>>=0,o>>>=0,d>>>=0,t+o>e.byteLength)return 3;try{return l().set(e.subarray(t,t+o),d>>>0),0}catch{return 4}}};function ut(e){this.name="ExitStatus",this.message=`Program terminated with exit(${e})`,this.status=e}var ft=e=>{e.terminate(),e.onmessage=()=>{}},Gt=e=>{c.ob.length==0&&(Mt(),c.Bb(c.ob[0]));var t=c.ob.pop();if(!t)return 6;c.pb.push(t),c.kb[e.nb]=t,t.nb=e.nb;var o={cmd:"run",start_routine:e.Ob,arg:e.Ib,pthread_ptr:e.nb};return U&&t.unref(),t.postMessage(o,e.Ub),0},B=0,_t=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Et=(e,t,o)=>{t>>>=0;var d=t+o;for(o=t;e[o]&&!(o>=d);)++o;if(16<o-t&&e.buffer&&_t)return _t.decode(e.buffer instanceof SharedArrayBuffer?e.slice(t,o):e.subarray(t,o));for(d="";t<o;){var g=e[t++];if(g&128){var w=e[t++]&63;if((g&224)==192)d+=String.fromCharCode((g&31)<<6|w);else{var S=e[t++]&63;g=(g&240)==224?(g&15)<<12|w<<6|S:(g&7)<<18|w<<12|S<<6|e[t++]&63,65536>g?d+=String.fromCharCode(g):(g-=65536,d+=String.fromCharCode(55296|g>>10,56320|g&1023))}}else d+=String.fromCharCode(g)}return d},Ye=(e,t)=>(e>>>=0)?Et(l(),e,t):"",jt=e=>{var t=Br();return e=e(),Kt(t),e};function J(e,t){var o=arguments.length-2,d=arguments;return jt(()=>{for(var g=2*o,w=Dr(8*g),S=w>>>3,R=0;R<o;R++){var N=d[2+R];typeof N=="bigint"?(ce[S+2*R]=1n,ce[S+2*R+1]=N):(ce[S+2*R]=0n,b()[S+2*R+1>>>0]=N)}return Gn(e,g,w,t)})}function At(e){if(C)return J(0,1,e);le=e,0<B||(c.Pb(),s.onExit?.(e),Me=!0),I(e,new ut(e))}var St=e=>{if(le=e,C)throw v(e),"unwind";At(e)};function lt(){for(var e=s.numThreads;e--;)Mt();ie.unshift(()=>{_e++,i(()=>bt())})}function Mt(){var e=j("ort-wasm-threaded.worker.js");e=new Worker(e),c.ob.push(e)}function i(e){C?e():Promise.all(c.ob.map(c.Bb)).then(e)}var c={ob:[],pb:[],Gb:[],kb:{},wb(){C?(c.receiveObjectTransfer=c.Nb,c.threadInitTLS=c.Fb,c.setExitStatus=c.Eb):lt()},Eb:e=>le=e,Xb:["$terminateWorker"],Pb:()=>{for(var e of c.pb)ft(e);for(e of c.ob)ft(e);c.ob=[],c.pb=[],c.kb=[]},Db:e=>{var t=e.nb;delete c.kb[t],c.ob.push(e),c.pb.splice(c.pb.indexOf(e),1),e.nb=0,xr(t)},Nb(){},Fb(){c.Gb.forEach(e=>e())},Bb:e=>new Promise(t=>{e.onmessage=w=>{w=w.data;var S=w.cmd;if(w.targetThread&&w.targetThread!=Jt()){var R=c.kb[w.targetThread];R?R.postMessage(w,w.transferList):ee(`Internal error! Worker sent a message "${S}" to target pthread ${w.targetThread}, but that thread no longer exists!`)}else S==="checkMailbox"?Yt():S==="spawnThread"?Gt(w):S==="cleanupThread"?c.Db(c.kb[w.thread]):S==="killThread"?(w=w.thread,S=c.kb[w],delete c.kb[w],ft(S),xr(w),c.pb.splice(c.pb.indexOf(S),1),S.nb=0):S==="cancelThread"?c.kb[w.thread].postMessage({cmd:"cancel"}):S==="loaded"?(e.loaded=!0,U&&!e.nb&&e.unref(),t(e)):S==="alert"?alert(`Thread ${w.threadId}: ${w.text}`):w.target==="setimmediate"?e.postMessage(w):S==="callHandler"?s[w.handler](...w.args):S&&ee(`worker sent an unknown command ${S}`)},e.onerror=w=>{throw ee(`worker sent an error! ${w.filename}:${w.lineno}: ${w.message}`),w},U&&(e.on("message",w=>e.onmessage({data:w})),e.on("error",w=>e.onerror(w)));var o=[],d=["onExit"],g;for(g of d)s.hasOwnProperty(g)&&o.push(g);e.postMessage({cmd:"load",handlers:o,urlOrBlob:s.mainScriptUrlOrBlob||a,wasmMemory:F,wasmModule:be})})};s.PThread=c;var h=e=>{for(;0<e.length;)e.shift()(s)};s.establishStackSpace=()=>{var e=Jt(),t=p()[e+52>>>2>>>0];e=p()[e+56>>>2>>>0],Yn(t,t-e),Kt(t)};function v(e){if(C)return J(1,0,e);St(e)}var M=[],D;s.invokeEntryPoint=(e,t)=>{var o=M[e];o||(e>=M.length&&(M.length=e+1),M[e]=o=D.get(e)),e=o(t),0<B?c.Eb(e):Ur(e)};function $(e){this.tb=e-24,this.Mb=function(t){p()[this.tb+4>>>2>>>0]=t},this.yb=function(t){p()[this.tb+8>>>2>>>0]=t},this.wb=function(t,o){this.xb(),this.Mb(t),this.yb(o)},this.xb=function(){p()[this.tb+16>>>2>>>0]=0}}var se=0,we=0;function de(e,t,o,d){return C?J(2,1,e,t,o,d):pe(e,t,o,d)}function pe(e,t,o,d){if(e>>>=0,t>>>=0,o>>>=0,d>>>=0,typeof SharedArrayBuffer>"u")return ee("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var g=[];return C&&g.length===0?de(e,t,o,d):(e={Ob:o,nb:e,Ib:d,Ub:g},C?(e.Wb="spawnThread",postMessage(e,g),0):Gt(e))}function Ct(e,t,o){return C?J(3,1,e,t,o):0}function Pt(e,t){if(C)return J(4,1,e,t)}var T=e=>{for(var t=0,o=0;o<e.length;++o){var d=e.charCodeAt(o);127>=d?t++:2047>=d?t+=2:55296<=d&&57343>=d?(t+=4,++o):t+=3}return t},V=(e,t,o,d)=>{if(o>>>=0,!(0<d))return 0;var g=o;d=o+d-1;for(var w=0;w<e.length;++w){var S=e.charCodeAt(w);if(55296<=S&&57343>=S){var R=e.charCodeAt(++w);S=65536+((S&1023)<<10)|R&1023}if(127>=S){if(o>=d)break;t[o++>>>0]=S}else{if(2047>=S){if(o+1>=d)break;t[o++>>>0]=192|S>>6}else{if(65535>=S){if(o+2>=d)break;t[o++>>>0]=224|S>>12}else{if(o+3>=d)break;t[o++>>>0]=240|S>>18,t[o++>>>0]=128|S>>12&63}t[o++>>>0]=128|S>>6&63}t[o++>>>0]=128|S&63}}return t[o>>>0]=0,o-g},K=(e,t,o)=>V(e,l(),t,o);function Ue(e,t){if(C)return J(5,1,e,t)}function Rt(e,t,o){if(C)return J(6,1,e,t,o)}function sn(e,t,o){return C?J(7,1,e,t,o):0}function un(e,t){if(C)return J(8,1,e,t)}function fn(e,t,o){if(C)return J(9,1,e,t,o)}function ln(e,t,o,d){if(C)return J(10,1,e,t,o,d)}function cn(e,t,o,d){if(C)return J(11,1,e,t,o,d)}function dn(e,t,o,d){if(C)return J(12,1,e,t,o,d)}function pn(e){if(C)return J(13,1,e)}function mn(e,t){if(C)return J(14,1,e,t)}function hn(e,t,o){if(C)return J(15,1,e,t,o)}var gn=e=>{if(e===null)return"null";var t=typeof e;return t==="object"||t==="array"||t==="function"?e.toString():""+e},yn,Ce=e=>{for(var t="";l()[e>>>0];)t+=yn[l()[e++>>>0]];return t},Tr={},_r={},go={},Ve;function yo(e,t,o={}){var d=t.name;if(!e)throw new Ve(`type "${d}" must have a positive integer typeid pointer`);if(_r.hasOwnProperty(e)){if(o.Kb)return;throw new Ve(`Cannot register type '${d}' twice`)}_r[e]=t,delete go[e],Tr.hasOwnProperty(e)&&(t=Tr[e],delete Tr[e],t.forEach(g=>g()))}function Le(e,t,o={}){if(!("argPackAdvance"in t))throw new TypeError("registerType registeredInstance requires argPackAdvance");yo(e,t,o)}var bn=(e,t,o)=>{switch(t){case 1:return o?d=>r()[d>>>0>>>0]:d=>l()[d>>>0>>>0];case 2:return o?d=>u()[d>>>1>>>0]:d=>m()[d>>>1>>>0];case 4:return o?d=>f()[d>>>2>>>0]:d=>p()[d>>>2>>>0];case 8:return o?d=>ce[d>>>3]:d=>Re[d>>>3];default:throw new TypeError(`invalid integer width (${t}): ${e}`)}};function wn(){this.mb=[void 0],this.Ab=[]}var Ae=new wn;function Er(e){e>>>=0,e>=Ae.tb&&--Ae.get(e).Cb===0&&Ae.yb(e)}var Oe=e=>{if(!e)throw new Ve("Cannot use deleted val. handle = "+e);return Ae.get(e).value},Be=e=>{switch(e){case void 0:return 1;case null:return 2;case!0:return 3;case!1:return 4;default:return Ae.xb({Cb:1,value:e})}};function vn(e){return this.fromWireType(f()[e>>>2>>>0])}var bo=(e,t)=>{switch(t){case 4:return function(o){var d=this.fromWireType;return F.buffer!=oe.buffer&&me(),d.call(this,Je[o>>>2>>>0])};case 8:return function(o){return this.fromWireType(b()[o>>>3>>>0])};default:throw new TypeError(`invalid float width (${t}): ${e}`)}};function wo(e){return this.fromWireType(p()[e>>>2>>>0])}var On=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,vo=(e,t)=>{for(var o=e>>1,d=o+t/2;!(o>=d)&&m()[o>>>0];)++o;if(o<<=1,32<o-e&&On)return On.decode(l().slice(e,o));for(o="",d=0;!(d>=t/2);++d){var g=u()[e+2*d>>>1>>>0];if(g==0)break;o+=String.fromCharCode(g)}return o},Oo=(e,t,o)=>{if(o??=2147483647,2>o)return 0;o-=2;var d=t;o=o<2*e.length?o/2:e.length;for(var g=0;g<o;++g){var w=e.charCodeAt(g);u()[t>>>1>>>0]=w,t+=2}return u()[t>>>1>>>0]=0,t-d},To=e=>2*e.length,_o=(e,t)=>{for(var o=0,d="";!(o>=t/4);){var g=f()[e+4*o>>>2>>>0];if(g==0)break;++o,65536<=g?(g-=65536,d+=String.fromCharCode(55296|g>>10,56320|g&1023)):d+=String.fromCharCode(g)}return d},Eo=(e,t,o)=>{if(t>>>=0,o??=2147483647,4>o)return 0;var d=t;o=d+o-4;for(var g=0;g<e.length;++g){var w=e.charCodeAt(g);if(55296<=w&&57343>=w){var S=e.charCodeAt(++g);w=65536+((w&1023)<<10)|S&1023}if(f()[t>>>2>>>0]=w,t+=4,t+4>o)break}return f()[t>>>2>>>0]=0,t-d},Ao=e=>{for(var t=0,o=0;o<e.length;++o){var d=e.charCodeAt(o);55296<=d&&57343>=d&&++o,t+=4}return t};function Ar(e){e>>>=0,typeof Atomics.Vb=="function"&&(Atomics.Vb(f(),e>>>2,e).value.then(Yt),e+=128,Atomics.store(f(),e>>>2,1))}s.__emscripten_thread_mailbox_await=Ar;var Yt=()=>{var e=Jt();if(e&&(Ar(e),e=jn,!Me))try{if(e(),!(0<B))try{C?Ur(le):St(le)}catch(t){t instanceof ut||t=="unwind"||I(1,t)}}catch(t){t instanceof ut||t=="unwind"||I(1,t)}};s.checkMailbox=Yt;var Sr=[],Mr=(e,t)=>{var o=_r[e];if(o===void 0)throw e=$n(e),o=Ce(e),He(e),new Ve(t+" has unknown type "+o);return o},Tn=(e,t,o)=>{var d=[];return e=e.toWireType(d,o),d.length&&(p()[t>>>2>>>0]=Be(d)),e},Vt=[],So={},Cr=e=>{var t=So[e];return t===void 0?Ce(e):t},_n=()=>typeof globalThis=="object"?globalThis:Function("return this")(),Mo=e=>{var t=Vt.length;return Vt.push(e),t},Co=(e,t)=>{for(var o=Array(e),d=0;d<e;++d)o[d]=Mr(p()[t+4*d>>>2>>>0],"parameter "+d);return o},En=(e,t)=>Object.defineProperty(t,"name",{value:e});function Po(e){var t=Function;if(!(t instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof t} which is not a function`);var o=En(t.name||"unknownFunctionName",function(){});return o.prototype=t.prototype,o=new o,e=t.apply(o,e),e instanceof Object?e:o}var ct=e=>e%4===0&&(e%100!==0||e%400===0),An=[0,31,60,91,121,152,182,213,244,274,305,335],Sn=[0,31,59,90,120,151,181,212,243,273,304,334];function Mn(e,t,o,d,g,w,S){return C?J(16,1,e,t,o,d,g,w,S):-52}function Cn(e,t,o,d,g,w){if(C)return J(17,1,e,t,o,d,g,w)}var Pn=e=>{var t=T(e)+1,o=Xt(t);return o&&K(e,o,t),o},Pr=[],Rr={},Rn=()=>{if(!Ir){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:A||"./this.program"},t;for(t in Rr)Rr[t]===void 0?delete e[t]:e[t]=Rr[t];var o=[];for(t in e)o.push(`${t}=${e[t]}`);Ir=o}return Ir},Ir;function In(e,t){if(C)return J(18,1,e,t);e>>>=0,t>>>=0;var o=0;return Rn().forEach((d,g)=>{var w=t+o;for(g=p()[e+4*g>>>2>>>0]=w,w=0;w<d.length;++w)r()[g++>>>0>>>0]=d.charCodeAt(w);r()[g>>>0>>>0]=0,o+=d.length+1}),0}function xn(e,t){if(C)return J(19,1,e,t);e>>>=0,t>>>=0;var o=Rn();p()[e>>>2>>>0]=o.length;var d=0;return o.forEach(g=>d+=g.length+1),p()[t>>>2>>>0]=d,0}function Un(e){return C?J(20,1,e):52}function Bn(e,t,o,d){return C?J(21,1,e,t,o,d):52}function Dn(e,t,o,d){return C?J(22,1,e,t,o,d):70}var Ro=[null,[],[]];function Fn(e,t,o,d){if(C)return J(23,1,e,t,o,d);t>>>=0,o>>>=0,d>>>=0;for(var g=0,w=0;w<o;w++){var S=p()[t>>>2>>>0],R=p()[t+4>>>2>>>0];t+=8;for(var N=0;N<R;N++){var k=l()[S+N>>>0],te=Ro[e];k===0||k===10?((e===1?qe:ee)(Et(te,0)),te.length=0):te.push(k)}g+=R}return p()[d>>>2>>>0]=g,0}var kn=[31,29,31,30,31,30,31,31,30,31,30,31],Ln=[31,28,31,30,31,30,31,31,30,31,30,31];function Io(e){var t=Array(T(e)+1);return V(e,t,0,t.length),t}var xo=(e,t)=>{r().set(e,t>>>0)};function Hn(e,t,o,d){function g(_,Y,re){for(_=typeof _=="number"?_.toString():_||"";_.length<Y;)_=re[0]+_;return _}function w(_,Y){return g(_,Y,"0")}function S(_,Y){function re(qn){return 0>qn?-1:0<qn?1:0}var Ke;return(Ke=re(_.getFullYear()-Y.getFullYear()))===0&&(Ke=re(_.getMonth()-Y.getMonth()))===0&&(Ke=re(_.getDate()-Y.getDate())),Ke}function R(_){switch(_.getDay()){case 0:return new Date(_.getFullYear()-1,11,29);case 1:return _;case 2:return new Date(_.getFullYear(),0,3);case 3:return new Date(_.getFullYear(),0,2);case 4:return new Date(_.getFullYear(),0,1);case 5:return new Date(_.getFullYear()-1,11,31);case 6:return new Date(_.getFullYear()-1,11,30)}}function N(_){var Y=_.qb;for(_=new Date(new Date(_.rb+1900,0,1).getTime());0<Y;){var re=_.getMonth(),Ke=(ct(_.getFullYear())?kn:Ln)[re];if(Y>Ke-_.getDate())Y-=Ke-_.getDate()+1,_.setDate(1),11>re?_.setMonth(re+1):(_.setMonth(0),_.setFullYear(_.getFullYear()+1));else{_.setDate(_.getDate()+Y);break}}return re=new Date(_.getFullYear()+1,0,4),Y=R(new Date(_.getFullYear(),0,4)),re=R(re),0>=S(Y,_)?0>=S(re,_)?_.getFullYear()+1:_.getFullYear():_.getFullYear()-1}e>>>=0,t>>>=0,o>>>=0,d>>>=0;var k=p()[d+40>>>2>>>0];d={Sb:f()[d>>>2>>>0],Rb:f()[d+4>>>2>>>0],ub:f()[d+8>>>2>>>0],zb:f()[d+12>>>2>>>0],vb:f()[d+16>>>2>>>0],rb:f()[d+20>>>2>>>0],lb:f()[d+24>>>2>>>0],qb:f()[d+28>>>2>>>0],Yb:f()[d+32>>>2>>>0],Qb:f()[d+36>>>2>>>0],Tb:k?Ye(k):""},o=Ye(o),k={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var te in k)o=o.replace(new RegExp(te,"g"),k[te]);var Te="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),We="January February March April May June July August September October November December".split(" ");k={"%a":_=>Te[_.lb].substring(0,3),"%A":_=>Te[_.lb],"%b":_=>We[_.vb].substring(0,3),"%B":_=>We[_.vb],"%C":_=>w((_.rb+1900)/100|0,2),"%d":_=>w(_.zb,2),"%e":_=>g(_.zb,2," "),"%g":_=>N(_).toString().substring(2),"%G":_=>N(_),"%H":_=>w(_.ub,2),"%I":_=>(_=_.ub,_==0?_=12:12<_&&(_-=12),w(_,2)),"%j":_=>{for(var Y=0,re=0;re<=_.vb-1;Y+=(ct(_.rb+1900)?kn:Ln)[re++]);return w(_.zb+Y,3)},"%m":_=>w(_.vb+1,2),"%M":_=>w(_.Rb,2),"%n":()=>`
`,"%p":_=>0<=_.ub&&12>_.ub?"AM":"PM","%S":_=>w(_.Sb,2),"%t":()=>"	","%u":_=>_.lb||7,"%U":_=>w(Math.floor((_.qb+7-_.lb)/7),2),"%V":_=>{var Y=Math.floor((_.qb+7-(_.lb+6)%7)/7);if(2>=(_.lb+371-_.qb-2)%7&&Y++,Y)Y==53&&(re=(_.lb+371-_.qb)%7,re==4||re==3&&ct(_.rb)||(Y=1));else{Y=52;var re=(_.lb+7-_.qb-1)%7;(re==4||re==5&&ct(_.rb%400-1))&&Y++}return w(Y,2)},"%w":_=>_.lb,"%W":_=>w(Math.floor((_.qb+7-(_.lb+6)%7)/7),2),"%y":_=>(_.rb+1900).toString().substring(2),"%Y":_=>_.rb+1900,"%z":_=>{_=_.Qb;var Y=0<=_;return _=Math.abs(_)/60,(Y?"+":"-")+("0000"+(_/60*100+_%60)).slice(-4)},"%Z":_=>_.Tb,"%%":()=>"%"},o=o.replace(/%%/g,"\0\0");for(te in k)o.includes(te)&&(o=o.replace(new RegExp(te,"g"),k[te](d)));return o=o.replace(/\0\0/g,"%"),te=Io(o),te.length>t?0:(xo(te,e),te.length-1)}c.wb();for(var Wn=Array(256),qt=0;256>qt;++qt)Wn[qt]=String.fromCharCode(qt);yn=Wn,Ve=s.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},s.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(wn.prototype,{get(e){return this.mb[e]},has(e){return this.mb[e]!==void 0},xb(e){var t=this.Ab.pop()||this.mb.length;return this.mb[t]=e,t},yb(e){this.mb[e]=void 0,this.Ab.push(e)}}),Ae.mb.push({value:void 0},{value:null},{value:!0},{value:!1}),Ae.tb=Ae.mb.length,s.count_emval_handles=()=>{for(var e=0,t=Ae.tb;t<Ae.mb.length;++t)Ae.mb[t]!==void 0&&++e;return e};var Uo=[At,v,de,Ct,Pt,Ue,Rt,sn,un,fn,ln,cn,dn,pn,mn,hn,Mn,Cn,In,xn,Un,Bn,Dn,Fn],Bo={b:function(e,t,o){throw e>>>=0,new $(e).wb(t>>>0,o>>>0),se=e,we++,se},da:function(e){zn(e>>>0,!H,1,!P,131072,!1),c.Fb()},D:function(e){e>>>=0,C?postMessage({cmd:"cleanupThread",thread:e}):c.Db(c.kb[e])},V:pe,x:Ct,ka:Pt,R:Ue,T:Rt,K:sn,ia:un,aa:fn,ga:ln,F:cn,S:dn,P:pn,ja:mn,Q:hn,I:function(e,t,o,d,g){e>>>=0,t>>>=0,o>>>=0,t=Ce(t);var w=t.indexOf("u")!=-1;w&&(g=(1n<<64n)-1n),Le(e,{name:t,fromWireType:S=>S,toWireType:function(S,R){if(typeof R!="bigint"&&typeof R!="number")throw new TypeError(`Cannot convert "${gn(R)}" to ${this.name}`);if(R<d||R>g)throw new TypeError(`Passing a number "${gn(R)}" from JS side to C/C++ side to an argument of type "${t}", which is outside the valid range [${d}, ${g}]!`);return R},argPackAdvance:8,readValueFromPointer:bn(t,o,!w),sb:null})},pa:function(e,t,o,d){e>>>=0,t=Ce(t>>>0),Le(e,{name:t,fromWireType:function(g){return!!g},toWireType:function(g,w){return w?o:d},argPackAdvance:8,readValueFromPointer:function(g){return this.fromWireType(l()[g>>>0])},sb:null})},oa:function(e,t){e>>>=0,t=Ce(t>>>0),Le(e,{name:t,fromWireType:o=>{var d=Oe(o);return Er(o),d},toWireType:(o,d)=>Be(d),argPackAdvance:8,readValueFromPointer:vn,sb:null})},H:function(e,t,o){e>>>=0,o>>>=0,t=Ce(t>>>0),Le(e,{name:t,fromWireType:d=>d,toWireType:(d,g)=>g,argPackAdvance:8,readValueFromPointer:bo(t,o),sb:null})},u:function(e,t,o,d,g){if(e>>>=0,o>>>=0,t=Ce(t>>>0),g===-1&&(g=4294967295),g=R=>R,d===0){var w=32-8*o;g=R=>R<<w>>>w}var S=t.includes("unsigned")?function(R,N){return N>>>0}:function(R,N){return N};Le(e,{name:t,fromWireType:g,toWireType:S,argPackAdvance:8,readValueFromPointer:bn(t,o,d!==0),sb:null})},n:function(e,t,o){function d(w){var S=p()[w>>>2>>>0];return w=p()[w+4>>>2>>>0],new g(r().buffer,w,S)}e>>>=0;var g=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][t];o=Ce(o>>>0),Le(e,{name:o,fromWireType:d,argPackAdvance:8,readValueFromPointer:d},{Kb:!0})},J:function(e,t){e>>>=0,t=Ce(t>>>0);var o=t==="std::string";Le(e,{name:t,fromWireType:function(d){var g=p()[d>>>2>>>0],w=d+4;if(o)for(var S=w,R=0;R<=g;++R){var N=w+R;if(R==g||l()[N>>>0]==0){if(S=Ye(S,N-S),k===void 0)var k=S;else k+=String.fromCharCode(0),k+=S;S=N+1}}else{for(k=Array(g),R=0;R<g;++R)k[R]=String.fromCharCode(l()[w+R>>>0]);k=k.join("")}return He(d),k},toWireType:function(d,g){g instanceof ArrayBuffer&&(g=new Uint8Array(g));var w=typeof g=="string";if(!(w||g instanceof Uint8Array||g instanceof Uint8ClampedArray||g instanceof Int8Array))throw new Ve("Cannot pass non-string to std::string");var S=o&&w?T(g):g.length,R=Xt(4+S+1),N=R+4;if(p()[R>>>2>>>0]=S,o&&w)K(g,N,S+1);else if(w)for(w=0;w<S;++w){var k=g.charCodeAt(w);if(255<k)throw He(N),new Ve("String has UTF-16 code units that do not fit in 8 bits");l()[N+w>>>0]=k}else for(w=0;w<S;++w)l()[N+w>>>0]=g[w];return d!==null&&d.push(He,R),R},argPackAdvance:8,readValueFromPointer:wo,sb(d){He(d)}})},z:function(e,t,o){if(e>>>=0,t>>>=0,o>>>=0,o=Ce(o),t===2)var d=vo,g=Oo,w=To,S=()=>m(),R=1;else t===4&&(d=_o,g=Eo,w=Ao,S=()=>p(),R=2);Le(e,{name:o,fromWireType:N=>{for(var k=p()[N>>>2>>>0],te=S(),Te,We=N+4,_=0;_<=k;++_){var Y=N+4+_*t;(_==k||te[Y>>>R]==0)&&(We=d(We,Y-We),Te===void 0?Te=We:(Te+=String.fromCharCode(0),Te+=We),We=Y+t)}return He(N),Te},toWireType:(N,k)=>{if(typeof k!="string")throw new Ve(`Cannot pass non-string to C++ string type ${o}`);var te=w(k),Te=Xt(4+te+t);return p()[Te>>>2]=te>>R,g(k,Te+4,te+t),N!==null&&N.push(He,Te),Te},argPackAdvance:8,readValueFromPointer:vn,sb(N){He(N)}})},qa:function(e,t){e>>>=0,t=Ce(t>>>0),Le(e,{Lb:!0,name:t,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>1,N:function(e,t){e>>>=0,e==t>>>0?setTimeout(()=>Yt()):C?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=c.kb[e])&&e.postMessage({cmd:"checkMailbox"})},W:function(e,t,o,d){t>>>=0,o/=2,Sr.length=o,d=d>>>0>>>3;for(var g=0;g<o;g++)Sr[g]=ce[d+2*g]?ce[d+2*g+1]:b()[d+2*g+1>>>0];return e=0>e?Tt[-e-1]:Uo[e],c.Jb=t,t=e.apply(null,Sr),c.Jb=0,t},ca:Ar,ma:function(e){U&&c.kb[e>>>0].ref()},s:function(e,t,o){return t>>>=0,o>>>=0,e=Oe(e>>>0),t=Mr(t,"emval::as"),Tn(t,o,e)},o:function(e,t,o,d){return o>>>=0,d>>>=0,e=Vt[e>>>0],t=Oe(t>>>0),e(null,t,o,d)},j:function(e,t,o,d,g){return o>>>=0,d>>>=0,g>>>=0,e=Vt[e>>>0],t=Oe(t>>>0),o=Cr(o),e(t,t[o],d,g)},c:Er,A:function(e,t){return t>>>=0,e=Oe(e>>>0),t=Oe(t),e==t},m:function(e){return e>>>=0,e===0?Be(_n()):(e=Cr(e),Be(_n()[e]))},i:function(e,t,o){t=Co(e,t>>>0);var d=t.shift();e--;var g=`return function (obj, func, destructorsRef, args) {
