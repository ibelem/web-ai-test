...
`))(lr,s,_e,()=>Y)},Hr={},je=t=>t%4===0&&(t%100!==0||t%400===0),jr=[0,31,60,91,121,152,182,213,244,274,305,335],zr=[0,31,59,90,120,151,181,212,243,273,304,334],Yr=t=>{var n=He(t)+1,u=Fr(n);return u&&Be(t,Z,u,n),u},Cr={},Gr=()=>{if(!Mr){var t={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:d||"./this.program"},n;for(n in Cr)Cr[n]===void 0?delete t[n]:t[n]=Cr[n];var u=[];for(n in t)u.push(`${n}=${t[n]}`);Mr=u}return Mr},Mr,ct=[null,[],[]],Vr=[31,29,31,30,31,30,31,31,30,31,30,31],qr=[31,28,31,30,31,30,31,31,30,31,30,31];function dt(t){var n=Array(He(t)+1);return Be(t,n,0,n.length),n}function Me(t,n,u,p){function v(g,G,ee){for(g=typeof g=="number"?g.toString():g||"";g.length<G;)g=ee[0]+g;return g}function A(g,G){return v(g,G,"0")}function D(g,G){function ee(pr){return 0>pr?-1:0<pr?1:0}var ze;return(ze=ee(g.getFullYear()-G.getFullYear()))===0&&(ze=ee(g.getMonth()-G.getMonth()))===0&&(ze=ee(g.getDate()-G.getDate())),ze}function P(g){switch(g.getDay()){case 0:return new Date(g.getFullYear()-1,11,29);case 1:return g;case 2:return new Date(g.getFullYear(),0,3);case 3:return new Date(g.getFullYear(),0,2);case 4:return new Date(g.getFullYear(),0,1);case 5:return new Date(g.getFullYear()-1,11,31);case 6:return new Date(g.getFullYear()-1,11,30)}}function L(g){var G=g.Ta;for(g=new Date(new Date(g.Ua+1900,0,1).getTime());0<G;){var ee=g.getMonth(),ze=(je(g.getFullYear())?Vr:qr)[ee];if(G>ze-g.getDate())G-=ze-g.getDate()+1,g.setDate(1),11>ee?g.setMonth(ee+1):(g.setMonth(0),g.setFullYear(g.getFullYear()+1));else{g.setDate(g.getDate()+G);break}}return ee=new Date(g.getFullYear()+1,0,4),G=P(new Date(g.getFullYear(),0,4)),ee=P(ee),0>=D(G,g)?0>=D(ee,g)?g.getFullYear()+1:g.getFullYear():g.getFullYear()-1}t>>>=0,n>>>=0,u>>>=0,p>>>=0;var j=Y[p+40>>>2>>>0];p={kb:I[p>>>2>>>0],jb:I[p+4>>>2>>>0],Xa:I[p+8>>>2>>>0],ab:I[p+12>>>2>>>0],Ya:I[p+16>>>2>>>0],Ua:I[p+20>>>2>>>0],Oa:I[p+24>>>2>>>0],Ta:I[p+28>>>2>>>0],mb:I[p+32>>>2>>>0],ib:I[p+36>>>2>>>0],lb:j?ir(j):""},u=ir(u),j={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ne in j)u=u.replace(new RegExp(ne,"g"),j[ne]);var me="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),We="January February March April May June July August September October November December".split(" ");j={"%a":g=>me[g.Oa].substring(0,3),"%A":g=>me[g.Oa],"%b":g=>We[g.Ya].substring(0,3),"%B":g=>We[g.Ya],"%C":g=>A((g.Ua+1900)/100|0,2),"%d":g=>A(g.ab,2),"%e":g=>v(g.ab,2," "),"%g":g=>L(g).toString().substring(2),"%G":g=>L(g),"%H":g=>A(g.Xa,2),"%I":g=>(g=g.Xa,g==0?g=12:12<g&&(g-=12),A(g,2)),"%j":g=>{for(var G=0,ee=0;ee<=g.Ya-1;G+=(je(g.Ua+1900)?Vr:qr)[ee++]);return A(g.ab+G,3)},"%m":g=>A(g.Ya+1,2),"%M":g=>A(g.jb,2),"%n":()=>`
`,"%p":g=>0<=g.Xa&&12>g.Xa?"AM":"PM","%S":g=>A(g.kb,2),"%t":()=>"	","%u":g=>g.Oa||7,"%U":g=>A(Math.floor((g.Ta+7-g.Oa)/7),2),"%V":g=>{var G=Math.floor((g.Ta+7-(g.Oa+6)%7)/7);if(2>=(g.Oa+371-g.Ta-2)%7&&G++,G)G==53&&(ee=(g.Oa+371-g.Ta)%7,ee==4||ee==3&&je(g.Ua)||(G=1));else{G=52;var ee=(g.Oa+7-g.Ta-1)%7;(ee==4||ee==5&&je(g.Ua%400-1))&&G++}return A(G,2)},"%w":g=>g.Oa,"%W":g=>A(Math.floor((g.Ta+7-(g.Oa+6)%7)/7),2),"%y":g=>(g.Ua+1900).toString().substring(2),"%Y":g=>g.Ua+1900,"%z":g=>{g=g.ib;var G=0<=g;return g=Math.abs(g)/60,(G?"+":"-")+("0000"+(g/60*100+g%60)).slice(-4)},"%Z":g=>g.lb,"%%":()=>"%"},u=u.replace(/%%/g,"\0\0");for(ne in j)u.includes(ne)&&(u=u.replace(new RegExp(ne,"g"),j[ne](p)));return u=u.replace(/\0\0/g,"%"),ne=dt(u),ne.length>n?0:(le.set(ne,t>>>0),ne.length-1)}for(var Pr=Array(256),Je=0;256>Je;++Je)Pr[Je]=String.fromCharCode(Je);Xe=Pr,Re=s.BindingError=class extends Error{constructor(t){super(t),this.name="BindingError"}},s.InternalError=class extends Error{constructor(t){super(t),this.name="InternalError"}},Object.assign(ur.prototype,{get(t){return this.Sa[t]},has(t){return this.Sa[t]!==void 0},Za(t){var n=this.bb.pop()||this.Sa.length;return this.Sa[n]=t,n},$a(t){this.Sa[t]=void 0,this.bb.push(t)}}),be.Sa.push({value:void 0},{value:null},{value:!0},{value:!1}),be.Va=be.Sa.length,s.count_emval_handles=()=>{for(var t=0,n=be.Va;n<be.Sa.length;++n)be.Sa[n]!==void 0&&++t;return t};var kt={a:function(t,n,u){throw t>>>=0,new te(t).Za(n>>>0,u>>>0),se=t,qe++,se},v:function(){return 0},ba:function(){},N:function(){},P:function(){},H:function(){return 0},$:function(){},V:function(){},_:function(){},B:function(){},O:function(){},L:function(){},aa:function(){},M:function(){},E:function(t,n,u,p,v){n>>>=0,n=Ce(n);var A=n.indexOf("u")!=-1;A&&(v=(1n<<64n)-1n),Ue(t>>>0,{name:n,fromWireType:D=>D,toWireType:function(D,P){if(typeof P!="bigint"&&typeof P!="number")throw new TypeError(`Cannot convert "${Or(P)}" to ${this.name}`);if(P<p||P>v)throw new TypeError(`Passing a number "${Or(P)}" from JS side to C/C++ side to an argument of type "${n}", which is outside the valid range [${p}, ${v}]!`);return P},argPackAdvance:8,readValueFromPointer:tt(n,u>>>0,!A),Wa:null})},ea:function(t,n,u,p){n=Ce(n>>>0),Ue(t>>>0,{name:n,fromWireType:function(v){return!!v},toWireType:function(v,A){return A?u:p},argPackAdvance:8,readValueFromPointer:function(v){return this.fromWireType(Z[v>>>0])},Wa:null})},da:function(t,n){n=Ce(n>>>0),Ue(t>>>0,{name:n,fromWireType:u=>{var p=ge(u);return _r(u),p},toWireType:(u,p)=>_e(p),argPackAdvance:8,readValueFromPointer:fr,Wa:null})},D:function(t,n,u){n=Ce(n>>>0),Ue(t>>>0,{name:n,fromWireType:p=>p,toWireType:(p,v)=>v,argPackAdvance:8,readValueFromPointer:nt(n,u>>>0),Wa:null})},p:function(t,n,u,p,v){if(t>>>=0,u>>>=0,n=Ce(n>>>0),v===-1&&(v=4294967295),v=P=>P,p===0){var A=32-8*u;v=P=>P<<A>>>A}var D=n.includes("unsigned")?function(P,L){return L>>>0}:function(P,L){return L};Ue(t,{name:n,fromWireType:v,toWireType:D,argPackAdvance:8,readValueFromPointer:tt(n,u,p!==0),Wa:null})},l:function(t,n,u){function p(A){return new v(le.buffer,Y[A+4>>>2>>>0],Y[A>>>2>>>0])}var v=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][n];u=Ce(u>>>0),Ue(t>>>0,{name:u,fromWireType:p,argPackAdvance:8,readValueFromPointer:p},{gb:!0})},F:function(t,n){n=Ce(n>>>0);var u=n==="std::string";Ue(t>>>0,{name:n,fromWireType:function(p){var v=Y[p>>>2>>>0],A=p+4;if(u)for(var D=A,P=0;P<=v;++P){var L=A+P;if(P==v||Z[L>>>0]==0){if(D=ir(D,L-D),j===void 0)var j=D;else j+=String.fromCharCode(0),j+=D;D=L+1}}else{for(j=Array(v),P=0;P<v;++P)j[P]=String.fromCharCode(Z[A+P>>>0]);j=j.join("")}return de(p),j},toWireType:function(p,v){v instanceof ArrayBuffer&&(v=new Uint8Array(v));var A=typeof v=="string";if(!(A||v instanceof Uint8Array||v instanceof Uint8ClampedArray||v instanceof Int8Array))throw new Re("Cannot pass non-string to std::string");var D=u&&A?He(v):v.length,P=Fr(4+D+1),L=P+4;if(Y[P>>>2>>>0]=D,u&&A)Be(v,Z,L,D+1);else if(A)for(A=0;A<D;++A){var j=v.charCodeAt(A);if(255<j)throw de(L),new Re("String has UTF-16 code units that do not fit in 8 bits");Z[L+A>>>0]=j}else for(A=0;A<D;++A)Z[L+A>>>0]=v[A];return p!==null&&p.push(de,P),P},argPackAdvance:8,readValueFromPointer:kr,Wa(p){de(p)}})},x:function(t,n,u){if(n>>>=0,u>>>=0,u=Ce(u),n===2)var p=ot,v=Rt,A=B,D=()=>Fe,P=1;else n===4&&(p=Ar,v=it,A=Er,D=()=>Y,P=2);Ue(t>>>0,{name:u,fromWireType:L=>{for(var j=Y[L>>>2>>>0],ne=D(),me,We=L+4,g=0;g<=j;++g){var G=L+4+g*n;(g==j||ne[G>>>P]==0)&&(We=p(We,G-We),me===void 0?me=We:(me+=String.fromCharCode(0),me+=We),We=G+n)}return de(L),me},toWireType:(L,j)=>{if(typeof j!="string")throw new Re(`Cannot pass non-string to C++ string type ${u}`);var ne=A(j),me=Fr(4+ne+n);return Y[me>>>2]=ne>>P,v(j,me+4,ne+n),L!==null&&L.push(de,me),me},argPackAdvance:8,readValueFromPointer:fr,Wa(L){de(L)}})},fa:function(t,n){n=Ce(n>>>0),Ue(t>>>0,{hb:!0,name:n,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},ca:()=>!0,o:function(t,n,u){n>>>=0,u>>>=0,t=ge(t>>>0),n=lr(n,"emval::as");var p=[],v=_e(p);return Y[u>>>2>>>0]=v,n.toWireType(p,t)},h:function(t,n,u,p,v){u>>>=0,p>>>=0,v>>>=0,t=Sr[t>>>0],n=ge(n>>>0),u=cr(u);var A=[];return Y[p>>>2>>>0]=_e(A),t(n,u,A,v)},r:function(t,n,u,p){u>>>=0,p>>>=0,t=Sr[t>>>0],n=ge(n>>>0),u=cr(u),t(n,u,null,p)},b:_r,y:function(t,n){return n>>>=0,t=ge(t>>>0),n=ge(n),t==n},u:function(t){return t>>>=0,t===0?_e(Lr()):(t=cr(t),_e(Lr()[t]))},g:function(t,n){var u=ut(t,n>>>0),p=u[0];n=p.name+"_$"+u.slice(1).map(function(ne){return ne.name}).join("_")+"$";var v=dr[n];if(v!==void 0)return v;v=["retType"];for(var A=[p],D="",P=0;P<t-1;++P)D+=(P!==0?", ":"")+"arg"+P,v.push("argType"+P),A.push(u[1+P]);var L="return function "+$r("methodCaller_"+n)+`(handle, name, destructors, args) {
...
`),v.push(L+`};
`),t=Nr(v).apply(null,A),v=st(t),dr[n]=v},q:function(t,n){return n>>>=0,t=ge(t>>>0),n=ge(n),_e(t[n])},c:function(t){t>>>=0,4<t&&(be.get(t).cb+=1)},G:function(t,n,u,p){u>>>=0,p>>>=0,t=ge(t>>>0);var v=Hr[n];return v||(v=lt(n),Hr[n]=v),v(t,u,p)},s:function(){return _e([])},k:function(t){t=ge(t>>>0);for(var n=Array(t.length),u=0;u<t.length;u++)n[u]=t[u];return _e(n)},d:function(t){return _e(cr(t>>>0))},j:function(){return _e({})},e:function(t){t>>>=0;for(var n=ge(t);n.length;){var u=n.pop();n.pop()(u)}_r(t)},i:function(t,n,u){n>>>=0,u>>>=0,t=ge(t>>>0),n=ge(n),u=ge(u),t[n]=u},f:function(t,n){return n>>>=0,t=lr(t>>>0,"_emval_take_value"),t=t.readValueFromPointer(n),_e(t)},S:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),I[n>>>2>>>0]=t.getUTCSeconds(),I[n+4>>>2>>>0]=t.getUTCMinutes(),I[n+8>>>2>>>0]=t.getUTCHours(),I[n+12>>>2>>>0]=t.getUTCDate(),I[n+16>>>2>>>0]=t.getUTCMonth(),I[n+20>>>2>>>0]=t.getUTCFullYear()-1900,I[n+24>>>2>>>0]=t.getUTCDay(),I[n+28>>>2>>>0]=(t.getTime()-Date.UTC(t.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},T:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),I[n>>>2>>>0]=t.getSeconds(),I[n+4>>>2>>>0]=t.getMinutes(),I[n+8>>>2>>>0]=t.getHours(),I[n+12>>>2>>>0]=t.getDate(),I[n+16>>>2>>>0]=t.getMonth(),I[n+20>>>2>>>0]=t.getFullYear()-1900,I[n+24>>>2>>>0]=t.getDay(),I[n+28>>>2>>>0]=(je(t.getFullYear())?jr:zr)[t.getMonth()]+t.getDate()-1|0,I[n+36>>>2>>>0]=-(60*t.getTimezoneOffset());var u=new Date(t.getFullYear(),6,1).getTimezoneOffset(),p=new Date(t.getFullYear(),0,1).getTimezoneOffset();I[n+32>>>2>>>0]=(u!=p&&t.getTimezoneOffset()==Math.min(p,u))|0},U:function(t){t>>>=0;var n=new Date(I[t+20>>>2>>>0]+1900,I[t+16>>>2>>>0],I[t+12>>>2>>>0],I[t+8>>>2>>>0],I[t+4>>>2>>>0],I[t>>>2>>>0],0),u=I[t+32>>>2>>>0],p=n.getTimezoneOffset(),v=new Date(n.getFullYear(),6,1).getTimezoneOffset(),A=new Date(n.getFullYear(),0,1).getTimezoneOffset(),D=Math.min(A,v);return 0>u?I[t+32>>>2>>>0]=+(v!=A&&D==p):0<u!=(D==p)&&(v=Math.max(A,v),n.setTime(n.getTime()+6e4*((0<u?D:v)-p))),I[t+24>>>2>>>0]=n.getDay(),I[t+28>>>2>>>0]=(je(n.getFullYear())?jr:zr)[n.getMonth()]+n.getDate()-1|0,I[t>>>2>>>0]=n.getSeconds(),I[t+4>>>2>>>0]=n.getMinutes(),I[t+8>>>2>>>0]=n.getHours(),I[t+12>>>2>>>0]=n.getDate(),I[t+16>>>2>>>0]=n.getMonth(),I[t+20>>>2>>>0]=n.getYear(),BigInt(n.getTime()/1e3)},Q:function(){return-52},R:function(){},J:function(t,n,u){function p(L){return(L=L.toTimeString().match(/\(([A-Za-z ]+)\)$/))?L[1]:"GMT"}u>>>=0;var v=new Date().getFullYear(),A=new Date(v,0,1),D=new Date(v,6,1);v=A.getTimezoneOffset();var P=D.getTimezoneOffset();Y[t>>>0>>>2>>>0]=60*Math.max(v,P),I[n>>>0>>>2>>>0]=+(v!=P),t=p(A),n=p(D),t=Yr(t),n=Yr(n),P<v?(Y[u>>>2>>>0]=t,Y[u+4>>>2>>>0]=n):(Y[u>>>2>>>0]=n,Y[u+4>>>2>>>0]=t)},t:()=>{nr("")},C:()=>Date.now(),K:function(){return 4294901760},n:()=>performance.now(),Z:function(t,n,u){return n>>>=0,Z.copyWithin(t>>>0>>>0,n>>>0,n+(u>>>0)>>>0)},I:function(t){t>>>=0;var n=Z.length;if(4294901760<t)return!1;for(var u=1;4>=u;u*=2){var p=n*(1+.2/u);p=Math.min(p,t+100663296);var v=Math;p=Math.max(t,p);e:{v=(v.min.call(v,4294901760,p+(65536-p%65536)%65536)-U.buffer.byteLength+65535)/65536;try{U.grow(v),V();var A=1;break e}catch{}A=void 0}if(A)return!0}return!1},X:function(t,n){t>>>=0,n>>>=0;var u=0;return Gr().forEach((p,v)=>{var A=n+u;for(v=Y[t+4*v>>>2>>>0]=A,A=0;A<p.length;++A)le[v++>>>0>>>0]=p.charCodeAt(A);le[v>>>0>>>0]=0,u+=p.length+1}),0},Y:function(t,n){t>>>=0,n>>>=0;var u=Gr();Y[t>>>2>>>0]=u.length;var p=0;return u.forEach(v=>p+=v.length+1),Y[n>>>2>>>0]=p,0},w:()=>52,A:function(){return 52},W:function(){return 70},z:function(t,n,u,p){n>>>=0,u>>>=0,p>>>=0;for(var v=0,A=0;A<u;A++){var D=Y[n>>>2>>>0],P=Y[n+4>>>2>>>0];n+=8;for(var L=0;L<P;L++){var j=Z[D+L>>>0],ne=ct[t];j===0||j===10?((t===1?z:W)(wr(ne,0)),ne.length=0):ne.push(j)}v+=P}return Y[p>>>2>>>0]=v,0},ga:Me,m:function(t,n,u,p){return Me(t>>>0,n>>>0,u>>>0,p>>>0)}},R=function(){var t={a:kt};return he++,or(t,function(n){R=n.instance.exports,R=we(),U=R.ha,V(),$e.unshift(R.ia),he--,he==0&&(Q!==null&&(clearInterval(Q),Q=null),pe&&(n=pe,pe=null,n()))}).catch(c),{}}();s._OrtInit=(t,n)=>(s._OrtInit=R.ja)(t,n),s._OrtGetLastError=(t,n)=>(s._OrtGetLastError=R.ka)(t,n),s._OrtCreateSessionOptions=(t,n,u,p,v,A,D,P,L,j)=>(s._OrtCreateSessionOptions=R.la)(t,n,u,p,v,A,D,P,L,j),s._OrtAppendExecutionProvider=(t,n)=>(s._OrtAppendExecutionProvider=R.ma)(t,n),s._OrtAddFreeDimensionOverride=(t,n,u)=>(s._OrtAddFreeDimensionOverride=R.na)(t,n,u),s._OrtAddSessionConfigEntry=(t,n,u)=>(s._OrtAddSessionConfigEntry=R.oa)(t,n,u),s._OrtReleaseSessionOptions=t=>(s._OrtReleaseSessionOptions=R.pa)(t),s._OrtCreateSession=(t,n,u)=>(s._OrtCreateSession=R.qa)(t,n,u),s._OrtReleaseSession=t=>(s._OrtReleaseSession=R.ra)(t),s._OrtGetInputOutputCount=(t,n,u)=>(s._OrtGetInputOutputCount=R.sa)(t,n,u),s._OrtGetInputName=(t,n)=>(s._OrtGetInputName=R.ta)(t,n),s._OrtGetOutputName=(t,n)=>(s._OrtGetOutputName=R.ua)(t,n),s._OrtFree=t=>(s._OrtFree=R.va)(t),s._OrtCreateTensor=(t,n,u,p,v,A)=>(s._OrtCreateTensor=R.wa)(t,n,u,p,v,A),s._OrtGetTensorData=(t,n,u,p,v)=>(s._OrtGetTensorData=R.xa)(t,n,u,p,v),s._OrtReleaseTensor=t=>(s._OrtReleaseTensor=R.ya)(t),s._OrtCreateRunOptions=(t,n,u,p)=>(s._OrtCreateRunOptions=R.za)(t,n,u,p),s._OrtAddRunConfigEntry=(t,n,u)=>(s._OrtAddRunConfigEntry=R.Aa)(t,n,u),s._OrtReleaseRunOptions=t=>(s._OrtReleaseRunOptions=R.Ba)(t),s._OrtCreateBinding=t=>(s._OrtCreateBinding=R.Ca)(t),s._OrtBindInput=(t,n,u)=>(s._OrtBindInput=R.Da)(t,n,u),s._OrtBindOutput=(t,n,u,p)=>(s._OrtBindOutput=R.Ea)(t,n,u,p),s._OrtClearBoundOutputs=t=>(s._OrtClearBoundOutputs=R.Fa)(t),s._OrtReleaseBinding=t=>(s._OrtReleaseBinding=R.Ga)(t),s._OrtRunWithBinding=(t,n,u,p,v)=>(s._OrtRunWithBinding=R.Ha)(t,n,u,p,v),s._OrtRun=(t,n,u,p,v,A,D,P)=>(s._OrtRun=R.Ia)(t,n,u,p,v,A,D,P),s._OrtEndProfiling=t=>(s._OrtEndProfiling=R.Ja)(t);var Fr=s._malloc=t=>(Fr=s._malloc=R.Ka)(t),de=s._free=t=>(de=s._free=R.La)(t),Xr=t=>(Xr=R.Ma)(t);s.__embind_initialize_bindings=()=>(s.__embind_initialize_bindings=R.Na)();var Jr=()=>(Jr=R.Pa)(),Ae=t=>(Ae=R.Qa)(t),Ur=t=>(Ur=R.Ra)(t);function we(){var t=R;t=Object.assign({},t);var n=p=>()=>p()>>>0,u=p=>v=>p(v)>>>0;return t.__errno_location=n(t.__errno_location),t.Ka=u(t.Ka),t.Ma=u(t.Ma),t.Pa=n(t.Pa),t.Ra=u(t.Ra),t}s.stackAlloc=Ur,s.stackSave=Jr,s.stackRestore=Ae,s.UTF8ToString=ir,s.stringToUTF8=(t,n,u)=>Be(t,Z,n,u),s.lengthBytesUTF8=He;var ye;pe=function t(){ye||Zr(),ye||(pe=t)};function Zr(){if(!(0<he)){for(;0<K.length;)K.shift()(s);if(!(0<he||ye||(ye=!0,s.calledRun=!0,J))){for(;0<$e.length;)$e.shift()(s);for(m(s);0<Oe.length;)Oe.shift()(s)}}}return Zr(),i.ready}})();typeof ha=="object"&&typeof rn=="object"?rn.exports=ma:typeof define=="function"&&define.amd&&define([],()=>ma)});var ya=Dr(()=>{});var va=Dr(()=>{});var ba={};xr(ba,{cpus:()=>_o});var _o,wa=X(()=>{_o=void 0});var _a=Dr((Ta,tn)=>{"use strict";var Oa=(()=>{var o=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(o=o||__filename),function(i={}){function s(){return K.buffer!=Q.buffer&&te(),Q}function m(){return K.buffer!=Q.buffer&&te(),pe}function c(){return K.buffer!=Q.buffer&&te(),nr}function w(){return K.buffer!=Q.buffer&&te(),ke}function d(){return K.buffer!=Q.buffer&&te(),De}function y(){return K.buffer!=Q.buffer&&te(),Ve}function T(){return K.buffer!=Q.buffer&&te(),or}var f=i,_,S;f.ready=new Promise((e,r)=>{_=e,S=r});var E=Object.assign({},f),F="./this.program",N=(e,r)=>{throw r},k=typeof window=="object",z=typeof importScripts=="function",W=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",U=f.ENVIRONMENT_IS_PTHREAD||!1,J="";function le(e){return f.locateFile?f.locateFile(e,J):J+e}var Z,Se,Fe;if(W){var I=(Kt(),hr(Zt)),Y=(en(),hr(Qt));J=z?Y.dirname(J)+"/":__dirname+"/",Z=(r,a)=>(r=r.startsWith("file://")?new URL(r):Y.normalize(r),I.readFileSync(r,a?void 0:"utf8")),Fe=r=>(r=Z(r,!0),r.buffer||(r=new Uint8Array(r)),r),Se=(r,a,l,h=!0)=>{r=r.startsWith("file://")?new URL(r):Y.normalize(r),I.readFile(r,h?void 0:"utf8",(b,C)=>{b?l(b):a(h?C.buffer:C)})},!f.thisProgram&&1<process.argv.length&&(F=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),N=(r,a)=>{throw process.exitCode=r,a},f.inspect=()=>"[Emscripten Module object]";let e;try{e=ya()}catch(r){throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'),r}global.Worker=e.Worker}else(k||z)&&(z?J=self.location.href:typeof document<"u"&&document.currentScript&&(J=document.currentScript.src),typeof o<"u"&&o&&(J=o),J.indexOf("blob:")!==0?J=J.substr(0,J.replace(/[?#].*/,"").lastIndexOf("/")+1):J="",W||(Z=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.send(null),r.responseText},z&&(Fe=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.responseType="arraybuffer",r.send(null),new Uint8Array(r.response)}),Se=(e,r,a)=>{var l=new XMLHttpRequest;l.open("GET",e,!0),l.responseType="arraybuffer",l.onload=()=>{l.status==200||l.status==0&&l.response?r(l.response):a()},l.onerror=a,l.send(null)}));W&&typeof performance>"u"&&(global.performance=va().performance);var er=console.log.bind(console),rr=console.error.bind(console);W&&(er=(...e)=>I.writeSync(1,e.join(" ")+`
`),rr=(...e)=>I.writeSync(2,e.join(" ")+`
`));var tr=er,ce=rr;Object.assign(f,E),E=null;var V=!0;typeof WebAssembly!="object"&&Le("no native wasm support detected");var K,$e,Oe=!1,he,Q,pe,nr,ke,De,Ve,ar,Te,xe,or;function te(){var e=K.buffer;f.HEAP8=Q=new Int8Array(e),f.HEAP16=nr=new Int16Array(e),f.HEAPU8=pe=new Uint8Array(e),f.HEAPU16=ke=new Uint16Array(e),f.HEAP32=De=new Int32Array(e),f.HEAPU32=Ve=new Uint32Array(e),f.HEAPF32=ar=new Float32Array(e),f.HEAPF64=or=new Float64Array(e),f.HEAP64=Te=new BigInt64Array(e),f.HEAPU64=xe=new BigUint64Array(e)}var se=16777216;if(5242880<=se||Le("INITIAL_MEMORY should be larger than STACK_SIZE, was "+se+"! (STACK_SIZE=5242880)"),U)K=f.wasmMemory;else if(K=new WebAssembly.Memory({initial:se/65536,maximum:65536,shared:!0}),!(K.buffer instanceof SharedArrayBuffer))throw ce("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),W&&ce("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");te(),se=K.buffer.byteLength;var qe=[],Ne=[],wr=[],ir=0;function He(){return V||0<ir}var Be=0,Or=null,Xe=null;function Ce(){if(Be--,Be==0&&(Or!==null&&(clearInterval(Or),Or=null),Xe)){var e=Xe;Xe=null,e()}}function Le(e){throw e="Aborted("+e+")",ce(e),Oe=!0,he=1,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),S(e),e}function Tr(e){return e.startsWith("data:application/octet-stream;base64,")}var sr;sr="ort-wasm-threaded.wasm",Tr(sr)||(sr=le(sr));function Re(e){if(Fe)return Fe(e);throw"both async and sync fetching of the wasm failed"}function Bt(e){if(k||z){if(typeof fetch=="function"&&!e.startsWith("file://"))return fetch(e,{credentials:"same-origin"}).then(r=>{if(!r.ok)throw"failed to load wasm binary file at '"+e+"'";return r.arrayBuffer()}).catch(()=>Re(e));if(Se)return new Promise((r,a)=>{Se(e,l=>r(new Uint8Array(l)),a)})}return Promise.resolve().then(()=>Re(e))}function Ue(e,r,a){return Bt(e).then(l=>WebAssembly.instantiate(l,r)).then(l=>l).then(a,l=>{ce(`failed to asynchronously prepare wasm: ${l}`),Le(l)})}function tt(e,r){var a=sr;return typeof WebAssembly.instantiateStreaming!="function"||Tr(a)||a.startsWith("file://")||W||typeof fetch!="function"?Ue(a,e,r):fetch(a,{credentials:"same-origin"}).then(l=>WebAssembly.instantiateStreaming(l,e).then(r,function(h){return ce(`wasm streaming compile failed: ${h}`),ce("falling back to ArrayBuffer instantiation"),Ue(a,e,r)}))}function ur(e){this.name="ExitStatus",this.message=`Program terminated with exit(${e})`,this.status=e}var be=e=>{e.terminate(),e.onmessage=()=>{}},_r=e=>{B.nb.length==0&&(ot(),B.Ab(B.nb[0]));var r=B.nb.pop();if(!r)return 6;B.ob.push(r),B.jb[e.mb]=r,r.mb=e.mb;var a={cmd:"run",start_routine:e.Mb,arg:e.Gb,pthread_ptr:e.mb};return W&&r.unref(),r.postMessage(a,e.Sb),0},ge=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,_e=(e,r,a)=>{r>>>=0;var l=r+a;for(a=r;e[a]&&!(a>=l);)++a;if(16<a-r&&e.buffer&&ge)return ge.decode(e.buffer instanceof SharedArrayBuffer?e.slice(r,a):e.subarray(r,a));for(l="";r<a;){var h=e[r++];if(h&128){var b=e[r++]&63;if((h&224)==192)l+=String.fromCharCode((h&31)<<6|b);else{var C=e[r++]&63;h=(h&240)==224?(h&15)<<12|b<<6|C:(h&7)<<18|b<<12|C<<6|e[r++]&63,65536>h?l+=String.fromCharCode(h):(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023))}}else l+=String.fromCharCode(h)}return l},fr=(e,r)=>(e>>>=0)?_e(m(),e,r):"";function nt(e){if(U)return g(0,1,e);he=e,He()||(B.Nb(),Oe=!0),N(e,new ur(e))}var kr=e=>{if(he=e,U)throw it(e),"unwind";nt(e)};function at(){for(var e=f.numThreads;e--;)ot();qe.unshift(()=>{Be++,Rt(()=>Ce())})}function ot(){var e=le("ort-wasm-threaded.worker.js");e=new Worker(e),B.nb.push(e)}function Rt(e){U?e():Promise.all(B.nb.map(B.Ab)).then(e)}var B={nb:[],ob:[],Fb:[],jb:{},vb(){U?(B.receiveObjectTransfer=B.Lb,B.threadInitTLS=B.Eb,B.setExitStatus=B.Db,V=!1):at()},Db:e=>{he=e},Vb:["$terminateWorker"],Nb:()=>{for(var e of B.ob)be(e);for(e of B.nb)be(e);B.nb=[],B.ob=[],B.jb=[]},Cb:e=>{var r=e.mb;delete B.jb[r],B.nb.push(e),B.ob.splice(B.ob.indexOf(e),1),e.mb=0,Nt(r)},Lb(){},Eb(){B.Fb.forEach(e=>e())},Ab:e=>new Promise(r=>{e.onmessage=b=>{b=b.data;var C=b.cmd;if(b.targetThread&&b.targetThread!=ht()){var M=B.jb[b.targetThread];M?M.postMessage(b,b.transferList):ce(`Internal error! Worker sent a message "${C}" to target pthread ${b.targetThread}, but that thread no longer exists!`)}else C==="checkMailbox"?me():C==="spawnThread"?_r(b):C==="cleanupThread"?((b=B.jb[b.thread])||Le(),B.Cb(b)):C==="killThread"?(b=b.thread,C=B.jb[b],delete B.jb[b],be(C),Nt(b),B.ob.splice(B.ob.indexOf(C),1),C.mb=0):C==="cancelThread"?B.jb[b.thread].postMessage({cmd:"cancel"}):C==="loaded"?(e.loaded=!0,W&&!e.mb&&e.unref(),r(e)):C==="alert"?alert(`Thread ${b.threadId}: ${b.text}`):b.target==="setimmediate"?e.postMessage(b):C==="callHandler"?f[b.handler](...b.args):C&&ce(`worker sent an unknown command ${C}`)},e.onerror=b=>{throw ce(`worker sent an error! ${b.filename}:${b.lineno}: ${b.message}`),b},W&&(e.on("message",b=>e.onmessage({data:b})),e.on("error",b=>e.onerror(b)));var a=[],l=[],h;for(h of l)f.hasOwnProperty(h)&&a.push(h);e.postMessage({cmd:"load",handlers:a,urlOrBlob:f.mainScriptUrlOrBlob||o,wasmMemory:K,wasmModule:$e})})};f.PThread=B;var Ar=e=>{for(;0<e.length;)e.shift()(f)};f.establishStackSpace=()=>{var e=ht(),r=y()[e+52>>>2>>>0];e=y()[e+56>>>2>>>0],Wn(r,r-e),yt(r)};function it(e){if(U)return g(1,0,e);kr(e)}var Er=[],lr;f.invokeEntryPoint=(e,r)=>{var a=Er[e];a||(e>=Er.length&&(Er.length=e+1),Er[e]=a=lr.get(e)),e=a(r),He()?B.Db(e):Ht(e)};function Wt(e){this.sb=e-24,this.Kb=function(r){y()[this.sb+4>>>2>>>0]=r},this.xb=function(r){y()[this.sb+8>>>2>>>0]=r},this.vb=function(r,a){this.wb(),this.Kb(r),this.xb(a)},this.wb=function(){y()[this.sb+16>>>2>>>0]=0}}var cr=0,Sr=0;function Lr(e,r,a,l){return U?g(2,1,e,r,a,l):st(e,r,a,l)}function st(e,r,a,l){if(e>>>=0,r>>>=0,a>>>=0,l>>>=0,typeof SharedArrayBuffer>"u")return ce("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var h=[];return U&&h.length===0?Lr(e,r,a,l):(e={Mb:a,mb:e,Gb:l,Sb:h},U?(e.Ub="spawnThread",postMessage(e,h),0):_r(e))}function ut(e,r,a){return U?g(3,1,e,r,a):0}function $r(e,r){if(U)return g(4,1,e,r)}var dr=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);127>=l?r++:2047>=l?r+=2:55296<=l&&57343>=l?(r+=4,++a):r+=3}return r},ft=(e,r,a,l)=>{if(a>>>=0,!(0<l))return 0;var h=a;l=a+l-1;for(var b=0;b<e.length;++b){var C=e.charCodeAt(b);if(55296<=C&&57343>=C){var M=e.charCodeAt(++b);C=65536+((C&1023)<<10)|M&1023}if(127>=C){if(a>=l)break;r[a++>>>0]=C}else{if(2047>=C){if(a+1>=l)break;r[a++>>>0]=192|C>>6}else{if(65535>=C){if(a+2>=l)break;r[a++>>>0]=224|C>>12}else{if(a+3>=l)break;r[a++>>>0]=240|C>>18,r[a++>>>0]=128|C>>12&63}r[a++>>>0]=128|C>>6&63}r[a++>>>0]=128|C&63}}return r[a>>>0]=0,a-h},Nr=(e,r,a)=>ft(e,m(),r,a);function lt(e,r){if(U)return g(5,1,e,r)}function Hr(e,r,a){if(U)return g(6,1,e,r,a)}function je(e,r,a){return U?g(7,1,e,r,a):0}function jr(e,r){if(U)return g(8,1,e,r)}function zr(e,r,a){if(U)return g(9,1,e,r,a)}function Yr(e,r,a,l){if(U)return g(10,1,e,r,a,l)}function Cr(e,r,a,l){if(U)return g(11,1,e,r,a,l)}function Gr(e,r,a,l){if(U)return g(12,1,e,r,a,l)}function Mr(e){if(U)return g(13,1,e)}function ct(e,r){if(U)return g(14,1,e,r)}function Vr(e,r,a){if(U)return g(15,1,e,r,a)}var qr=e=>{if(e===null)return"null";var r=typeof e;return r==="object"||r==="array"||r==="function"?e.toString():""+e},dt,Me=e=>{for(var r="";m()[e>>>0];)r+=dt[m()[e++>>>0]];return r},Pr={},Je={},kt={},R;function Fr(e,r,a={}){var l=r.name;if(!e)throw new R(`type "${l}" must have a positive integer typeid pointer`);if(Je.hasOwnProperty(e)){if(a.Ib)return;throw new R(`Cannot register type '${l}' twice`)}Je[e]=r,delete kt[e],Pr.hasOwnProperty(e)&&(r=Pr[e],delete Pr[e],r.forEach(h=>h()))}function de(e,r,a={}){if(!("argPackAdvance"in r))throw new TypeError("registerType registeredInstance requires argPackAdvance");Fr(e,r,a)}var Xr=(e,r,a)=>{switch(r){case 1:return a?l=>s()[l>>>0>>>0]:l=>m()[l>>>0>>>0];case 2:return a?l=>c()[l>>>1>>>0]:l=>w()[l>>>1>>>0];case 4:return a?l=>d()[l>>>2>>>0]:l=>y()[l>>>2>>>0];case 8:return a?l=>Te[l>>>3]:l=>xe[l>>>3];default:throw new TypeError(`invalid integer width (${r}): ${e}`)}};function Jr(){this.lb=[void 0],this.zb=[]}var Ae=new Jr;function Ur(e){e>>>=0,e>=Ae.sb&&--Ae.get(e).Bb===0&&Ae.xb(e)}var we=e=>{if(!e)throw new R("Cannot use deleted val. handle = "+e);return Ae.get(e).value},ye=e=>{switch(e){case void 0:return 1;case null:return 2;case!0:return 3;case!1:return 4;default:return Ae.wb({Bb:1,value:e})}};function Zr(e){return this.fromWireType(d()[e>>>2>>>0])}var t=(e,r)=>{switch(r){case 4:return function(a){var l=this.fromWireType;return K.buffer!=Q.buffer&&te(),l.call(this,ar[a>>>2>>>0])};case 8:return function(a){return this.fromWireType(T()[a>>>3>>>0])};default:throw new TypeError(`invalid float width (${r}): ${e}`)}};function n(e){return this.fromWireType(y()[e>>>2>>>0])}var u=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,p=(e,r)=>{for(var a=e>>1,l=a+r/2;!(a>=l)&&w()[a>>>0];)++a;if(a<<=1,32<a-e&&u)return u.decode(m().slice(e,a));for(a="",l=0;!(l>=r/2);++l){var h=c()[e+2*l>>>1>>>0];if(h==0)break;a+=String.fromCharCode(h)}return a},v=(e,r,a)=>{if(a===void 0&&(a=2147483647),2>a)return 0;a-=2;var l=r;a=a<2*e.length?a/2:e.length;for(var h=0;h<a;++h){var b=e.charCodeAt(h);c()[r>>>1>>>0]=b,r+=2}return c()[r>>>1>>>0]=0,r-l},A=e=>2*e.length,D=(e,r)=>{for(var a=0,l="";!(a>=r/4);){var h=d()[e+4*a>>>2>>>0];if(h==0)break;++a,65536<=h?(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023)):l+=String.fromCharCode(h)}return l},P=(e,r,a)=>{if(r>>>=0,a===void 0&&(a=2147483647),4>a)return 0;var l=r;a=l+a-4;for(var h=0;h<e.length;++h){var b=e.charCodeAt(h);if(55296<=b&&57343>=b){var C=e.charCodeAt(++h);b=65536+((b&1023)<<10)|C&1023}if(d()[r>>>2>>>0]=b,r+=4,r+4>a)break}return d()[r>>>2>>>0]=0,r-l},L=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);55296<=l&&57343>=l&&++a,r+=4}return r},j=e=>{if(!Oe)try{if(e(),!He())try{U?Ht(he):kr(he)}catch(r){r instanceof ur||r=="unwind"||N(1,r)}}catch(r){r instanceof ur||r=="unwind"||N(1,r)}};function ne(e){e>>>=0,typeof Atomics.Tb=="function"&&(Atomics.Tb(d(),e>>>2,e).value.then(me),e+=128,Atomics.store(d(),e>>>2,1))}f.__emscripten_thread_mailbox_await=ne;var me=()=>{var e=ht();e&&(ne(e),j(()=>Rn()))};f.checkMailbox=me;var We=e=>{var r=jt();return e=e(),yt(r),e};function g(e,r){var a=arguments.length-2,l=arguments;return We(()=>{for(var h=2*a,b=zt(8*h),C=b>>>3,M=0;M<a;M++){var $=l[2+M];typeof $=="bigint"?(Te[C+2*M]=1n,Te[C+2*M+1]=$):(Te[C+2*M]=0n,T()[C+2*M+1>>>0]=$)}return Bn(e,h,b,r)})}var G=[],ee=(e,r)=>{var a=Je[e];if(a===void 0)throw e=Dn(e),a=Me(e),Ye(e),new R(r+" has unknown type "+a);return a},ze={},pr=e=>{var r=ze[e];return r===void 0?Me(e):r},pt=[],pn=()=>typeof globalThis=="object"?globalThis:Function("return this")(),ao=e=>{var r=pt.length;return pt.push(e),r},oo=(e,r)=>{for(var a=Array(e),l=0;l<e;++l)a[l]=ee(y()[r+4*l>>>2>>>0],"parameter "+l);return a},mn=e=>{if(e===void 0)return"_unknown";e=e.replace(/[^a-zA-Z0-9_]/g,"$");var r=e.charCodeAt(0);return 48<=r&&57>=r?`_${e}`:e},hn={};function io(e,r){return e=mn(e),{[e]:function(){return r.apply(this,arguments)}}[e]}function so(e){var r=Function;if(!(r instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof r} which is not a function`);var a=io(r.name||"unknownFunctionName",function(){});return a.prototype=r.prototype,a=new a,e=r.apply(a,e),e instanceof Object?e:a}var uo=e=>{for(var r="",a=0;a<e;++a)r+=(a!==0?", ":"")+"arg"+a;var l="return function emval_allocator_"+e+`(constructor, argTypes, args) {
  var HEAPU32 = getMemory();
...
`))(ee,f,ye,()=>y())},gn={},Ir=e=>e%4===0&&(e%100!==0||e%400===0),yn=[0,31,60,91,121,152,182,213,244,274,305,335],vn=[0,31,59,90,120,151,181,212,243,273,304,334];function bn(e,r,a,l,h,b,C){return U?g(16,1,e,r,a,l,h,b,C):-52}function wn(e,r,a,l,h,b){if(U)return g(17,1,e,r,a,l,h,b)}var On=e=>{var r=dr(e)+1,a=gt(r);return a&&Nr(e,a,r),a},Lt={},Tn=()=>{if(!$t){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:F||"./this.program"},r;for(r in Lt)Lt[r]===void 0?delete e[r]:e[r]=Lt[r];var a=[];for(r in e)a.push(`${r}=${e[r]}`);$t=a}return $t},$t;function _n(e,r){if(U)return g(18,1,e,r);e>>>=0,r>>>=0;var a=0;return Tn().forEach((l,h)=>{var b=r+a;for(h=y()[e+4*h>>>2>>>0]=b,b=0;b<l.length;++b)s()[h++>>>0>>>0]=l.charCodeAt(b);s()[h>>>0>>>0]=0,a+=l.length+1}),0}function An(e,r){if(U)return g(19,1,e,r);e>>>=0,r>>>=0;var a=Tn();y()[e>>>2>>>0]=a.length;var l=0;return a.forEach(h=>l+=h.length+1),y()[r>>>2>>>0]=l,0}function En(e){return U?g(20,1,e):52}function Sn(e,r,a,l){return U?g(21,1,e,r,a,l):52}function Cn(e,r,a,l){return U?g(22,1,e,r,a,l):70}var fo=[null,[],[]];function Mn(e,r,a,l){if(U)return g(23,1,e,r,a,l);r>>>=0,a>>>=0,l>>>=0;for(var h=0,b=0;b<a;b++){var C=y()[r>>>2>>>0],M=y()[r+4>>>2>>>0];r+=8;for(var $=0;$<M;$++){var H=m()[C+$>>>0],ae=fo[e];H===0||H===10?((e===1?tr:ce)(_e(ae,0)),ae.length=0):ae.push(H)}h+=M}return y()[l>>>2>>>0]=h,0}var Pn=[31,29,31,30,31,30,31,31,30,31,30,31],Fn=[31,28,31,30,31,30,31,31,30,31,30,31];function lo(e){var r=Array(dr(e)+1);return ft(e,r,0,r.length),r}var co=(e,r)=>{s().set(e,r>>>0)};function Un(e,r,a,l){function h(O,q,oe){for(O=typeof O=="number"?O.toString():O||"";O.length<q;)O=oe[0]+O;return O}function b(O,q){return h(O,q,"0")}function C(O,q){function oe(Ln){return 0>Ln?-1:0<Ln?1:0}var mr;return(mr=oe(O.getFullYear()-q.getFullYear()))===0&&(mr=oe(O.getMonth()-q.getMonth()))===0&&(mr=oe(O.getDate()-q.getDate())),mr}function M(O){switch(O.getDay()){case 0:return new Date(O.getFullYear()-1,11,29);case 1:return O;case 2:return new Date(O.getFullYear(),0,3);case 3:return new Date(O.getFullYear(),0,2);case 4:return new Date(O.getFullYear(),0,1);case 5:return new Date(O.getFullYear()-1,11,31);case 6:return new Date(O.getFullYear()-1,11,30)}}function $(O){var q=O.pb;for(O=new Date(new Date(O.qb+1900,0,1).getTime());0<q;){var oe=O.getMonth(),mr=(Ir(O.getFullYear())?Pn:Fn)[oe];if(q>mr-O.getDate())q-=mr-O.getDate()+1,O.setDate(1),11>oe?O.setMonth(oe+1):(O.setMonth(0),O.setFullYear(O.getFullYear()+1));else{O.setDate(O.getDate()+q);break}}return oe=new Date(O.getFullYear()+1,0,4),q=M(new Date(O.getFullYear(),0,4)),oe=M(oe),0>=C(q,O)?0>=C(oe,O)?O.getFullYear()+1:O.getFullYear():O.getFullYear()-1}e>>>=0,r>>>=0,a>>>=0,l>>>=0;var H=y()[l+40>>>2>>>0];l={Qb:d()[l>>>2>>>0],Pb:d()[l+4>>>2>>>0],tb:d()[l+8>>>2>>>0],yb:d()[l+12>>>2>>>0],ub:d()[l+16>>>2>>>0],qb:d()[l+20>>>2>>>0],kb:d()[l+24>>>2>>>0],pb:d()[l+28>>>2>>>0],Wb:d()[l+32>>>2>>>0],Ob:d()[l+36>>>2>>>0],Rb:H?fr(H):""},a=fr(a),H={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ae in H)a=a.replace(new RegExp(ae,"g"),H[ae]);var Pe="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ge="January February March April May June July August September October November December".split(" ");H={"%a":O=>Pe[O.kb].substring(0,3),"%A":O=>Pe[O.kb],"%b":O=>Ge[O.ub].substring(0,3),"%B":O=>Ge[O.ub],"%C":O=>b((O.qb+1900)/100|0,2),"%d":O=>b(O.yb,2),"%e":O=>h(O.yb,2," "),"%g":O=>$(O).toString().substring(2),"%G":O=>$(O),"%H":O=>b(O.tb,2),"%I":O=>(O=O.tb,O==0?O=12:12<O&&(O-=12),b(O,2)),"%j":O=>{for(var q=0,oe=0;oe<=O.ub-1;q+=(Ir(O.qb+1900)?Pn:Fn)[oe++]);return b(O.yb+q,3)},"%m":O=>b(O.ub+1,2),"%M":O=>b(O.Pb,2),"%n":()=>`
`,"%p":O=>0<=O.tb&&12>O.tb?"AM":"PM","%S":O=>b(O.Qb,2),"%t":()=>"	","%u":O=>O.kb||7,"%U":O=>b(Math.floor((O.pb+7-O.kb)/7),2),"%V":O=>{var q=Math.floor((O.pb+7-(O.kb+6)%7)/7);if(2>=(O.kb+371-O.pb-2)%7&&q++,q)q==53&&(oe=(O.kb+371-O.pb)%7,oe==4||oe==3&&Ir(O.qb)||(q=1));else{q=52;var oe=(O.kb+7-O.pb-1)%7;(oe==4||oe==5&&Ir(O.qb%400-1))&&q++}return b(q,2)},"%w":O=>O.kb,"%W":O=>b(Math.floor((O.pb+7-(O.kb+6)%7)/7),2),"%y":O=>(O.qb+1900).toString().substring(2),"%Y":O=>O.qb+1900,"%z":O=>{O=O.Ob;var q=0<=O;return O=Math.abs(O)/60,(q?"+":"-")+("0000"+(O/60*100+O%60)).slice(-4)},"%Z":O=>O.Rb,"%%":()=>"%"},a=a.replace(/%%/g,"\0\0");for(ae in H)a.includes(ae)&&(a=a.replace(new RegExp(ae,"g"),H[ae](l)));return a=a.replace(/\0\0/g,"%"),ae=lo(a),ae.length>r?0:(co(ae,e),ae.length-1)}B.vb();for(var In=Array(256),mt=0;256>mt;++mt)In[mt]=String.fromCharCode(mt);dt=In,R=f.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},f.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(Jr.prototype,{get(e){return this.lb[e]},has(e){return this.lb[e]!==void 0},wb(e){var r=this.zb.pop()||this.lb.length;return this.lb[r]=e,r},xb(e){this.lb[e]=void 0,this.zb.push(e)}}),Ae.lb.push({value:void 0},{value:null},{value:!0},{value:!1}),Ae.sb=Ae.lb.length,f.count_emval_handles=()=>{for(var e=0,r=Ae.sb;r<Ae.lb.length;++r)Ae.lb[r]!==void 0&&++e;return e};var po=[nt,it,Lr,ut,$r,lt,Hr,je,jr,zr,Yr,Cr,Gr,Mr,ct,Vr,bn,wn,_n,An,En,Sn,Cn,Mn],mo={b:function(e,r,a){throw e>>>=0,new Wt(e).vb(r>>>0,a>>>0),cr=e,Sr++,cr},ea:function(e){xn(e>>>0,!z,1,!k,131072,!1),B.Eb()},E:function(e){e>>>=0,U?postMessage({cmd:"cleanupThread",thread:e}):((e=B.jb[e])||Le(),B.Cb(e))},W:st,y:ut,ka:$r,S:lt,U:Hr,L:je,ia:jr,ba:zr,ha:Yr,G:Cr,T:Gr,Q:Mr,ja:ct,R:Vr,J:function(e,r,a,l,h){e>>>=0,r>>>=0,a>>>=0,r=Me(r);var b=r.indexOf("u")!=-1;b&&(h=(1n<<64n)-1n),de(e,{name:r,fromWireType:C=>C,toWireType:function(C,M){if(typeof M!="bigint"&&typeof M!="number")throw new TypeError(`Cannot convert "${qr(M)}" to ${this.name}`);if(M<l||M>h)throw new TypeError(`Passing a number "${qr(M)}" from JS side to C/C++ side to an argument of type "${r}", which is outside the valid range [${l}, ${h}]!`);return M},argPackAdvance:8,readValueFromPointer:Xr(r,a,!b),rb:null})},qa:function(e,r,a,l){e>>>=0,r=Me(r>>>0),de(e,{name:r,fromWireType:function(h){return!!h},toWireType:function(h,b){return b?a:l},argPackAdvance:8,readValueFromPointer:function(h){return this.fromWireType(m()[h>>>0])},rb:null})},pa:function(e,r){e>>>=0,r=Me(r>>>0),de(e,{name:r,fromWireType:a=>{var l=we(a);return Ur(a),l},toWireType:(a,l)=>ye(l),argPackAdvance:8,readValueFromPointer:Zr,rb:null})},I:function(e,r,a){e>>>=0,a>>>=0,r=Me(r>>>0),de(e,{name:r,fromWireType:l=>l,toWireType:(l,h)=>h,argPackAdvance:8,readValueFromPointer:t(r,a),rb:null})},u:function(e,r,a,l,h){if(e>>>=0,a>>>=0,r=Me(r>>>0),h===-1&&(h=4294967295),h=M=>M,l===0){var b=32-8*a;h=M=>M<<b>>>b}var C=r.includes("unsigned")?function(M,$){return $>>>0}:function(M,$){return $};de(e,{name:r,fromWireType:h,toWireType:C,argPackAdvance:8,readValueFromPointer:Xr(r,a,l!==0),rb:null})},m:function(e,r,a){function l(b){var C=y()[b>>>2>>>0];return b=y()[b+4>>>2>>>0],new h(s().buffer,b,C)}e>>>=0;var h=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][r];a=Me(a>>>0),de(e,{name:a,fromWireType:l,argPackAdvance:8,readValueFromPointer:l},{Ib:!0})},K:function(e,r){e>>>=0,r=Me(r>>>0);var a=r==="std::string";de(e,{name:r,fromWireType:function(l){var h=y()[l>>>2>>>0],b=l+4;if(a)for(var C=b,M=0;M<=h;++M){var $=b+M;if(M==h||m()[$>>>0]==0){if(C=fr(C,$-C),H===void 0)var H=C;else H+=String.fromCharCode(0),H+=C;C=$+1}}else{for(H=Array(h),M=0;M<h;++M)H[M]=String.fromCharCode(m()[b+M>>>0]);H=H.join("")}return Ye(l),H},toWireType:function(l,h){h instanceof ArrayBuffer&&(h=new Uint8Array(h));var b=typeof h=="string";if(!(b||h instanceof Uint8Array||h instanceof Uint8ClampedArray||h instanceof Int8Array))throw new R("Cannot pass non-string to std::string");var C=a&&b?dr(h):h.length,M=gt(4+C+1),$=M+4;if(y()[M>>>2>>>0]=C,a&&b)Nr(h,$,C+1);else if(b)for(b=0;b<C;++b){var H=h.charCodeAt(b);if(255<H)throw Ye($),new R("String has UTF-16 code units that do not fit in 8 bits");m()[$+b>>>0]=H}else for(b=0;b<C;++b)m()[$+b>>>0]=h[b];return l!==null&&l.push(Ye,M),M},argPackAdvance:8,readValueFromPointer:n,rb(l){Ye(l)}})},A:function(e,r,a){if(e>>>=0,r>>>=0,a>>>=0,a=Me(a),r===2)var l=p,h=v,b=A,C=()=>w(),M=1;else r===4&&(l=D,h=P,b=L,C=()=>y(),M=2);de(e,{name:a,fromWireType:$=>{for(var H=y()[$>>>2>>>0],ae=C(),Pe,Ge=$+4,O=0;O<=H;++O){var q=$+4+O*r;(O==H||ae[q>>>M]==0)&&(Ge=l(Ge,q-Ge),Pe===void 0?Pe=Ge:(Pe+=String.fromCharCode(0),Pe+=Ge),Ge=q+r)}return Ye($),Pe},toWireType:($,H)=>{if(typeof H!="string")throw new R(`Cannot pass non-string to C++ string type ${a}`);var ae=b(H),Pe=gt(4+ae+r);return y()[Pe>>>2]=ae>>M,h(H,Pe+4,ae+r),$!==null&&$.push(Ye,Pe),Pe},argPackAdvance:8,readValueFromPointer:Zr,rb($){Ye($)}})},ra:function(e,r){e>>>=0,r=Me(r>>>0),de(e,{Jb:!0,name:r,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>!0,O:function(e,r){e>>>=0,e==r>>>0?setTimeout(()=>me()):U?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=B.jb[e])&&e.postMessage({cmd:"checkMailbox"})},X:function(e,r,a,l){r>>>=0,a/=2,G.length=a,l=l>>>0>>>3;for(var h=0;h<a;h++)G[h]=Te[l+2*h]?Te[l+2*h+1]:T()[l+2*h+1>>>0];return e=po[e],B.Hb=r,r=e.apply(null,G),B.Hb=0,r},da:ne,ma:function(e){W&&B.jb[e>>>0].ref()},r:function(e,r,a){r>>>=0,a>>>=0,e=we(e>>>0),r=ee(r,"emval::as");var l=[],h=ye(l);return y()[a>>>2>>>0]=h,r.toWireType(l,e)},i:function(e,r,a,l,h){a>>>=0,l>>>=0,h>>>=0,e=pt[e>>>0],r=we(r>>>0),a=pr(a);var b=[];return y()[l>>>2>>>0]=ye(b),e(r,a,b,h)},s:function(e,r,a,l){a>>>=0,l>>>=0,e=pt[e>>>0],r=we(r>>>0),a=pr(a),e(r,a,null,l)},c:Ur,B:function(e,r){return r>>>=0,e=we(e>>>0),r=we(r),e==r},o:function(e){return e>>>=0,e===0?ye(pn()):(e=pr(e),ye(pn()[e]))},g:function(e,r){var a=oo(e,r>>>0),l=a[0];r=l.name+"_$"+a.slice(1).map(function(ae){return ae.name}).join("_")+"$";var h=hn[r];if(h!==void 0)return h;h=["retType"];for(var b=[l],C="",M=0;M<e-1;++M)C+=(M!==0?", ":"")+"arg"+M,h.push("argType"+M),b.push(a[1+M]);var $="return function "+mn("methodCaller_"+r)+`(handle, name, destructors, args) {
