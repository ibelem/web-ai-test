...
`)}},Po=e=>new Dn(e),Wn=(e,t)=>{let r=e.length,o=[];for(let a=0;a<r;a++){let s=r-1-a,u=e[s]||1;(t[t.length-1-a]||1)>1&&u===1&&o.unshift(s)}return o}});var at,Tl,Fr,Rl,ot,Bo,Mo,Do,zo,Wo,No,Uo,Go,Fo,Ho,Ye,Nn=H(()=>{"use strict";me();Re();$e();at=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Tl=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],Fr=(e,t,r,o,a,s,u=!1,n=!1)=>{let d=[],p=r[0].dims,h=z.normalizeAxes(a,r[0].dims.length),y=!n&&h.length===0;p.forEach((U,F)=>{y||h.indexOf(F)>=0?u&&d.push(1):d.push(U)});let b=[],w=q("_A",r[0].dataType,p),$=se("output",s,d),v=o(w,$,h),x=`inputOffset = ${w.indicesToOffset("inputIndices")};`,I=`let ${x};`,R=`var ${x};`,M=v[1]===""?"":R,B=(v[1]===""?I:x)+`
...
`)}
        }`,getRunData:()=>({outputs:[{dims:d,dataType:s}],dispatchGroup:{x:Math.ceil(W/64)}})}},Rl=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),oe({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},ot=(e,t,r,o)=>{let a=e.inputs,s=a.length===1?r:Rl(a,r);e.compute(Fr(t,{hint:s.cacheKey},[a[0]],s.noopWithEmptyAxes&&s.axes.length===0?Tl:o,s.axes,a[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},Bo=(e,t)=>{at(e.inputs),ot(e,"ReduceLogSum",t,(o,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${o.getByOffset("inputOffset")};`,"value = log(value);"])},Mo=(e,t)=>{at(e.inputs),ot(e,"ReduceL1",t,(o,a)=>[`var value = ${a.type.storage}(0);`,"",`value += abs(${o.getByOffset("inputOffset")});`,""])},Do=(e,t)=>{at(e.inputs),ot(e,"ReduceL2",t,(o,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${o.getByOffset("inputOffset")}; value += (t * t);`,"value = sqrt(value);"])},zo=(e,t)=>{at(e.inputs),ot(e,"ReduceLogSumExp",t,(o,a)=>[`var value = ${a.type.storage}(0);`,"",`value += exp(${o.getByOffset("inputOffset")});`,"value = log(value);"])},Wo=(e,t)=>{at(e.inputs),ot(e,"ReduceMax",t,(o,a,s)=>{let u=[];for(let n=0;n<o.rank;n++)(s.indexOf(n)>=0||s.length===0)&&u.push(o.indicesSet("inputIndices",n,0));return[`${u.join(`
`)}`,`var value = ${o.getByOffset("inputOffset")};`,`value = max(value, ${o.getByOffset("inputOffset")});`,""]})},No=(e,t)=>{at(e.inputs),ot(e,"ReduceMean",t,(o,a,s)=>{let u=1;for(let n=0;n<o.rank;n++)(s.indexOf(n)>=0||s.length===0)&&(u*=e.inputs[0].dims[n]);return["var sum = f32(0);","",`sum += f32(${o.getByOffset("inputOffset")});`,`let value = ${a.type.value}(sum / ${u});`]})},Uo=(e,t)=>{at(e.inputs),ot(e,"ReduceMin",t,(o,a,s)=>{let u=[];for(let n=0;n<o.rank;n++)(s.indexOf(n)>=0||s.length===0)&&u.push(`inputIndices[${n}] = 0;`);return[`${u.join(`
`)}`,`var value = ${o.getByOffset("inputOffset")};`,`value = min(value, ${o.getByOffset("inputOffset")});`,""]})},Go=(e,t)=>{at(e.inputs),ot(e,"ReduceProd",t,(o,a)=>[`var value = ${a.type.storage}(1);`,"",`value *= ${o.getByOffset("inputOffset")};`,""])},Fo=(e,t)=>{at(e.inputs),ot(e,"ReduceSum",t,(o,a)=>[`var value = ${a.type.storage}(0);`,"",`value += ${o.getByOffset("inputOffset")};`,""])},Ho=(e,t)=>{at(e.inputs),ot(e,"ReduceSumSquare",t,(o,a)=>[`var t = ${a.type.value}(0); var value = ${a.type.value}(0);`,"",`t = ${o.getByOffset("inputOffset")}; value += t * t;`,""])},Ye=e=>oe(e)});var Lo,Vo,jo,qo,Un,Ko=H(()=>{"use strict";Me();Re();Nn();Lo=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},Vo=(e,t)=>oe({axis:t.axis,keepDims:t.keepDims,selectLastIndex:t.selectLastIndex}),jo=(e,t)=>{Lo(e.inputs);let r=(a,s,u)=>{let n=[];for(let d=0;d<a.rank;d++)(u.indexOf(d)>=0||u.length===0)&&n.push(`inputIndices[${d}] = 0;`);return[`${n.join(`
...
var bestIndex : i32 = 0;`,`if (${a.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${a.getByOffset("inputOffset")};
         bestIndex = i32(lastIndex);
       }`,"",s.setByOffset("global_idx","bestIndex")]},o=e.inputs.length===1?t:Vo(e.inputs,t);e.compute(Fr("argMax",{hint:o.cacheKey},[e.inputs[0]],r,[o.axis],7,o.keepDims),{inputs:[0]})},Un=e=>oe(e)});var kl,Pl,Yo,Xo=H(()=>{"use strict";me();$e();kl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Pl=e=>{let t=e[0].dims,r=e[0].dims[2],o=z.size(t)/4,a=e[0].dataType,s=q("input",a,t,4),u=q("bias",a,[r],4),n=q("residual",a,t,4),d=se("output",a,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:h=>`
  ...
  }`}},Yo=e=>{kl(e.inputs),e.compute(Pl(e.inputs))}});var Bl,xe,Qo,Jo,Zo,ei,ti,ri,ni,ai,oi,Gn,Ml,ii,si,ui,li,Hr,di,Lr,ci,pi,fi,mi,hi,gi,yi,bi,wi,vi,$i,xi,Si,Ci,Ii,Ai,_i,Fn=H(()=>{"use strict";Me();me();Re();$e();Bl=(e,t,r,o,a,s)=>{let u=Math.ceil(t/4),n="";typeof a=="string"?n=`${a}(a)`:n=a("a");let d=q("inputData",r,[u],4),p=se("outputData",o,[u],4);return`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,ci=e=>{let t=ke(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Lr(`vec4<${t}>`,t)))},pi=e=>{e.compute(xe(e.inputs[0],"Exp","exp"))},fi=e=>{e.compute(xe(e.inputs[0],"Floor","floor"))},mi=e=>{let t=ke(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Lr(`vec4<${t}>`,t)))},hi=(e,t)=>{e.compute(xe(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},gi=e=>{e.compute(xe(e.inputs[0],"Not",t=>`!${t}`))},yi=e=>{e.compute(xe(e.inputs[0],"Neg",t=>`-${t}`))},bi=e=>{e.compute(xe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},wi=e=>{e.compute(xe(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},vi=e=>{e.compute(xe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},$i=e=>{e.compute(xe(e.inputs[0],"Sin","sin"))},xi=e=>{e.compute(xe(e.inputs[0],"Sinh","sinh"))},Si=e=>{e.compute(xe(e.inputs[0],"Sqrt","sqrt"))},Ci=e=>{e.compute(xe(e.inputs[0],"Tan","tan"))},Ii=e=>{e.compute(xe(e.inputs[0],"Tanh","tanh"))},Ai=(e,t)=>(e.compute(xe(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),_i=e=>{e.compute(xe(e.inputs[0],"Log","log"))}});var zl,Wl,Ei,Oi=H(()=>{"use strict";me();$e();Fn();zl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Wl=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=q("input",e[0].dataType,e[0].dims,4),o=q("bias",e[0].dataType,[e[0].dims[2]],4),a=se("output",e[0].dataType,t,4),s=z.size(t)/4;return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:n=>`
  ...
  ${n.mainStart()}
    ...
    ${a.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${M}
      }`},Ul=(e,t,r,o,a,s,u=r.dataType)=>{let n=!z.areEqual(r.dims,o.dims),d=r.dims,p=z.size(r.dims),h=!1;if(n){let y=nt.calcShape(r.dims,o.dims,!1);if(!y)throw new Error("Can't perform binary op on the given tensors");d=y,p=z.size(d);let b=z.size(r.dims)===1,w=z.size(o.dims)===1,$=1;for(let v=1;v<d.length;v++){let x=r.dims[r.dims.length-v]??1,I=o.dims[o.dims.length-v]??1;if(x===I)$*=x;else break}($%4===0||b||w)&&(h=!0)}else h=!0;return{name:e,shaderCache:{hint:t},getShaderSource:y=>Nl(y,r.dims,o.dims,d,h,n,a,r.dataType,o.dataType,u,s),getRunData:()=>({outputs:[{dims:d,dataType:u}],dispatchGroup:{x:Math.ceil(p/64/4)}})}},it=(e,t,r,o,a,s)=>{e.compute(Ul(t,a??"",e.inputs[0],e.inputs[1],r,o,s))},Ti=e=>{it(e,"Add",(t,r)=>`${t}+${r}`)},Ri=e=>{it(e,"Div",(t,r)=>`${t}/${r}`)},ki=e=>{it(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Pi=e=>{it(e,"Mul",(t,r)=>`${t}*${r}`)},Bi=e=>{let t=q("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;it(e,"Pow",{scalar:(o,a)=>`pow_custom(${o},${a})`,vector:(o,a)=>`pow_vector_custom(${o},${a})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Mi=e=>{it(e,"Sub",(t,r)=>`${t}-${r}`)},Di=e=>{it(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},zi=e=>{it(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Wi=e=>{it(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},Ni=e=>{it(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Fl,Hl,Ll,Vl,Gi,Fi,Hi=H(()=>{"use strict";me();Re();$e();Fl=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let o of e){if(o.dataType!==t)throw new Error("input tensors should be one type");if(o.dims.length!==r)throw new Error("input tensors should have the same shape")}},Hl=e=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,Ll=(e,t)=>{let r=e.length,o=[];for(let a=0;a<r;++a){let s=t.setByOffset("global_idx",e[a].getByIndices("indices"));r===1?o.push(s):a===0?o.push(`if (inputIndex == ${a}u) { ${s} }`):a===r-1?o.push(`else { ${s} }`):o.push(`else if (inputIndex == ${a}) { ${s} }`)}return o.join(`
`)},Vl=(e,t)=>{let r=e[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");let o=t<0?r.length+t:t,a=r.slice(0);for(let w=1;w<e.length;w++){let $=e[w].dims.slice();for(let v=0;v<r.length;v++)if(v===o)a[o]+=$[v];else if(r[v]!==$[v])throw new Error("non concat dimensions must match")}let s=z.size(a),u=new Array(e.length),n=new Array(e.length),d=e[0].dataType,p=0;for(let w=0;w<e.length;++w)p+=e[w].dims[o],u[w]=p,n[w]=q(`input${w}`,d,e[w].dims);let h=se("output",d,a),y=h.indicesGet("indices",o),b=w=>`
  ...
  ${w.mainStart()}
    ...
    ${Ll(n,h)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:b}},Gi=(e,t)=>{Fl(e.inputs),e.compute(Vl(e.inputs,t.axis))},Fi=e=>oe({axis:e.axis})});var De,Vr,jr,qr=H(()=>{"use strict";De=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Vr=(e,t=!1,r=!1,o=3)=>"",jr=(e,t)=>`
...
`});var Yr,Xr,dr=H(()=>{"use strict";me();Yr=e=>{switch(e.activation){case"Relu":return{activationFunction:"",applyActivation:"value = max(value, 0.0);"};case"Sigmoid":return{activationFunction:"",applyActivation:"value = (1.0 / (1.0 + exp(-value)));"};case"Clip":return{activationFunction:`const clip_min_=f32(${e.clipMin});const clip_max_=f32(${e.clipMax});`,applyActivation:"value = clamp(value, clip_min_, clip_max_);"};default:return{activationFunction:"",applyActivation:""}}},Xr=e=>{let t=e?.activation||"";if(t==="Clip"){let[r,o]=e?.activation_params||[Ur,Gr];return{activation:t,clipMax:o,clipMin:r,activationCacheKey:`${t}:${r},${o}`}}return{activation:t,activationCacheKey:t}}});var jl,ql,cr,Li,Kl,pr,Yl,Qr,fr=H(()=>{"use strict";me();$e();dr();qr();jl=(e,t)=>e?`
...
`},Yl=(e,t,r,o,a,s=!1)=>{let u=a[0],n=a[1],d=a[2],p=o[0],h=o[1],y=o[2],b=o[3],w=Wn(u,d),$=Wn(n,d),v=ke(o[0].type.tensor),x=()=>{let M=h.rank,B=p.rank,W=`var aIndices: ${h.type.indices};`;for(let T=M-2-1,U=B-1;T>=0;T--,U--)W+=`
...
bIndices[${M-2}] = u32(row);
    ...
    `},Qr=(e,t,r,o,a=!1)=>{let s=e[0].dims,u=e[1].dims,n=s.slice(0,-2),d=u.slice(0,-2),p=o?o.slice(0,-2):r.slice(0,-2),h=q("batchDims",e[0].dataType,p),y=[h],b=[n,d,p],w=z.size(p),$=s[s.length-2],v=s[s.length-1],x=u[u.length-1],I=v%4===0&&x%4===0,{activationFunction:R,applyActivation:M}=Yr(t),B=$<=8?[4,1,1]:[4,4,1],W=[8,8,1],T=[Math.ceil(x/W[0]/B[0]),Math.ceil($/W[1]/B[1]),Math.ceil(w/W[2]/B[2])],U=ke(e[0].dataType),F=I?4:1,j=q("a",e[0].dataType,[...n,$,v/F],F),le=q("b",e[1].dataType,[...d,v,x/F],F),P=se("result",e[0].dataType,[w,$,x/F],F);y.push(j),y.push(le),y.push(P);let X=[j,le],Ce=e.length>2,K=Yl(F,Ce,M,y,b,a);if(Ce){let ze=a?F:1;X.push(q("bias",e[2].dataType,e[2].dims,ze))}let V=ze=>`
  const dimAOuter: i32 = ${$};
  ...
  ${I?cr(B,W,U,h):pr(B,W,U,h)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${$?`vec4<${X}>`:X}) {
        ...
        ${K}
        ${Xl(d,F,j,le,u,void 0,!1,P[0],P[1],P[2],X)}
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(y):y,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(b/64)}}),getShaderSource:I}}});var Ql,Ki,Jl,Zl,Ut,Yi,Xi,Jr=H(()=>{"use strict";me();Re();$e();Ql=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Ki=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Jl=(e,t)=>z.sortBasedOnPerm(e,Ki(e.length,t)),Zl=(e,t,r,o)=>{let a=[];a.push(`fn perm(i: ${o.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)a.push(r.indicesSet("a",e[s],`i[${s}]`));return a.push("return a;}"),a.join(`
`)},Ut=(e,t,r)=>{let o=Ki(t,r),a=se("output",e,r&&r.length||t),s=q("a",e,t),u=n=>`
  ...
  }`;return{name:"Transpose",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:n=>{let d=Jl(n[0].dims,o),p=z.size(d);return{outputs:[{dims:d,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:"uint32",data:p},...zn(n[0].dims),...zn(d)]}},getShaderSource:u}},Yi=(e,t)=>{Ql(e.inputs),e.compute(Ut(e.inputs[0].dataType,e.inputs[0].dims.length,t.perm))},Xi=e=>oe({perm:e.perm})});var Vn,Qi,ed,Ji,Zi,td,rd,es,jn=H(()=>{"use strict";me();Re();ji();fr();qi();dr();Jr();Vn=(e,t,r,o,a,s)=>{let u=e[0],n=e.slice(s?1:2,s?3:4),d=n.length,p=t[0],y=t.slice(2).map(($,v)=>$+($-1)*(r[v]-1)),w=n.map(($,v)=>$+o[v]+o[v+d]).map(($,v)=>Math.floor(($-y[v]+a[v])/a[v]));return w.splice(0,0,u),w.splice(s?3:1,0,p),w},Qi=[2,3,1,0],ed=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],o=e[1].dims[1]*t.group;if(r!==o)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ji=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let o=e.pads.slice();_t.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,o,e.format==="NHWC",e.autoPad);let a=Object.assign({},e);return Object.assign(a,{kernelShape:r,pads:o,cacheKey:e.cacheKey}),a},Zi=e=>{let t=Xr(e),r=e.format,o=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],a=e.dilations,s=e.group,u=e.kernel_shape,n=e.pads,d=e.strides,p=e.w_is_const();return oe({autoPad:o,format:r,dilations:a,group:s,kernelShape:u,pads:n,strides:d,wIsConst:p,...t})},td=(e,t,r)=>{let o=Ji(r,t);if(r.group!==1){e.compute(Ln(t,o));return}let a=r.format==="NHWC",s=t.length===3,u=t[0].dims[a?1:2],n=t[0].dims[a?2:3],d=t[0].dims[a?3:1],p=t[1].dims[2],h=t[1].dims[3],y=Vn(t[0].dims,t[1].dims,r.dilations,o.pads,r.strides,a),b=y[a?1:2],w=y[a?2:3],$=y[a?3:1],v=a&&p===u&&h===n&&r.pads[0]===0&&r.pads[1]===0;if(v||p===1&&h===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let T=y[0],U,F,j,le=[];if(a){let P=e.kernelCustomData.wT??e.compute(Ut(t[1].dataType,t[1].dims.length,Qi),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=P),v){let X=u*n*d;U=t[0].reshape([1,T,X]),F=P.reshape([1,X,$]),j=[1,T,$]}else U=t[0].reshape([T,u*n,d]),F=P.reshape([1,d,$]),j=[T,b*w,$];le.push(U),le.push(F)}else U=t[0].reshape([T,d,u*n]),F=t[1].reshape([1,$,d]),j=[T,$,b*w],le.push(F),le.push(U);s&&le.push(t[2]),e.compute(Qr(le,o,y,j,a),{inputs:le});return}let x=!0,I=e.kernelCustomData.wT??e.compute(Ut(t[1].dataType,t[1].dims.length,Qi),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let R=[t[0],I];s&&R.push(t[2]);let M=a?b*w:$,B=a?$:b*w,W=p*h*d;e.compute(Vi(R,o,y,M,B,W,s,x),{inputs:R})},rd=(e,t)=>{let r=t.format==="NHWC",o=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&o.push(e.inputs[2]);let a=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),u=[1].concat(t.dilations),n=[1].concat(t.kernelShape),d=Ji({...t,pads:a,strides:s,dilations:u,kernelShape:n},o);e.compute(Ln(o,d,p=>r?[p[0],p[2],p[3]]:[]))},es=(e,t)=>{ed(e.inputs,t),e.inputs[0].dims.length===3?rd(e,t):td(e,e.inputs,t)}});var nd,ts,rs=H(()=>{"use strict";ht();me();qr();Hn();fr();nd=(e,t=!1,r,o=!1,a=4)=>{let s=De(a,"f32"),u=I=>{switch(I){case 1:return"return W[getIndexFromCoords4D(coord, wShape)];";case 4:return`
...
`)}
        ...
        ${U}
        ${nd(d,u,void 0,!1,B)}
        ${$?cr(R,I,"f32",void 0,!d,W):pr(R,I,"f32",void 0,!d,W,!1,void 0,n)}`}}});var ad,qn,ns=H(()=>{"use strict";ht();me();$e();ad=(e,t,r,o,a,s,u=!1,n)=>{let d=r.format==="NHWC",p=d?1:2,h=d?2:3,y=d?3:1,b=z.size(o),w=u?2:1,$=r.group,v=t[1].dims,x=v[0]/$,I=v[1],R=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:R}},ls=(e,t)=>{let r=new Xn(e.inputs,t.equation);e.compute(md(e.inputs,r))},ds=e=>{let t=e.equation.replace(/\s+/g,"");return oe({equation:t})}});var hd,ps,gd,yd,fs,ms=H(()=>{"use strict";me();$e();hd=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=r.length<t.length?0:r.length-t.length,a=t.length<r.length?0:t.length-r.length;for(;o<r.length&&a<t.length;++o,++a)if(r[o]!==t[a]&&r[o]!==1&&t[a]!==1)throw new Error("Expand requires shape to be broadcastable to input")},ps=(e,t)=>{let r=e.length-t.length,o=[];for(let a=0;a<r;++a)o.push(e[a]);for(let a=0;a<t.length;++a)o.push(t[a]===1?e[a+r]:t[a]);return o},gd=(e,t)=>e.length>t.length?ps(e,t):ps(t,e),yd=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=gd(t,r),a=z.size(o),s=e[0].dataType,u=q("input",s,t),n=se("output",s,o),d=p=>`
  ...
  ${p.guardAgainstOutOfBoundsWorkgroupSizes(a)}
    ...
    ${n.setByOffset("global_idx",u.getByIndices("inputIndices"))}
  }`;return{name:"Expand",shaderCache:{hint:`${o}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}})}},fs=e=>{hd(e.inputs),e.compute(yd(e.inputs),{inputs:[0]})}});var bd,wd,hs,gs,ys=H(()=>{"use strict";me();Re();$e();bd=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},wd=(e,t)=>{let r=e[0].dims,o=e[1].dims,a=r.length,s=z.normalizeAxis(t.axis,a),u=r.slice(0);u.splice(s,1,...o);let n=r[s],d=z.size(u),p=q("data",e[0].dataType,e[0].dims),h=q("inputIndices",e[1].dataType,e[1].dims),y=se("output",e[0].dataType,u),b=()=>{let $=o.length,v=`var indicesIndices  = ${h.type.indices}(0);`;for(let x=0;x<$;x++)v+=`${$>1?`indicesIndices[${x}]`:"indicesIndices"} = ${u.length>1?`outputIndices[${s+x}]`:"outputIndices"};`;v+=`
      ...
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)}}),getShaderSource:w}},hs=e=>oe({axis:e.axis}),gs=(e,t)=>{let r=e.inputs;bd(r),e.compute(wd(e.inputs,t))}});var vd,$d,bs,ws,vs=H(()=>{"use strict";me();Re();$e();vd=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},$d=(e,t)=>{let r=e[0].dims,o=e[0].dataType,a=r.length,s=z.computeStrides(r),u=z.size(r),n=e[1].dims,d=e[1].dataType,p=z.size(n),h=z.normalizeAxis(t.axis,a),y=r[h],b=n.slice(0),w=z.size(b),$=q("input",o,r),v=q("indices",d,[p]),x=se("output",o,b),I=R=>`
  ...
  }`;return{name:"GatherElements",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:b,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)}}),getShaderSource:I}},bs=e=>oe({axis:e.axis}),ws=(e,t)=>{let r=e.inputs;vd(r),e.compute($d(e.inputs,t))}});var xd,Sd,Cd,$s,xs,Ss=H(()=>{"use strict";me();Re();$e();xd=e=>{if(!e)throw new Error("Input is missing");if(e.length<2||e.length>3)throw new Error("Invaid input number.");if(e.length===3&&e[2].dims.length>2)throw new Error("Invalid input shape of C");if(e[0].dataType!==e[1].dataType||e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("Input types are mismatched")},Sd=(e,t,r)=>{if(r.length===0)return"0u";let o=r.length===1&&e!==1||r.length===2&&r[0]!==e,a=r[r.length-1]!==t,s="0u";return o||(s+=`+ m * ${r[r.length-1]}u`),a||(s+="+n"),s},Cd=(e,t)=>{let r=e[0].dims.slice(),o=e[1].dims.slice(),[a,s,u]=Nr.getShapeOfGemmResult(r,t.transA,o,t.transB,e.length===3?e[2].dims:void 0),n=[a,s];if(!n)throw new Error("Can't use gemm on the given tensors");let d=z.size(n),p="";t.transA&&t.transB?p="value += a[k * M + m] * b[n * K + k];":t.transA&&!t.transB?p="value += a[k * M + m] * b[k * N + n];":!t.transA&&t.transB?p="value += a[m * K + k] * b[n * K + k];":!t.transA&&!t.transB&&(p="value += a[m * K + k] * b[k * N + n];");let h=ke(e[0].dataType),y=t.alpha===1?"":"value *= alpha;",b=e.length===3?`value += beta * c[${Sd(a,s,e[2].dims)}];`:"",w=[`@group(0) @binding(0) var<storage, read> a : array<${h}>;`,`@group(0) @binding(1) var<storage, read> b : array<${h}>;`];e.length===3&&w.push(`@group(0) @binding(2) var<storage, read> c : array<${h}>;`);let $=v=>`
  const M: u32 = ${a}u;
  const N: u32 = ${s}u;
  const K: u32 = ${u}u;
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)}}),getShaderSource:$}},$s=(e,t)=>{xd(e.inputs),e.compute(Cd(e.inputs,t))},xs=e=>oe(e)});var Cs,Id,Ad,Is,As,_s=H(()=>{"use strict";me();Re();$e();Cs={name:"InstanceNormalization"},Id=(e,t)=>{let r=e[0].dims,o=r,a=2,s=z.sizeToDimension(r,a),u=z.sizeFromDimension(r,a),n=r[1],d=q("x",e[0].dataType,[r[0],r[1],u]),p=q("scale",e[1].dataType,e[1].dims),h=q("bias",e[2].dataType,e[2].dims),y=se("output",e[0].dataType,[r[0],r[1],u]),b=[d,p,h,y],w=d.type.value,$=64,v=x=>`
  ...
  }`;return{...Cs,shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:s}}),getShaderSource:v}},Ad=(e,t)=>{let r=e[0].dims,o=r,a=z.size(o),s=r[0],u=r[r.length-1],n=z.sizeFromDimension(r,1)/u,d=ke(e[0].dataType),p=u*s,h=y=>`
  const N: u32 = ${s};
  const H: u32 = ${n};
  const C: u32 = ${u};
  ...
  }`;return{...Cs,shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:h}},Is=e=>oe({epsilon:e.epsilon,format:e.format}),As=(e,t)=>{t.format==="NHWC"?e.compute(Ad(e.inputs,t)):e.compute(Id(e.inputs,t))}});var _d,Ed,Es,Os,Ts=H(()=>{"use strict";Me();me();Re();$e();_d=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.");if(e[0].dataType!==1||e[1].dataType!==1)throw new Error("inputs should be float type")},Ed=(e,t,r)=>{let o=e[0].dims,a=e[1],s=e[2],u=o,n=z.size(u),d=z.normalizeAxis(t.axis,o.length),p=z.sizeToDimension(o,d),h=z.sizeFromDimension(o,d),y=z.size(a.dims),b=s?z.size(s.dims):0;if(y!==h||s&&b!==h)throw new Error(`Size of X.shape()[axis:] == ${h}.
  ...
  ${B.mainStart()}
    ...
    ${x?"invStdOutput[global_idx] = 1 / meanSquare":""};
  }`,M=[{dims:u,dataType:e[0].dataType}];return v&&M.push({dims:w,dataType:e[0].dataType}),x&&M.push({dims:w,dataType:e[0].dataType}),{name:"LayerNormalization",shaderCache:{hint:`${t.cacheKey}|${r}|${e.length}`},getRunData:()=>({outputs:M,dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:R}},Es=e=>oe({axis:e.axis,epsilon:e.epsilon}),Os=(e,t)=>{_d(e.inputs),e.compute(Ed(e.inputs,t,e.outputCount))}});var Od,Rs,ks=H(()=>{"use strict";me();fr();Od=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Rs=e=>{Od(e.inputs);let t=nt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");e.compute(Qr(e.inputs,{activation:"",activationCacheKey:""},t))}});var Td,Rd,kd,Pd,Bd,Md,Dd,zd,Wd,Ps,Bs,Ms=H(()=>{"use strict";Me();me();Re();$e();Td=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1)throw new Error("Input type must be float.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Rd=(e,t,r,o,a,s,u)=>{let n=r.length,d="";for(let p=n-1;p>=0;--p)d+=`
      ...
      `},kd=(e,t,r,o,a)=>{let s=r.length,u="";for(let n=s-1;n>=0;--n)u+=`
            ...
            `;return`
              ...
              ${u}
              value = x[offset];
          `},Pd=(e,t,r,o,a)=>{let s=r.length,u="";for(let n=s-1;n>=0;--n)u+=`
                k = i32(${e.indicesGet("indices",n)}) - ${a[n]};
                if (k < 0) {
                  k = 0;
                }
            ...
            `;return`
              ...
              ${u}
              value = x[offset];
          `},Bd=(e,t,r,o,a)=>{let s=r.length,u="";for(let n=s-1;n>=0;--n)u+=`
                k = i32(${e.indicesGet("indices",n)}) - ${a[n]};
                if (k < 0)  {
                  k += ${r[n]};
                }
            ...
            `;return`
              ...
              ${u}
              value = x[offset];
          `},Md=(e,t,r,o,a,s)=>{switch(a.mode){case 0:return Rd(e,t,r,o,a.pads,s,a.value);case 1:return kd(e,t,r,o,a.pads);case 2:return Pd(e,t,r,o,a.pads);case 3:return Bd(e,t,r,o,a.pads);default:throw new Error("Invalid mode")}},Dd=(e,t,r,o)=>{let a=t[0].dims,s=z.padShape(a.slice(),r.pads),u=z.size(s),n=z.computeStrides(a),d=se("output",t[0].dataType,s),p=q("x",t[0].dataType,a),h=Md(d,s,a,n,r,o);return`
    ...
    `,n="",d=q("x",t.dataType,t.dims);return{name:e,shaderCache:{hint:o.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(s)/64)}}),getShaderSource:p=>zs(p,d,t.dims,s,a,u,n,"-1e5")}},js=(e,t)=>{en(e.inputs),e.compute(Vs("MaxPool",e.inputs[0],!1,t))},qs=e=>{let t=e.storage_order,r=e.dilations,o=Ws(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(o.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return oe({storageOrder:t,dilations:r,...o})},Ks=e=>{let t=e.format;return{format:t,...Fs,cacheKey:t}},Ys=(e,t)=>{en(e.inputs),e.compute(Vs("GlobalMaxPool",e.inputs[0],!0,t))}});var Ud,Gd,Qs,Js=H(()=>{"use strict";At();Me();$e();Ud=(e,t,r)=>{let o=e===t,a=e<t&&r<0,s=e>t&&r>0;if(o||a||s)throw new Error("Range these inputs' contents are invalid.")},Gd=(e,t,r,o)=>{let a=Math.abs(Math.ceil((t-e)/r)),s=[a],u=a,n=se("output",o,s),d=n.type.storage,p=h=>`
        ${h.declareVariables(n)}
        ${h.mainStart()}
        ${h.guardAgainstOutOfBoundsWorkgroupSizes(u)}
        output[global_idx] = ${d}(${e}) + ${d}(global_idx) * ${d}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(h=>h.toString()).join("_")},getShaderSource:p,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:Math.ceil(u/64)}})}},Qs=e=>{let t=0,r=0,o=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],o=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],o=e.inputs[2].getFloat32Array()[0]),Ae.webgpu.validateInputContent&&Ud(t,r,o),e.compute(Gd(t,r,o,e.inputs[0].dataType),{inputs:[]})}});var Fd,Hd,Ld,Vd,jd,qd,Kd,Yd,Xd,Qd,Jd,Zd,ec,tc,rc,Zs,eu,tu=H(()=>{"use strict";me();Re();$e();Fd=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},Hd=(e,t,r)=>{t.every(a=>a>=0&&a<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let o=new Array(r).fill(1);return t.forEach((a,s)=>o[a]=e[s]),o},Ld=(e,t,r,o,a,s)=>{let[u,n,d]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],p=e[0].dims.length;if(u>0&&e.length>u&&e[u].dims.length>0)e[u].getFloat32Array().forEach(h=>s.push(h));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(n>0&&e.length>n&&e[n].dims.length>0){if(e[n].getFloat32Array().forEach(h=>o.push(h)),o.length!==0&&o.length!==p&&r>=18&&o.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");Fd(o,t),t.axes.length>0&&Hd(o,t.axes,p).forEach((h,y)=>o[y]=h)}if(d>0&&e.length>d&&(e[d].getBigInt64Array().forEach(h=>a.push(Number(h))),a.length!==p||r>=18&&a.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(o.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(a.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof o<"u"&&typeof a<"u"&&o.length>0&&a.length>p)throw new Error("Resize requires only of scales or sizes to be specified")},Vd=e=>"fn getOriginalCoordinateFromResizedCoordinate(xResized: f32, xScale: f32, lengthResized: f32,    lengthOriginal: f32, roiStart: f32, roiEnd: f32) -> f32 { "+(()=>{switch(e){case"asymmetric":return"return xResized / xScale;";case"pytorch_half_pixel":return"if (lengthResized > 1) {                     return (xResized + 0.5) / xScale - 0.5;                   } else {                     return 0.0;                   }";case"tf_half_pixel_for_nn":return"return (xResized + 0.5) / xScale;";case"align_corners":return"if (lengthResized == 1) {                     return 0.0;                   } else {                     return xResized * (lengthOriginal - 1) / (lengthResized - 1);                   }";case"tf_crop_and_resize":return"if (lengthResized > 1) {                     return roiStart * (lengthOriginal - 1) +                           (xResized * (roiEnd - roiStart) * (lengthOriginal - 1)) / (lengthResized - 1);                   } else {                     return 0.5 * (roiStart + roiEnd) * f32(lengthOriginal - 1);                   }";case"half_pixel_symmetric":return["const outputWidth = xScale * lengthResized;","const adjustment = lengthResized / outputWidth;","const center = lengthOriginal / 2;","const offset = center * (1 - adjustment);","return offset + ((xResized + 0.5) / xScale) - 0.5;"].join(`
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",jd=(e,t)=>"fn getNearestPixelFromOriginal(xOriginal: f32, isDownSample: bool) -> f32 {"+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",qd=(e,t,r)=>{let o=new Array(r).fill(0).concat(new Array(r).fill(1)),a=e.length===0?o:e.slice();return t.length>0?(t.forEach((s,u)=>{o[s]=a[u],o[u+r]=a[t.length+u]}),o):a},Kd=(e,t,r,o)=>{let a=[];if(r.length>0)if(o.length>0){if(e.forEach(s=>a.push(s)),Math.max(...o)>e.length)throw new Error("axes is out of bound");o.forEach((s,u)=>a[s]=r[u])}else r.forEach(s=>a.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");a=e.map((s,u)=>Math.round(s*t[u]))}return a},Yd=(e,t,r,o)=>{let a=(()=>{switch(o.keepAspectRatioPolicy){case"not_larger":return o.axes.length>0?Math.min(...o.axes.map(u=>r[u]),Number.MAX_VALUE):Math.min(...r,Number.MAX_VALUE);case"not_smaller":return o.axes.length>0?Math.max(...o.axes.map(u=>r[u]),Number.MIN_VALUE):Math.max(...r,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${o.keepAspectRatioPolicy} is not supported`)}})();r.fill(1,0,r.length);let s=e.slice();return o.axes.length>0?(o.axes.forEach(u=>r[u]=a),o.axes.forEach(u=>s[u]=Math.round(e[u]*r[u]))):(r.fill(a,0,r.length),s.forEach((u,n)=>s[n]=Math.round(u*r[n]))),s},Xd=(e,t,r,o,a)=>`
    ...
    fn checkInputIndices(inputIndices: ${e.type.indices}) -> bool {
      ...
      return true;
    }`,Zd=(e,t,r,o,a,s,u)=>{let[n,d,p,h]=r.length===2?[-1,0,1,-1]:a[1]===1?[0,2,3,1]:[0,1,2,3];return`
    ...
    }`},ec=(e,t,r,o,a,s,u,n,d,p)=>{let[h,y]=r.length===2?[0,1]:a[1]===1?[2,3]:[1,2],b=w=>{let $=w===h?"row":"col";return`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> f32 {
    ...
    `},tc=(e,t,r,o,a,s)=>{let u=e.dims,n=qd(s,t.axes,u.length),d=Kd(u,o,a,t.axes),p=o.slice();o.length===0&&(p=u.map((x,I)=>x===0?1:d[I]/x),t.keepAspectRatioPolicy!=="stretch"&&(d=Yd(u,d,p,t)));let h=se("output",e.dataType,d),y=q("input",e.dataType,u),b=z.size(d),w=u.length===d.length&&u.every((x,I)=>x===d[I]),$=t.coordinateTransformMode==="tf_crop_and_resize",v=x=>`
      ...
      ${(()=>{switch(t.mode){case"nearest":return`
              ...
              `;case"linear":return`
              ${Xd(h,u,d,p,n)};
              ${Zd(y,h,u,d,p,$,t.extrapolationValue)};
              `;case"cubic":return`
            ${ec(y,h,u,d,p,n,t.cubicCoeffA,$,t.extrapolationValue,t.excludeOutside)};
      ...
      }`,R=[{dims:u,dataType:e[0].dataType}];return r>1&&R.push({dims:p,dataType:e[0].dataType}),r>2&&R.push({dims:p,dataType:e[0].dataType}),r>3&&R.push({dims:a,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:I,getRunData:()=>({outputs:R,dispatchGroup:{x:Math.ceil(n/d/64)}})}},ru=(e,t)=>{nc(e.inputs);let o=[0];e.outputCount>1&&o.push(-3),e.outputCount>2&&o.push(-3),e.outputCount>3&&o.push(3),e.compute(ac(e.inputs,t,e.outputCount,!1),{outputs:o})},nu=e=>{let t=e.epsilon;return oe({epsilon:t})}});var oc,tn,ic,ou,sc,uc,iu,su,uu=H(()=>{"use strict";Me();me();Re();$e();oc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,o)=>{if(e[o+1].dataType!==6&&e[o+1].dataType!==7)throw new Error(`Input ${o} must be an array of int32 or int64`)})},tn=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(o=>r.push(Number(o)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(o=>r.push(Number(o)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},ic=(e,t)=>{if(e.length>1){let r=tn(e,1),o=tn(e,2),a=tn(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),oe({starts:r,ends:o,axes:a})}else return t},ou=(e,t,r,o,a)=>{let s=e;return e<0&&(s+=r[o[t]]),a[t]<0?Math.max(0,Math.min(s,r[o[t]]-1)):Math.max(0,Math.min(s,r[o[t]]))},sc=(e,t,r,o)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${t.cacheKey}|${e[4]?.dims??""}`},getShaderSource:$,getRunData:()=>({outputs:[h],dispatchGroup:{x:Math.ceil(o/64)}})}},iu=(e,t)=>{oc(e.inputs,t);let r=ic(e.inputs,t);e.compute(uc(e.inputs,r),{inputs:[0]})},su=e=>{let t=e.starts,r=e.ends,o=e.axes;return oe({starts:t,ends:r,axes:o})}});var lc,dc,lu,du,cu=H(()=>{"use strict";me();Re();$e();lc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},dc=(e,t)=>{let r=ke(e.dataType),o=e.dims,a=z.size(o),s=64,u=t.axis;if(u<0&&(u=o.length+u),u<o.length-1)throw new Error("softmax only supports last axis for now.");let n=o[u],d=a/n,p=r==="f32"?"var threadMax: f32 = -3.402823e+38f;":"var threadMax: f16 = -65504.0h;";return{name:"Softmax",getRunData:()=>({outputs:[{dims:o,dataType:e.dataType}],dispatchGroup:{x:d}}),getShaderSource:y=>`
      ...
      }`}},lu=(e,t)=>{lc(e.inputs),e.compute(dc(e.inputs[0],t))},du=e=>oe({axis:e.axis})});var cc,pc,fc,mc,hc,pu,fu,mu=H(()=>{"use strict";me();Re();$e();cc=e=>{if(!e||e.length<1)throw new Error("too few inputs")},pc=(e,t)=>{let r=[],o=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),o=r.length),oe({numOutputs:o,axis:t.axis,splitSizes:r})},fc=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:v,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(o/64)}})}},pu=(e,t)=>{cc(e.inputs);let r=e.inputs.length===1?t:pc(e.inputs,t);e.compute(hc(e.inputs,r),{inputs:[0]})},fu=e=>{let t=e.axis,r=e.splitSizes,o=e.numOutputs<0?r.length:e.numOutputs;if(o!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return oe({axis:t,numOutputs:o,splitSizes:r})}});var hu,gc,yc,bc,gu,yu=H(()=>{"use strict";Me();me();$e();hu=e=>Array.from(e.getBigInt64Array(),Number),gc=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(hu(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},yc=(e,t)=>{let r=[];for(let o=0;o<e.length;++o)r.push(e[o]*t[o]);return r},bc=e=>{let t=e[0].dims,r=hu(e[1]),o=yc(t,r),a=z.size(o),s=e[0].dataType,u=q("input",s,t),n=se("output",s,o),d=p=>`
      const inputShape = ${u.indices(...t)};
      ${p.declareVariables(u,n)}
      ${p.mainStart()}
      ${p.guardAgainstOutOfBoundsWorkgroupSizes(a)}
