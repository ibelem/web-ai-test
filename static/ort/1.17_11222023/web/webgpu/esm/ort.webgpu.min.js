...
`)}},Yo=e=>new Yn(e),Zn=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let s=r-1-n,u=e[s]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(s)}return a},je=e=>e<=4});var ud,Zo,ld,dd,at,Xo,Qo,Zt=F(()=>{"use strict";me();Te();be();ud=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Zo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,ld=(e,t)=>z.sortBasedOnPerm(e,Zo(e.length,t)),dd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)n.push(r.indicesSet("a",e[s],`i[${s}]`));return n.push("return a;}"),n.join(`
`)},at=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Zo(a,t),s=je(a),u=ld(e.dims,n),l=s?u.length:u,o=s?a:e.dims,p=q("output",r,l),f=L("a",r,o),y=g=>`
  ...
  ${g.mainStart()}
    ...
    ${p.setByOffset("global_idx",f.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:$=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:o},programUniforms:[{type:"uint32",data:p}]})}},dt=(e,t,r,a)=>{let n=e.inputs.length===1?r:Xn(e.inputs,r),s=n.axes;s.length===0&&!n.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((b,v)=>v));let u=z.normalizeAxes(s,e.inputs[0].dims.length),l=u,o=e.inputs[0],p=wd(l,e.inputs[0].dims.length);p.length>0&&(o=e.compute(at(e.inputs[0],p),{inputs:[0],outputs:[-1]})[0],l=hd(l.length,o.dims.length));let[f,y]=gd(o.dims,l),g=f;n.keepDims&&(g=yd(f,u)),e.compute(vd(t,{hint:n.cacheKey,inputDependencies:["type"]},[o],a,e.inputs[0].dataType,g,y),{inputs:[o]})},Jo=(e,t)=>{dt(e,"ReduceMeanShared",t,"mean")},ei=(e,t)=>{dt(e,"ReduceL1Shared",t,"l1")},ti=(e,t)=>{dt(e,"ReduceL2Shared",t,"l2")},ri=(e,t)=>{dt(e,"ReduceLogSumExpShared",t,"logSumExp")},ni=(e,t)=>{dt(e,"ReduceMaxShared",t,"max")},ai=(e,t)=>{dt(e,"ReduceMinShared",t,"min")},oi=(e,t)=>{dt(e,"ReduceProdShared",t,"prod")},ii=(e,t)=>{dt(e,"ReduceSumShared",t,"sum")},si=(e,t)=>{dt(e,"ReduceSumSquareShared",t,"sumSquare")},ui=(e,t)=>{dt(e,"ReduceLogSumShared",t,"logSum")}});var ct,$d,on,Xn,pt,Sd,xd,Id,Cd,_d,Ad,Ed,Od,Td,kd,ft,di,ci,pi,fi,mi,hi,gi,yi,bi,wi,ot,an=F(()=>{"use strict";me();Te();be();li();ct=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},$d=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],on=(e,t,r,a,n,s,u=!1,l=!1)=>{let o=[],p=r[0].dims,f=z.normalizeAxes(n,r[0].dims.length),y=!l&&f.length===0;p.forEach((W,V)=>{y||f.indexOf(V)>=0?u&&o.push(1):o.push(W)});let g=[],b=L("_A",r[0].dataType,p),v=q("output",s,o),$=a(b,v,f),I=`inputOffset = ${b.indicesToOffset("inputIndices")};`,_=`let ${I};`,C=`var ${I};`,P=$[1]===""?"":C,A=($[1]===""?_:I)+`
...
var bestIndex : i32 = 0;`,`if (${a.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},_i=e=>{zd(e.inputs),e.compute(Wd(e.inputs))}});var Vd,$e,Ei,Oi,Ti,ki,Ri,Pi,Bi,Mi,Di,Nd,zi,Wi,Vi,Ni,un,Ui,ln,Hi,Li,Gi,Fi,ji,qi,Ki,Yi,Zi,Xi,Qi,Ji,es,ts,rs,ns,as,ea=F(()=>{"use strict";De();me();Te();be();Vd=(e,t,r,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let o=L("inputData",r,[u],4),p=q("outputData",a,[u],4);return`
  ...
  }`},$e=(e,t,r,a,n,s=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Vd(u,z.size(e.dims),e.dataType,s,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(z.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(z.size(e.dims)/4)}]})}),Ei=e=>{e.compute($e(e.inputs[0],"Abs","abs"))},Oi=e=>{e.compute($e(e.inputs[0],"Acos","acos"))},Ti=e=>{e.compute($e(e.inputs[0],"Acosh","acosh"))},ki=e=>{e.compute($e(e.inputs[0],"Asin","asin"))},Ri=e=>{e.compute($e(e.inputs[0],"Asinh","asinh"))},Pi=e=>{e.compute($e(e.inputs[0],"Atan","atan"))},Bi=e=>{e.compute($e(e.inputs[0],"Atanh","atanh"))},Mi=e=>re(e),Di=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($e(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Nd=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:rn,r=e.length>=3?e[2].getFloat32Array()[0]:nn;return re({min:t,max:r})},zi=(e,t)=>{let r=e.inputs.length===1?t:Nd(e.inputs),a=Ce(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Clip",n=>`clamp(${n}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Wi=e=>{e.compute($e(e.inputs[0],"Ceil","ceil"))},Vi=e=>{e.compute($e(e.inputs[0],"Cos","cos"))},Ni=e=>{e.compute($e(e.inputs[0],"Cosh","cosh"))},un=e=>re(e),Ui=(e,t)=>{e.compute($e(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Hi=e=>{let t=Ce(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ln(`vec4<${t}>`,t)))},Li=e=>{e.compute($e(e.inputs[0],"Exp","exp"))},Gi=e=>{e.compute($e(e.inputs[0],"Floor","floor"))},Fi=e=>{let t=Ce(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ln(`vec4<${t}>`,t)))},ji=(e,t)=>{e.compute($e(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},qi=e=>{e.compute($e(e.inputs[0],"Not",t=>`!${t}`))},Ki=e=>{e.compute($e(e.inputs[0],"Neg",t=>`-${t}`))},Yi=e=>{e.compute($e(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Zi=e=>{e.compute($e(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},Xi=e=>{e.compute($e(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Qi=e=>{e.compute($e(e.inputs[0],"Sin","sin"))},Ji=e=>{e.compute($e(e.inputs[0],"Sinh","sinh"))},es=e=>{e.compute($e(e.inputs[0],"Sqrt","sqrt"))},ts=e=>{e.compute($e(e.inputs[0],"Tan","tan"))},rs=e=>{e.compute($e(e.inputs[0],"Tanh","tanh"))},ns=(e,t)=>(e.compute($e(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),as=e=>{e.compute($e(e.inputs[0],"Log","log"))}});var Hd,Ld,os,is=F(()=>{"use strict";me();be();ea();Hd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ld=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=L("input",e[0].dataType,e[0].dims,4),a=L("bias",e[0].dataType,[e[0].dims[2]],4),n=q("output",e[0].dataType,t,4),s=z.size(t)/4;return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ps=e=>{mt(e,"Sub",(t,r)=>`${t}-${r}`)},fs=e=>{mt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},ms=e=>{mt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},hs=e=>{mt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},gs=e=>{mt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var qd,Kd,Yd,Zd,bs,ws,vs=F(()=>{"use strict";me();Te();be();qd=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},Kd=(e,t)=>`
...
`});var Xd,Qd,wr,$s,Jd,vr,ec,mn,$r=F(()=>{"use strict";me();be();Vt();pn();Xd=(e,t)=>e?`
...
bIndices[${P-2}] = u32(row);
    ...
    `},mn=(e,t,r,a,n=!1)=>{let s=e[0].dims,u=e[1].dims,l=s.slice(0,-2),o=u.slice(0,-2),p=a?a.slice(0,-2):r.slice(0,-2),f=L("batchDims",e[0].dataType,p),y=[f],g=[l,o,p],b=z.size(p),v=s[s.length-2],$=s[s.length-1],I=u[u.length-1],_=$%4===0&&I%4===0,C=v<=8?[4,1,1]:[4,4,1],P=[8,8,1],A=[Math.ceil(I/P[0]/C[0]),Math.ceil(v/P[1]/C[1]),Math.ceil(b/P[2]/C[2])],B=Ce(e[0].dataType),O=_?4:1,W=L("a",e[0].dataType,[...l,v,$/O],O),V=L("b",e[1].dataType,[...o,$,I/O],O),Y=q("result",e[0].dataType,[b,v,I/O],O);y.push(W),y.push(V),y.push(Y);let oe=[W,V],M=e.length>2,{activationFunction:K,applyActivation:Se}=At(t,Y.type.value),ue=ec(O,M,Se,y,g,n);if(M){let j=n?O:1;oe.push(L("bias",e[2].dataType,e[2].dims,j))}let ve=j=>`
  ...
  ${_?wr(C,P,B,f):vr(C,P,B,f)}
    ...
    return ${We(u,p)}(0.0);`,A=`${y(l)}`,B=We(o,p),O=e?We(u,p):We(l,p),W=e?We(l,p):We(u,p),{activationFunction:V,applyActivation:Y}=At(s,B);return`
    ${V}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${B}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${v?`vec4<${K}>`:K}) {
        ...
        ${tc(o,V,Y,oe,u,t,M[0],M[1],M[2],K)}
            ${v?wr(C,_,K,void 0,!o,W):vr(C,_,K,void 0,!o,W,!1,void 0,l)}`}}});var ra,Is=F(()=>{"use strict";me();be();aa();Vt();ra=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,l=u[0]/t.group,o=t.format==="NHWC",p=na(s,u,t.dilations,t.pads,t.strides,o),f=z.size(p),y=q("output",e[0].dataType,p),{activationFunction:g,applyActivation:b}=At(t,y.type.value),v=L("x",e[0].dataType,s),$=L("w",e[1].dataType,u),I=[v,$];a&&I.push(L("b",e[2].dataType,e[2].dims));let _=C=>`
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(p):p,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)}}),getShaderSource:_}}});var na,Cs,rc,_s,oa,nc,ac,ia,aa=F(()=>{"use strict";me();Te();xs();$r();Is();Vt();Zt();na=(e,t,r,a,n,s)=>{let u=e[0],l=e.slice(s?1:2,s?3:4),o=l.length,p=t[0],y=t.slice(2).map((v,$)=>v+(v-1)*(r[$]-1)),b=l.map((v,$)=>v+a[$]+a[$+o]).map((v,$)=>Math.floor((v-y[$]+n[$])/n[$]));return b.splice(0,0,u),b.splice(s?3:1,0,p),b},Cs=[2,3,1,0],rc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},_s=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let a=e.pads.slice();Wt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},oa=e=>{let t=dn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,s=e.group,u=e.kernel_shape,l=e.pads,o=e.strides,p=e.w_is_const();return re({autoPad:a,format:r,dilations:n,group:s,kernelShape:u,pads:l,strides:o,wIsConst:p,...t})},nc=(e,t,r)=>{let a=_s(r,t);if(r.group!==1){e.compute(ra(t,a));return}let n=r.format==="NHWC",s=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],o=t[0].dims[n?3:1],p=t[1].dims[2],f=t[1].dims[3],y=na(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),g=y[n?1:2],b=y[n?2:3],v=y[n?3:1],$=n&&p===u&&f===l&&r.pads[0]===0&&r.pads[1]===0;if($||p===1&&f===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let O=y[0],W,V,Y,oe=[];if(n){let M=e.kernelCustomData.wT??e.compute(at(t[1],Cs),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=M),$){let K=u*l*o;W=t[0].reshape([1,O,K]),V=M.reshape([1,K,v]),Y=[1,O,v]}else W=t[0].reshape([O,u*l,o]),V=M.reshape([1,o,v]),Y=[O,g*b,v];oe.push(W),oe.push(V)}else W=t[0].reshape([O,o,u*l]),V=t[1].reshape([1,v,o]),Y=[O,v,g*b],oe.push(V),oe.push(W);s&&oe.push(t[2]),e.compute(mn(oe,a,y,Y,n),{inputs:oe});return}let I=!0,_=e.kernelCustomData.wT??e.compute(at(t[1],Cs),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=_);let C=[t[0],_];s&&C.push(t[2]);let P=n?g*b:v,A=n?v:g*b,B=p*f*o;e.compute(Ss(C,a,y,P,A,B,s,I),{inputs:C})},ac=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),o=_s({...t,pads:n,strides:s,dilations:u,kernelShape:l},a);e.compute(ra(a,o,p=>r?[p[0],p[2],p[3]]:[]))},ia=(e,t)=>{rc(e.inputs,t),e.inputs[0].dims.length===3?ac(e,t):nc(e,e.inputs,t)}});var oc,As,Es=F(()=>{"use strict";_t();me();Vt();pn();ta();$r();oc=(e,t=!1,r,a=4)=>{let n=We(a,"f32"),s=C=>{switch(C){case 1:return"return W[getIndexFromCoords4D(coord, wShape)];";case 4:return`
...
`)}
        ...
        ${W}
        ${oc(o,u,t,A)}
        ${v?wr(C,_,"f32",void 0,!o,B):vr(C,_,"f32",void 0,!o,B,!1,void 0,l)}`}}});var ic,sa,Os=F(()=>{"use strict";_t();me();be();ic=(e,t,r,a,n,s,u=!1,l)=>{let o=r.format==="NHWC",p=o?1:2,f=o?2:3,y=o?3:1,g=z.size(a),b=u?2:1,v=r.group,$=t[1].dims,I=$[0]/v,_=$[1],C=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:C}},Ms=(e,t)=>{let r=new da(e.inputs,t.equation);e.compute(gc(e.inputs,r))},Ds=e=>{let t=e.equation.replace(/\s+/g,"");return re({equation:t})}});var yc,Ws,bc,wc,Vs,Ns=F(()=>{"use strict";me();be();yc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Ws=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},bc=(e,t)=>e.length>t.length?Ws(e,t):Ws(t,e),wc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=bc(t,r),n=z.size(a),s=e[0].dataType,u=L("input",s,t),l=q("output",s,a),o=p=>`
  ...
  ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
    ...
    ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
  }`;return{name:"Expand",shaderCache:{hint:`${a}`},getShaderSource:o,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}})}},Vs=e=>{yc(e.inputs),e.compute(wc(e.inputs),{inputs:[0]})}});var vc,$c,Us,Hs,Ls=F(()=>{"use strict";me();Te();be();vc=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},$c=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,s=z.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(s,1,...a);let l=r[s],o=z.size(u),p=je(e[0].dims.length),f=p?e[0].dims.length:e[0].dims,y=je(e[1].dims.length),g=y?e[1].dims.length:e[1].dims,b=je(u.length),v=b?u.length:u,$=L("data",e[0].dataType,f),I=L("inputIndices",e[1].dataType,g),_=q("output",e[0].dataType,v),C=[{type:"uint32",data:o},{type:"int32",data:l},{type:"uint32",data:s}];p&&C.push(...Ue(e[0].dims)),y&&C.push(...Ue(e[1].dims)),b&&C.push(...Ue(u));let P=[];P.push(p?"rank":"dims"),P.push(y?"rank":"dims");let A=()=>{let O=a.length,W=`var indicesIndices  = ${I.type.indices}(0);`;for(let V=0;V<O;V++)W+=`${O>1?`indicesIndices[${V}]`:"indicesIndices"} = ${u.length>1?`outputIndices[uniforms.axis + ${V}]`:"outputIndices"};`;W+=`
      ...
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:P},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:C}),getShaderSource:B}},Us=e=>re({axis:e.axis}),Hs=(e,t)=>{let r=e.inputs;vc(r),e.compute($c(e.inputs,t))}});var Sc,xc,Gs,Fs,js=F(()=>{"use strict";me();Te();be();Sc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:I},{inputs:[t[0],$]})},Zs=e=>re({epsilon:e.epsilon,format:e.format}),Xs=(e,t)=>{t.format==="NHWC"?Tc(e,e.inputs,t):e.compute(Ec(e.inputs,t))}});var kc,Rc,Js,eu,tu=F(()=>{"use strict";De();me();Te();be();kc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Rc=(e,t,r)=>{let a=e[0].dims,n=e[1],s=e[2],u=a,l=z.normalizeAxis(t.axis,a.length),o=z.sizeToDimension(a,l),p=z.sizeFromDimension(a,l),f=z.size(n.dims),y=s?z.size(s.dims):0;if(f!==p||s&&y!==p)throw new Error(`Size of X.shape()[axis:] == ${p}.
  ...
  ${y.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[biasOffsetIdx];
      ...
      `},Wc=(e,t,r,a)=>{let n=t.length,s="";for(let u=n-1;u>=0;--u)s+=`
          ...
          }`},Lc=(e,t)=>{let r=z.padShape(e[0].dims.slice(),t.pads);return{name:"Pad",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(z.size(r)/64)}}),getShaderSource:a=>Hc(a,e,t,"f32")}},Gc=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let l=e[3].getBigInt64Array();for(let o=0;o<l.length;o++)s[Number(l[o])]=Number(r[o]),s[Number(l[o])+n]=Number(r[o+l.length])}else r.forEach((l,o)=>s[Number(o)]=Number(l));let u=[];return s.forEach(l=>u.push(l)),re({mode:t.mode,value:a,pads:u})}else return t},uu=(e,t)=>{Dc(e.inputs);let r=Gc(e.inputs,t);e.compute(Lc(e.inputs,r),{inputs:[0]})},lu=e=>{let t=e.mode,r=e.value,a=e.pads;return re({mode:t,value:r,pads:a})}});var gn,cu,pu,fu,mu,hu,gu,yu,bu,wu,vu,$u,Su,xu,Iu,Cu=F(()=>{"use strict";me();Te();be();gn=e=>{if(!e||e.length!==1)throw new Error("Pool ops requires 1 input.");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("Pool ops supports 1-D or 2-D inputs only for now.")},cu=(e,t,r)=>{let a=t.format==="NHWC",n=e.dims.slice();a&&n.splice(1,0,n.pop());let s=Object.hasOwnProperty.call(t,"dilations"),u=t.kernelShape.slice(),l=t.strides.slice(),o=s?t.dilations.slice():[],p=t.pads.slice();Wt.adjustPoolAttributes(r,n,u,l,o,p);let f=Wt.computePoolOutputShape(r,n,l,o,u,p,t.autoPad),y=Object.assign({},t);s?Object.assign(y,{kernelShape:u,strides:l,pads:p,dilations:o,cacheKey:t.cacheKey}):Object.assign(y,{kernelShape:u,strides:l,pads:p,cacheKey:t.cacheKey});let g=f.slice();return g.push(g.splice(1,1)[0]),[y,a?g:f]},pu=(e,t,r,a,n,s,u,l)=>{let o=n.format==="NHWC",p=r,f=t.type.value,y=p.length,g=z.size(a),b=q("output",t.type.tensor,a);if(n.kernelShape.length<=2){let v=n.kernelShape[n.kernelShape.length-1],$=n.strides[n.strides.length-1],I=n.pads[n.pads.length/2-1],_=n.pads[n.pads.length-1],C=y-(o?2:1),P="",A="",B="";if(I+_!==0?P=`
...
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Qc=(e,t)=>"fn getNearestPixelFromOriginal(xOriginal: f32, isDownSample: bool) -> f32 {"+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",Jc=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((s,u)=>{a[s]=n[u],a[u+r]=n[t.length+u]}),a):n},ep=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(s=>n.push(s)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((s,u)=>n[s]=r[u])}else r.forEach(s=>n.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((s,u)=>Math.round(s*t[u]))}return n},tp=(e,t,r)=>{let a=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(s=>t[s]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(s=>t[s]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let n=e.slice();return r.axes.length>0?(r.axes.forEach(s=>t[s]=a),r.axes.forEach(s=>n[s]=Math.round(e[s]*t[s]))):(t.fill(a,0,t.length),n.forEach((s,u)=>n[u]=Math.round(s*t[u]))),n},rp=(e,t,r,a,n)=>`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> f32 {
    ...
    `},sp=(e,t,r,a,n,s)=>{let u=e.dims,l=Jc(s,t.axes,u.length),o=ep(u,a,n,t.axes),p=a.slice();a.length===0&&(p=u.map((I,_)=>I===0?1:o[_]/I),t.keepAspectRatioPolicy!=="stretch"&&(o=tp(u,p,t)));let f=q("output",e.dataType,o),y=L("input",e.dataType,u),g=z.size(o),b=u.length===o.length&&u.every((I,_)=>I===o[_]),v=t.coordinateTransformMode==="tf_crop_and_resize",$=I=>`
      ...
      }`,P=[{dims:u,dataType:e[0].dataType}];return r>1&&P.push({dims:p,dataType:1}),r>2&&P.push({dims:p,dataType:1}),r>3&&P.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:C,getRunData:()=>({outputs:P,dispatchGroup:{x:Math.ceil(l/o/64)}})}},ku=(e,t)=>{lp(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(dp(e.inputs,t,e.outputCount,!1),{outputs:a})},Ru=e=>{let t=e.epsilon;return re({epsilon:t})}});var cp,yn,pp,Bu,fp,mp,Mu,Du,zu=F(()=>{"use strict";De();me();Te();be();cp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},yn=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},pp=(e,t)=>{if(e.length>1){let r=yn(e,1),a=yn(e,2),n=yn(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),re({starts:r,ends:a,axes:n})}else return t},Bu=(e,t,r,a,n)=>{let s=e;return e<0&&(s+=r[a[t]]),n[t]<0?Math.max(0,Math.min(s,r[a[t]]-1)):Math.max(0,Math.min(s,r[a[t]]))},fp=(e,t,r,a,n)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
...
`)}
  ...
  ${I.mainStart()}
    ...
    writeBufferData(outputNumber, indices, global_idx);
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:$,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(a/64)}})}},Uu=(e,t)=>{yp(e.inputs);let r=e.inputs.length===1?t:bp(e.inputs,t);e.compute($p(e.inputs,r),{inputs:[0]})},Hu=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return re({axis:t,numOutputs:a,splitSizes:r})}});var Gu,Sp,xp,Ip,Fu,ju=F(()=>{"use strict";De();me();be();Gu=e=>Array.from(e.getBigInt64Array(),Number),Sp=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Gu(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},xp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},Ip=e=>{let t=e[0].dims,r=Gu(e[1]),a=xp(t,r),n=z.size(a),s=e[0].dataType,u=L("input",s,t),l=q("output",s,a),o=p=>`
      const inputShape = ${u.indices(...t)};
      ${p.declareVariables(u,l)}
      ${p.mainStart()}
      ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
      ...
      ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
    }`;return{name:"Tile",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o}},Fu=e=>{Sp(e.inputs),e.compute(Ip(e.inputs),{inputs:[0]})}});var Cp,_p,qu,Ku=F(()=>{"use strict";De();me();be();Cp=(e,t,r,a,n)=>{let s=z.size(r),u=Math.ceil(s/4),l=q("outputData",n,r,4),o=L("aData",t[1].dataType,t[1].dims,4),p=L("bData",t[2].dataType,t[2].dims,4),f=L("cData",t[0].dataType,t[0].dims,4),y,g=(b,v,$)=>`select(${v}, ${b}, ${$})`;if(!a)y=l.setByOffset("global_idx",g(o.getByOffset("global_idx"),p.getByOffset("global_idx"),f.getByOffset("global_idx")));else{let b=(v,$,I="")=>{let _=`aData[indexA${$}][componentA${$}]`,C=`bData[indexB${$}][componentB${$}]`,P=`bool(cData[indexC${$}] & ${4278190080>>>(3-$)*8}u)`;return`
