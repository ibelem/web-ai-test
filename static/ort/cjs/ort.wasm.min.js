...
`))(ur,s,Oe,()=>G)},Lr={},Ye=t=>t%4===0&&(t%100!==0||t%400===0),$r=[0,31,60,91,121,152,182,213,244,274,305,335],Hr=[0,31,59,90,120,151,181,212,243,273,304,334],jr=t=>{var n=ze(t)+1,u=cr(n);return u&&ke(t,Z,u,n),u},Er={},Nr=()=>{if(!Sr){var t={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:c||"./this.program"},n;for(n in Er)Er[n]===void 0?delete t[n]:t[n]=Er[n];var u=[];for(n in t)u.push(`${n}=${t[n]}`);Sr=u}return Sr},Sr,it=[null,[],[]],zr=[31,29,31,30,31,30,31,31,30,31,30,31],Me=[31,28,31,30,31,30,31,31,30,31,30,31];function Yr(t){var n=Array(ze(t)+1);return ke(t,n,0,n.length),n}function Mr(t,n,u,p){function y(b,q,re){for(b=typeof b=="number"?b.toString():b||"";b.length<q;)b=re[0]+b;return b}function A(b,q){return y(b,q,"0")}function D(b,q){function re(Gr){return 0>Gr?-1:0<Gr?1:0}var xe;return(xe=re(b.getFullYear()-q.getFullYear()))===0&&(xe=re(b.getMonth()-q.getMonth()))===0&&(xe=re(b.getDate()-q.getDate())),xe}function C(b){switch(b.getDay()){case 0:return new Date(b.getFullYear()-1,11,29);case 1:return b;case 2:return new Date(b.getFullYear(),0,3);case 3:return new Date(b.getFullYear(),0,2);case 4:return new Date(b.getFullYear(),0,1);case 5:return new Date(b.getFullYear()-1,11,31);case 6:return new Date(b.getFullYear()-1,11,30)}}function k(b){var q=b.Ta;for(b=new Date(new Date(b.Ua+1900,0,1).getTime());0<q;){var re=b.getMonth(),xe=(Ye(b.getFullYear())?zr:Me)[re];if(q>xe-b.getDate())q-=xe-b.getDate()+1,b.setDate(1),11>re?b.setMonth(re+1):(b.setMonth(0),b.setFullYear(b.getFullYear()+1));else{b.setDate(b.getDate()+q);break}}return re=new Date(b.getFullYear()+1,0,4),q=C(new Date(b.getFullYear(),0,4)),re=C(re),0>=D(q,b)?0>=D(re,b)?b.getFullYear()+1:b.getFullYear():b.getFullYear()-1}t>>>=0,n>>>=0,u>>>=0,p>>>=0;var j=G[p+40>>>2>>>0];p={kb:F[p>>>2>>>0],jb:F[p+4>>>2>>>0],Xa:F[p+8>>>2>>>0],ab:F[p+12>>>2>>>0],Ya:F[p+16>>>2>>>0],Ua:F[p+20>>>2>>>0],Oa:F[p+24>>>2>>>0],Ta:F[p+28>>>2>>>0],mb:F[p+32>>>2>>>0],ib:F[p+36>>>2>>>0],lb:j?ar(j):""},u=ar(u),j={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ae in j)u=u.replace(new RegExp(ae,"g"),j[ae]);var z="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ce="January February March April May June July August September October November December".split(" ");j={"%a":b=>z[b.Oa].substring(0,3),"%A":b=>z[b.Oa],"%b":b=>Ce[b.Ya].substring(0,3),"%B":b=>Ce[b.Ya],"%C":b=>A((b.Ua+1900)/100|0,2),"%d":b=>A(b.ab,2),"%e":b=>y(b.ab,2," "),"%g":b=>k(b).toString().substring(2),"%G":b=>k(b),"%H":b=>A(b.Xa,2),"%I":b=>(b=b.Xa,b==0?b=12:12<b&&(b-=12),A(b,2)),"%j":b=>{for(var q=0,re=0;re<=b.Ya-1;q+=(Ye(b.Ua+1900)?zr:Me)[re++]);return A(b.ab+q,3)},"%m":b=>A(b.Ya+1,2),"%M":b=>A(b.jb,2),"%n":()=>`
`,"%p":b=>0<=b.Xa&&12>b.Xa?"AM":"PM","%S":b=>A(b.kb,2),"%t":()=>"	","%u":b=>b.Oa||7,"%U":b=>A(Math.floor((b.Ta+7-b.Oa)/7),2),"%V":b=>{var q=Math.floor((b.Ta+7-(b.Oa+6)%7)/7);if(2>=(b.Oa+371-b.Ta-2)%7&&q++,q)q==53&&(re=(b.Oa+371-b.Ta)%7,re==4||re==3&&Ye(b.Ua)||(q=1));else{q=52;var re=(b.Oa+7-b.Ta-1)%7;(re==4||re==5&&Ye(b.Ua%400-1))&&q++}return A(q,2)},"%w":b=>b.Oa,"%W":b=>A(Math.floor((b.Ta+7-(b.Oa+6)%7)/7),2),"%y":b=>(b.Ua+1900).toString().substring(2),"%Y":b=>b.Ua+1900,"%z":b=>{b=b.ib;var q=0<=b;return b=Math.abs(b)/60,(q?"+":"-")+("0000"+(b/60*100+b%60)).slice(-4)},"%Z":b=>b.lb,"%%":()=>"%"},u=u.replace(/%%/g,"\0\0");for(ae in j)u.includes(ae)&&(u=u.replace(new RegExp(ae,"g"),j[ae](p)));return u=u.replace(/\0\0/g,"%"),ae=Yr(u),ae.length>n?0:(ce.set(ae,t>>>0),ae.length-1)}for(var st=Array(256),Pe=0;256>Pe;++Pe)st[Pe]=String.fromCharCode(Pe);Je=st,Le=s.BindingError=class extends Error{constructor(t){super(t),this.name="BindingError"}},s.InternalError=class extends Error{constructor(t){super(t),this.name="InternalError"}},Object.assign(ir.prototype,{get(t){return this.Sa[t]},has(t){return this.Sa[t]!==void 0},Za(t){var n=this.bb.pop()||this.Sa.length;return this.Sa[n]=t,n},$a(t){this.Sa[t]=void 0,this.bb.push(t)}}),ve.Sa.push({value:void 0},{value:null},{value:!0},{value:!1}),ve.Va=ve.Sa.length,s.count_emval_handles=()=>{for(var t=0,n=ve.Va;n<ve.Sa.length;++n)ve.Sa[n]!==void 0&&++t;return t};var xt={a:function(t,n,u){throw t>>>=0,new te(t).Za(n>>>0,u>>>0),ue=t,Xe++,ue},v:function(){return 0},ba:function(){},N:function(){},P:function(){},H:function(){return 0},$:function(){},V:function(){},_:function(){},B:function(){},O:function(){},L:function(){},aa:function(){},M:function(){},E:function(t,n,u,p,y){n>>>=0,n=Se(n);var A=n.indexOf("u")!=-1;A&&(y=(1n<<64n)-1n),Ue(t>>>0,{name:n,fromWireType:D=>D,toWireType:function(D,C){if(typeof C!="bigint"&&typeof C!="number")throw new TypeError(`Cannot convert "${vr(C)}" to ${this.name}`);if(C<p||C>y)throw new TypeError(`Passing a number "${vr(C)}" from JS side to C/C++ side to an argument of type "${n}", which is outside the valid range [${p}, ${y}]!`);return C},argPackAdvance:8,readValueFromPointer:Zr(n,u>>>0,!A),Wa:null})},ea:function(t,n,u,p){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:function(y){return!!y},toWireType:function(y,A){return A?u:p},argPackAdvance:8,readValueFromPointer:function(y){return this.fromWireType(Z[y>>>0])},Wa:null})},da:function(t,n){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:u=>{var p=he(u);return wr(u),p},toWireType:(u,p)=>Oe(p),argPackAdvance:8,readValueFromPointer:sr,Wa:null})},D:function(t,n,u){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:p=>p,toWireType:(p,y)=>y,argPackAdvance:8,readValueFromPointer:Kr(n,u>>>0),Wa:null})},p:function(t,n,u,p,y){if(t>>>=0,u>>>=0,n=Se(n>>>0),y===-1&&(y=4294967295),y=C=>C,p===0){var A=32-8*u;y=C=>C<<A>>>A}var D=n.includes("unsigned")?function(C,k){return k>>>0}:function(C,k){return k};Ue(t,{name:n,fromWireType:y,toWireType:D,argPackAdvance:8,readValueFromPointer:Zr(n,u,p!==0),Wa:null})},l:function(t,n,u){function p(A){return new y(ce.buffer,G[A+4>>>2>>>0],G[A>>>2>>>0])}var y=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][n];u=Se(u>>>0),Ue(t>>>0,{name:u,fromWireType:p,argPackAdvance:8,readValueFromPointer:p},{gb:!0})},F:function(t,n){n=Se(n>>>0);var u=n==="std::string";Ue(t>>>0,{name:n,fromWireType:function(p){var y=G[p>>>2>>>0],A=p+4;if(u)for(var D=A,C=0;C<=y;++C){var k=A+C;if(C==y||Z[k>>>0]==0){if(D=ar(D,k-D),j===void 0)var j=D;else j+=String.fromCharCode(0),j+=D;D=k+1}}else{for(j=Array(y),C=0;C<y;++C)j[C]=String.fromCharCode(Z[A+C>>>0]);j=j.join("")}return De(p),j},toWireType:function(p,y){y instanceof ArrayBuffer&&(y=new Uint8Array(y));var A=typeof y=="string";if(!(A||y instanceof Uint8Array||y instanceof Uint8ClampedArray||y instanceof Int8Array))throw new Le("Cannot pass non-string to std::string");var D=u&&A?ze(y):y.length,C=cr(4+D+1),k=C+4;if(G[C>>>2>>>0]=D,u&&A)ke(y,Z,k,D+1);else if(A)for(A=0;A<D;++A){var j=y.charCodeAt(A);if(255<j)throw De(k),new Le("String has UTF-16 code units that do not fit in 8 bits");Z[k+A>>>0]=j}else for(A=0;A<D;++A)Z[k+A>>>0]=y[A];return p!==null&&p.push(De,C),C},argPackAdvance:8,readValueFromPointer:Rr,Wa(p){De(p)}})},x:function(t,n,u){if(n>>>=0,u>>>=0,u=Se(u),n===2)var p=R,y=Or,A=et,D=()=>Fe,C=1;else n===4&&(p=Tr,y=rt,A=Ut,D=()=>G,C=2);Ue(t>>>0,{name:u,fromWireType:k=>{for(var j=G[k>>>2>>>0],ae=D(),z,Ce=k+4,b=0;b<=j;++b){var q=k+4+b*n;(b==j||ae[q>>>C]==0)&&(Ce=p(Ce,q-Ce),z===void 0?z=Ce:(z+=String.fromCharCode(0),z+=Ce),Ce=q+n)}return De(k),z},toWireType:(k,j)=>{if(typeof j!="string")throw new Le(`Cannot pass non-string to C++ string type ${u}`);var ae=A(j),z=cr(4+ae+n);return G[z>>>2]=ae>>C,y(j,z+4,ae+n),k!==null&&k.push(De,z),z},argPackAdvance:8,readValueFromPointer:sr,Wa(k){De(k)}})},fa:function(t,n){n=Se(n>>>0),Ue(t>>>0,{hb:!0,name:n,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},ca:()=>!0,o:function(t,n,u){n>>>=0,u>>>=0,t=he(t>>>0),n=ur(n,"emval::as");var p=[],y=Oe(p);return G[u>>>2>>>0]=y,n.toWireType(p,t)},h:function(t,n,u,p,y){u>>>=0,p>>>=0,y>>>=0,t=lr[t>>>0],n=he(n>>>0),u=fr(u);var A=[];return G[p>>>2>>>0]=Oe(A),t(n,u,A,y)},r:function(t,n,u,p){u>>>=0,p>>>=0,t=lr[t>>>0],n=he(n>>>0),u=fr(u),t(n,u,null,p)},b:wr,y:function(t,n){return n>>>=0,t=he(t>>>0),n=he(n),t==n},u:function(t){return t>>>=0,t===0?Oe(Wr()):(t=fr(t),Oe(Wr()[t]))},g:function(t,n){var u=_r(t,n>>>0),p=u[0];n=p.name+"_$"+u.slice(1).map(function(ae){return ae.name}).join("_")+"$";var y=Ar[n];if(y!==void 0)return y;y=["retType"];for(var A=[p],D="",C=0;C<t-1;++C)D+=(C!==0?", ":"")+"arg"+C,y.push("argType"+C),A.push(u[1+C]);var k="return function "+kr("methodCaller_"+n)+`(handle, name, destructors, args) {
...
`),y.push(k+`};
`),t=at(y).apply(null,A),y=tt(t),Ar[n]=y},q:function(t,n){return n>>>=0,t=he(t>>>0),n=he(n),Oe(t[n])},c:function(t){t>>>=0,4<t&&(ve.get(t).cb+=1)},G:function(t,n,u,p){u>>>=0,p>>>=0,t=he(t>>>0);var y=Lr[n];return y||(y=ot(n),Lr[n]=y),y(t,u,p)},s:function(){return Oe([])},k:function(t){t=he(t>>>0);for(var n=Array(t.length),u=0;u<t.length;u++)n[u]=t[u];return Oe(n)},d:function(t){return Oe(fr(t>>>0))},j:function(){return Oe({})},e:function(t){t>>>=0;for(var n=he(t);n.length;){var u=n.pop();n.pop()(u)}wr(t)},i:function(t,n,u){n>>>=0,u>>>=0,t=he(t>>>0),n=he(n),u=he(u),t[n]=u},f:function(t,n){return n>>>=0,t=ur(t>>>0,"_emval_take_value"),t=t.readValueFromPointer(n),Oe(t)},S:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),F[n>>>2>>>0]=t.getUTCSeconds(),F[n+4>>>2>>>0]=t.getUTCMinutes(),F[n+8>>>2>>>0]=t.getUTCHours(),F[n+12>>>2>>>0]=t.getUTCDate(),F[n+16>>>2>>>0]=t.getUTCMonth(),F[n+20>>>2>>>0]=t.getUTCFullYear()-1900,F[n+24>>>2>>>0]=t.getUTCDay(),F[n+28>>>2>>>0]=(t.getTime()-Date.UTC(t.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},T:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),F[n>>>2>>>0]=t.getSeconds(),F[n+4>>>2>>>0]=t.getMinutes(),F[n+8>>>2>>>0]=t.getHours(),F[n+12>>>2>>>0]=t.getDate(),F[n+16>>>2>>>0]=t.getMonth(),F[n+20>>>2>>>0]=t.getFullYear()-1900,F[n+24>>>2>>>0]=t.getDay(),F[n+28>>>2>>>0]=(Ye(t.getFullYear())?$r:Hr)[t.getMonth()]+t.getDate()-1|0,F[n+36>>>2>>>0]=-(60*t.getTimezoneOffset());var u=new Date(t.getFullYear(),6,1).getTimezoneOffset(),p=new Date(t.getFullYear(),0,1).getTimezoneOffset();F[n+32>>>2>>>0]=(u!=p&&t.getTimezoneOffset()==Math.min(p,u))|0},U:function(t){t>>>=0;var n=new Date(F[t+20>>>2>>>0]+1900,F[t+16>>>2>>>0],F[t+12>>>2>>>0],F[t+8>>>2>>>0],F[t+4>>>2>>>0],F[t>>>2>>>0],0),u=F[t+32>>>2>>>0],p=n.getTimezoneOffset(),y=new Date(n.getFullYear(),6,1).getTimezoneOffset(),A=new Date(n.getFullYear(),0,1).getTimezoneOffset(),D=Math.min(A,y);return 0>u?F[t+32>>>2>>>0]=+(y!=A&&D==p):0<u!=(D==p)&&(y=Math.max(A,y),n.setTime(n.getTime()+6e4*((0<u?D:y)-p))),F[t+24>>>2>>>0]=n.getDay(),F[t+28>>>2>>>0]=(Ye(n.getFullYear())?$r:Hr)[n.getMonth()]+n.getDate()-1|0,F[t>>>2>>>0]=n.getSeconds(),F[t+4>>>2>>>0]=n.getMinutes(),F[t+8>>>2>>>0]=n.getHours(),F[t+12>>>2>>>0]=n.getDate(),F[t+16>>>2>>>0]=n.getMonth(),F[t+20>>>2>>>0]=n.getYear(),BigInt(n.getTime()/1e3)},Q:function(){return-52},R:function(){},J:function(t,n,u){function p(k){return(k=k.toTimeString().match(/\(([A-Za-z ]+)\)$/))?k[1]:"GMT"}u>>>=0;var y=new Date().getFullYear(),A=new Date(y,0,1),D=new Date(y,6,1);y=A.getTimezoneOffset();var C=D.getTimezoneOffset();G[t>>>0>>>2>>>0]=60*Math.max(y,C),F[n>>>0>>>2>>>0]=+(y!=C),t=p(A),n=p(D),t=jr(t),n=jr(n),C<y?(G[u>>>2>>>0]=t,G[u+4>>>2>>>0]=n):(G[u>>>2>>>0]=n,G[u+4>>>2>>>0]=t)},t:()=>{rr("")},C:()=>Date.now(),K:function(){return 4294901760},n:()=>performance.now(),Z:function(t,n,u){return n>>>=0,Z.copyWithin(t>>>0>>>0,n>>>0,n+(u>>>0)>>>0)},I:function(t){t>>>=0;var n=Z.length;if(4294901760<t)return!1;for(var u=1;4>=u;u*=2){var p=n*(1+.2/u);p=Math.min(p,t+100663296);var y=Math;p=Math.max(t,p);e:{y=(y.min.call(y,4294901760,p+(65536-p%65536)%65536)-U.buffer.byteLength+65535)/65536;try{U.grow(y),V();var A=1;break e}catch{}A=void 0}if(A)return!0}return!1},X:function(t,n){t>>>=0,n>>>=0;var u=0;return Nr().forEach((p,y)=>{var A=n+u;for(y=G[t+4*y>>>2>>>0]=A,A=0;A<p.length;++A)ce[y++>>>0>>>0]=p.charCodeAt(A);ce[y>>>0>>>0]=0,u+=p.length+1}),0},Y:function(t,n){t>>>=0,n>>>=0;var u=Nr();G[t>>>2>>>0]=u.length;var p=0;return u.forEach(y=>p+=y.length+1),G[n>>>2>>>0]=p,0},w:()=>52,A:function(){return 52},W:function(){return 70},z:function(t,n,u,p){n>>>=0,u>>>=0,p>>>=0;for(var y=0,A=0;A<u;A++){var D=G[n>>>2>>>0],C=G[n+4>>>2>>>0];n+=8;for(var k=0;k<C;k++){var j=Z[D+k>>>0],ae=it[t];j===0||j===10?((t===1?Y:W)(yr(ae,0)),ae.length=0):ae.push(j)}y+=C}return G[p>>>2>>>0]=y,0},ga:Mr,m:function(t,n,u,p){return Mr(t>>>0,n>>>0,u>>>0,p>>>0)}},x=function(){var t={a:xt};return me++,nr(t,function(n){x=n.instance.exports,x=ut(),U=x.ha,V(),je.unshift(x.ia),me--,me==0&&(ee!==null&&(clearInterval(ee),ee=null),pe&&(n=pe,pe=null,n()))}).catch(d),{}}();s._OrtInit=(t,n)=>(s._OrtInit=x.ja)(t,n),s._OrtGetLastError=(t,n)=>(s._OrtGetLastError=x.ka)(t,n),s._OrtCreateSessionOptions=(t,n,u,p,y,A,D,C,k,j)=>(s._OrtCreateSessionOptions=x.la)(t,n,u,p,y,A,D,C,k,j),s._OrtAppendExecutionProvider=(t,n)=>(s._OrtAppendExecutionProvider=x.ma)(t,n),s._OrtAddFreeDimensionOverride=(t,n,u)=>(s._OrtAddFreeDimensionOverride=x.na)(t,n,u),s._OrtAddSessionConfigEntry=(t,n,u)=>(s._OrtAddSessionConfigEntry=x.oa)(t,n,u),s._OrtReleaseSessionOptions=t=>(s._OrtReleaseSessionOptions=x.pa)(t),s._OrtCreateSession=(t,n,u)=>(s._OrtCreateSession=x.qa)(t,n,u),s._OrtReleaseSession=t=>(s._OrtReleaseSession=x.ra)(t),s._OrtGetInputOutputCount=(t,n,u)=>(s._OrtGetInputOutputCount=x.sa)(t,n,u),s._OrtGetInputName=(t,n)=>(s._OrtGetInputName=x.ta)(t,n),s._OrtGetOutputName=(t,n)=>(s._OrtGetOutputName=x.ua)(t,n),s._OrtFree=t=>(s._OrtFree=x.va)(t),s._OrtCreateTensor=(t,n,u,p,y,A)=>(s._OrtCreateTensor=x.wa)(t,n,u,p,y,A),s._OrtGetTensorData=(t,n,u,p,y)=>(s._OrtGetTensorData=x.xa)(t,n,u,p,y),s._OrtReleaseTensor=t=>(s._OrtReleaseTensor=x.ya)(t),s._OrtCreateRunOptions=(t,n,u,p)=>(s._OrtCreateRunOptions=x.za)(t,n,u,p),s._OrtAddRunConfigEntry=(t,n,u)=>(s._OrtAddRunConfigEntry=x.Aa)(t,n,u),s._OrtReleaseRunOptions=t=>(s._OrtReleaseRunOptions=x.Ba)(t),s._OrtCreateBinding=t=>(s._OrtCreateBinding=x.Ca)(t),s._OrtBindInput=(t,n,u)=>(s._OrtBindInput=x.Da)(t,n,u),s._OrtBindOutput=(t,n,u,p)=>(s._OrtBindOutput=x.Ea)(t,n,u,p),s._OrtClearBoundOutputs=t=>(s._OrtClearBoundOutputs=x.Fa)(t),s._OrtReleaseBinding=t=>(s._OrtReleaseBinding=x.Ga)(t),s._OrtRunWithBinding=(t,n,u,p,y)=>(s._OrtRunWithBinding=x.Ha)(t,n,u,p,y),s._OrtRun=(t,n,u,p,y,A,D,C)=>(s._OrtRun=x.Ia)(t,n,u,p,y,A,D,C),s._OrtEndProfiling=t=>(s._OrtEndProfiling=x.Ja)(t);var cr=s._malloc=t=>(cr=s._malloc=x.Ka)(t),De=s._free=t=>(De=s._free=x.La)(t),Te=t=>(Te=x.Ma)(t);s.__embind_initialize_bindings=()=>(s.__embind_initialize_bindings=x.Na)();var Pr=()=>(Pr=x.Pa)(),ge=t=>(ge=x.Qa)(t),_e=t=>(_e=x.Ra)(t);function ut(){var t=x;t=Object.assign({},t);var n=p=>()=>p()>>>0,u=p=>y=>p(y)>>>0;return t.__errno_location=n(t.__errno_location),t.Ka=u(t.Ka),t.Ma=u(t.Ma),t.Pa=n(t.Pa),t.Ra=u(t.Ra),t}s.stackAlloc=_e,s.stackSave=Pr,s.stackRestore=ge,s.UTF8ToString=ar,s.stringToUTF8=(t,n,u)=>ke(t,Z,n,u),s.lengthBytesUTF8=ze;var Cr;pe=function t(){Cr||ft(),Cr||(pe=t)};function ft(){if(!(0<me)){for(;0<Q.length;)Q.shift()(s);if(!(0<me||Cr||(Cr=!0,s.calledRun=!0,J))){for(;0<je.length;)je.shift()(s);for(m(s);0<be.length;)be.shift()(s)}}}return ft(),o.ready}})();typeof ua=="object"&&typeof Xt=="object"?Xt.exports=sa:typeof define=="function"&&define.amd&&define([],()=>sa)});var la=Fr(()=>{});var ca=Fr(()=>{});var da={};Ur(da,{cpus:()=>go});var go,pa=K(()=>{go=void 0});var ga=Fr((ha,Jt)=>{"use strict";var ma=(()=>{var i=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(i=i||__filename),function(o={}){function s(){return Q.buffer!=ee.buffer&&te(),ee}function m(){return Q.buffer!=ee.buffer&&te(),pe}function d(){return Q.buffer!=ee.buffer&&te(),rr}function w(){return Q.buffer!=ee.buffer&&te(),$e}function c(){return Q.buffer!=ee.buffer&&te(),Re}function g(){return Q.buffer!=ee.buffer&&te(),qe}function T(){return Q.buffer!=ee.buffer&&te(),nr}var f=o,_,S;f.ready=new Promise((e,r)=>{_=e,S=r});var E=Object.assign({},f),I="./this.program",H=(e,r)=>{throw r},L=typeof window=="object",Y=typeof importScripts=="function",W=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",U=f.ENVIRONMENT_IS_PTHREAD||!1,J="";function ce(e){return f.locateFile?f.locateFile(e,J):J+e}var Z,Ee,Fe;if(W){var F=(Gt(),pr(Yt)),G=(qt(),pr(Vt));J=Y?G.dirname(J)+"/":__dirname+"/",Z=(r,a)=>(r=r.startsWith("file://")?new URL(r):G.normalize(r),F.readFileSync(r,a?void 0:"utf8")),Fe=r=>(r=Z(r,!0),r.buffer||(r=new Uint8Array(r)),r),Ee=(r,a,l,h=!0)=>{r=r.startsWith("file://")?new URL(r):G.normalize(r),F.readFile(r,h?void 0:"utf8",(v,M)=>{v?l(v):a(h?M.buffer:M)})},!f.thisProgram&&1<process.argv.length&&(I=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),H=(r,a)=>{throw process.exitCode=r,a},f.inspect=()=>"[Emscripten Module object]";let e;try{e=la()}catch(r){throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'),r}global.Worker=e.Worker}else(L||Y)&&(Y?J=self.location.href:typeof document<"u"&&document.currentScript&&(J=document.currentScript.src),typeof i<"u"&&i&&(J=i),J.indexOf("blob:")!==0?J=J.substr(0,J.replace(/[?#].*/,"").lastIndexOf("/")+1):J="",W||(Z=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.send(null),r.responseText},Y&&(Fe=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.responseType="arraybuffer",r.send(null),new Uint8Array(r.response)}),Ee=(e,r,a)=>{var l=new XMLHttpRequest;l.open("GET",e,!0),l.responseType="arraybuffer",l.onload=()=>{l.status==200||l.status==0&&l.response?r(l.response):a()},l.onerror=a,l.send(null)}));W&&typeof performance>"u"&&(global.performance=ca().performance);var Ke=console.log.bind(console),Qe=console.error.bind(console);W&&(Ke=(...e)=>F.writeSync(1,e.join(" ")+`
`),Qe=(...e)=>F.writeSync(2,e.join(" ")+`
`));var er=Ke,de=Qe;Object.assign(f,E),E=null;var V=!0;typeof WebAssembly!="object"&&He("no native wasm support detected");var Q,je,be=!1,me,ee,pe,rr,$e,Re,qe,tr,we,We,nr;function te(){var e=Q.buffer;f.HEAP8=ee=new Int8Array(e),f.HEAP16=rr=new Int16Array(e),f.HEAPU8=pe=new Uint8Array(e),f.HEAPU16=$e=new Uint16Array(e),f.HEAP32=Re=new Int32Array(e),f.HEAPU32=qe=new Uint32Array(e),f.HEAPF32=tr=new Float32Array(e),f.HEAPF64=nr=new Float64Array(e),f.HEAP64=we=new BigInt64Array(e),f.HEAPU64=We=new BigUint64Array(e)}var ue=16777216;if(5242880<=ue||He("INITIAL_MEMORY should be larger than STACK_SIZE, was "+ue+"! (STACK_SIZE=5242880)"),U)Q=f.wasmMemory;else if(Q=new WebAssembly.Memory({initial:ue/65536,maximum:65536,shared:!0}),!(Q.buffer instanceof SharedArrayBuffer))throw de("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),W&&de("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");te(),ue=Q.buffer.byteLength;var Xe=[],Ne=[],yr=[],ar=0;function ze(){return V||0<ar}var ke=0,vr=null,Je=null;function Se(){if(ke--,ke==0&&(vr!==null&&(clearInterval(vr),vr=null),Je)){var e=Je;Je=null,e()}}function He(e){throw e="Aborted("+e+")",de(e),be=!0,me=1,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),S(e),e}function br(e){return e.startsWith("data:application/octet-stream;base64,")}var or;or="ort-wasm-threaded.wasm",br(or)||(or=ce(or));function Le(e){if(Fe)return Fe(e);throw"both async and sync fetching of the wasm failed"}function Ft(e){if(L||Y){if(typeof fetch=="function"&&!e.startsWith("file://"))return fetch(e,{credentials:"same-origin"}).then(r=>{if(!r.ok)throw"failed to load wasm binary file at '"+e+"'";return r.arrayBuffer()}).catch(()=>Le(e));if(Ee)return new Promise((r,a)=>{Ee(e,l=>r(new Uint8Array(l)),a)})}return Promise.resolve().then(()=>Le(e))}function Ue(e,r,a){return Ft(e).then(l=>WebAssembly.instantiate(l,r)).then(l=>l).then(a,l=>{de(`failed to asynchronously prepare wasm: ${l}`),He(l)})}function Zr(e,r){var a=or;return typeof WebAssembly.instantiateStreaming!="function"||br(a)||a.startsWith("file://")||W||typeof fetch!="function"?Ue(a,e,r):fetch(a,{credentials:"same-origin"}).then(l=>WebAssembly.instantiateStreaming(l,e).then(r,function(h){return de(`wasm streaming compile failed: ${h}`),de("falling back to ArrayBuffer instantiation"),Ue(a,e,r)}))}function ir(e){this.name="ExitStatus",this.message=`Program terminated with exit(${e})`,this.status=e}var ve=e=>{e.terminate(),e.onmessage=()=>{}},wr=e=>{if(R.qb.length==0){var r=ce("ort-wasm-threaded.worker.js");r=new Worker(r),R.qb.push(r),R.Jb(R.qb[0])}if(r=R.qb.pop(),!r)return 6;R.nb.push(r),R.jb[e.mb]=r,r.mb=e.mb;var a={cmd:"run",start_routine:e.Mb,arg:e.Fb,pthread_ptr:e.mb};return W&&r.unref(),r.postMessage(a,e.Sb),0},he=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Oe=(e,r,a)=>{r>>>=0;var l=r+a;for(a=r;e[a]&&!(a>=l);)++a;if(16<a-r&&e.buffer&&he)return he.decode(e.buffer instanceof SharedArrayBuffer?e.slice(r,a):e.subarray(r,a));for(l="";r<a;){var h=e[r++];if(h&128){var v=e[r++]&63;if((h&224)==192)l+=String.fromCharCode((h&31)<<6|v);else{var M=e[r++]&63;h=(h&240)==224?(h&15)<<12|v<<6|M:(h&7)<<18|v<<12|M<<6|e[r++]&63,65536>h?l+=String.fromCharCode(h):(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023))}}else l+=String.fromCharCode(h)}return l},sr=(e,r)=>(e>>>=0)?Oe(m(),e,r):"";function Kr(e){if(U)return z(0,1,e);me=e,ze()||(R.Nb(),be=!0),H(e,new ir(e))}var Rr=e=>{if(me=e,U)throw et(e),"unwind";Kr(e)};function Qr(){Xe.unshift(()=>{ke++,Se()})}var R={qb:[],nb:[],Eb:[],jb:{},vb(){U?(R.receiveObjectTransfer=R.Lb,R.threadInitTLS=R.Db,R.setExitStatus=R.Cb,V=!1):Qr()},Cb:e=>{me=e},Vb:["$terminateWorker"],Nb:()=>{for(var e of R.nb)ve(e);for(e of R.qb)ve(e);R.qb=[],R.nb=[],R.jb=[]},Bb:e=>{var r=e.mb;delete R.jb[r],R.qb.push(e),R.nb.splice(R.nb.indexOf(e),1),e.mb=0,Wt(r)},Lb(){},Db(){R.Eb.forEach(e=>e())},Jb:e=>new Promise(r=>{e.onmessage=v=>{v=v.data;var M=v.cmd;if(v.targetThread&&v.targetThread!=ct()){var P=R.jb[v.targetThread];P?P.postMessage(v,v.transferList):de(`Internal error! Worker sent a message "${M}" to target pthread ${v.targetThread}, but that thread no longer exists!`)}else M==="checkMailbox"?j():M==="spawnThread"?wr(v):M==="cleanupThread"?((v=R.jb[v.thread])||He(),R.Bb(v)):M==="killThread"?(v=v.thread,M=R.jb[v],delete R.jb[v],ve(M),Wt(v),R.nb.splice(R.nb.indexOf(M),1),M.mb=0):M==="cancelThread"?R.jb[v.thread].postMessage({cmd:"cancel"}):M==="loaded"?(e.loaded=!0,r(e)):M==="alert"?alert(`Thread ${v.threadId}: ${v.text}`):v.target==="setimmediate"?e.postMessage(v):M==="callHandler"?f[v.handler](...v.args):M&&de(`worker sent an unknown command ${M}`)},e.onerror=v=>{throw de(`worker sent an error! ${v.filename}:${v.lineno}: ${v.message}`),v},W&&(e.on("message",v=>e.onmessage({data:v})),e.on("error",v=>e.onerror(v)));var a=[],l=[],h;for(h of l)f.hasOwnProperty(h)&&a.push(h);e.postMessage({cmd:"load",handlers:a,urlOrBlob:f.mainScriptUrlOrBlob||i,wasmMemory:Q,wasmModule:je})})};f.PThread=R;var Or=e=>{for(;0<e.length;)e.shift()(f)};f.establishStackSpace=()=>{var e=ct(),r=g()[e+52>>>2>>>0];e=g()[e+56>>>2>>>0],In(r,r-e),pt(r)};function et(e){if(U)return z(1,0,e);Rr(e)}var Tr=[],rt;f.invokeEntryPoint=(e,r)=>{var a=Tr[e];a||(e>=Tr.length&&(Tr.length=e+1),Tr[e]=a=rt.get(e)),e=a(r),ze()?R.Cb(e):kt(e)};function Ut(e){this.sb=e-24,this.Kb=function(r){g()[this.sb+4>>>2>>>0]=r},this.xb=function(r){g()[this.sb+8>>>2>>>0]=r},this.vb=function(r,a){this.wb(),this.Kb(r),this.xb(a)},this.wb=function(){g()[this.sb+16>>>2>>>0]=0}}var ur=0,Dt=0;function fr(e,r,a,l){return U?z(2,1,e,r,a,l):lr(e,r,a,l)}function lr(e,r,a,l){if(e>>>=0,r>>>=0,a>>>=0,l>>>=0,typeof SharedArrayBuffer>"u")return de("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var h=[];return U&&h.length===0?fr(e,r,a,l):(e={Mb:a,mb:e,Fb:l,Sb:h},U?(e.Ub="spawnThread",postMessage(e,h),0):wr(e))}function Wr(e,r,a){return U?z(3,1,e,r,a):0}function tt(e,r){if(U)return z(4,1,e,r)}var _r=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);127>=l?r++:2047>=l?r+=2:55296<=l&&57343>=l?(r+=4,++a):r+=3}return r},kr=(e,r,a,l)=>{if(a>>>=0,!(0<l))return 0;var h=a;l=a+l-1;for(var v=0;v<e.length;++v){var M=e.charCodeAt(v);if(55296<=M&&57343>=M){var P=e.charCodeAt(++v);M=65536+((M&1023)<<10)|P&1023}if(127>=M){if(a>=l)break;r[a++>>>0]=M}else{if(2047>=M){if(a+1>=l)break;r[a++>>>0]=192|M>>6}else{if(65535>=M){if(a+2>=l)break;r[a++>>>0]=224|M>>12}else{if(a+3>=l)break;r[a++>>>0]=240|M>>18,r[a++>>>0]=128|M>>12&63}r[a++>>>0]=128|M>>6&63}r[a++>>>0]=128|M&63}}return r[a>>>0]=0,a-h},Ar=(e,r,a)=>kr(e,m(),r,a);function nt(e,r){if(U)return z(5,1,e,r)}function at(e,r,a){if(U)return z(6,1,e,r,a)}function ot(e,r,a){return U?z(7,1,e,r,a):0}function Lr(e,r){if(U)return z(8,1,e,r)}function Ye(e,r,a){if(U)return z(9,1,e,r,a)}function $r(e,r,a,l){if(U)return z(10,1,e,r,a,l)}function Hr(e,r,a,l){if(U)return z(11,1,e,r,a,l)}function jr(e,r,a,l){if(U)return z(12,1,e,r,a,l)}function Er(e){if(U)return z(13,1,e)}function Nr(e,r){if(U)return z(14,1,e,r)}function Sr(e,r,a){if(U)return z(15,1,e,r,a)}var it=e=>{if(e===null)return"null";var r=typeof e;return r==="object"||r==="array"||r==="function"?e.toString():""+e},zr,Me=e=>{for(var r="";m()[e>>>0];)r+=zr[m()[e++>>>0]];return r},Yr={},Mr={},st={},Pe;function xt(e,r,a={}){var l=r.name;if(!e)throw new Pe(`type "${l}" must have a positive integer typeid pointer`);if(Mr.hasOwnProperty(e)){if(a.Hb)return;throw new Pe(`Cannot register type '${l}' twice`)}Mr[e]=r,delete st[e],Yr.hasOwnProperty(e)&&(r=Yr[e],delete Yr[e],r.forEach(h=>h()))}function x(e,r,a={}){if(!("argPackAdvance"in r))throw new TypeError("registerType registeredInstance requires argPackAdvance");xt(e,r,a)}var cr=(e,r,a)=>{switch(r){case 1:return a?l=>s()[l>>>0>>>0]:l=>m()[l>>>0>>>0];case 2:return a?l=>d()[l>>>1>>>0]:l=>w()[l>>>1>>>0];case 4:return a?l=>c()[l>>>2>>>0]:l=>g()[l>>>2>>>0];case 8:return a?l=>we[l>>>3]:l=>We[l>>>3];default:throw new TypeError(`invalid integer width (${r}): ${e}`)}};function De(){this.lb=[void 0],this.zb=[]}var Te=new De;function Pr(e){e>>>=0,e>=Te.sb&&--Te.get(e).Ab===0&&Te.xb(e)}var ge=e=>{if(!e)throw new Pe("Cannot use deleted val. handle = "+e);return Te.get(e).value},_e=e=>{switch(e){case void 0:return 1;case null:return 2;case!0:return 3;case!1:return 4;default:return Te.wb({Ab:1,value:e})}};function ut(e){return this.fromWireType(c()[e>>>2>>>0])}var Cr=(e,r)=>{switch(r){case 4:return function(a){var l=this.fromWireType;return Q.buffer!=ee.buffer&&te(),l.call(this,tr[a>>>2>>>0])};case 8:return function(a){return this.fromWireType(T()[a>>>3>>>0])};default:throw new TypeError(`invalid float width (${r}): ${e}`)}};function ft(e){return this.fromWireType(g()[e>>>2>>>0])}var t=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,n=(e,r)=>{for(var a=e>>1,l=a+r/2;!(a>=l)&&w()[a>>>0];)++a;if(a<<=1,32<a-e&&t)return t.decode(m().slice(e,a));for(a="",l=0;!(l>=r/2);++l){var h=d()[e+2*l>>>1>>>0];if(h==0)break;a+=String.fromCharCode(h)}return a},u=(e,r,a)=>{if(a===void 0&&(a=2147483647),2>a)return 0;a-=2;var l=r;a=a<2*e.length?a/2:e.length;for(var h=0;h<a;++h){var v=e.charCodeAt(h);d()[r>>>1>>>0]=v,r+=2}return d()[r>>>1>>>0]=0,r-l},p=e=>2*e.length,y=(e,r)=>{for(var a=0,l="";!(a>=r/4);){var h=c()[e+4*a>>>2>>>0];if(h==0)break;++a,65536<=h?(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023)):l+=String.fromCharCode(h)}return l},A=(e,r,a)=>{if(r>>>=0,a===void 0&&(a=2147483647),4>a)return 0;var l=r;a=l+a-4;for(var h=0;h<e.length;++h){var v=e.charCodeAt(h);if(55296<=v&&57343>=v){var M=e.charCodeAt(++h);v=65536+((v&1023)<<10)|M&1023}if(c()[r>>>2>>>0]=v,r+=4,r+4>a)break}return c()[r>>>2>>>0]=0,r-l},D=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);55296<=l&&57343>=l&&++a,r+=4}return r},C=e=>{if(!be)try{if(e(),!ze())try{U?kt(me):Rr(me)}catch(r){r instanceof ir||r=="unwind"||H(1,r)}}catch(r){r instanceof ir||r=="unwind"||H(1,r)}};function k(e){e>>>=0,typeof Atomics.Tb=="function"&&(Atomics.Tb(c(),e>>>2,e).value.then(j),e+=128,Atomics.store(c(),e>>>2,1))}f.__emscripten_thread_mailbox_await=k;var j=()=>{var e=ct();e&&(k(e),C(()=>Cn()))};f.checkMailbox=j;var ae=e=>{var r=Lt();return e=e(),pt(r),e};function z(e,r){var a=arguments.length-2,l=arguments;return ae(()=>{for(var h=2*a,v=$t(8*h),M=v>>>3,P=0;P<a;P++){var $=l[2+P];typeof $=="bigint"?(we[M+2*P]=1n,we[M+2*P+1]=$):(we[M+2*P]=0n,T()[M+2*P+1>>>0]=$)}return Pn(e,h,v,r)})}var Ce=[],b=(e,r)=>{var a=Mr[e];if(a===void 0)throw e=Sn(e),a=Me(e),Ge(e),new Pe(r+" has unknown type "+a);return a},q={},re=e=>{var r=q[e];return r===void 0?Me(e):r},xe=[],Gr=()=>typeof globalThis=="object"?globalThis:Function("return this")(),Za=e=>{var r=xe.length;return xe.push(e),r},Ka=(e,r)=>{for(var a=Array(e),l=0;l<e;++l)a[l]=b(g()[r+4*l>>>2>>>0],"parameter "+l);return a},sn=e=>{if(e===void 0)return"_unknown";e=e.replace(/[^a-zA-Z0-9_]/g,"$");var r=e.charCodeAt(0);return 48<=r&&57>=r?`_${e}`:e},un={};function Qa(e,r){return e=sn(e),{[e]:function(){return r.apply(this,arguments)}}[e]}function eo(e){var r=Function;if(!(r instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof r} which is not a function`);var a=Qa(r.name||"unknownFunctionName",function(){});return a.prototype=r.prototype,a=new a,e=r.apply(a,e),e instanceof Object?e:a}var ro=e=>{for(var r="",a=0;a<e;++a)r+=(a!==0?", ":"")+"arg"+a;var l="return function emval_allocator_"+e+`(constructor, argTypes, args) {
  var HEAPU32 = getMemory();
...
`))(b,f,_e,()=>g())},fn={},Ir=e=>e%4===0&&(e%100!==0||e%400===0),ln=[0,31,60,91,121,152,182,213,244,274,305,335],cn=[0,31,59,90,120,151,181,212,243,273,304,334];function dn(e,r,a,l,h,v,M){return U?z(16,1,e,r,a,l,h,v,M):-52}function pn(e,r,a,l,h,v){if(U)return z(17,1,e,r,a,l,h,v)}var mn=e=>{var r=_r(e)+1,a=dt(r);return a&&Ar(e,a,r),a},Bt={},hn=()=>{if(!Rt){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:I||"./this.program"},r;for(r in Bt)Bt[r]===void 0?delete e[r]:e[r]=Bt[r];var a=[];for(r in e)a.push(`${r}=${e[r]}`);Rt=a}return Rt},Rt;function gn(e,r){if(U)return z(18,1,e,r);e>>>=0,r>>>=0;var a=0;return hn().forEach((l,h)=>{var v=r+a;for(h=g()[e+4*h>>>2>>>0]=v,v=0;v<l.length;++v)s()[h++>>>0>>>0]=l.charCodeAt(v);s()[h>>>0>>>0]=0,a+=l.length+1}),0}function yn(e,r){if(U)return z(19,1,e,r);e>>>=0,r>>>=0;var a=hn();g()[e>>>2>>>0]=a.length;var l=0;return a.forEach(h=>l+=h.length+1),g()[r>>>2>>>0]=l,0}function vn(e){return U?z(20,1,e):52}function bn(e,r,a,l){return U?z(21,1,e,r,a,l):52}function wn(e,r,a,l){return U?z(22,1,e,r,a,l):70}var to=[null,[],[]];function On(e,r,a,l){if(U)return z(23,1,e,r,a,l);r>>>=0,a>>>=0,l>>>=0;for(var h=0,v=0;v<a;v++){var M=g()[r>>>2>>>0],P=g()[r+4>>>2>>>0];r+=8;for(var $=0;$<P;$++){var N=m()[M+$>>>0],oe=to[e];N===0||N===10?((e===1?er:de)(Oe(oe,0)),oe.length=0):oe.push(N)}h+=P}return g()[l>>>2>>>0]=h,0}var Tn=[31,29,31,30,31,30,31,31,30,31,30,31],_n=[31,28,31,30,31,30,31,31,30,31,30,31];function no(e){var r=Array(_r(e)+1);return kr(e,r,0,r.length),r}var ao=(e,r)=>{s().set(e,r>>>0)};function An(e,r,a,l){function h(O,X,ie){for(O=typeof O=="number"?O.toString():O||"";O.length<X;)O=ie[0]+O;return O}function v(O,X){return h(O,X,"0")}function M(O,X){function ie(Un){return 0>Un?-1:0<Un?1:0}var dr;return(dr=ie(O.getFullYear()-X.getFullYear()))===0&&(dr=ie(O.getMonth()-X.getMonth()))===0&&(dr=ie(O.getDate()-X.getDate())),dr}function P(O){switch(O.getDay()){case 0:return new Date(O.getFullYear()-1,11,29);case 1:return O;case 2:return new Date(O.getFullYear(),0,3);case 3:return new Date(O.getFullYear(),0,2);case 4:return new Date(O.getFullYear(),0,1);case 5:return new Date(O.getFullYear()-1,11,31);case 6:return new Date(O.getFullYear()-1,11,30)}}function $(O){var X=O.ob;for(O=new Date(new Date(O.pb+1900,0,1).getTime());0<X;){var ie=O.getMonth(),dr=(Ir(O.getFullYear())?Tn:_n)[ie];if(X>dr-O.getDate())X-=dr-O.getDate()+1,O.setDate(1),11>ie?O.setMonth(ie+1):(O.setMonth(0),O.setFullYear(O.getFullYear()+1));else{O.setDate(O.getDate()+X);break}}return ie=new Date(O.getFullYear()+1,0,4),X=P(new Date(O.getFullYear(),0,4)),ie=P(ie),0>=M(X,O)?0>=M(ie,O)?O.getFullYear()+1:O.getFullYear():O.getFullYear()-1}e>>>=0,r>>>=0,a>>>=0,l>>>=0;var N=g()[l+40>>>2>>>0];l={Qb:c()[l>>>2>>>0],Pb:c()[l+4>>>2>>>0],tb:c()[l+8>>>2>>>0],yb:c()[l+12>>>2>>>0],ub:c()[l+16>>>2>>>0],pb:c()[l+20>>>2>>>0],kb:c()[l+24>>>2>>>0],ob:c()[l+28>>>2>>>0],Wb:c()[l+32>>>2>>>0],Ob:c()[l+36>>>2>>>0],Rb:N?sr(N):""},a=sr(a),N={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var oe in N)a=a.replace(new RegExp(oe,"g"),N[oe]);var Ie="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ve="January February March April May June July August September October November December".split(" ");N={"%a":O=>Ie[O.kb].substring(0,3),"%A":O=>Ie[O.kb],"%b":O=>Ve[O.ub].substring(0,3),"%B":O=>Ve[O.ub],"%C":O=>v((O.pb+1900)/100|0,2),"%d":O=>v(O.yb,2),"%e":O=>h(O.yb,2," "),"%g":O=>$(O).toString().substring(2),"%G":O=>$(O),"%H":O=>v(O.tb,2),"%I":O=>(O=O.tb,O==0?O=12:12<O&&(O-=12),v(O,2)),"%j":O=>{for(var X=0,ie=0;ie<=O.ub-1;X+=(Ir(O.pb+1900)?Tn:_n)[ie++]);return v(O.yb+X,3)},"%m":O=>v(O.ub+1,2),"%M":O=>v(O.Pb,2),"%n":()=>`
`,"%p":O=>0<=O.tb&&12>O.tb?"AM":"PM","%S":O=>v(O.Qb,2),"%t":()=>"	","%u":O=>O.kb||7,"%U":O=>v(Math.floor((O.ob+7-O.kb)/7),2),"%V":O=>{var X=Math.floor((O.ob+7-(O.kb+6)%7)/7);if(2>=(O.kb+371-O.ob-2)%7&&X++,X)X==53&&(ie=(O.kb+371-O.ob)%7,ie==4||ie==3&&Ir(O.pb)||(X=1));else{X=52;var ie=(O.kb+7-O.ob-1)%7;(ie==4||ie==5&&Ir(O.pb%400-1))&&X++}return v(X,2)},"%w":O=>O.kb,"%W":O=>v(Math.floor((O.ob+7-(O.kb+6)%7)/7),2),"%y":O=>(O.pb+1900).toString().substring(2),"%Y":O=>O.pb+1900,"%z":O=>{O=O.Ob;var X=0<=O;return O=Math.abs(O)/60,(X?"+":"-")+("0000"+(O/60*100+O%60)).slice(-4)},"%Z":O=>O.Rb,"%%":()=>"%"},a=a.replace(/%%/g,"\0\0");for(oe in N)a.includes(oe)&&(a=a.replace(new RegExp(oe,"g"),N[oe](l)));return a=a.replace(/\0\0/g,"%"),oe=no(a),oe.length>r?0:(ao(oe,e),oe.length-1)}R.vb();for(var En=Array(256),lt=0;256>lt;++lt)En[lt]=String.fromCharCode(lt);zr=En,Pe=f.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},f.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(De.prototype,{get(e){return this.lb[e]},has(e){return this.lb[e]!==void 0},wb(e){var r=this.zb.pop()||this.lb.length;return this.lb[r]=e,r},xb(e){this.lb[e]=void 0,this.zb.push(e)}}),Te.lb.push({value:void 0},{value:null},{value:!0},{value:!1}),Te.sb=Te.lb.length,f.count_emval_handles=()=>{for(var e=0,r=Te.sb;r<Te.lb.length;++r)Te.lb[r]!==void 0&&++e;return e};var oo=[Kr,et,fr,Wr,tt,nt,at,ot,Lr,Ye,$r,Hr,jr,Er,Nr,Sr,dn,pn,gn,yn,vn,bn,wn,On],io={b:function(e,r,a){throw e>>>=0,new Ut(e).vb(r>>>0,a>>>0),ur=e,Dt++,ur},ea:function(e){Mn(e>>>0,!Y,1,!L,131072,!1),R.Db()},E:function(e){e>>>=0,U?postMessage({cmd:"cleanupThread",thread:e}):((e=R.jb[e])||He(),R.Bb(e))},W:lr,y:Wr,ka:tt,S:nt,U:at,L:ot,ia:Lr,ba:Ye,ha:$r,G:Hr,T:jr,Q:Er,ja:Nr,R:Sr,J:function(e,r,a,l,h){e>>>=0,r>>>=0,a>>>=0,r=Me(r);var v=r.indexOf("u")!=-1;v&&(h=(1n<<64n)-1n),x(e,{name:r,fromWireType:M=>M,toWireType:function(M,P){if(typeof P!="bigint"&&typeof P!="number")throw new TypeError(`Cannot convert "${it(P)}" to ${this.name}`);if(P<l||P>h)throw new TypeError(`Passing a number "${it(P)}" from JS side to C/C++ side to an argument of type "${r}", which is outside the valid range [${l}, ${h}]!`);return P},argPackAdvance:8,readValueFromPointer:cr(r,a,!v),rb:null})},qa:function(e,r,a,l){e>>>=0,r=Me(r>>>0),x(e,{name:r,fromWireType:function(h){return!!h},toWireType:function(h,v){return v?a:l},argPackAdvance:8,readValueFromPointer:function(h){return this.fromWireType(m()[h>>>0])},rb:null})},pa:function(e,r){e>>>=0,r=Me(r>>>0),x(e,{name:r,fromWireType:a=>{var l=ge(a);return Pr(a),l},toWireType:(a,l)=>_e(l),argPackAdvance:8,readValueFromPointer:ut,rb:null})},I:function(e,r,a){e>>>=0,a>>>=0,r=Me(r>>>0),x(e,{name:r,fromWireType:l=>l,toWireType:(l,h)=>h,argPackAdvance:8,readValueFromPointer:Cr(r,a),rb:null})},u:function(e,r,a,l,h){if(e>>>=0,a>>>=0,r=Me(r>>>0),h===-1&&(h=4294967295),h=P=>P,l===0){var v=32-8*a;h=P=>P<<v>>>v}var M=r.includes("unsigned")?function(P,$){return $>>>0}:function(P,$){return $};x(e,{name:r,fromWireType:h,toWireType:M,argPackAdvance:8,readValueFromPointer:cr(r,a,l!==0),rb:null})},m:function(e,r,a){function l(v){var M=g()[v>>>2>>>0];return v=g()[v+4>>>2>>>0],new h(s().buffer,v,M)}e>>>=0;var h=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][r];a=Me(a>>>0),x(e,{name:a,fromWireType:l,argPackAdvance:8,readValueFromPointer:l},{Hb:!0})},K:function(e,r){e>>>=0,r=Me(r>>>0);var a=r==="std::string";x(e,{name:r,fromWireType:function(l){var h=g()[l>>>2>>>0],v=l+4;if(a)for(var M=v,P=0;P<=h;++P){var $=v+P;if(P==h||m()[$>>>0]==0){if(M=sr(M,$-M),N===void 0)var N=M;else N+=String.fromCharCode(0),N+=M;M=$+1}}else{for(N=Array(h),P=0;P<h;++P)N[P]=String.fromCharCode(m()[v+P>>>0]);N=N.join("")}return Ge(l),N},toWireType:function(l,h){h instanceof ArrayBuffer&&(h=new Uint8Array(h));var v=typeof h=="string";if(!(v||h instanceof Uint8Array||h instanceof Uint8ClampedArray||h instanceof Int8Array))throw new Pe("Cannot pass non-string to std::string");var M=a&&v?_r(h):h.length,P=dt(4+M+1),$=P+4;if(g()[P>>>2>>>0]=M,a&&v)Ar(h,$,M+1);else if(v)for(v=0;v<M;++v){var N=h.charCodeAt(v);if(255<N)throw Ge($),new Pe("String has UTF-16 code units that do not fit in 8 bits");m()[$+v>>>0]=N}else for(v=0;v<M;++v)m()[$+v>>>0]=h[v];return l!==null&&l.push(Ge,P),P},argPackAdvance:8,readValueFromPointer:ft,rb(l){Ge(l)}})},A:function(e,r,a){if(e>>>=0,r>>>=0,a>>>=0,a=Me(a),r===2)var l=n,h=u,v=p,M=()=>w(),P=1;else r===4&&(l=y,h=A,v=D,M=()=>g(),P=2);x(e,{name:a,fromWireType:$=>{for(var N=g()[$>>>2>>>0],oe=M(),Ie,Ve=$+4,O=0;O<=N;++O){var X=$+4+O*r;(O==N||oe[X>>>P]==0)&&(Ve=l(Ve,X-Ve),Ie===void 0?Ie=Ve:(Ie+=String.fromCharCode(0),Ie+=Ve),Ve=X+r)}return Ge($),Ie},toWireType:($,N)=>{if(typeof N!="string")throw new Pe(`Cannot pass non-string to C++ string type ${a}`);var oe=v(N),Ie=dt(4+oe+r);return g()[Ie>>>2]=oe>>P,h(N,Ie+4,oe+r),$!==null&&$.push(Ge,Ie),Ie},argPackAdvance:8,readValueFromPointer:ut,rb($){Ge($)}})},ra:function(e,r){e>>>=0,r=Me(r>>>0),x(e,{Ib:!0,name:r,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>!0,O:function(e,r){e>>>=0,e==r>>>0?setTimeout(()=>j()):U?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=R.jb[e])&&e.postMessage({cmd:"checkMailbox"})},X:function(e,r,a,l){r>>>=0,a/=2,Ce.length=a,l=l>>>0>>>3;for(var h=0;h<a;h++)Ce[h]=we[l+2*h]?we[l+2*h+1]:T()[l+2*h+1>>>0];return e=oo[e],R.Gb=r,r=e.apply(null,Ce),R.Gb=0,r},da:k,ma:function(e){W&&R.jb[e>>>0].ref()},r:function(e,r,a){r>>>=0,a>>>=0,e=ge(e>>>0),r=b(r,"emval::as");var l=[],h=_e(l);return g()[a>>>2>>>0]=h,r.toWireType(l,e)},i:function(e,r,a,l,h){a>>>=0,l>>>=0,h>>>=0,e=xe[e>>>0],r=ge(r>>>0),a=re(a);var v=[];return g()[l>>>2>>>0]=_e(v),e(r,a,v,h)},s:function(e,r,a,l){a>>>=0,l>>>=0,e=xe[e>>>0],r=ge(r>>>0),a=re(a),e(r,a,null,l)},c:Pr,B:function(e,r){return r>>>=0,e=ge(e>>>0),r=ge(r),e==r},o:function(e){return e>>>=0,e===0?_e(Gr()):(e=re(e),_e(Gr()[e]))},g:function(e,r){var a=Ka(e,r>>>0),l=a[0];r=l.name+"_$"+a.slice(1).map(function(oe){return oe.name}).join("_")+"$";var h=un[r];if(h!==void 0)return h;h=["retType"];for(var v=[l],M="",P=0;P<e-1;++P)M+=(P!==0?", ":"")+"arg"+P,h.push("argType"+P),v.push(a[1+P]);var $="return function "+sn("methodCaller_"+r)+`(handle, name, destructors, args) {
