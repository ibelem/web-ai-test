...
`)}},Yo=e=>new Fa(e),wr=(e,t)=>{let r=e.length,a=[];for(let i=0;i<r;i++){let s=r-1-i,o=e[s]||1;(t[t.length-1-i]||1)>1&&o===1&&a.unshift(s)}return a}});var nc,Zo,ac,ic,xt,Xo,Qo,$r=Q(()=>{"use strict";Ce();Xe();_e();nc=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Zo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,ac=(e,t)=>N.sortBasedOnPerm(e,Zo(e.length,t)),ic=(e,t,r,a)=>{let i=[];i.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)i.push(r.indicesSet("a",e[s],`i[${s}]`));return i.push("return a;}"),i.join(`
`)},xt=(e,t)=>{let r=e.dataType,a=e.dims.length,i=Zo(a,t),s=ac(e.dims,i),o=J("output",r,s.length),c=W("a",r,a),p=m=>`
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${o}`,inputDependencies:m?["rank","type","type","type","type"]:void 0},getShaderSource:S,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m?[{type:"uint32",data:p},...L(s)]:[{type:"uint32",data:p}]})}},Bc=e=>xe(e),Cs=(e,t)=>{let{inputs:r,outputCount:a}=e,i=Bc({...t,outputCount:a});if(Ae.webgpu.validateInputContent&&Pc(r,i),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Rc(r,i))}});var Mc,Dc,As,Ts=Q(()=>{"use strict";Ce();_e();Mc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Dc=e=>{let t=e[0].dims,r=e[0].dims[2],a=N.size(t)/4,i=e[0].dataType,s=W("input",i,t,4),o=W("bias",i,[r],4),c=W("residual",i,t,4),p=J("output",i,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:l=>`
  ...
  }`}},As=e=>{Mc(e.inputs),e.compute(Dc(e.inputs))}});var zc,Ee,Es,Os,ks,Ps,Rs,Bs,Ms,Ds,zs,Uc,Us,Ws,Ns,Vs,Zn,Hs,Xn,Ls,Gs,Fs,qs,js,Ks,Ys,Zs,Xs,Qs,Js,eu,tu,ru,nu,au,iu,ou,su,Xa=Q(()=>{"use strict";ze();Ce();Xe();_e();zc=(e,t,r,a,i,s)=>{let o=Math.ceil(t/4),c="";typeof i=="string"?c=`${i}(a)`:c=i("a");let p=W("inputData",r,[o],4),m=J("outputData",a,[o],4);return`
  ...
  }`},Ee=(e,t,r,a,i,s=e.dataType)=>({name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:o=>zc(o,N.size(e.dims),e.dataType,s,r,a),getRunData:o=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(N.size(o[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(N.size(e.dims)/4)}]})}),Es=e=>{e.compute(Ee(e.inputs[0],"Abs","abs"))},Os=e=>{e.compute(Ee(e.inputs[0],"Acos","acos"))},ks=e=>{e.compute(Ee(e.inputs[0],"Acosh","acosh"))},Ps=e=>{e.compute(Ee(e.inputs[0],"Asin","asin"))},Rs=e=>{e.compute(Ee(e.inputs[0],"Asinh","asinh"))},Bs=e=>{e.compute(Ee(e.inputs[0],"Atan","atan"))},Ms=e=>{e.compute(Ee(e.inputs[0],"Atanh","atanh"))},Ds=e=>xe(e),zs=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Ee(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Uc=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:Gn,r=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:Fn;return xe({min:t,max:r})},Us=(e,t)=>{let r=e.inputs.length===1?t:Uc(e.inputs),a=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Clip",i=>`clamp(${i}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Ws=e=>{e.compute(Ee(e.inputs[0],"Ceil","ceil"))},Ns=e=>{e.compute(Ee(e.inputs[0],"Cos","cos"))},Vs=e=>{e.compute(Ee(e.inputs[0],"Cosh","cosh"))},Zn=e=>xe(e),Hs=(e,t)=>{let r=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Elu",a=>`elu_vf32(${a})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Ls=e=>{let t=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Xn(`vec4<${t}>`,t)))},Gs=e=>{e.compute(Ee(e.inputs[0],"Exp","exp"))},Fs=e=>{e.compute(Ee(e.inputs[0],"Floor","floor"))},qs=e=>{let t=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Xn(`vec4<${t}>`,t)))},js=(e,t)=>{let r=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"LeakyRelu",a=>`select(leaky_relu_alpha_ * ${a}, ${a}, ${a} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Ks=e=>{e.compute(Ee(e.inputs[0],"Not",t=>`!${t}`))},Ys=e=>{e.compute(Ee(e.inputs[0],"Neg",t=>`-${t}`))},Zs=e=>{e.compute(Ee(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Xs=e=>{let t=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Qs=e=>{e.compute(Ee(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Js=e=>xe(e),eu=(e,t)=>{let r=_t(e.inputs[0].dataType);e.compute(Ee(e.inputs[0],"HardSigmoid",a=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${a} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},tu=e=>{e.compute(Ee(e.inputs[0],"Sin","sin"))},ru=e=>{e.compute(Ee(e.inputs[0],"Sinh","sinh"))},nu=e=>{e.compute(Ee(e.inputs[0],"Sqrt","sqrt"))},au=e=>{e.compute(Ee(e.inputs[0],"Tan","tan"))},iu=e=>{e.compute(Ee(e.inputs[0],"Tanh",t=>`sign(${t}) * (1 - exp(-2 * abs(${t}))) / (1 + exp(-2 * abs(${t})))`))},ou=(e,t)=>{let r=_t(e.inputs[0].dataType);return e.compute(Ee(e.inputs[0],"ThresholdedRelu",a=>`select(vec4<${r}>(0.0), ${a}, ${a} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},su=e=>{e.compute(Ee(e.inputs[0],"Log","log"))}});var Nc,Vc,uu,lu=Q(()=>{"use strict";Ce();_e();Xa();Nc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Vc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=W("input",e[0].dataType,e[0].dims,4),a=W("bias",e[0].dataType,[e[0].dims[2]],4),i=J("output",e[0].dataType,t,4),s=N.size(t)/4,o=He(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:p=>`
  ...
  ${p.mainStart()}
    ...
    ${i.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${C}
      }`},Lc=(e,t,r,a,i,s,o=r.dataType)=>{let c=!N.areEqual(r.dims,a.dims),p=r.dims,m=N.size(r.dims),l=!1,g=!1,b=[c];if(c){let w=At.calcShape(r.dims,a.dims,!1);if(!w)throw new Error("Can't perform binary op on the given tensors");p=w,m=N.size(p);let $=N.size(r.dims)===1,x=N.size(a.dims)===1,T=r.dims.length>0&&r.dims[r.dims.length-1]%4===0,C=a.dims.length>0&&a.dims[a.dims.length-1]%4===0;b.push($),b.push(x),b.push(T),b.push(C);let S=1;for(let E=1;E<p.length;E++){let O=r.dims[r.dims.length-E]??1,U=a.dims[a.dims.length-E]??1;if(O===U)S*=O;else break}S%4===0?(g=!0,l=!0):($||x||T||C)&&(l=!0)}else l=!0;return b.push(l),{name:e,shaderCache:{hint:t+b.map(w=>w.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:w=>Hc(w,r.dims,a.dims,p,l,c,g,i,r.dataType,a.dataType,o,s),getRunData:()=>({outputs:[{dims:p,dataType:o}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(N.size(p)/4)},...L(r.dims),...L(a.dims),...L(p)]})}},Pt=(e,t,r,a,i,s)=>{e.compute(Lc(t,i??"",e.inputs[0],e.inputs[1],r,a,s))},du=e=>{Pt(e,"Add",(t,r)=>`${t}+${r}`)},cu=e=>{Pt(e,"Div",(t,r)=>`${t}/${r}`)},pu=e=>{Pt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},fu=e=>{Pt(e,"Mul",(t,r)=>`${t}*${r}`)},mu=e=>{let t=W("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Pt(e,"Pow",{scalar:(a,i)=>`pow_custom(${a},${i})`,vector:(a,i)=>`pow_vector_custom(${a},${i})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},hu=e=>{Pt(e,"Sub",(t,r)=>`${t}-${r}`)},gu=e=>{Pt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},yu=e=>{Pt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},bu=e=>{Pt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},vu=e=>{Pt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Fc,qc,jc,Kc,$u,_u,Su=Q(()=>{"use strict";Ce();Xe();_e();Fc=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},qc=(e,t)=>`
...
`});var Yc,Zc,Xr,xu,Xc,Qr,Qc,ra,Jr=Q(()=>{"use strict";Ce();_e();jt();ea();Yc=(e,t)=>e?`
        ...
        }`,Xr=(e,t,r="f32",a,i=!1,s=32,o=!1,c=32)=>{let p=t[1]*e[1],m=t[0]*e[0],l=i?p:s,g=i?s:p,b=l/t[0],w=s/t[1];if(!((i&&b===4&&e[1]===4||!i&&(b===3||b===4))&&l%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${b} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Xc=e=>e?"let ACached = mm_Asub[k][tileRow + innerRow];":"let ACached = mm_Asub[tileRow + innerRow][k];",Qr=(e,t,r="f32",a,i=!1,s=32,o=!1,c=32,p=!1)=>{let m=e[1]*t[1],l=e[0]*t[0],g=i?m:s,b=i?s:m;if(!(b%t[1]===0&&g%t[0]===0&&s%t[1]===0))throw new Error(`tileAHight ${b} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${g} must be divisible by workgroupSize[0]${t[0]}, tileInner ${s} must be divisible by workgroupSize[1]${t[1]}`);let w=b/t[1],$=g/t[0],x=s/t[1],T=p?`
    let localRow = i32(localId.y);
...
`}return de};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${g};${b};${i}`,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:S}),getShaderSource:E}},ep=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Tu=e=>{ep(e.inputs);let t=At.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],a=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&a<8?e.compute(ri(e.inputs,{activation:""},t)):e.compute(ra(e.inputs,{activation:""},t))}});var ei,Eu,tp,Ou,ai,rp,np,ii,ti=Q(()=>{"use strict";Ce();Iu();Jr();Au();jt();ni();$r();ei=(e,t,r,a,i,s)=>{let o=e[0],c=e.slice(s?1:2,s?3:4),p=c.length,m=t[0],g=t.slice(2).map(($,x)=>$+($-1)*(r[x]-1)),w=c.map(($,x)=>$+a[x]+a[x+p]).map(($,x)=>Math.floor(($-g[x]+i[x])/i[x]));return w.splice(0,0,o),w.splice(s?3:1,0,m),w},Eu=[2,3,1,0],tp=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ou=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let a=e.pads.slice();or.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let i=Object.assign({},e);return Object.assign(i,{kernelShape:r,pads:a}),i},ai=e=>{let t=Qn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],i=e.dilations,s=e.group,o=e.kernel_shape,c=e.pads,p=e.strides,m=e.w_is_const();return{autoPad:a,format:r,dilations:i,group:s,kernelShape:o,pads:c,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},rp=(e,t,r)=>{let a=Ou(r,t),i=r.format==="NHWC";if(r.group!==1){e.compute(Ja(t,a));return}let s=t.length===3,o=t[0].dims[i?1:2],c=t[0].dims[i?2:3],p=t[0].dims[i?3:1],m=t[1].dims[2],l=t[1].dims[3],g=ei(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,i),b=g[i?1:2],w=g[i?2:3],$=g[i?3:1],x=i&&m===o&&l===c&&r.pads[0]===0&&r.pads[1]===0;if(x||m===1&&l===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let D=g[0],V,Y,se,B=[];if(i){let Oe=e.kernelCustomData.wT??e.compute(xt(t[1],Eu),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=Oe),x){let ee=o*c*p;V=t[0].reshape([1,D,ee]),Y=Oe.reshape([1,ee,$]),se=[1,D,$]}else V=t[0].reshape([D,o*c,p]),Y=Oe.reshape([1,p,$]),se=[D,b*w,$];B.push(V),B.push(Y)}else V=t[0].reshape([D,p,o*c]),Y=t[1].reshape([1,$,p]),se=[D,$,b*w],B.push(Y),B.push(V);s&&B.push(t[2]);let te=se[2],ke=B[0].dims[B[0].dims.length-1];te<8&&ke<8?e.compute(ri(B,a,g,se,i),{inputs:B}):e.compute(ra(B,a,g,se,i),{inputs:B});return}let T=!0,C=e.kernelCustomData.wT??e.compute(xt(t[1],Eu),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=C);let S=[t[0],C];s&&S.push(t[2]);let E=i?b*w:$,O=i?$:b*w,U=m*l*p;e.compute(Cu(S,a,g,E,O,U,s,T),{inputs:S})},np=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let i=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),o=[1].concat(t.dilations),c=[1].concat(t.kernelShape),p=Ou({...t,pads:i,strides:s,dilations:o,kernelShape:c},a);e.compute(Ja(a,p,m=>r?[m[0],m[2],m[3]]:[]))},ii=(e,t)=>{tp(e.inputs,t),e.inputs[0].dims.length===3?np(e,t):rp(e,e.inputs,t)}});var ap,ku,Pu=Q(()=>{"use strict";qt();_e();jt();ea();Qa();Jr();ap=(e,t=!1,r,a=4)=>{let i=je(a,"f32"),s=C=>{switch(C){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${i}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${a}] = value;
        ...
        ${ye}
        ${ap(p,o,t,O)}
        ${$?Xr(S,C,"f32",void 0,!p,U):Qr(S,C,"f32",void 0,!p,U,!1,void 0,c)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${S};${C};${$}`,inputDependencies:te},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:E[0],y:E[1],z:E[2]},programUniforms:B}),getShaderSource:ke}}});var ip,oi,Ru=Q(()=>{"use strict";qt();Ce();_e();ip=(e,t,r,a,i,s=!1,o,c,p=!1)=>{let m=p?1:2,l=p?2:3,g=p?3:1,b=s?2:1,w=`
  ...
  ${s?E:O}}`},oi=(e,t,r)=>{let a=e.length>2,i=t.outputShape,s=N.size(i),o=[Math.ceil(s/64),1,1];De("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${o}`);let c=t.format==="NHWC",p=["rank","rank"],m=[t.strides[0],t.strides[1]],l=[t.kernelShape[c?1:2],t.kernelShape[c?2:3]],g=[t.dilations[0],t.dilations[1]],b=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[c?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[c?2:3]-1)*(t.dilations[1]-1))],w=[b[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),b[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],$=!1,x=t.group,T=e[1].dims,C=T[0]/x,S=T[1],E=[{type:"int32",data:s},{type:"uint32",data:m},{type:"uint32",data:l},{type:"uint32",data:g},{type:"uint32",data:b},{type:"int32",data:w},{type:"uint32",data:C},{type:"uint32",data:S},...L(e[0].dims),...L(e[1].dims)];a&&(E.push(...L(e[2].dims)),p.push("rank")),E.push(...L(i));let O=o[1]===1&&o[2]===1,U=D=>{let V=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:m.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:b.length},{name:"pads",type:"i32",length:w.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],Y=He(e[0].dataType);return`${ip(D,e,i,a,O,$,Y,V,c)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:p},getRunData:()=>({dispatchGroup:{x:o[0],y:o[1],z:o[2]},outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],programUniforms:E}),getShaderSource:U}}});var op,sp,up,Bu,Mu,lp,dp,cp,pp,Du,zu=Q(()=>{"use strict";Pu();Ru();jt();$r();op=(e,t,r,a,i,s)=>(e-1)*t+r+(a-1)*i+1-s,sp=(e,t,r,a,i)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[a]=s,r[i]=e-s):t==="SAME_LOWER"&&(r[a]=e-s,r[i]=s)},up=(e,t,r,a,i,s,o,c,p,m)=>{let l=e.length-2,g=m.length===0;if(p.length===0)for(let $=0;$<l;++$)p.push(0);let b=e[0],w=t[c?3:1]*i;for(let $=0,x=e.length-l-(c?1:0);$<l;++$,++x){let T=e[x],C=g?T*o[$]:m[$],S=op(T,o[$],s[$],t[x],r[$],C);sp(S,a,s,$,$+l),g&&m.push(o[$]*(T-1)+p[$]+(t[x]-1)*r[$]+1-s[$]-s[$+l])}m.splice(0,0,b),m.splice(c?3:1,0,w)},Bu=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((g,b)=>g*b,1)===0){r.length=0;for(let g=2;g<t[1].dims.length;++g)r.push(t[1].dims[g])}let a=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(a?3:1,0,t[1].dims[1]);let i=e.pads.slice(),s=e.outputShape.slice(),o=e.outputPadding.slice(),c=t[0].dims,p=e.dilations.slice();if(p.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;p=new Array(g).fill(1)}let m=e.strides.slice();if(m.reduce((g,b)=>g+b,0)===0){let g=t[0].dims.length-2;m=new Array(g).fill(1)}up(c,r,p,e.autoPad,e.group,i,m,a,o,s);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:i,outputPadding:o,outputShape:s,dilations:p,strides:m}),l},Mu=e=>{let t=Qn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],i=e.dilations,s=e.group,o=e.kernelShape,c=e.pads,p=e.strides,m=e.wIsConst(),l=e.outputPadding,g=e.outputShape;return{autoPad:a,format:r,dilations:i,group:s,kernelShape:o,outputPadding:l,outputShape:g,pads:c,strides:p,wIsConst:m,...t,cacheKey:`${e.format};${t.activation};`}},lp=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[0];if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==i))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((l,g)=>l+g,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((l,g)=>l+g,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((l,g)=>l+g,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((l,g)=>l+g,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},dp=[2,3,1,0],cp=(e,t,r)=>{let a=Bu(r,t),i=r.format==="NHWC",s=a.outputShape,o=s[i?3:1],c=t[0].dims[i?3:1];if(a.group!==1||o===1&&c===1){e.compute(oi(t,a));return}let p=s[i?1:2],m=s[i?2:3],l=t[1].dims[2],g=t[1].dims[3],b=i?p*m:o,w=i?o:p*m,$=l*g*c,x=!0,T=e.kernelCustomData.wT??e.compute(xt(t[1],dp),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let C=[t[0],T],S=t.length===3;S&&(!i&&t[2].dims.length===1?C.push(t[2].reshape([t[2].dims[0],1,1])):C.push(t[2])),e.compute(ku(C,a,s,b,w,$,S,x),{inputs:C})},pp=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];a.length===3&&a.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let c=t.pads;c.length===0&&(c=[0,0]),c=[0,c[0],0,c[1]],o=[1].concat(o),s=[1].concat(s),i=[1].concat(i);let p=Bu({...t,pads:c,strides:o,dilations:s,kernelShape:i},a);e.compute(oi(a,p,m=>r?[m[0],m[2],m[3]]:[m[0],m[1],m[3]]))},Du=(e,t)=>{lp(e.inputs,t),e.inputs[0].dims.length===3?pp(e,t):cp(e,e.inputs,t)}});var fp,Uu,Wu,Nu=Q(()=>{"use strict";ze();Ce();Xe();_e();fp=(e,t,r,a)=>{let i=N.size(t),s=t.length,o=W("input",e,s),c=J("output",e,s),p=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),m=N.normalizeAxis(p,s),l=g=>{let b=` i32(${o.indicesGet("inputIndices","uniforms.axis")}) `,w=ce("uniforms.input_shape","uniforms.axis",s),$=a.reverse?b+(a.exclusive?" + 1":""):"0",x=a.reverse?w:b+(a.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:a.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:"uint32",data:i},{type:"int32",data:m},...L(t),...L(t)]}),getShaderSource:l}},Uu=(e,t)=>{let r=e.inputs[0].dims,a=e.inputs[0].dataType,i=e.inputs[1];e.compute(fp(a,r,i,t),{inputs:[0]})},Wu=e=>{let t=e.exclusive===1,r=e.reverse===1;return xe({exclusive:t,reverse:r})}});var si,na,Vu,mp,hp,ui,li,Hu,gp,Lu,Gu,Fu=Q(()=>{"use strict";Ce();Xe();_e();si="[a-zA-Z]|\\.\\.\\.",na="("+si+")+",Vu="^"+na+"$",mp="("+na+",)*"+na,hp="^"+mp+"$",ui=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let a=this.symbolToIndices.get(t);a===void 0?a=[r]:a.push(r),this.symbolToIndices.set(t,a)}},li=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[a,i]=r.includes("->")?r.split("->",2):[r,""];if(!a.match(RegExp(hp)))throw new Error("Invalid LHS term");if(a.split(",").forEach((c,p)=>{let m=t[p].dims.slice();if(!c.match(RegExp(Vu)))throw new Error("Invalid LHS term");let l=this.processTerm(c,!0,m,p);this.lhs.push(l)}),i==="")i+=[...this.symbolToInfo.entries()].filter(([c,p])=>p.count===1||c==="...").map(([c])=>c).join("");else if(!i.match(RegExp(na)))throw new Error("Invalid RHS");i.match(RegExp(si,"g"))?.forEach(c=>{if(c==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let p=this.symbolToInfo.get(c);if(p===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(p.dimValue)}}),this.rhs=this.processTerm(i,!1,this.outputDims)}addSymbol(t,r,a){let i=this.symbolToInfo.get(t);if(i!==void 0){if(i.dimValue!==r&&i.count!==1)throw new Error("Dimension mismatch");i.count++,i.inputIndices.push(a)}else i={count:1,dimValue:r,inputIndices:[a]};this.symbolToInfo.set(t,i)}processTerm(t,r,a,i=-1){let s=a.length,o=!1,c=[],p=0;if(!t.match(RegExp(Vu))&&!r&&t!=="")throw new Error("Invalid LHS term");let m=t.match(RegExp(si,"g")),l=new ui(i);return m?.forEach((g,b)=>{if(g==="..."){if(o)throw new Error("Only one ellipsis is allowed per input term");o=!0;let w=s-m.length+1;if(w<0)throw new Error("Ellipsis out of bounds");if(c=a.slice(p,p+w),this.hasEllipsis){if(this.ellipsisDims.length!==c.length||this.ellipsisDims.toString()!==c.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=c;else throw new Error("Ellipsis must be specified in the LHS");for(let $=0;$<c.length;$++){let x=String.fromCharCode("0".charCodeAt(0)+$);l.addSymbol(x,b+$),this.addSymbol(x,a[p++],i)}}else l.addSymbol(g,b+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(g,a[p++],i)}),l}},Hu=e=>e+"_max",gp=(e,t,r,a)=>{let s=e.map(l=>l.length).map((l,g)=>W(`input${g}`,t,l)),o=N.size(a),c=J("output",t,a.length),p=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),m=l=>{let g=[],b="var prod = 1.0;",w="var sum = 0.0;",$="sum += prod;",x=[],T=[],C=[],S=[],E=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((U,D)=>{if(r.rhs.symbolToIndices.has(D)){let V=r.rhs.symbolToIndices.get(D)?.[0];V!==void 0&&r.lhs.forEach((Y,se)=>{if(U.inputIndices.includes(se)){let B=Y.symbolToIndices.get(D);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(te=>{g.push(`${s[se].indicesSet(`input${se}Indices`,te,c.indicesGet("outputIndices",V))}`)})}})}else r.lhs.forEach((V,Y)=>{if(U.inputIndices.includes(Y)){let se=V.symbolToIndices.get(D);if(se===void 0)throw new Error("Invalid symbol error");se.forEach(B=>{x.push(`${s[Y].indicesSet(`input${Y}Indices`,B,`${D}`)}`)}),S.push(`prod *= ${s[Y].getByIndices(`input${Y}Indices`)};`)}}),T.push(`for(var ${D}: u32 = 0; ${D} < uniforms.${Hu(D)}; ${D}++) {`),C.push("}")});let O=E?[...g,`let sum = ${s.map((U,D)=>U.getByIndices(`input${D}Indices`)).join(" * ")};`]:[...g,w,...T,...x,b,...S,$,...C];return`
            ${l.registerUniforms(p.map(U=>({name:`${Hu(U)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...s,c)}
...
`)};
            ${c.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=p.filter(b=>r.symbolToInfo.has(b)).map(b=>({type:"uint32",data:r.symbolToInfo.get(b)?.dimValue||0}));l.push({type:"uint32",data:o});let g=e.map((b,w)=>[...L(b)]).reduce((b,w)=>b.concat(w),l);return g.push(...L(a)),{outputs:[{dims:a,dataType:t}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:g}},getShaderSource:m}},Lu=(e,t)=>{let r=new li(e.inputs,t.equation),a=r.outputDims,i=e.inputs.map((s,o)=>s.dims);e.compute(gp(i,e.inputs[0].dataType,r,a))},Gu=e=>{let t=e.equation.replace(/\s+/g,"");return xe({equation:t})}});var yp,qu,bp,vp,ju,Ku=Q(()=>{"use strict";ze();Ce();_e();yp=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,i=t.length<r.length?0:t.length-r.length;for(;a<r.length&&i<t.length;++a,++i)if(r[a]!==t[i]&&r[a]!==1&&t[i]!==1)throw new Error("Expand requires shape to be broadcastable to input")},qu=(e,t)=>{let r=e.length-t.length,a=[];for(let i=0;i<r;++i)a.push(e[i]);for(let i=0;i<t.length;++i)a.push(t[i]===1?e[i+r]:t[i]);return a},bp=(e,t)=>e.length>t.length?qu(e,t):qu(t,e),vp=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=bp(t,r),i=e[0].dataType,s=i===9?4:1,o=Math.ceil(N.size(a)/s),c=m=>{let l=W("input",i,t.length,s),g=J("output",i,a.length,s),b;if(i===9){let w=($,x,T="")=>`
    ...
    ${b}`},p=[{type:"uint32",data:o},...L(t),...L(a)];return{name:"Expand",shaderCache:{hint:`${a.length}`,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p})}},ju=e=>{yp(e.inputs),e.compute(vp(e.inputs),{inputs:[0]})}});var wp,$p,Yu,Zu,Xu=Q(()=>{"use strict";ze();Ce();Xe();_e();wp=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},$p=(e,t)=>{let r=e[0].dims,a=e[1].dims,i=r.length,s=N.normalizeAxis(t.axis,i),o=r.slice(0);o.splice(s,1,...a);let c=r[s],p=e[0].dataType===9?4:1,m=Math.ceil(N.size(o)/p),l=[{type:"uint32",data:m},{type:"int32",data:c},{type:"uint32",data:s},...L(e[0].dims),...L(e[1].dims),...L(o)],g=b=>{let w=W("data",e[0].dataType,e[0].dims.length,p),$=W("inputIndices",e[1].dataType,e[1].dims.length),x=J("output",e[0].dataType,o.length,p),T=S=>{let E=a.length,O=`var indicesIndices${S}  = ${$.type.indices}(0);`;for(let U=0;U<E;U++)O+=`${E>1?`indicesIndices${S}[${U}]`:`indicesIndices${S}`} = ${o.length>1?`outputIndices${S}[uniforms.axis + ${U}]`:`outputIndices${S}`};`;O+=`
      ...
      ${b.mainStart()}
        ...
        ${C}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:l}),getShaderSource:g}},Yu=e=>xe({axis:e.axis}),Zu=(e,t)=>{let r=e.inputs;wp(r),e.compute($p(e.inputs,t))}});var _p,Sp,Qu,Ju,el=Q(()=>{"use strict";Ce();Xe();_e();_p=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:g}},tl=e=>{let t=e.transA,r=e.transB,a=e.alpha,i=e.beta;return{transA:t,transB:r,alpha:a,beta:i,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},rl=(e,t)=>{xp(e.inputs),e.compute(Cp(e.inputs,t))}});var Ip,Ap,Tp,al,il=Q(()=>{"use strict";ze();Ce();_e();Ip=(e,t)=>{let r=e[0].dims,a=r,i=2,s=N.sizeToDimension(r,i),o=N.sizeFromDimension(r,i),c=Le(o),p=o/c,m=[r[0],r[1],p],l=["rank","type","type"],g=[{type:"uint32",data:o},{type:"uint32",data:p}];g.push(...L(m),...L(m));let b=w=>{let $=W("x",e[0].dataType,m.length,c),x=W("scale",e[1].dataType,e[1].dims),T=W("bias",e[2].dataType,e[2].dims),C=J("output",e[0].dataType,m.length,c),S=[$,x,T,C],E=$.type.value,O=c===1?"f32":`vec${c}<f32>`,U=64,D=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${p}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:l}),getShaderSource:w},{inputs:[t[0],b]})},al=(e,t)=>{t.format==="NHWC"?Tp(e,e.inputs,t):e.compute(Ip(e.inputs,t))}});var Ep,Op,ol,sl=Q(()=>{"use strict";ze();Ce();_e();Ep=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Op=(e,t,r)=>{let a=e[0].dims,i=e[1],s=e[2],o=a,c=N.normalizeAxis(t.axis,a.length),p=N.sizeToDimension(a,c),m=N.sizeFromDimension(a,c),l=N.size(i.dims),g=s?N.size(s.dims):0;if(l!==m||s&&g!==m)throw new Error(`Size of X.shape()[axis:] == ${m}.
  ...
  ${O.mainStart()}
    ...
    let mean = ${ft("meanVector",w)} / uniforms.norm_size;
    let invStdDev =
        inverseSqrt(${ft("meanSquareVector",w)} / uniforms.norm_size - mean * mean + uniforms.epsilon);
      ...
      `},Mp=(e,t,r)=>{let a="";for(let i=t-1;i>=0;--i)a+=`
          ...
          `},Up=(e,t,r)=>{switch(r.mode){case 0:return Bp(e,t,r.pads.length);case 1:return Mp(e,t,r.pads.length);case 2:return Dp(e,t,r.pads.length);case 3:return zp(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Wp=(e,t)=>{let r=N.padShape(e[0].dims.slice(),t.pads),a=e[0].dims,s=[{type:"uint32",data:N.size(r)},{type:"uint32",data:t.pads}];if(t.mode===0){let p=pt(e[0].dataType);s.push({type:p,data:t.value})}s.push(...L(e[0].dims),...L(r));let o=["rank"],c=p=>{let m=J("output",e[0].dataType,r.length),l=W("x",e[0].dataType,a.length),g=l.type.value,b=Up(m,a.length,t),w=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&w.push({name:"constant_value",type:g}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},yl=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Vp=e=>`${yl(e)};${e.countIncludePad}`,Hp=e=>`${yl(e)};${e.storageOrder};${e.dilations}`,bl=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),vl=(e,t,r,a)=>{let[i,s]=ml(t,a,r),o=W("x",t.dataType,t.dims.length),c=o.type.value,p="value += x_val;",m="";i.countIncludePad?m+=`value /= ${c}(uniforms.kernelSize);`:m+=`value /= ${c}(i32(uniforms.kernelSize) - pad);`;let[l,g,b,w,$]=hl(s,i);l.push(...L(t.dims),...L(s));let x=["rank"];return{name:e,shaderCache:{hint:`${a.cacheKey};${b};${w};${$}`,inputDependencies:x},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(N.size(s)/64)},programUniforms:l}),getShaderSource:T=>gl(T,o,t.dims.length,s.length,i,p,m,0,g,b,w,$)}},wl=e=>{let t=e.count_include_pad!==0,r=bl(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let a={countIncludePad:t,...r,cacheKey:""};return{...a,cacheKey:Vp(a)}},$l=(e,t)=>{aa(e.inputs),e.compute(vl("AveragePool",e.inputs[0],!1,t))},_l={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Sl=e=>{let t=e.format;return{format:t,..._l,cacheKey:t}},xl=(e,t)=>{aa(e.inputs),e.compute(vl("GlobalAveragePool",e.inputs[0],!0,t))},Cl=(e,t,r,a)=>{let[i,s]=ml(t,a,r),o=`
      value = max(x_val, value);
    `,c="",p=W("x",t.dataType,t.dims.length),m=["rank"],[l,g,b,w,$]=hl(s,i);return l.push(...L(t.dims),...L(s)),{name:e,shaderCache:{hint:`${a.cacheKey};${b};${w};${$}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(N.size(s)/64)},programUniforms:l}),getShaderSource:x=>gl(x,p,t.dims.length,s.length,i,o,c,-1e5,g,b,w,$)}},Il=(e,t)=>{aa(e.inputs),e.compute(Cl("MaxPool",e.inputs[0],!1,t))},Al=e=>{let t=e.storage_order,r=e.dilations,a=bl(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:r,...a,cacheKey:""};return{...i,cacheKey:Hp(i)}},Tl=e=>{let t=e.format;return{format:t,..._l,cacheKey:t}},El=(e,t)=>{aa(e.inputs),e.compute(Cl("GlobalMaxPool",e.inputs[0],!0,t))}});var Gp,Fp,kl,Pl=Q(()=>{"use strict";bt();ze();_e();Gp=(e,t,r)=>{let a=e===t,i=e<t&&r<0,s=e>t&&r>0;if(a||i||s)throw new Error("Range these inputs' contents are invalid.")},Fp=(e,t,r,a)=>{let i=Math.abs(Math.ceil((t-e)/r)),s=[i],o=i,c=pt(a),p=[{type:"uint32",data:o},{type:c,data:e},{type:c,data:r},...L(s)],m=l=>{let g=J("output",a,s.length),b=g.type.value,w=[{name:"outputSize",type:"u32"},{name:"start",type:b},{name:"delta",type:b}];return`
        ${l.registerUniforms(w).declareVariables(g)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${b}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:m,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:p})}},kl=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Ae.webgpu.validateInputContent&&Gp(t,r,a),e.compute(Fp(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var qp,jp,Kp,Yp,Zp,Xp,Qp,Jp,ef,tf,rf,Rl,nf,af,of,sf,uf,Bl,Ml,Dl=Q(()=>{"use strict";Ce();Xe();_e();qp=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},S=[{dims:o,dataType:e[0].dataType}];return r>1&&S.push({dims:m,dataType:1}),r>2&&S.push({dims:m,dataType:1}),r>3&&S.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${x};${b};${w};${$}`,inputDependencies:e.map((E,O)=>"type")},getShaderSource:C,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(c/p/64)},programUniforms:T})}},zl=(e,t)=>{lf(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(df(e.inputs,t,e.outputCount,!1),{outputs:a})}});var cf,ia,pf,Wl,ff,mf,Nl,Vl,Hl=Q(()=>{"use strict";ze();Ce();Xe();_e();cf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},ia=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},pf=(e,t)=>{if(e.length>1){let r=ia(e,1),a=ia(e,2),i=ia(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),xe({starts:r,ends:a,axes:i})}else return t},Wl=(e,t,r,a,i)=>{let s=e;return e<0&&(s+=r[a[t]]),i[t]<0?Math.max(0,Math.min(s,r[a[t]]-1)):Math.max(0,Math.min(s,r[a[t]]))},ff=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${p.length}_${o.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:x})}},Nl=(e,t)=>{cf(e.inputs,t);let r=pf(e.inputs,t);e.compute(mf(e.inputs,r),{inputs:[0]})},Vl=e=>{let t=e.starts,r=e.ends,a=e.axes;return xe({starts:t,ends:r,axes:a})}});var hf,gf,Ll,Gl,Fl=Q(()=>{"use strict";Ce();Xe();_e();hf=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},gf=(e,t)=>{let r=e.dims,a=N.size(r),i=64,s=t.axis;if(s<0&&(s=r.length+s),s<r.length-1)throw new Error("softmax only supports last axis for now.");let o=r[s],c=a/o,p=Le(o),m=o/p,l=(T,C)=>C===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:C===2?`max(${T}.x, ${T}.y)`:C===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,g=W("x",e.dataType,e.dims,p),b=J("result",e.dataType,e.dims,p),w=g.type.value,$=He(e.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,x=T=>`
      ...
      ${T.mainStart()}
        ...
        if (lindex == 0) {
          rowSumShared = ${w}(${ft("threadShared[0]",p)});
        }
        workgroupBarrier();
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${p}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:c},programUniforms:[{type:"uint32",data:m}]}),getShaderSource:x}},Ll=(e,t)=>{hf(e.inputs),e.compute(gf(e.inputs[0],t))},Gl=e=>xe({axis:e.axis})});var yf,bf,vf,wf,$f,ql,jl,Kl=Q(()=>{"use strict";Ce();Xe();_e();yf=e=>{if(!e||e.length<1)throw new Error("too few inputs")},bf=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),a=r.length),xe({numOutputs:a,axis:t.axis,splitSizes:r})},vf=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:w,getRunData:()=>({outputs:m,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:b})}},ql=(e,t)=>{yf(e.inputs);let r=e.inputs.length===1?t:bf(e.inputs,t);e.compute($f(e.inputs,r),{inputs:[0]})},jl=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return xe({axis:t,numOutputs:a,splitSizes:r})}});var Yl,_f,Sf,xf,Zl,Xl=Q(()=>{"use strict";ze();Ce();_e();Yl=e=>Array.from(e.getBigInt64Array(),Number),_f=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Yl(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Sf=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},xf=e=>{let t=e[0].dims,r=Yl(e[1]),a=Sf(t,r),i=N.size(a),s=e[0].dataType,o=W("input",s,t.length),c=J("output",s,a.length),p=m=>`
