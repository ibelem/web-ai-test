...
`)}
        }`,getRunData:()=>({outputs:[{dims:y,dataType:h}],dispatchGroup:{x:Math.ceil(X/64)}})}},Kh=(t,r)=>{let e=[];return t[1].dims[0]>0&&t[1].getBigInt64Array().forEach(d=>e.push(Number(d))),ye({axes:e,keepDims:r.keepDims,noopWithEmptyAxes:r.noopWithEmptyAxes})},It=(t,r,e,d)=>{let u=t.inputs,h=u.length===1?e:Kh(u,e);t.compute(un(r,{hint:h.cacheKey},[u[0]],h.noopWithEmptyAxes&&h.axes.length===0?qh:d,h.axes,u[0].dataType,h.keepDims,h.noopWithEmptyAxes),{inputs:[0]})},du=(t,r)=>{St(t.inputs),It(t,"ReduceLogSum",r,(d,u)=>[`var value = ${u.type.storage}(0);`,"",`value += ${d.getByOffset("inputOffset")};`,"value = log(value);"])},cu=(t,r)=>{St(t.inputs),It(t,"ReduceL1",r,(d,u)=>[`var value = ${u.type.storage}(0);`,"",`value += abs(${d.getByOffset("inputOffset")});`,""])},fu=(t,r)=>{St(t.inputs),It(t,"ReduceL2",r,(d,u)=>[`var t = ${u.type.value}(0); var value = ${u.type.value}(0);`,"",`t = ${d.getByOffset("inputOffset")}; value += (t * t);`,"value = sqrt(value);"])},pu=(t,r)=>{St(t.inputs),It(t,"ReduceLogSumExp",r,(d,u)=>[`var value = ${u.type.storage}(0);`,"",`value += exp(${d.getByOffset("inputOffset")});`,"value = log(value);"])},hu=(t,r)=>{St(t.inputs),It(t,"ReduceMax",r,(d,u,h)=>{let m=[];for(let o=0;o<d.rank;o++)(h.indexOf(o)>=0||h.length===0)&&m.push(d.indicesSet("inputIndices",o,0));return[`${m.join(`
`)}`,`var value = ${d.getByOffset("inputOffset")};`,`value = max(value, ${d.getByOffset("inputOffset")});`,""]})},mu=(t,r)=>{St(t.inputs),It(t,"ReduceMean",r,(d,u,h)=>{let m=1;for(let o=0;o<d.rank;o++)(h.indexOf(o)>=0||h.length===0)&&(m*=t.inputs[0].dims[o]);return["var sum = f32(0);","",`sum += f32(${d.getByOffset("inputOffset")});`,`let value = ${u.type.value}(sum / ${m});`]})},gu=(t,r)=>{St(t.inputs),It(t,"ReduceMin",r,(d,u,h)=>{let m=[];for(let o=0;o<d.rank;o++)(h.indexOf(o)>=0||h.length===0)&&m.push(`inputIndices[${o}] = 0;`);return[`${m.join(`
`)}`,`var value = ${d.getByOffset("inputOffset")};`,`value = min(value, ${d.getByOffset("inputOffset")});`,""]})},yu=(t,r)=>{St(t.inputs),It(t,"ReduceProd",r,(d,u)=>[`var value = ${u.type.storage}(1);`,"",`value *= ${d.getByOffset("inputOffset")};`,""])},vu=(t,r)=>{St(t.inputs),It(t,"ReduceSum",r,(d,u)=>[`var value = ${u.type.storage}(0);`,"",`value += ${d.getByOffset("inputOffset")};`,""])},bu=(t,r)=>{St(t.inputs),It(t,"ReduceSumSquare",r,(d,u)=>[`var t = ${u.type.value}(0); var value = ${u.type.value}(0);`,"",`t = ${d.getByOffset("inputOffset")}; value += t * t;`,""])},vt=t=>ye(t)});var wu,$u,Cu,_u,Zn,xu=ie(()=>{"use strict";Ye();Fe();Jn();wu=t=>{if(!t||t.length===0||t.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(t[0].dataType!==1)throw new Error("Invalid input type.")},$u=(t,r)=>ye({axis:r.axis,keepDims:r.keepDims,selectLastIndex:r.selectLastIndex}),Cu=(t,r)=>{wu(t.inputs);let e=(u,h,m)=>{let o=[];for(let y=0;y<u.rank;y++)(m.indexOf(y)>=0||m.length===0)&&o.push(`inputIndices[${y}] = 0;`);return[`${o.join(`
...
var bestIndex : i32 = 0;`,`if (${u.getByOffset("inputOffset")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${u.getByOffset("inputOffset")};
         bestIndex = i32(lastIndex);
       }`,"",h.setByOffset("global_idx","bestIndex")]},d=t.inputs.length===1?r:$u(t.inputs,r);t.compute(un("argMax",{hint:d.cacheKey},[t.inputs[0]],e,[d.axis],7,d.keepDims),{inputs:[0]})},Zn=t=>ye(t)});var Yh,Xh,Su,Iu=ie(()=>{"use strict";Ie();Re();Yh=t=>{if(t[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(t[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(t[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(t[0].dims[2]!==t[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Xh=t=>{let r=t[0].dims,e=t[0].dims[2],d=Q.size(r)/4,u=t[0].dataType,h=ne("input",u,r,4),m=ne("bias",u,[e],4),o=ne("residual",u,r,4),y=fe("output",u,r,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:r,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)}}),getShaderSource:A=>`
  ...
  }`}},Su=t=>{Yh(t.inputs),t.compute(Xh(t.inputs))}});var Qh,ke,Au,Eu,Ou,Tu,Ru,ku,ju,Pu,Bu,ea,Jh,Mu,Du,zu,Wu,ln,Nu,dn,Uu,Gu,Vu,Fu,Hu,Lu,qu,Ku,Yu,Xu,Qu,Ju,Zu,el,tl,rl,il,ta=ie(()=>{"use strict";Ye();Ie();Fe();Re();Qh=(t,r,e,d,u,h)=>{let m=Math.ceil(r/4),o="";typeof u=="string"?o=`${u}(a)`:o=u("a");let y=ne("inputData",e,[m],4),$=fe("outputData",d,[m],4);return`
...
fn erf_vf32(v: ${t}) -> ${t} {
  ...
  ${o.mainStart()}
    ...
    ${u.setByOffset("global_idx","valueLeft * geluRight")}
  }`}},nl=t=>{em(t.inputs),t.compute(tm(t.inputs))}});var rm,im,At,ol,sl,ul,ll,dl,cl,fl,pl,hl,ml,gl=ie(()=>{"use strict";Ye();Ie();Re();rm=(t,r,e,d,u,h,m,o,y,$,A)=>{let T=Q.size(d),O=Math.ceil(T/4),R,j;typeof m=="string"?R=j=(L,X)=>`${m}((${L}),(${X}))`:typeof m=="function"?R=j=m:(R=m.scalar,j=m.vector);let k="",P=fe("outputData",$,d,4),D=ne("aData",o,r,4),F=ne("bData",y,e,4);if(h){let L=X=>{let I=Q.computeStrides(X),Z=[];for(let re=X.length-1;re>=0;re--){let ae=P.indicesGet("outputIndices",re+d.length-X.length);Z.push(`${I[re]}u * (${ae} % ${X[re]}u)`)}return Z.length>0?Z.join("+"):"0u"};k=`
        ...
        ${Y}
      }`},im=(t,r,e,d,u,h,m=e.dataType)=>{let o=!Q.areEqual(e.dims,d.dims),y=e.dims,$=Q.size(e.dims),A=!1;if(o){let T=xt.calcShape(e.dims,d.dims,!1);if(!T)throw new Error("Can't perform binary op on the given tensors");y=T,$=Q.size(y);let O=Q.size(e.dims)===1,R=Q.size(d.dims)===1,j=1;for(let k=1;k<y.length;k++){let P=e.dims[e.dims.length-k]??1,D=d.dims[d.dims.length-k]??1;if(P===D)j*=P;else break}(j%4===0||O||R)&&(A=!0)}else A=!0;return{name:t,shaderCache:{hint:r},getShaderSource:T=>rm(T,e.dims,d.dims,y,A,o,u,e.dataType,d.dataType,m,h),getRunData:()=>({outputs:[{dims:y,dataType:m}],dispatchGroup:{x:Math.ceil($/64/4)}})}},At=(t,r,e,d,u,h)=>{t.compute(im(r,u??"",t.inputs[0],t.inputs[1],e,d,h))},ol=t=>{At(t,"Add",(r,e)=>`${r}+${e}`)},sl=t=>{At(t,"Div",(r,e)=>`${r}/${e}`)},ul=t=>{At(t,"Equal",{scalar:(r,e)=>`u32(${r}==${e})`,vector:(r,e)=>`vec4<u32>(${r}==${e})`},void 0,void 0,9)},ll=t=>{At(t,"Mul",(r,e)=>`${r}*${e}`)},dl=t=>{let r=ne("input",t.inputs[0].dataType,t.inputs[0].dims).type.value;At(t,"Pow",{scalar:(d,u)=>`pow_custom(${d},${u})`,vector:(d,u)=>`pow_vector_custom(${d},${u})`},`
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},cl=t=>{At(t,"Sub",(r,e)=>`${r}-${e}`)},fl=t=>{At(t,"Greater",{scalar:(r,e)=>`u32(${r}>${e})`,vector:(r,e)=>`vec4<u32>(${r}>${e})`},void 0,void 0,9)},pl=t=>{At(t,"Less",{scalar:(r,e)=>`u32(${r}<${e})`,vector:(r,e)=>`vec4<u32>(${r}<${e})`},void 0,void 0,9)},hl=t=>{At(t,"GreaterOrEqual",{scalar:(r,e)=>`u32(${r}>=${e})`,vector:(r,e)=>`vec4<u32>(${r}>=${e})`},void 0,void 0,9)},ml=t=>{At(t,"LessOrEqual",{scalar:(r,e)=>`u32(${r}<=${e})`,vector:(r,e)=>`vec4<u32>(${r}<=${e})`},void 0,void 0,9)}});var am,om,sm,um,yl,vl,bl=ie(()=>{"use strict";Ie();Fe();Re();am=t=>{if(!t||t.length<1)throw new Error("too few inputs");let r=t[0].dataType,e=t[0].dims.length;for(let d of t){if(d.dataType!==r)throw new Error("input tensors should be one type");if(d.dims.length!==e)throw new Error("input tensors should have the same shape")}},om=t=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${t}u;
  }`,sm=(t,r)=>{let e=t.length,d=[];for(let u=0;u<e;++u){let h=r.setByOffset("global_idx",t[u].getByIndices("indices"));e===1?d.push(h):u===0?d.push(`if (inputIndex == ${u}u) { ${h} }`):u===e-1?d.push(`else { ${h} }`):d.push(`else if (inputIndex == ${u}) { ${h} }`)}return d.join(`
`)},um=(t,r)=>{let e=t[0].dims.slice();if(r>=e.length||r<-1*e.length)throw new Error("axis specified for concat doesn't match input dimensionality");let d=r<0?e.length+r:r,u=e.slice(0);for(let R=1;R<t.length;R++){let j=t[R].dims.slice();for(let k=0;k<e.length;k++)if(k===d)u[d]+=j[k];else if(e[k]!==j[k])throw new Error("non concat dimensions must match")}let h=Q.size(u),m=new Array(t.length),o=new Array(t.length),y=t[0].dataType,$=0;for(let R=0;R<t.length;++R)$+=t[R].dims[d],m[R]=$,o[R]=ne(`input${R}`,y,t[R].dims);let A=fe("output",y,u),T=A.indicesGet("indices",d),O=R=>`
  ...
  ${R.mainStart()}
    ...
    ${sm(o,A)}
  }`;return{name:"Concat",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:u,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)}}),getShaderSource:O}},yl=(t,r)=>{am(t.inputs),t.compute(um(t.inputs,r.axis))},vl=t=>ye({axis:t.axis})});var Je,cn,fn,pn=ie(()=>{"use strict";Je=(t,r)=>{switch(t){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw new Error(`${t}-component is not supported.`)}},cn=(t,r=!1,e=!1,d=3)=>"",fn=(t,r)=>`
...
`});var mn,gn,gi=ie(()=>{"use strict";Ie();mn=t=>{switch(t.activation){case"Relu":return{activationFunction:"",applyActivation:"value = max(value, 0.0);"};case"Sigmoid":return{activationFunction:"",applyActivation:"value = (1.0 / (1.0 + exp(-value)));"};case"Clip":return{activationFunction:`const clip_min_=f32(${t.clipMin});const clip_max_=f32(${t.clipMax});`,applyActivation:"value = clamp(value, clip_min_, clip_max_);"};default:return{activationFunction:"",applyActivation:""}}},gn=t=>{let r=t?.activation||"";if(r==="Clip"){let[e,d]=t?.activation_params||[on,sn];return{activation:r,clipMax:d,clipMin:e,activationCacheKey:`${r}:${e},${d}`}}return{activation:r,activationCacheKey:r}}});var lm,dm,yi,wl,cm,vi,fm,yn,bi=ie(()=>{"use strict";Ie();Re();gi();pn();lm=(t,r)=>t?`
...
`},fm=(t,r,e,d,u,h=!1)=>{let m=u[0],o=u[1],y=u[2],$=d[0],A=d[1],T=d[2],O=d[3],R=Qn(m,y),j=Qn(o,y),k=He(d[0].type.tensor),P=()=>{let Y=A.rank,L=$.rank,X=`var aIndices: ${A.type.indices};`;for(let I=Y-2-1,Z=L-1;I>=0;I--,Z--)X+=`
...
bIndices[${Y-2}] = u32(row);
    ...
    `},yn=(t,r,e,d,u=!1)=>{let h=t[0].dims,m=t[1].dims,o=h.slice(0,-2),y=m.slice(0,-2),$=d?d.slice(0,-2):e.slice(0,-2),A=ne("batchDims",t[0].dataType,$),T=[A],O=[o,y,$],R=Q.size($),j=h[h.length-2],k=h[h.length-1],P=m[m.length-1],D=k%4===0&&P%4===0,{activationFunction:F,applyActivation:Y}=mn(r),L=j<=8?[4,1,1]:[4,4,1],X=[8,8,1],I=[Math.ceil(P/X[0]/L[0]),Math.ceil(j/X[1]/L[1]),Math.ceil(R/X[2]/L[2])],Z=He(t[0].dataType),re=D?4:1,ae=ne("a",t[0].dataType,[...o,j,k/re],re),$e=ne("b",t[1].dataType,[...y,k,P/re],re),q=fe("result",t[0].dataType,[R,j,P/re],re);T.push(ae),T.push($e),T.push(q);let le=[ae,$e],Pe=t.length>2,ue=fm(re,Pe,Y,T,O,u);if(Pe){let et=u?re:1;le.push(ne("bias",t[2].dataType,t[2].dims,et))}let oe=et=>`
  ...
  ${D?yi(L,X,Z,A):vi(L,X,Z,A)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${j?`vec4<${le}>`:le}) {
        ...
        ${ue}
        ${pm(y,re,ae,$e,m,void 0,!1,q[0],q[1],q[2],le)}
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:e?e(T):T,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(O/64)}}),getShaderSource:D}}});var hm,xl,mm,gm,_r,Sl,Il,vn=ie(()=>{"use strict";Ie();Fe();Re();hm=t=>{if(!t||t.length!==1)throw new Error("Transpose requires 1 input.")},xl=(t,r)=>r&&r.length!==t?[...new Array(t).keys()].reverse():r,mm=(t,r)=>Q.sortBasedOnPerm(t,xl(t.length,r)),gm=(t,r,e,d)=>{let u=[];u.push(`fn perm(i: ${d.type.indices}) -> ${e.type.indices} {
    var a: ${e.type.indices};`);for(let h=0;h<r;++h)u.push(e.indicesSet("a",t[h],`i[${h}]`));return u.push("return a;}"),u.join(`
`)},_r=(t,r,e)=>{let d=xl(r,e),u=fe("output",t,e&&e.length||r),h=ne("a",t,r),m=o=>`
...
`)}
        ...
        ${Z}
        ${wm(y,m,void 0,!1,L)}
        ${j?yi(F,D,"f32",void 0,!y,X):vi(F,D,"f32",void 0,!y,X,!1,void 0,o)}`}}});var $m,oa,jl=ie(()=>{"use strict";kt();Ie();Re();$m=(t,r,e,d,u,h,m=!1,o)=>{let y=e.format==="NHWC",$=y?1:2,A=y?2:3,T=y?3:1,O=Q.size(d),R=m?2:1,j=e.group,k=r[1].dims,P=k[0]/j,D=k[1],F=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:r.equation},getRunData:()=>({outputs:[{dims:u,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)}}),getShaderSource:F}},Wl=(t,r)=>{let e=new la(t.inputs,r.equation);t.compute(Rm(t.inputs,e))},Nl=t=>{let r=t.equation.replace(/\s+/g,"");return ye({equation:r})}});var km,Gl,jm,Pm,Vl,Fl=ie(()=>{"use strict";Ie();Re();km=t=>{if(!t||t.length!==2)throw new Error("Expand requires 2 input.");let r=t[0].dims,e=Array.from(t[1].getBigInt64Array(),Number),d=e.length<r.length?0:e.length-r.length,u=r.length<e.length?0:r.length-e.length;for(;d<e.length&&u<r.length;++d,++u)if(e[d]!==r[u]&&e[d]!==1&&r[u]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Gl=(t,r)=>{let e=t.length-r.length,d=[];for(let u=0;u<e;++u)d.push(t[u]);for(let u=0;u<r.length;++u)d.push(r[u]===1?t[u+e]:r[u]);return d},jm=(t,r)=>t.length>r.length?Gl(t,r):Gl(r,t),Pm=t=>{let r=t[0].dims,e=Array.from(t[1].getBigInt64Array(),Number),d=jm(r,e),u=Q.size(d),h=t[0].dataType,m=ne("input",h,r),o=fe("output",h,d),y=$=>`
  ...
  ${$.guardAgainstOutOfBoundsWorkgroupSizes(u)}
    ...
    ${o.setByOffset("global_idx",m.getByIndices("inputIndices"))}
      ...
      }`;return{name:"Gather",shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:m,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)}}),getShaderSource:R}},Hl=t=>ye({axis:t.axis}),Ll=(t,r)=>{let e=t.inputs;Bm(e),t.compute(Mm(t.inputs,r))}});var Dm,zm,Kl,Yl,Xl=ie(()=>{"use strict";Ie();Fe();Re();Dm=t=>{if(!t||t.length!==2)throw new Error("GatherElements requires 2 inputs.");if(t[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(t[0].dims.length!==t[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},zm=(t,r)=>{let e=t[0].dims,d=t[0].dataType,u=e.length,h=Q.computeStrides(e),m=Q.size(e),o=t[1].dims,y=t[1].dataType,$=Q.size(o),A=Q.normalizeAxis(r.axis,u),T=e[A],O=o.slice(0),R=Q.size(O),j=ne("input",d,e),k=ne("indices",y,[$]),P=fe("output",d,O),D=F=>`
  ...
  }`;return{name:"GatherElements",shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:O,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(R/64)}}),getShaderSource:D}},Kl=t=>ye({axis:t.axis}),Yl=(t,r)=>{let e=t.inputs;Dm(e),t.compute(zm(t.inputs,r))}});var Wm,Nm,Um,Ql,Jl,Zl=ie(()=>{"use strict";Ie();Fe();Re();Wm=t=>{if(!t)throw new Error("Input is missing");if(t.length<2||t.length>3)throw new Error("Invaid input number.");if(t.length===3&&t[2].dims.length>2)throw new Error("Invalid input shape of C");if(t[0].dataType!==t[1].dataType||t.length===3&&t[0].dataType!==t[2].dataType)throw new Error("Input types are mismatched")},Nm=(t,r,e)=>{if(e.length===0)return"0u";let d=e.length===1&&t!==1||e.length===2&&e[0]!==t,u=e[e.length-1]!==r,h="0u";return d||(h+=`+ m * ${e[e.length-1]}u`),u||(h+="+n"),h},Um=(t,r)=>{let e=t[0].dims.slice(),d=t[1].dims.slice(),[u,h,m]=an.getShapeOfGemmResult(e,r.transA,d,r.transB,t.length===3?t[2].dims:void 0),o=[u,h];if(!o)throw new Error("Can't use gemm on the given tensors");let y=Q.size(o),$="";r.transA&&r.transB?$="value += a[k * M + m] * b[n * K + k];":r.transA&&!r.transB?$="value += a[k * M + m] * b[k * N + n];":!r.transA&&r.transB?$="value += a[m * K + k] * b[n * K + k];":!r.transA&&!r.transB&&($="value += a[m * K + k] * b[k * N + n];");let A=He(t[0].dataType),T=r.alpha===1?"":"value *= alpha;",O=t.length===3?`value += beta * c[${Nm(u,h,t[2].dims)}];`:"",R=[`@group(0) @binding(0) var<storage, read> a : array<${A}>;`,`@group(0) @binding(1) var<storage, read> b : array<${A}>;`];t.length===3&&R.push(`@group(0) @binding(2) var<storage, read> c : array<${A}>;`);let j=k=>`
  const M: u32 = ${u}u;
  const N: u32 = ${h}u;
  const K: u32 = ${m}u;
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)}}),getShaderSource:j}},Ql=(t,r)=>{Wm(t.inputs),t.compute(Um(t.inputs,r))},Jl=t=>ye(t)});var Gm,Vm,Fm,Hm,ed,td,rd=ie(()=>{"use strict";Ye();Ie();Fe();Re();Gm={name:"InstanceNormalization"},Vm=(t,r)=>{let e=t[0].dims,d=e,u=2,h=Q.sizeToDimension(e,u),m=Q.sizeFromDimension(e,u),o=e[1],y=ne("x",t[0].dataType,[e[0],e[1],m]),$=ne("scale",t[1].dataType,t[1].dims),A=ne("bias",t[2].dataType,t[2].dims),T=fe("output",t[0].dataType,[e[0],e[1],m]),O=[y,$,A,T],R=y.type.value,j=64,k=P=>`
  ...
  }`;return{...Gm,shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:d,dataType:t[0].dataType}],dispatchGroup:{x:h}}),getShaderSource:k}},Fm=(t,r,e,d,u,h,m,o)=>{let y=Zt(m),$=ne("input",r.dataType,r.dims,y),A=ne("scale",e.dataType,e.dims,y),T=ne("bias",d.dataType,d.dims,y),O=64,R=y===1?"vec2f":`mat2x${y}f`,j=y===1?"f32":`vec${y}f`,k=(X,I)=>`${R}(${X}, ${I})`,P=u*m/y,D=Math.ceil(h/O),F=X=>`
  const H: u32 = ${h};
  const C: u32 = ${m/y};
  ...
  }`;return t.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:JSON.stringify({components:y,n:u,h,c:m,epsilon:o})},getRunData:()=>({outputs:[{dims:[u,m,2],dataType:1}],dispatchGroup:{x:Math.ceil(P/64)}}),getShaderSource:L},{inputs:[Y,e,d],outputs:[-1]})[0]},Hm=(t,r,e)=>{let d=r[0].dims,u=d,h=d[0],m=d[d.length-1],o=Q.sizeFromDimension(d,1)/m,y=Zt(m),$=Q.size(u)/y,A=ne("input",r[0].dataType,r[0].dims,y),T=fe("output",r[0].dataType,u,y),O=He(r[0].dataType),R=y===1?"vec2f":`mat2x${y}f`,j=y===1?O:`vec${y}<${O}>`,k=Fm(t,r[0],r[1],r[2],h,o,m,e.epsilon),P=D=>`
  const H: u32 = ${o};
  const C: u32 = ${m/y};
  ...
  }`;t.compute({name:"InstanceNormalization",shaderCache:{hint:`${e.cacheKey}`},getRunData:()=>({outputs:[{dims:u,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil($/64)}}),getShaderSource:P},{inputs:[r[0],k]})},ed=t=>ye({epsilon:t.epsilon,format:t.format}),td=(t,r)=>{r.format==="NHWC"?Hm(t,t.inputs,r):t.compute(Vm(t.inputs,r))}});var Lm,qm,id,nd,ad=ie(()=>{"use strict";Ye();Ie();Fe();Re();Lm=t=>{if(!t||t.length<2)throw new Error("layerNorm requires at least 2 inputs.")},qm=(t,r,e)=>{let d=t[0].dims,u=t[1],h=t[2],m=d,o=Q.normalizeAxis(r.axis,d.length),y=Q.sizeToDimension(d,o),$=Q.sizeFromDimension(d,o),A=Q.size(u.dims),T=h?Q.size(h.dims):0;if(A!==$||h&&T!==$)throw new Error(`Size of X.shape()[axis:] == ${$}.
  ...
  ${L.mainStart()}
    ...
    let mean = ${Cr("meanVector",R)} / normSize;
    let meanSquare = sqrt(${Cr("meanSquareVector",R)} 
    ...
    ${D?"invStdOutput[global_idx] = 1 / meanSquare":""};
  }`,Y=[{dims:m,dataType:t[0].dataType}];return P&&Y.push({dims:O,dataType:1}),D&&Y.push({dims:O,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${r.cacheKey}|${e}|${t.length}`},getRunData:()=>({outputs:Y,dispatchGroup:{x:Math.ceil(y/64)}}),getShaderSource:F}},id=t=>ye({axis:t.axis,epsilon:t.epsilon}),nd=(t,r)=>{Lm(t.inputs),t.compute(qm(t.inputs,r,t.outputCount))}});var Km,od,sd=ie(()=>{"use strict";Ie();bi();Km=t=>{if(!t||t.length!==2)throw new Error("MatMul requires 2 inputs.");if(t[0].dims[t[0].dims.length-1]!==t[1].dims[t[1].dims.length-2])throw new Error("shared dimension does not match.")},od=t=>{Km(t.inputs);let r=xt.calcShape(t.inputs[0].dims,t.inputs[1].dims,!0);if(!r)throw new Error("Can't use matmul on the given tensors");t.compute(yn(t.inputs,{activation:"",activationCacheKey:""},r))}});var Ym,Xm,Qm,Jm,Zm,eg,tg,rg,ig,ud,ld,dd=ie(()=>{"use strict";Ye();Ie();Fe();Re();Ym=t=>{if(!t||t.length<1)throw new Error("Too few inputs");if(t[0].dataType!==1)throw new Error("Input type must be float.");if(t.length>=2){let r=t[0].dims.length*2===t[1].dims[0];if(t.length===4&&(r=t[3].dims[0]*2===t[1].dims[0]),!r)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Xm=(t,r,e,d,u,h,m)=>{let o=e.length,y="";for(let $=o-1;$>=0;--$)y+=`
      ...
      `},Qm=(t,r,e,d,u)=>{let h=e.length,m="";for(let o=h-1;o>=0;--o)m+=`
            ...
            `;return`
              ...
              ${m}
              value = x[offset];
          `},Jm=(t,r,e,d,u)=>{let h=e.length,m="";for(let o=h-1;o>=0;--o)m+=`
                k = i32(${t.indicesGet("indices",o)}) - ${u[o]};
                if (k < 0) {
                  k = 0;
                }
          ...
          `},Zm=(t,r,e,d,u)=>{let h=e.length,m="";for(let o=h-1;o>=0;--o)m+=`
            ...
            `;return`
              ...
              ${m}
              value = x[offset];
          `},eg=(t,r,e,d,u,h)=>{switch(u.mode){case 0:return Xm(t,r,e,d,u.pads,h,u.value);case 1:return Qm(t,r,e,d,u.pads);case 2:return Jm(t,r,e,d,u.pads);case 3:return Zm(t,r,e,d,u.pads);default:throw new Error("Invalid mode")}},tg=(t,r,e,d)=>{let u=r[0].dims,h=Q.padShape(u.slice(),e.pads),m=Q.size(h),o=Q.computeStrides(u),y=fe("output",r[0].dataType,h),$=ne("x",r[0].dataType,u),A=eg(y,h,u,o,e,d);return`
              ${t.declareVariables($,y)}
              ${t.mainStart()}
              ${t.guardAgainstOutOfBoundsWorkgroupSizes(m)}
          ...
          }`},rg=(t,r)=>{let e=Q.padShape(t[0].dims.slice(),r.pads);return{name:"Pad",shaderCache:{hint:r.cacheKey},getRunData:()=>({outputs:[{dims:e,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(Q.size(e)/64)}}),getShaderSource:d=>tg(d,t,r,"f32")}},ig=(t,r)=>{if(t.length>1){let e=t[1].getBigInt64Array(),d=t.length>=3&&t[2].data?t[2].getFloat32Array()[0]:0,u=t[0].dims.length,h=new Int32Array(2*u).fill(0);if(t.length>=4){let o=t[3].getBigInt64Array();for(let y=0;y<o.length;y++)h[Number(o[y])]=Number(e[y]),h[Number(o[y])+u]=Number(e[y+o.length])}else e.forEach((o,y)=>h[Number(y)]=Number(o));let m=[];return h.forEach(o=>m.push(o)),ye({mode:r.mode,value:d,pads:m})}else return r},ud=(t,r)=>{Ym(t.inputs);let e=ig(t.inputs,r);t.compute(rg(t.inputs,e),{inputs:[0]})},ld=t=>{let r=t.mode,e=t.value,d=t.pads;return ye({mode:r,value:e,pads:d})}});var wn,cd,fd,pd,hd,md,gd,yd,vd,bd,wd,$d,Cd,_d,xd,Sd=ie(()=>{"use strict";Ie();Fe();Re();wn=t=>{if(!t||t.length!==1)throw new Error("Pool ops requires 1 input.");if(t[0].dims.length!==4)throw new Error("Pool ops supports 2-D inputs only for now.")},cd=(t,r,e)=>{let d=r.format==="NHWC",u=d?[t.dims[0],t.dims[3],t.dims[1],t.dims[2]]:t.dims.slice(),h=Object.hasOwnProperty.call(r,"dilations"),m=r.kernelShape.slice(),o=r.strides.slice(),y=h?r.dilations.slice():[],$=r.pads.slice();Jt.adjustPoolAttributes(e,u,m,o,y,$);let A=Jt.computePoolOutputShape(e,u,o,y,m,$,r.autoPad),T=Object.assign({},r);return h?Object.assign(T,{kernelShape:m,strides:o,pads:$,dilations:y,cacheKey:r.cacheKey}):Object.assign(T,{kernelShape:m,strides:o,pads:$,cacheKey:r.cacheKey}),[T,d?[A[0],A[2],A[3],A[1]]:A]},fd=(t,r,e,d,u,h,m,o)=>{let y=u.format==="NHWC",$=e,A=r.type.value,T=$.length,O=Q.size(d),R=fe("output",r.type.tensor,d);if(u.kernelShape.length<=2){let j=u.kernelShape[u.kernelShape.length-1],k=u.strides[u.strides.length-1],P=u.pads[u.pads.length/2-1],D=u.pads[u.pads.length-1],F=T-(y?2:1),Y="",L="",X="";if(P+D!==0?Y=`
    ...
    `,o="",y=ne("x",r.dataType,r.dims);return{name:t,shaderCache:{hint:d.cacheKey},getRunData:()=>({outputs:[{dims:h,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(Q.size(h)/64)}}),getShaderSource:$=>fd($,y,r.dims,h,u,m,o,"-1e5")}},$d=(t,r)=>{wn(t.inputs),t.compute(wd("MaxPool",t.inputs[0],!1,r))},Cd=t=>{let r=t.storage_order,e=t.dilations,d=pd(t);if(r!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(d.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return ye({storageOrder:r,dilations:e,...d})},_d=t=>{let r=t.format;return{format:r,...yd,cacheKey:r}},xd=(t,r)=>{wn(t.inputs),t.compute(wd("GlobalMaxPool",t.inputs[0],!0,r))}});var ag,og,Id,Ad=ie(()=>{"use strict";Qt();Ye();Re();ag=(t,r,e)=>{let d=t===r,u=t<r&&e<0,h=t>r&&e>0;if(d||u||h)throw new Error("Range these inputs' contents are invalid.")},og=(t,r,e,d)=>{let u=Math.abs(Math.ceil((r-t)/e)),h=[u],m=u,o=fe("output",d,h),y=o.type.storage,$=A=>`
        ${A.declareVariables(o)}
        ${A.mainStart()}
        ${A.guardAgainstOutOfBoundsWorkgroupSizes(m)}
        output[global_idx] = ${y}(${t}) + ${y}(global_idx) * ${y}(${e});
      }`;return{name:"Range",shaderCache:{hint:[t,r,e].map(A=>A.toString()).join("_")},getShaderSource:$,getRunData:()=>({outputs:[{dims:h,dataType:d}],dispatchGroup:{x:Math.ceil(m/64)}})}},Id=t=>{let r=0,e=0,d=0;t.inputs[0].dataType===6?(r=t.inputs[0].getInt32Array()[0],e=t.inputs[1].getInt32Array()[0],d=t.inputs[2].getInt32Array()[0]):t.inputs[0].dataType===1&&(r=t.inputs[0].getFloat32Array()[0],e=t.inputs[1].getFloat32Array()[0],d=t.inputs[2].getFloat32Array()[0]),We.webgpu.validateInputContent&&ag(r,e,d),t.compute(og(r,e,d,t.inputs[0].dataType),{inputs:[]})}});var sg,ug,lg,dg,cg,fg,pg,hg,mg,gg,yg,vg,bg,wg,$g,Ed,Od,Td=ie(()=>{"use strict";Ie();Fe();Re();sg=(t,r)=>{if(t.every(e=>e>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),t.length>0){if(r.mode==="linear"){if(!(t.length===2||t.length===4&&t[0]===1&&t[1]===1||t.length===4&&t[0]===1&&t[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(r.mode==="cubic"&&!(t.length===2||t.length===4&&t[0]===1&&t[1]===1||t.length===4&&t[0]===1&&t[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},ug=(t,r,e)=>{r.every(u=>u>=0&&u<e||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let d=new Array(e).fill(1);return r.forEach((u,h)=>d[u]=t[h]),d},lg=(t,r,e,d,u,h)=>{let[m,o,y]=e>10?[1,2,3]:[-1,t.length>1?1:-1,-1],$=t[0].dims.length;if(m>0&&t.length>m&&t[m].dims.length>0)t[m].getFloat32Array().forEach(A=>h.push(A));else if(r.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(o>0&&t.length>o&&t[o].dims.length>0){if(t[o].getFloat32Array().forEach(A=>d.push(A)),d.length!==0&&d.length!==$&&e>=18&&d.length!==r.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");sg(d,r),r.axes.length>0&&ug(d,r.axes,$).forEach((A,T)=>d[T]=A)}if(y>0&&t.length>y&&(t[y].getBigInt64Array().forEach(A=>u.push(Number(A))),u.length!==$||e>=18&&u.length===r.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(r.axes.length>0){if(d.length!==r.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(u.length!==r.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof d<"u"&&typeof u<"u"&&d.length>0&&u.length>$)throw new Error("Resize requires only of scales or sizes to be specified")},dg=t=>"fn getOriginalCoordinateFromResizedCoordinate(xResized: f32, xScale: f32, lengthResized: f32,    lengthOriginal: f32, roiStart: f32, roiEnd: f32) -> f32 { "+(()=>{switch(t){case"asymmetric":return"return xResized / xScale;";case"pytorch_half_pixel":return"if (lengthResized > 1) {                     return (xResized + 0.5) / xScale - 0.5;                   } else {                     return 0.0;                   }";case"tf_half_pixel_for_nn":return"return (xResized + 0.5) / xScale;";case"align_corners":return"if (lengthResized == 1) {                     return 0.0;                   } else {                     return xResized * (lengthOriginal - 1) / (lengthResized - 1);                   }";case"tf_crop_and_resize":return"if (lengthResized > 1) {                     return roiStart * (lengthOriginal - 1) +                           (xResized * (roiEnd - roiStart) * (lengthOriginal - 1)) / (lengthResized - 1);                   } else {                     return 0.5 * (roiStart + roiEnd) * f32(lengthOriginal - 1);                   }";case"half_pixel_symmetric":return["const outputWidth = xScale * lengthResized;","const adjustment = lengthResized / outputWidth;","const center = lengthOriginal / 2;","const offset = center * (1 - adjustment);","return offset + ((xResized + 0.5) / xScale) - 0.5;"].join(`
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${t} is not supported`)}})()+"}",cg=(t,r)=>"fn getNearestPixelFromOriginal(xOriginal: f32, isDownSample: bool) -> f32 {"+(()=>{switch(t){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(r<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${t} is not supported`)}})()+"}",fg=(t,r,e)=>{let d=new Array(e).fill(0).concat(new Array(e).fill(1)),u=t.length===0?d:t.slice();return r.length>0?(r.forEach((h,m)=>{d[h]=u[m],d[m+e]=u[r.length+m]}),d):u},pg=(t,r,e,d)=>{let u=[];if(e.length>0)if(d.length>0){if(t.forEach(h=>u.push(h)),Math.max(...d)>t.length)throw new Error("axes is out of bound");d.forEach((h,m)=>u[h]=e[m])}else e.forEach(h=>u.push(h));else{if(r.length===0)throw new Error("Resize requires either scales or sizes.");u=t.map((h,m)=>Math.round(h*r[m]))}return u},hg=(t,r,e,d)=>{let u=(()=>{switch(d.keepAspectRatioPolicy){case"not_larger":return d.axes.length>0?Math.min(...d.axes.map(m=>e[m]),Number.MAX_VALUE):Math.min(...e,Number.MAX_VALUE);case"not_smaller":return d.axes.length>0?Math.max(...d.axes.map(m=>e[m]),Number.MIN_VALUE):Math.max(...e,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${d.keepAspectRatioPolicy} is not supported`)}})();e.fill(1,0,e.length);let h=t.slice();return d.axes.length>0?(d.axes.forEach(m=>e[m]=u),d.axes.forEach(m=>h[m]=Math.round(t[m]*e[m]))):(e.fill(u,0,e.length),h.forEach((m,o)=>h[o]=Math.round(m*e[o]))),h},mg=(t,r,e,d,u)=>`
    ...
    fn checkInputIndices(inputIndices: ${t.type.indices}) -> bool {
      ...
      return true;
    }`,vg=(t,r,e,d,u,h,m)=>{let[o,y,$,A]=e.length===2?[-1,0,1,-1]:u[1]===1?[0,2,3,1]:[0,1,2,3];return`
    ...
    }`},bg=(t,r,e,d,u,h,m,o,y,$)=>{let[A,T]=e.length===2?[0,1]:u[1]===1?[2,3]:[1,2],O=R=>{let j=R===A?"row":"col";return`
  ...
  fn bicubicInterpolation(outputIndices: ${r.type.indices}) -> f32 {
    ...
    `},wg=(t,r,e,d,u,h)=>{let m=t.dims,o=fg(h,r.axes,m.length),y=pg(m,d,u,r.axes),$=d.slice();d.length===0&&($=m.map((P,D)=>P===0?1:y[D]/P),r.keepAspectRatioPolicy!=="stretch"&&(y=hg(m,y,$,r)));let A=fe("output",t.dataType,y),T=ne("input",t.dataType,m),O=Q.size(y),R=m.length===y.length&&m.every((P,D)=>P===y[D]),j=r.coordinateTransformMode==="tf_crop_and_resize",k=P=>`
      ${dg(r.coordinateTransformMode)};
      ${(()=>{switch(r.mode){case"nearest":return`
              ...
              `;case"linear":return`
              ${mg(A,m,y,$,o)};
              ${vg(T,A,m,y,$,j,r.extrapolationValue)};
              `;case"cubic":return`
            ${bg(T,A,m,y,$,o,r.cubicCoeffA,j,r.extrapolationValue,r.excludeOutside)};
      ...
      ${L.mainStart()}
        ...
        let mean = ${Cr("sum",k)} / hiddenSize;
        let variance = sqrt(${Cr("squareSum",k)} / hiddenSize - mean * mean + epsilon);
      ...
      }`,Y=[{dims:m,dataType:t[0].dataType}];return e>1&&Y.push({dims:$,dataType:1}),e>2&&Y.push({dims:$,dataType:1}),e>3&&Y.push({dims:u,dataType:t[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:r.cacheKey},getShaderSource:F,getRunData:()=>({outputs:Y,dispatchGroup:{x:Math.ceil(o/y/64)}})}},Rd=(t,r)=>{Cg(t.inputs);let d=[0];t.outputCount>1&&d.push(-3),t.outputCount>2&&d.push(-3),t.outputCount>3&&d.push(3),t.compute(_g(t.inputs,r,t.outputCount,!1),{outputs:d})},kd=t=>{let r=t.epsilon;return ye({epsilon:r})}});var xg,$n,Sg,Pd,Ig,Ag,Bd,Md,Dd=ie(()=>{"use strict";Ye();Ie();Fe();Re();xg=(t,r)=>{if(!t||t.length<1)throw new Error("too few inputs");if(r.axes.length!==0){if(r.axes.length!==r.starts.length||r.axes.length!==r.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(r.starts.length!==r.ends.length)throw new Error("starts and ends must have the same length");t.slice(1).forEach((e,d)=>{if(t[d+1].dataType!==6&&t[d+1].dataType!==7)throw new Error(`Input ${d} must be an array of int32 or int64`)})},$n=(t,r)=>{let e=[];if(t.length>r)if(t[r].dataType===7)t[r].getBigInt64Array().forEach(d=>e.push(Number(d)));else if(t[r].dataType===6)t[r].getInt32Array().forEach(d=>e.push(Number(d)));else throw new Error(`Input ${r} must be an array of int32 or int64`);return e},Sg=(t,r)=>{if(t.length>1){let e=$n(t,1),d=$n(t,2),u=$n(t,3);return u.length===0&&(u=[...Array(t[0].dims.length).keys()]),ye({starts:e,ends:d,axes:u})}else return r},Pd=(t,r,e,d,u)=>{let h=t;return t<0&&(h+=e[d[r]]),u[r]<0?Math.max(0,Math.min(h,e[d[r]]-1)):Math.max(0,Math.min(h,e[d[r]]))},Ig=(t,r,e,d)=>`fn calculateInputIndices(outputIndices: ${r.type.indices}) -> ${t.type.indices} {
          var inputIndices: ${t.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${r.cacheKey}|${t[4]?.dims??""}`},getShaderSource:j,getRunData:()=>({outputs:[A],dispatchGroup:{x:Math.ceil(d/64)}})}},Bd=(t,r)=>{xg(t.inputs,r);let e=Sg(t.inputs,r);t.compute(Ag(t.inputs,e),{inputs:[0]})},Md=t=>{let r=t.starts,e=t.ends,d=t.axes;return ye({starts:r,ends:e,axes:d})}});var Eg,Og,zd,Wd,Nd=ie(()=>{"use strict";Ie();Fe();Re();Eg=t=>{if(!t||t.length!==1)throw new Error("Softmax op requires 1 input.")},Og=(t,r)=>{let e=He(t.dataType),d=t.dims,u=Q.size(d),h=64,m=r.axis;if(m<0&&(m=d.length+m),m<d.length-1)throw new Error("softmax only supports last axis for now.");let o=d[m],y=u/o,$=e==="f32"?"var threadMax: f32 = -3.402823e+38f;":"var threadMax: f16 = -65504.0h;";return{name:"Softmax",getRunData:()=>({outputs:[{dims:d,dataType:t.dataType}],dispatchGroup:{x:y}}),getShaderSource:T=>`
      ...
      }`}},zd=(t,r)=>{Eg(t.inputs),t.compute(Og(t.inputs[0],r))},Wd=t=>ye({axis:t.axis})});var Tg,Rg,kg,jg,Pg,Ud,Gd,Vd=ie(()=>{"use strict";Ie();Fe();Re();Tg=t=>{if(!t||t.length<1)throw new Error("too few inputs")},Rg=(t,r)=>{let e=[],d=r.numOutputs;return t[1].dims[0]>0&&(t[1].getBigInt64Array().forEach(u=>e.push(Number(u))),d=e.length),ye({numOutputs:d,axis:r.axis,splitSizes:e})},kg=t=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:r.cacheKey},getShaderSource:k,getRunData:()=>({outputs:T,dispatchGroup:{x:Math.ceil(d/64)}})}},Ud=(t,r)=>{Tg(t.inputs);let e=t.inputs.length===1?r:Rg(t.inputs,r);t.compute(Pg(t.inputs,e),{inputs:[0]})},Gd=t=>{let r=t.axis,e=t.splitSizes,d=t.numOutputs<0?e.length:t.numOutputs;if(d!==e.length)throw new Error("numOutputs and splitSizes lengh must be equal");return ye({axis:r,numOutputs:d,splitSizes:e})}});var Fd,Bg,Mg,Dg,Hd,Ld=ie(()=>{"use strict";Ye();Ie();Re();Fd=t=>Array.from(t.getBigInt64Array(),Number),Bg=t=>{if(!t||t.length!==2)throw new Error("Tile requires 2 inputs.");if(t[0].dataType!==1&&t[0].dataType!==6&&t[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(t[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(t[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Fd(t[1]).length!==t[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Mg=(t,r)=>{let e=[];for(let d=0;d<t.length;++d)e.push(t[d]*r[d]);return e},Dg=t=>{let r=t[0].dims,e=Fd(t[1]),d=Mg(r,e),u=Q.size(d),h=t[0].dataType,m=ne("input",h,r),o=fe("output",h,d),y=$=>`
      const inputShape = ${m.indices(...r)};
      ${$.declareVariables(m,o)}
      ${$.mainStart()}
      ${$.guardAgainstOutOfBoundsWorkgroupSizes(u)}
