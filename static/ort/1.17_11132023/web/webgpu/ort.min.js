...
`}var oh,ih,Xu,Ju=D(()=>{"use strict";ue();Oe();oe();br();oh=a=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${a}`}),ih=(a,t,n,e)=>{let r=t.dims,o=e,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:t,type:0}}var ht,Ph,fl,cl,pl,dl,hl,ml,bl,gl,yl,Tl,xl,vl,wl=D(()=>{"use strict";ue();Wt();Oe();oe();ht=(a,t,n,e=t[0].type,r)=>{let o=a.session.pack?2:0;return{name:n.name,inputNames:["A","B"],inputTypes:[o,o],cacheHint:r,get:()=>Ph(a,t,n,e)}},Ph=(a,t,n,e=t[0].type)=>{let r=a.session.pack?2:0,o=!z.areEqual(t[0].dims,t[1].dims),s=t[0].dims,i=a.session.pack;if(o){let f=Je.calcShape(t[0].dims,t[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let p=s.length,b=t[0].dims.length!==0?t[0].dims.length:1,x=t[1].dims.length!==0?t[1].dims.length:1,I=t[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",v=t[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",S=Y(a.session.backend.glContext.version),L=i?`
    ...
    `;return{name:n.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:t[0].dims,type:e,textureType:r},shaderSource:l,hasMain:!0}},fl=(a,t)=>[a.run(ht(a,t,mh()),t)],cl=(a,t)=>[a.run(ht(a,t,wh(),"bool"),t)],pl=(a,t)=>[a.run(ht(a,t,bh()),t)],dl=(a,t)=>[a.run(ht(a,t,Th(),"bool"),t)],hl=(a,t)=>[a.run(ht(a,t,xh(),"bool"),t)],ml=(a,t)=>[a.run(ht(a,t,vh(),"bool"),t)],bl=(a,t)=>[a.run(ht(a,t,gh()),t)],gl=(a,t)=>[a.run(ht(a,t,_h(),"bool"),t)],yl=(a,t)=>[a.run(ht(a,t,Ih()),t)],Tl=(a,t)=>[a.run(ht(a,t,Sh()),t)],xl=(a,t)=>[a.run(ht(a,t,yh()),t)],vl=(a,t)=>[a.run(ht(a,t,Oh(),"bool"),t)]});var _l,Ol,Dh,Il=D(()=>{"use strict";ue();_l=(a,t,n)=>(Dh(t),[a.cast(t[0],n)]),Ol=a=>je.tensorDataTypeFromProto(a.attributes.getInt("to")),Dh=a=>{if(!a||a.length!==1)throw new Error("Cast requires 1 input.");if(a[0].type==="string")throw new Error("Invalid input type.")}});var Lh,Fh,Sl,to,Al=D(()=>{"use strict";Oe();oe();Lt();br();Lh=(a,t)=>({name:"Concat (packed)",inputNames:Array.from({length:a},(n,e)=>`X${e}`),inputTypes:Array(a).fill(2),cacheHint:t}),Fh=(a,t,n,e)=>{let r=n[0].dims.slice();if(e>=r.length||e<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");e<0&&(e=r.length+e);let o=r.slice(0);for(let N=1;N<n.length;N++){let he=n[N].dims.slice();for(let Ie=0;Ie<r.length;Ie++)if(Ie===e)o[e]+=he[Ie];else if(r[Ie]!==he[Ie])throw new Error("non concat dimensions must match")}let s=o.length,i=Nr("coords",s),u=Ze(s),l=Ft(),f=n.map(N=>N.dims),p=It(s),b=new Array(f.length-1);b[0]=f[0][e];for(let N=1;N<b.length;N++)b[N]=b[N-1]+f[N][e];let x=p[e],I=p.slice(-2),v=p.join(),S=`if (${x} < ${b[0]}) {
        ...
        }`;return{...t,output:{dims:o,type:n[0].type,textureType:0},shaderSource:b}},$h=(a,t,n)=>{let e=Ch(t.length,n.cacheKey);return{...e,get:()=>kh(a,e,t,n.axis)}},El=a=>`int getTextureWhereDataResides(int index) {
      ${a.map((n,e)=>`if(index<${n}) {return ${e};}
`).join("")}
    }`,Bh=a=>El(a),Rh=(a,t)=>{let n=[`float fetchDataFromCorrectTexture(int textureIndex, int indices[${t}]) {`];for(let e=0;e<a;++e)e===0?n.push(`	if (textureIndex == ${e}) { return _X${e}(indices); }`):e===a-1?n.push(`	else { return _X${e}(indices); }`):n.push(`	else if (textureIndex == ${e}) { return _X${e}(indices); }`);return n.push("	}"),n.join(`
...
`)},Dl=a=>te({axis:a.attributes.getInt("axis")}),Mh=a=>{if(!a||a.length<1)throw new Error("too few inputs");let t=a[0].type,n=a[0].dims.length;if(t==="string")throw new Error("string tensor is not supported yet");for(let e of a){if(e.type!==t)throw new Error("input tensors should be one type");if(e.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function Gh(){return mt("abs")}function Uh(){return mt("acos")}function zh(){return mt("asin")}function Wh(){return mt("atan")}function Vh(){return mt("ceil")}function Hh(){return mt("cos")}function jh(a){let t="elu";return{body:`
  ...
  `,name:a,type:0}}var om,De,Fl,Cl,kl,$l,wi,Bl,Rl,im,Nl,Ml,Gl,Ul,zl,Wl,_i,Vl,Hl,jl,ql,Yl,Xl,Kl,Jl,Zl,Ql,ef,Oi=D(()=>{"use strict";ze();ue();Wt();Oe();oe();om=(a,t,n,e)=>{let r=a.session.pack?2:0,o=Y(a.session.backend.glContext.version);return{...t,output:{dims:n.dims,type:n.type,textureType:r},shaderSource:`
     ${e.body}
     void main() {
...
`)},tb=a=>{if(!a||a.length!==1)throw new Error("ImageScaler requires 1 input.");if(a[0].dims.length!==4)throw new Error("Invalid input shape.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type.")}});var Bf,Rf,$f,rb,nb,ob,ib,ab,sb,Nf=D(()=>{"use strict";Oe();oe();Bf=(a,t,n)=>{sb(t);let e=a.run(nb(t[0]),t);return[a.run(ab(a,t[0],n,e.dims),[t[0],e,t[1],t[2]])]},Rf=a=>a.attributes.getFloat("epsilon",1e-5),$f={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},rb=(a,t)=>{let n=t.dims.slice(),e=n[1],r=n[2]*n[3],o=[n[0],e],s=`
      vec4 process(int[2] indices) {
        ...
        return v;
      }`;return{...a,output:{dims:o,type:t.type,textureType:4},shaderSource:s}},nb=a=>({...$f,get:()=>rb($f,a)}),ob={name:"InstanceNormalization_ComputeOutput",inputNames:["X","MeanAndVariance","Scale","B"],inputTypes:[0,4,0,0]},ib=(a,t,n,e,r)=>{let o=Y(a.session.backend.glContext.version),[s,i]=a.calculateTextureWidthAndHeight(r,4),[u,l]=[s/4,i],f=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),fc=(a,t,n)=>Tr(a,t,n,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),cc=(a,t,n)=>Tr(a,t,n,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),pc=(a,t,n)=>Tr(a,t,n,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var hc,mc=D(()=>{"use strict";ue();hc=(a,t)=>{let n=z.calculateReshapedDims(t[0].dims,t[1].integerData);return a.session.pack?[a.reshapePacked(t[0],n)]:[a.reshapeUnpacked(t[0],n)]}});var bc,ki,gc,yc,dn,Ob,$i,uo,Bi=D(()=>{"use strict";ze();Oe();oe();bc={name:"Upsample",inputNames:["X"],inputTypes:[0]},ki=(a,t,n)=>($i(t,n),[a.run({...bc,cacheHint:n.cacheKey,get:()=>Ob(a,t,n)},t)]),gc=a=>dn(a,7),yc=a=>dn(a,9),dn=(a,t)=>{let n=t>=10,e=a.attributes.getString("mode","nearest");if(e!=="nearest"&&e!=="linear"&&(t<11||e!=="cubic"))throw new Error(`unrecognized mode: ${e}`);let r=[];t<9&&(r=a.attributes.getFloats("scales"),uo(r,e,n));let o=a.attributes.getFloat("extrapolation_value",0),s=t>10?a.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let i=s==="tf_crop_and_resize",u=i,l=e==="nearest"&&t>=11?a.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=a.attributes.getFloat("cubic_coeff_a",-.75),p=a.attributes.getInt("exclude_outside",0)!==0;if(p&&e!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let b=t<11?!0:e==="nearest"&&s==="asymmetric"&&l==="floor",x=0,I=0,v=0;return t>10?a.inputs.length>2?(x=1,I=2,v=3):(I=1,v=2):t===9&&(I=1),te({opset:t,isResize:n,mode:e,scales:r,extrapolationValue:o,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:i,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:b,roiInputIdx:x,scalesInputIdx:I,sizesInputIdx:v})},Ob=(a,t,n)=>{let e=Y(a.session.backend.glContext.version),[r,o]=a.calculateTextureWidthAndHeight(t[0].dims,0),s=t[0].dims.map((v,S)=>Math.floor(v*n.scales[S])),[i,u]=a.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),b=`
    ...
    float process(int indices[2]) {
    ...
    }`;return{...bc,output:{dims:s,type:t[0].type,textureType:0},shaderSource:I,variables:[{name:"scales",type:"int",arrayLength:n.scales.length,data:n.scales.map(v=>Math.ceil(v))}]}},$i=(a,t)=>{if(!a||t.opset<9&&a.length!==1||t.opset>=9&&t.opset<11&&a.length!==2||t.opset>=11&&a.length<2)throw new Error("invalid inputs.");if(t.scales.length>0&&a[0].dims.length!==t.scales.length)throw new Error("Invalid input shape.");if(a[0].type==="string")throw new Error("Invalid input tensor types.")},uo=(a,t,n)=>{if(n){for(let e of a)if(e<=0)throw new Error("Scale value should be greater than 0.")}else for(let e of a)if(e<1)throw new Error("Scale value should be greater than or equal to 1.");if((t==="linear"||t==="cubic")&&a.length!==2&&(a.length!==4||a[0]!==1||a[1]!==1))throw new Error(`'Linear' mode and 'Cubic' mode only support 2-D inputs ('Bilinear', 'Bicubic')         or 4-D inputs with the corresponding outermost 2 scale values being 1         in the ${n?"Resize":"Upsample"} opeartor.`)}});var Ri,Ni,Tc,xc,Ib,Sb,Ab,Pb,vc=D(()=>{"use strict";Oe();oe();Lt();br();Bi();Ri={name:"Resize",inputNames:["A"],inputTypes:[2]},Ni=(a,t,n)=>($i(t,n),[a.run({...Ri,cacheHint:n.cacheKey,get:()=>Ib(a,t,n)},t)]),Tc=a=>dn(a,10),xc=a=>dn(a,11),Ib=(a,t,n)=>{let e=Y(a.session.backend.glContext.version),[r,o]=Sb(t,n);if(r.every(M=>M===1)&&n.coordinateTransformMode!=="tf_crop_and_resize")return{...Ri,output:{dims:o,type:t[0].type,textureType:2},hasMain:!0,shaderSource:`void main() {
      ...
      float process(int[${u}] indices) {
        ...
        return norm_factor;
      }`;return{...Dc,output:{dims:o,type:t.type,textureType:0},shaderSource:f}},$b=(a,t,n,e,r,o)=>{let[s,i]=a.calculateTextureWidthAndHeight(t.dims,0),u=t.dims.length;if(n<1||e<1)throw new Error("Logical row count N and feature count D must be greater than or equal to 1");if(r.length!==1||o.length!==1)throw new Error("Dimensionality of the intermediate results should be 1");if(r[0]!==n||o[0]!==n)throw new Error("Shape of the intermediate results should be equal to logical row count");let l=`
      float process(int[${u}] indices) {
    ...
    }`;return{...Lc,output:{dims:t.dims,type:t.type,textureType:0},shaderSource:l}},Rc=a=>{if(!a||a.length!==1)throw new Error("Softmax requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type")}});var Mc,Gc,Uc,Bb,Rb,Nb,zc=D(()=>{"use strict";ze();ue();oe();Mc={name:"Split",inputNames:["A"],inputTypes:[0]},Gc=(a,t,n)=>{Nb(t);let e=z.normalizeAxis(n.axis,t[0].dims.length),r=Bb(a,t,e,n),o=[];for(let s=0;s<r;++s)o.push(a.run({...Mc,cacheHint:`${n.cacheKey};${s}`,get:()=>Rb(a,t[0],n,e,s)},t));return o},Uc=a=>{let t=a.attributes.getInt("axis",0),n=a.attributes.getInts("split",[]),e=a.outputs.length;return te({axis:t,split:n,numOutputs:e})},Bb=(a,t,n,e)=>{let[,r]=an.splitShape(t[0].dims,n,e.split,e.numOutputs);return r.length},Rb=(a,t,n,e,r)=>{let[o,s]=an.splitShape(t.dims,e,n.split,n.numOutputs),i=s[r],u=o[r],f=`
