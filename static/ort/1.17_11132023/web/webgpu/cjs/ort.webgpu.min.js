...
`)}},_i=e=>new da(e),ca=(e,t)=>{let r=e.length,a=[];for(let o=0;o<r;o++){let u=r-1-o,i=e[u]||1;(t[t.length-1-o]||1)>1&&i===1&&a.unshift(u)}return a},Ct=e=>e<=4});var Ud,Oi,Gd,Fd,kt,Ti,Ei,Or=j(()=>{"use strict";ge();Be();$e();Ud=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Oi=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Gd=(e,t)=>V.sortBasedOnPerm(e,Oi(e.length,t)),Fd=(e,t,r,a)=>{let o=[];o.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let u=0;u<t;++u)o.push(r.indicesSet("a",e[u],`i[${u}]`));return o.push("return a;}"),o.join(`
`)},kt=(e,t)=>{let r=e.dataType,a=e.dims.length,o=Oi(a,t),u=Ct(a),i=Gd(e.dims,o),l=u?i.length:i,p=u?a:e.dims,m=Y("output",r,l),d=H("a",r,p),v=y=>`
  ...
  ${y.mainStart()}
    ...
    ${m.setByOffset("global_idx",d.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:$=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:u,dataType:o}],dispatchGroup:{x:p},programUniforms:[{type:"uint32",data:m}]})}},ft=(e,t,r,a)=>{let o=e.inputs.length===1?r:pa(e.inputs,r),u=o.axes;u.length===0&&!o.noopWithEmptyAxes&&(u=e.inputs[0].dims.map((w,x)=>x));let i=V.normalizeAxes(u,e.inputs[0].dims.length),l=i,p=e.inputs[0],m=Zd(l,e.inputs[0].dims.length);m.length>0&&(p=e.compute(kt(e.inputs[0],m),{inputs:[0],outputs:[-1]})[0],l=Kd(l.length,p.dims.length));let[d,v]=Yd(p.dims,l),y=d;o.keepDims&&(y=Xd(d,i)),e.compute(Qd(t,{hint:o.cacheKey,inputDependencies:["type"]},[p],a,e.inputs[0].dataType,y,v),{inputs:[p]})},Ri=(e,t)=>{ft(e,"ReduceMeanShared",t,"mean")},Pi=(e,t)=>{ft(e,"ReduceL1Shared",t,"l1")},ki=(e,t)=>{ft(e,"ReduceL2Shared",t,"l2")},Bi=(e,t)=>{ft(e,"ReduceLogSumExpShared",t,"logSumExp")},Mi=(e,t)=>{ft(e,"ReduceMaxShared",t,"max")},Di=(e,t)=>{ft(e,"ReduceMinShared",t,"min")},zi=(e,t)=>{ft(e,"ReduceProdShared",t,"prod")},Wi=(e,t)=>{ft(e,"ReduceSumShared",t,"sum")},Vi=(e,t)=>{ft(e,"ReduceSumSquareShared",t,"sumSquare")},Ni=(e,t)=>{ft(e,"ReduceLogSumShared",t,"logSum")}});var mt,ec,hn,pa,ht,tc,rc,nc,ac,oc,ic,sc,uc,lc,dc,gt,Gi,Fi,Li,Hi,ji,qi,Ki,Yi,Xi,Ji,it,mn=j(()=>{"use strict";ge();Be();$e();Ui();mt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},ec=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],hn=(e,t,r,a,o,u,i=!1,l=!1)=>{let p=[],m=r[0].dims,d=V.normalizeAxes(o,r[0].dims.length),v=!l&&d.length===0;m.forEach((W,K)=>{v||d.indexOf(K)>=0?i&&p.push(1):p.push(W)});let y=[],w=H("_A",r[0].dataType,m),x=Y("output",u,p),$=a(w,x,d),A=`inputOffset = ${w.indicesToOffset("inputIndices")};`,k=`let ${A};`,O=`var ${A};`,T=$[1]===""?"":O,R=($[1]===""?k:A)+`
...
`)}`,`var value = ${a.getByOffset("inputOffset")};`,`value = min(value, ${a.getByOffset("inputOffset")});`,""]})},uc=(e,t)=>{mt(e.inputs),ht(e,"ReduceProd",t,(a,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${a.getByOffset("inputOffset")};`,""])},lc=(e,t)=>{mt(e.inputs),ht(e,"ReduceSum",t,(a,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${a.getByOffset("inputOffset")};`,""])},dc=(e,t)=>{mt(e.inputs),ht(e,"ReduceSumSquare",t,(a,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${a.getByOffset("inputOffset")}; value += t * t;`,""])},gt=(e,t,r)=>{if(t.length===0)return!!r;let a=1,o=1;for(let u=0;u<t.length;u++)t.indexOf(u)===-1?a*=e[u]:o*=e[u];return o<32&&a>1024},Gi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?ic(e,t):Ri(e,t)},Fi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?rc(e,t):Pi(e,t)},Li=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?nc(e,t):ki(e,t)},Hi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?ac(e,t):Bi(e,t)},ji=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?oc(e,t):Mi(e,t)},qi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?sc(e,t):Di(e,t)},Ki=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?uc(e,t):zi(e,t)},Yi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?lc(e,t):Wi(e,t)},Xi=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?dc(e,t):Vi(e,t)},Ji=(e,t)=>{gt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?tc(e,t):Ni(e,t)},it=e=>ue(e)});var Zi,Qi,es,ts,fa,rs=j(()=>{"use strict";We();Be();mn();Zi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},Qi=(e,t)=>ue({axis:t.axis,keepDims:t.keepDims,selectLastIndex:t.selectLastIndex}),es=(e,t)=>{Zi(e.inputs);let r=(o,u,i)=>{let l=[];for(let p=0;p<o.rank;p++)(i.indexOf(p)>=0||i.length===0)&&l.push(`inputIndices[${p}] = 0;`);return[`${l.join(`
...
var bestIndex : i32 = 0;`,`if (${o.getByOffset("inputOffset")} ${t.selectLastIndex>0?"<=":"<"} value) {
       ...
       }`,"",u.setByOffset("global_idx","bestIndex")]},a=e.inputs.length===1?t:Qi(e.inputs,t);e.compute(hn("ArgMin",{hint:a.cacheKey},[e.inputs[0]],r,[a.axis],7,a.keepDims),{inputs:[0]})},ts=(e,t)=>{Zi(e.inputs);let r=(o,u,i)=>{let l=[];for(let p=0;p<o.rank;p++)(i.indexOf(p)>=0||i.length===0)&&l.push(`inputIndices[${p}] = 0;`);return[`${l.join(`
`)}`,`var value = ${o.getByOffset("inputOffset")};
var bestIndex : i32 = 0;`,`if (${o.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${o.getByOffset("inputOffset")};
         bestIndex = i32(lastIndex);
       }`,"",u.setByOffset("global_idx","bestIndex")]},a=e.inputs.length===1?t:Qi(e.inputs,t);e.compute(hn("argMax",{hint:a.cacheKey},[e.inputs[0]],r,[a.axis],7,a.keepDims),{inputs:[0]})},fa=e=>ue(e)});var cc,pc,ns,as=j(()=>{"use strict";ge();$e();cc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},pc=e=>{let t=e[0].dims,r=e[0].dims[2],a=V.size(t)/4,o=e[0].dataType,u=H("input",o,t,4),i=H("bias",o,[r],4),l=H("residual",o,t,4),p=Y("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:d=>`
  ...
  }`}},ns=e=>{cc(e.inputs),e.compute(pc(e.inputs))}});var fc,xe,os,is,ss,us,ls,ds,cs,ps,fs,ma,mc,ms,hs,gs,ys,gn,bs,yn,vs,ws,$s,xs,Ss,Cs,As,Is,_s,Os,Ts,Es,Rs,Ps,ks,Bs,Ms,ha=j(()=>{"use strict";We();ge();Be();$e();fc=(e,t,r,a,o,u)=>{let i=Math.ceil(t/4),l="";typeof o=="string"?l=`${o}(a)`:l=o("a");let p=H("inputData",r,[i],4),m=Y("outputData",a,[i],4);return`
  ...
  }`},xe=(e,t,r,a,o,u=e.dataType)=>({name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:i=>fc(i,V.size(e.dims),e.dataType,u,r,a),getRunData:i=>({outputs:[{dims:e.dims,dataType:u}],dispatchGroup:{x:Math.ceil(V.size(i[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(V.size(e.dims)/4)}]})}),os=e=>{e.compute(xe(e.inputs[0],"Abs","abs"))},is=e=>{e.compute(xe(e.inputs[0],"Acos","acos"))},ss=e=>{e.compute(xe(e.inputs[0],"Acosh","acosh"))},us=e=>{e.compute(xe(e.inputs[0],"Asin","asin"))},ls=e=>{e.compute(xe(e.inputs[0],"Asinh","asinh"))},ds=e=>{e.compute(xe(e.inputs[0],"Atan","atan"))},cs=e=>{e.compute(xe(e.inputs[0],"Atanh","atanh"))},ps=e=>ue(e),fs=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(xe(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},ma=(e,t)=>{let r=Me(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"Clip",a=>`clamp(${a}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${r}> = vec4(${r}(${t.min}));
    const clip_max_: vec4<${r}> = vec4(${r}(${t.max}));
`,t.cacheKey),{inputs:[0]})},mc=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:pn,r=e.length>=3?e[2].getFloat32Array()[0]:fn;return ue({min:t,max:r})},ms=e=>{let t=mc(e.inputs);ma(e,t)},hs=e=>{e.compute(xe(e.inputs[0],"Ceil","ceil"))},gs=e=>{e.compute(xe(e.inputs[0],"Cos","cos"))},ys=e=>{e.compute(xe(e.inputs[0],"Cosh","cosh"))},gn=e=>ue(e),bs=(e,t)=>{e.compute(xe(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,vs=e=>{let t=Me(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,yn(`vec4<${t}>`,t)))},ws=e=>{e.compute(xe(e.inputs[0],"Exp","exp"))},$s=e=>{e.compute(xe(e.inputs[0],"Floor","floor"))},xs=e=>{let t=Me(e.inputs[0].dataType);e.compute(xe(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,yn(`vec4<${t}>`,t)))},Ss=(e,t)=>{e.compute(xe(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},Cs=e=>{e.compute(xe(e.inputs[0],"Not",t=>`!${t}`))},As=e=>{e.compute(xe(e.inputs[0],"Neg",t=>`-${t}`))},Is=e=>{e.compute(xe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},_s=e=>{e.compute(xe(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},Os=e=>{e.compute(xe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Ts=e=>{e.compute(xe(e.inputs[0],"Sin","sin"))},Es=e=>{e.compute(xe(e.inputs[0],"Sinh","sinh"))},Rs=e=>{e.compute(xe(e.inputs[0],"Sqrt","sqrt"))},Ps=e=>{e.compute(xe(e.inputs[0],"Tan","tan"))},ks=e=>{e.compute(xe(e.inputs[0],"Tanh","tanh"))},Bs=(e,t)=>(e.compute(xe(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),Ms=e=>{e.compute(xe(e.inputs[0],"Log","log"))}});var gc,yc,Ds,zs=j(()=>{"use strict";ge();$e();ha();gc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},yc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=H("input",e[0].dataType,e[0].dims,4),a=H("bias",e[0].dataType,[e[0].dims[2]],4),o=Y("output",e[0].dataType,t,4),u=V.size(t)/4;return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${R}
      }`},vc=(e,t,r,a,o,u,i=r.dataType)=>{let l=!V.areEqual(r.dims,a.dims),p=r.dims,m=V.size(r.dims),d=!1,v=[l];if(l){let w=ct.calcShape(r.dims,a.dims,!1);if(!w)throw new Error("Can't perform binary op on the given tensors");p=w,m=V.size(p);let x=V.size(r.dims)===1,$=V.size(a.dims)===1;v.push(x),v.push($);let A=1;for(let k=1;k<p.length;k++){let O=r.dims[r.dims.length-k]??1,T=a.dims[a.dims.length-k]??1;if(O===T)A*=O;else break}(A%4===0||x||$)&&(d=!0)}else d=!0;v.push(d);let y=Ct(r.dims.length)&&Ct(a.dims.length)&&Ct(p.length);return{name:e,shaderCache:{hint:t+v.map(w=>w.toString()).join("_"),inputDependencies:y?["rank","rank"]:["dims","dims"]},getShaderSource:w=>bc(w,r.dims,a.dims,p,d,l,o,r.dataType,a.dataType,i,y,u),getRunData:()=>({outputs:[{dims:p,dataType:i}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:y?[{type:"uint32",data:Math.ceil(V.size(p)/4)},...pt(r.dims),...pt(a.dims),...pt(p)]:[{type:"uint32",data:Math.ceil(V.size(p)/4)}]})}},yt=(e,t,r,a,o,u)=>{e.compute(vc(t,o??"",e.inputs[0],e.inputs[1],r,a,u))},Ws=e=>{yt(e,"Add",(t,r)=>`${t}+${r}`)},Vs=e=>{yt(e,"Div",(t,r)=>`${t}/${r}`)},Ns=e=>{yt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Us=e=>{yt(e,"Mul",(t,r)=>`${t}*${r}`)},Gs=e=>{let t=H("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;yt(e,"Pow",{scalar:(a,o)=>`pow_custom(${a},${o})`,vector:(a,o)=>`pow_vector_custom(${a},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Fs=e=>{yt(e,"Sub",(t,r)=>`${t}-${r}`)},Ls=e=>{yt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},Hs=e=>{yt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},js=e=>{yt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},qs=e=>{yt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var $c,xc,Sc,Cc,Ys,Xs,Js=j(()=>{"use strict";ge();Be();$e();$c=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},xc=(e,t)=>`
...
`});var Ac,Ic,Tr,Zs,_c,Er,Oc,xn,Rr=j(()=>{"use strict";ge();$e();Kt();wn();Ac=(e,t)=>e?`
...
bIndices[${T-2}] = u32(row);
  ...
  ${k?Tr(O,T,z,d):Er(O,T,z,d)}
    ...
    return ${Ve(i,m)}(0.0);`,R=`${v(l)}`,z=Ve(p,m),M=e?Ve(i,m):Ve(l,m),W=e?Ve(l,m):Ve(i,m),{activationFunction:K,applyActivation:ee}=Bt(u,z);return`
    ${K}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${z}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${x?`vec4<${te}>`:te}) {
        ...
        ${Tc(p,K,ee,ae,i,t,D[0],D[1],D[2],te)}
            ${x?Tr(O,k,te,void 0,!p,W):Er(O,k,te,void 0,!p,W,!1,void 0,l)}`}}});var ya,tu=j(()=>{"use strict";ge();$e();va();Kt();ya=(e,t,r)=>{let a=e.length>2,o=a?"value += b[output_channel];":"",u=e[0].dims,i=e[1].dims,l=i[0]/t.group,p=t.format==="NHWC",m=ba(u,i,t.dilations,t.pads,t.strides,p),d=V.size(m),v=Y("output",e[0].dataType,m),{activationFunction:y,applyActivation:w}=Bt(t,v.type.value),x=H("x",e[0].dataType,u),$=H("w",e[1].dataType,i),A=[x,$];a&&A.push(H("b",e[2].dataType,e[2].dims));let k=O=>`
  ...
  ${O.mainStart()}
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(m):m,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)}}),getShaderSource:k}}});var ba,ru,Ec,nu,wa,Rc,Pc,$a,va=j(()=>{"use strict";ge();Be();eu();Rr();tu();Kt();Or();ba=(e,t,r,a,o,u)=>{let i=e[0],l=e.slice(u?1:2,u?3:4),p=l.length,m=t[0],v=t.slice(2).map((x,$)=>x+(x-1)*(r[$]-1)),w=l.map((x,$)=>x+a[$]+a[$+p]).map((x,$)=>Math.floor((x-v[$]+o[$])/o[$]));return w.splice(0,0,i),w.splice(u?3:1,0,m),w},ru=[2,3,1,0],Ec=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},nu=(e,t)=>{let r=e.kernelShape.slice();for(let u=2;u<t[1].dims.length;++u)r[u-2]===0&&(r[u-2]=t[1].dims[u]);let a=e.pads.slice();jt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),o},wa=e=>{let t=bn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,u=e.group,i=e.kernel_shape,l=e.pads,p=e.strides,m=e.w_is_const();return ue({autoPad:a,format:r,dilations:o,group:u,kernelShape:i,pads:l,strides:p,wIsConst:m,...t})},Rc=(e,t,r)=>{let a=nu(r,t);if(r.group!==1){e.compute(ya(t,a));return}let o=r.format==="NHWC",u=t.length===3,i=t[0].dims[o?1:2],l=t[0].dims[o?2:3],p=t[0].dims[o?3:1],m=t[1].dims[2],d=t[1].dims[3],v=ba(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,o),y=v[o?1:2],w=v[o?2:3],x=v[o?3:1],$=o&&m===i&&d===l&&r.pads[0]===0&&r.pads[1]===0;if($||m===1&&d===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let M=v[0],W,K,ee,ae=[];if(o){let D=e.kernelCustomData.wT??e.compute(kt(t[1],ru),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=D),$){let te=i*l*p;W=t[0].reshape([1,M,te]),K=D.reshape([1,te,x]),ee=[1,M,x]}else W=t[0].reshape([M,i*l,p]),K=D.reshape([1,p,x]),ee=[M,y*w,x];ae.push(W),ae.push(K)}else W=t[0].reshape([M,p,i*l]),K=t[1].reshape([1,x,p]),ee=[M,x,y*w],ae.push(K),ae.push(W);u&&ae.push(t[2]),e.compute(xn(ae,a,v,ee,o),{inputs:ae});return}let A=!0,k=e.kernelCustomData.wT??e.compute(kt(t[1],ru),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=k);let O=[t[0],k];u&&O.push(t[2]);let T=o?y*w:x,R=o?x:y*w,z=m*d*p;e.compute(Qs(O,a,v,T,R,z,u,A),{inputs:O})},Pc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],u=[1].concat(t.strides),i=[1].concat(t.dilations),l=[1].concat(t.kernelShape),p=nu({...t,pads:o,strides:u,dilations:i,kernelShape:l},a);e.compute(ya(a,p,m=>r?[m[0],m[2],m[3]]:[]))},$a=(e,t)=>{Ec(e.inputs,t),e.inputs[0].dims.length===3?Pc(e,t):Rc(e,e.inputs,t)}});var kc,au,ou=j(()=>{"use strict";Rt();ge();Kt();wn();ga();Rr();kc=(e,t=!1,r,a=4)=>{let o=Ve(a,"f32"),u=O=>{switch(O){case 1:return"return W[getIndexFromCoords4D(coord, wShape)];";case 4:return`
    ...
    `,p=e?"outBackprop[1]":"outBackprop[2]",m=e?"outBackprop[2]":"outBackprop[3]",d=e?"row":"col",v=e?"col":"row",y=`
      ...
      return ${o}(0.0);
      `,{activationFunction:$,applyActivation:A}=Bt(r,o);return`
      ${$}
...
`)}
        ...
        ${W}
        ${kc(p,i,t,R)}
        ${x?Tr(O,k,"f32",void 0,!p,z):Er(O,k,"f32",void 0,!p,z,!1,void 0,l)}`}}});var Bc,xa,iu=j(()=>{"use strict";Rt();ge();$e();Bc=(e,t,r,a,o,u,i=!1,l)=>{let p=r.format==="NHWC",m=p?1:2,d=p?2:3,v=p?3:1,y=V.size(a),w=i?2:1,x=r.group,$=t[1].dims,A=$[0]/x,k=$[1],O=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)}}),getShaderSource:O}},pu=(e,t)=>{let r=new Aa(e.inputs,t.equation);e.compute(Lc(e.inputs,r))},fu=e=>{let t=e.equation.replace(/\s+/g,"");return ue({equation:t})}});var Hc,hu,jc,qc,gu,yu=j(()=>{"use strict";ge();$e();Hc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,o=t.length<r.length?0:t.length-r.length;for(;a<r.length&&o<t.length;++a,++o)if(r[a]!==t[o]&&r[a]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},hu=(e,t)=>{let r=e.length-t.length,a=[];for(let o=0;o<r;++o)a.push(e[o]);for(let o=0;o<t.length;++o)a.push(t[o]===1?e[o+r]:t[o]);return a},jc=(e,t)=>e.length>t.length?hu(e,t):hu(t,e),qc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=jc(t,r),o=V.size(a),u=e[0].dataType,i=H("input",u,t),l=Y("output",u,a),p=m=>`
  ...
  ${m.guardAgainstOutOfBoundsWorkgroupSizes(o)}
    ...
    ${l.setByOffset("global_idx",i.getByIndices("inputIndices"))}
  }`;return{name:"Expand",shaderCache:{hint:`${a}`},getShaderSource:p,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}})}},gu=e=>{Hc(e.inputs),e.compute(qc(e.inputs),{inputs:[0]})}});var Kc,Yc,bu,vu,wu=j(()=>{"use strict";ge();Be();$e();Kc=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Yc=(e,t)=>{let r=e[0].dims,a=e[1].dims,o=r.length,u=V.normalizeAxis(t.axis,o),i=r.slice(0);i.splice(u,1,...a);let l=r[u],p=V.size(i),m=H("data",e[0].dataType,e[0].dims),d=H("inputIndices",e[1].dataType,e[1].dims),v=Y("output",e[0].dataType,i),y=()=>{let x=a.length,$=`var indicesIndices  = ${d.type.indices}(0);`;for(let A=0;A<x;A++)$+=`${x>1?`indicesIndices[${A}]`:"indicesIndices"} = ${i.length>1?`outputIndices[${u+A}]`:"outputIndices"};`;$+=`
      ...
      ${x.mainStart()}
        ...
        ${v.setByOffset("global_idx","value")};
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:w}},bu=e=>ue({axis:e.axis}),vu=(e,t)=>{let r=e.inputs;Kc(r),e.compute(Yc(e.inputs,t))}});var Xc,Jc,$u,xu,Su=j(()=>{"use strict";ge();Be();$e();Xc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:x}},Cu=(e,t)=>{Zc(e.inputs),e.compute(ep(e.inputs,t))},Au=e=>ue(e)});var tp,rp,np,ap,_u,Ou,Tu=j(()=>{"use strict";We();ge();Be();$e();tp={name:"InstanceNormalization"},rp=(e,t)=>{let r=e[0].dims,a=r,o=2,u=V.sizeToDimension(r,o),i=V.sizeFromDimension(r,o),l=r[1],p=H("x",e[0].dataType,[r[0],r[1],i]),m=H("scale",e[1].dataType,e[1].dims),d=H("bias",e[2].dataType,e[2].dims),v=Y("output",e[0].dataType,[r[0],r[1],i]),y=[p,m,d,v],w=p.type.value,x=64,$=A=>`
  ...
  }`;return{...tp,shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:u}}),getShaderSource:$}},np=(e,t,r,a,o,u,i,l)=>{let p=St(i),m=H("input",t.dataType,t.dims,p),d=H("scale",r.dataType,r.dims,p),v=H("bias",a.dataType,a.dims,p),y=64,w=p===1?"vec2f":`mat2x${p}f`,x=p===1?"f32":`vec${p}f`,$=(z,M)=>`${w}(${z}, ${M})`,A=o*i/p,k=Math.ceil(u/y),O=z=>`
  const H: u32 = ${u};
  const C: u32 = ${i/p};
  ...
  }`;return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:JSON.stringify({components:p,n:o,h:u,c:i,epsilon:l})},getRunData:()=>({outputs:[{dims:[o,i,2],dataType:1}],dispatchGroup:{x:Math.ceil(A/64)}}),getShaderSource:R},{inputs:[T,r,a],outputs:[-1]})[0]},ap=(e,t,r)=>{let a=t[0].dims,o=a,u=a[0],i=a[a.length-1],l=V.sizeFromDimension(a,1)/i,p=St(i),m=V.size(o)/p,d=H("input",t[0].dataType,t[0].dims,p),v=Y("output",t[0].dataType,o,p),y=Me(t[0].dataType),w=p===1?"vec2f":`mat2x${p}f`,x=p===1?y:`vec${p}<${y}>`,$=np(e,t[0],t[1],t[2],u,l,i,r.epsilon),A=k=>`
  const H: u32 = ${l};
  const C: u32 = ${i/p};
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)}}),getShaderSource:A},{inputs:[t[0],$]})},_u=e=>ue({epsilon:e.epsilon,format:e.format}),Ou=(e,t)=>{t.format==="NHWC"?ap(e,e.inputs,t):e.compute(rp(e.inputs,t))}});var op,ip,Eu,Ru,Pu=j(()=>{"use strict";We();ge();Be();$e();op=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},ip=(e,t,r)=>{let a=e[0].dims,o=e[1],u=e[2],i=a,l=V.normalizeAxis(t.axis,a.length),p=V.sizeToDimension(a,l),m=V.sizeFromDimension(a,l),d=V.size(o.dims),v=u?V.size(u.dims):0;if(d!==m||u&&v!==m)throw new Error(`Size of X.shape()[axis:] == ${m}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${d} and bias size of ${v}`);let y=[];for(let R=0;R<a.length;++R)R<l?y.push(a[R]):y.push(1);let w=St(m),x=Me(e[0].dataType),$=[H("x",e[0].dataType,e[0].dims,w),H("scale",o.dataType,o.dims,w)];u&&$.push(H("bias",u.dataType,u.dims,w)),$.push(Y("output",e[0].dataType,i,w));let A=r>1,k=r>2;A&&$.push(Y("meanDataOutput",1,y)),k&&$.push(Y("invStdOutput",1,y));let O=R=>`
  ...
  ${R.mainStart()}
    ...
    for (var h: u32 = 0u; h < normSizeVectorized; h++) {
      let value = ${qt(x,w,"x[h + offset]")};
      meanVector += value;
      meanSquareVector += value * value;
    }
    let mean = ${Pt("meanVector",w)} / normSize;
    let meanSquare = sqrt(${Pt("meanSquareVector",w)} 
      / normSize - mean * mean + epsilon);

    for (var j: u32 = 0; j < normSizeVectorized; j++) {
      let f32input = ${qt(x,w,"x[j + offset]")};
      let f32scale = ${qt(x,w,"scale[j]")};
    ...
    ${k?"invStdOutput[global_idx] = 1 / meanSquare":""};
  }`,T=[{dims:i,dataType:e[0].dataType}];return A&&T.push({dims:y,dataType:1}),k&&T.push({dims:y,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${t.cacheKey}|${r}|${e.length}`},getRunData:()=>({outputs:T,dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:O}},Eu=e=>ue({axis:e.axis,epsilon:e.epsilon}),Ru=(e,t)=>{op(e.inputs),e.compute(ip(e.inputs,t,e.outputCount))}});var sp,ku,Bu=j(()=>{"use strict";ge();Rr();sp=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},ku=e=>{sp(e.inputs);let t=ct.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");e.compute(xn(e.inputs,{activation:"",activationCacheKey:""},t))}});var up,lp,dp,cp,pp,fp,mp,hp,gp,Mu,Du,zu=j(()=>{"use strict";We();ge();Be();$e();up=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1)throw new Error("Input type must be float.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},lp=(e,t,r,a,o,u,i)=>{let l=r.length,p="";for(let m=l-1;m>=0;--m)p+=`
      ...
      `},dp=(e,t,r,a,o)=>{let u=r.length,i="";for(let l=u-1;l>=0;--l)i+=`
          ...
          `},fp=(e,t,r,a,o,u)=>{switch(o.mode){case 0:return lp(e,t,r,a,o.pads,u,o.value);case 1:return dp(e,t,r,a,o.pads);case 2:return cp(e,t,r,a,o.pads);case 3:return pp(e,t,r,a,o.pads);default:throw new Error("Invalid mode")}},mp=(e,t,r,a)=>{let o=t[0].dims,u=V.padShape(o.slice(),r.pads),i=V.size(u),l=V.computeStrides(o),p=Y("output",t[0].dataType,u),m=H("x",t[0].dataType,o),d=fp(p,u,o,l,r,a);return`
          ...
          }`},hp=(e,t)=>{let r=V.padShape(e[0].dims.slice(),t.pads);return{name:"Pad",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(V.size(r)/64)}}),getShaderSource:a=>mp(a,e,t,"f32")}},gp=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?e[2].getFloat32Array()[0]:0,o=e[0].dims.length,u=new Int32Array(2*o).fill(0);if(e.length>=4){let l=e[3].getBigInt64Array();for(let p=0;p<l.length;p++)u[Number(l[p])]=Number(r[p]),u[Number(l[p])+o]=Number(r[p+l.length])}else r.forEach((l,p)=>u[Number(p)]=Number(l));let i=[];return u.forEach(l=>i.push(l)),ue({mode:t.mode,value:a,pads:i})}else return t},Mu=(e,t)=>{up(e.inputs);let r=gp(e.inputs,t);e.compute(hp(e.inputs,r),{inputs:[0]})},Du=e=>{let t=e.mode,r=e.value,a=e.pads;return ue({mode:t,value:r,pads:a})}});var Cn,Wu,Vu,Nu,Uu,Gu,Fu,Lu,Hu,ju,qu,Ku,Yu,Xu,Ju,Zu=j(()=>{"use strict";ge();Be();$e();Cn=e=>{if(!e||e.length!==1)throw new Error("Pool ops requires 1 input.");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("Pool ops supports 1-D or 2-D inputs only for now.")},Wu=(e,t,r)=>{let a=t.format==="NHWC",o=e.dims.slice();a&&o.splice(1,0,o.pop());let u=Object.hasOwnProperty.call(t,"dilations"),i=t.kernelShape.slice(),l=t.strides.slice(),p=u?t.dilations.slice():[],m=t.pads.slice();jt.adjustPoolAttributes(r,o,i,l,p,m);let d=jt.computePoolOutputShape(r,o,l,p,i,m,t.autoPad),v=Object.assign({},t);u?Object.assign(v,{kernelShape:i,strides:l,pads:m,dilations:p,cacheKey:t.cacheKey}):Object.assign(v,{kernelShape:i,strides:l,pads:m,cacheKey:t.cacheKey});let y=d.slice();return y.push(y.splice(1,1)[0]),[v,a?y:d]},Vu=(e,t,r,a,o,u,i,l)=>{let p=o.format==="NHWC",m=r,d=t.type.value,v=m.length,y=V.size(a),w=Y("output",t.type.tensor,a);if(o.kernelShape.length<=2){let x=o.kernelShape[o.kernelShape.length-1],$=o.strides[o.strides.length-1],A=o.pads[o.pads.length/2-1],k=o.pads[o.pads.length-1],O=v-(p?2:1),T="",R="",z="";if(A+k!==0?T=`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Nu=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),Uu=(e,t,r,a)=>{let[o,u]=Wu(t,a,r),i=V.size(o.kernelShape),l=H("x",t.dataType,t.dims),p=l.type.value,m="value += x_val;",d="";return o.countIncludePad?d+=`value /= ${p}(${i});`:d+=`value /= ${p}(${i} - pad);`,{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(u)/64)}}),getShaderSource:v=>Vu(v,l,t.dims,u,o,m,d,"0.0")}},Gu=e=>{let t=e.count_include_pad!==0,r=Nu(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");return ue({countIncludePad:t,...r})},Fu=(e,t)=>{Cn(e.inputs),e.compute(Uu("AveragePool",e.inputs[0],!1,t))},Lu={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},Hu=e=>{let t=e.format;return{format:t,...Lu,cacheKey:t}},ju=(e,t)=>{Cn(e.inputs),e.compute(Uu("GlobalAveragePool",e.inputs[0],!0,t))},qu=(e,t,r,a)=>{let[o,u]=Wu(t,a,r),i=`
      value = max(x_val, value);
    `,l="",p=H("x",t.dataType,t.dims);return{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(V.size(u)/64)}}),getShaderSource:m=>Vu(m,p,t.dims,u,o,i,l,"-1e5")}},Ku=(e,t)=>{Cn(e.inputs),e.compute(qu("MaxPool",e.inputs[0],!1,t))},Yu=e=>{let t=e.storage_order,r=e.dilations,a=Nu(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return ue({storageOrder:t,dilations:r,...a})},Xu=e=>{let t=e.format;return{format:t,...Lu,cacheKey:t}},Ju=(e,t)=>{Cn(e.inputs),e.compute(qu("GlobalMaxPool",e.inputs[0],!0,t))}});var bp,vp,Qu,el=j(()=>{"use strict";Et();We();$e();bp=(e,t,r)=>{let a=e===t,o=e<t&&r<0,u=e>t&&r>0;if(a||o||u)throw new Error("Range these inputs' contents are invalid.")},vp=(e,t,r,a)=>{let o=Math.abs(Math.ceil((t-e)/r)),u=[o],i=o,l=Y("output",a,u),p=l.type.storage,m=d=>`
        ${d.declareVariables(l)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes(i)}
        output[global_idx] = ${p}(${e}) + ${p}(global_idx) * ${p}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(d=>d.toString()).join("_")},getShaderSource:m,getRunData:()=>({outputs:[{dims:u,dataType:a}],dispatchGroup:{x:Math.ceil(i/64)}})}},Qu=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Ae.webgpu.validateInputContent&&bp(t,r,a),e.compute(vp(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var wp,$p,xp,Sp,Cp,Ap,Ip,_p,Op,Tp,Ep,Rp,Pp,kp,Bp,tl,rl,nl=j(()=>{"use strict";ge();Be();$e();wp=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},$p=(e,t,r)=>{t.every(o=>o>=0&&o<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(r).fill(1);return t.forEach((o,u)=>a[o]=e[u]),a},xp=(e,t,r,a,o,u)=>{let[i,l,p]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],m=e[0].dims.length;if(i>0&&e.length>i&&e[i].dims.length>0)e[i].getFloat32Array().forEach(d=>u.push(d));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length>0){if(e[l].getFloat32Array().forEach(d=>a.push(d)),a.length!==0&&a.length!==m&&r>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");wp(a,t),t.axes.length>0&&$p(a,t.axes,m).forEach((d,v)=>a[v]=d)}if(p>0&&e.length>p&&(e[p].getBigInt64Array().forEach(d=>o.push(Number(d))),o.length!==m||r>=18&&o.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(o.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof o<"u"&&a.length>0&&o.length>m)throw new Error("Resize requires only of scales or sizes to be specified")},Sp=e=>"fn getOriginalCoordinateFromResizedCoordinate(xResized: f32, xScale: f32, lengthResized: f32,    lengthOriginal: f32, roiStart: f32, roiEnd: f32) -> f32 { "+(()=>{switch(e){case"asymmetric":return"return xResized / xScale;";case"pytorch_half_pixel":return"if (lengthResized > 1) {                     return (xResized + 0.5) / xScale - 0.5;                   } else {                     return 0.0;                   }";case"tf_half_pixel_for_nn":return"return (xResized + 0.5) / xScale;";case"align_corners":return"if (lengthResized == 1) {                     return 0.0;                   } else {                     return xResized * (lengthOriginal - 1) / (lengthResized - 1);                   }";case"tf_crop_and_resize":return"if (lengthResized > 1) {                     return roiStart * (lengthOriginal - 1) +                           (xResized * (roiEnd - roiStart) * (lengthOriginal - 1)) / (lengthResized - 1);                   } else {                     return 0.5 * (roiStart + roiEnd) * f32(lengthOriginal - 1);                   }";case"half_pixel_symmetric":return["const outputWidth = xScale * lengthResized;","const adjustment = lengthResized / outputWidth;","const center = lengthOriginal / 2;","const offset = center * (1 - adjustment);","return offset + ((xResized + 0.5) / xScale) - 0.5;"].join(`
    ...
    `},kp=(e,t,r,a,o,u)=>{let i=e.dims,l=Ap(u,t.axes,i.length),p=Ip(i,a,o,t.axes),m=a.slice();a.length===0&&(m=i.map((A,k)=>A===0?1:p[k]/A),t.keepAspectRatioPolicy!=="stretch"&&(p=_p(i,p,m,t)));let d=Y("output",e.dataType,p),v=H("input",e.dataType,i),y=V.size(p),w=i.length===p.length&&i.every((A,k)=>A===p[k]),x=t.coordinateTransformMode==="tf_crop_and_resize",$=A=>`
      ...
      ${R.mainStart()}
        ...
        for (var i: u32 = 0; i < hiddenSizeVectorized; i++) {
          ...
          let f32Value = ${qt(k,$,"value")};
          sum += f32Value;
          squareSum += f32Value * f32Value;
        }
        let mean = ${Pt("sum",$)} / hiddenSize;
        let variance = sqrt(${Pt("squareSum",$)} / hiddenSize - mean * mean + epsilon);
      ...
      }`,T=[{dims:i,dataType:e[0].dataType}];return r>1&&T.push({dims:m,dataType:1}),r>2&&T.push({dims:m,dataType:1}),r>3&&T.push({dims:o,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:O,getRunData:()=>({outputs:T,dispatchGroup:{x:Math.ceil(l/p/64)}})}},al=(e,t)=>{Mp(e.inputs);let a=[0];e.outputCount>1&&a.push(-3),e.outputCount>2&&a.push(-3),e.outputCount>3&&a.push(3),e.compute(Dp(e.inputs,t,e.outputCount,!1),{outputs:a})},ol=e=>{let t=e.epsilon;return ue({epsilon:t})}});var zp,An,Wp,sl,Vp,Np,ul,ll,dl=j(()=>{"use strict";We();ge();Be();$e();zp=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,a)=>{if(e[a+1].dataType!==6&&e[a+1].dataType!==7)throw new Error(`Input ${a} must be an array of int32 or int64`)})},An=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(a=>r.push(Number(a)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(a=>r.push(Number(a)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Wp=(e,t)=>{if(e.length>1){let r=An(e,1),a=An(e,2),o=An(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),ue({starts:r,ends:a,axes:o})}else return t},sl=(e,t,r,a,o)=>{let u=e;return e<0&&(u+=r[a[t]]),o[t]<0?Math.max(0,Math.min(u,r[a[t]]-1)):Math.max(0,Math.min(u,r[a[t]]))},Vp=(e,t,r,a)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${t.cacheKey}|${e[4]?.dims??""}`},getShaderSource:x,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(a/64)}})}},ul=(e,t)=>{zp(e.inputs,t);let r=Wp(e.inputs,t);e.compute(Np(e.inputs,r),{inputs:[0]})},ll=e=>{let t=e.starts,r=e.ends,a=e.axes;return ue({starts:t,ends:r,axes:a})}});var Up,Gp,cl,pl,fl=j(()=>{"use strict";ge();Be();$e();Up=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Gp=(e,t)=>{let r=e.dims,a=V.size(r),o=64,u=t.axis;if(u<0&&(u=r.length+u),u<r.length-1)throw new Error("softmax only supports last axis for now.");let i=r[u],l=a/i,p=St(i),m=i/p,d=(A,k)=>k===4?`max(max(${A}.x, ${A}.y), max(${A}.z, ${A}.w))`:k===2?`max(${A}.x, ${A}.y)`:k===3?`max(max(${A}.x, ${A}.y), ${A}.z)`:A,v=H("x",e.dataType,e.dims,p),y=Y("result",e.dataType,e.dims,p),w=v.type.value,x=Me(e.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=A=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${p}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:m}]}),getShaderSource:$}},cl=(e,t)=>{Up(e.inputs),e.compute(Gp(e.inputs[0],t))},pl=e=>ue({axis:e.axis})});var Fp,Lp,Hp,jp,qp,ml,hl,gl=j(()=>{"use strict";ge();Be();$e();Fp=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Lp=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),a=r.length),ue({numOutputs:a,axis:t.axis,splitSizes:r})},Hp=e=>`
...
`)}
  ...
  ${A.mainStart()}
    ...
    writeBufferData(outputNumber, indices, global_idx);
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:$,getRunData:()=>({outputs:v,dispatchGroup:{x:Math.ceil(a/64)}})}},ml=(e,t)=>{Fp(e.inputs);let r=e.inputs.length===1?t:Lp(e.inputs,t);e.compute(qp(e.inputs,r),{inputs:[0]})},hl=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return ue({axis:t,numOutputs:a,splitSizes:r})}});var yl,Kp,Yp,Xp,bl,vl=j(()=>{"use strict";We();ge();$e();yl=e=>Array.from(e.getBigInt64Array(),Number),Kp=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(yl(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Yp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},Xp=e=>{let t=e[0].dims,r=yl(e[1]),a=Yp(t,r),o=V.size(a),u=e[0].dataType,i=H("input",u,t),l=Y("output",u,a),p=m=>`
      const inputShape = ${i.indices(...t)};
      ${m.declareVariables(i,l)}
      ${m.mainStart()}
      ${m.guardAgainstOutOfBoundsWorkgroupSizes(o)}
      ...
      ${l.setByOffset("global_idx",i.getByIndices("inputIndices"))}
    }`;return{name:"Tile",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:p}},bl=e=>{Kp(e.inputs),e.compute(Xp(e.inputs),{inputs:[0]})}});var Jp,Zp,wl,$l=j(()=>{"use strict";We();ge();$e();Jp=(e,t,r,a,o)=>{let u=V.size(r),i=Math.ceil(u/4),l=Y("outputData",o,r,4),p=H("aData",t[1].dataType,t[1].dims,4),m=H("bData",t[2].dataType,t[2].dims,4),d=H("cData",t[0].dataType,t[0].dims,4),v,y=(w,x,$)=>`select(${x}, ${w}, ${$})`;if(!a)v=l.setByOffset("global_idx",y(p.getByOffset("global_idx"),m.getByOffset("global_idx"),d.getByOffset("global_idx")));else{let w=(x,$,A="")=>{let k=`aData[indexA${$}][componentA${$}]`,O=`bData[indexB${$}][componentB${$}]`,T=`bool(cData[indexC${$}] & ${4278190080>>>(3-$)*8}u)`;return`
