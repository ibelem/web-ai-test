...
`))(fr,i,Oe,()=>G)},kr={},Ye=t=>t%4===0&&(t%100!==0||t%400===0),Wr=[0,31,60,91,121,152,182,213,244,274,305,335],Lr=[0,31,59,90,120,151,181,212,243,273,304,334],$r=t=>{var n=ze(t)+1,u=dr(n);return u&&We(t,J,u,n),u},Er={},Hr=()=>{if(!Sr){var t={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:c||"./this.program"},n;for(n in Er)Er[n]===void 0?delete t[n]:t[n]=Er[n];var u=[];for(n in t)u.push(`${n}=${t[n]}`);Sr=u}return Sr},Sr,at=[null,[],[]],jr=[31,29,31,30,31,30,31,31,30,31,30,31],Me=[31,28,31,30,31,30,31,31,30,31,30,31];function Nr(t){var n=Array(ze(t)+1);return We(t,n,0,n.length),n}function Mr(t,n,u,d){function y(b,q,re){for(b=typeof b=="number"?b.toString():b||"";b.length<q;)b=re[0]+b;return b}function A(b,q){return y(b,q,"0")}function D(b,q){function re(zr){return 0>zr?-1:0<zr?1:0}var Be;return(Be=re(b.getFullYear()-q.getFullYear()))===0&&(Be=re(b.getMonth()-q.getMonth()))===0&&(Be=re(b.getDate()-q.getDate())),Be}function C(b){switch(b.getDay()){case 0:return new Date(b.getFullYear()-1,11,29);case 1:return b;case 2:return new Date(b.getFullYear(),0,3);case 3:return new Date(b.getFullYear(),0,2);case 4:return new Date(b.getFullYear(),0,1);case 5:return new Date(b.getFullYear()-1,11,31);case 6:return new Date(b.getFullYear()-1,11,30)}}function W(b){var q=b.Ta;for(b=new Date(new Date(b.Ua+1900,0,1).getTime());0<q;){var re=b.getMonth(),Be=(Ye(b.getFullYear())?jr:Me)[re];if(q>Be-b.getDate())q-=Be-b.getDate()+1,b.setDate(1),11>re?b.setMonth(re+1):(b.setMonth(0),b.setFullYear(b.getFullYear()+1));else{b.setDate(b.getDate()+q);break}}return re=new Date(b.getFullYear()+1,0,4),q=C(new Date(b.getFullYear(),0,4)),re=C(re),0>=D(q,b)?0>=D(re,b)?b.getFullYear()+1:b.getFullYear():b.getFullYear()-1}t>>>=0,n>>>=0,u>>>=0,d>>>=0;var H=G[d+40>>>2>>>0];d={kb:I[d>>>2>>>0],jb:I[d+4>>>2>>>0],Xa:I[d+8>>>2>>>0],ab:I[d+12>>>2>>>0],Ya:I[d+16>>>2>>>0],Ua:I[d+20>>>2>>>0],Oa:I[d+24>>>2>>>0],Ta:I[d+28>>>2>>>0],mb:I[d+32>>>2>>>0],ib:I[d+36>>>2>>>0],lb:H?or(H):""},u=or(u),H={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ne in H)u=u.replace(new RegExp(ne,"g"),H[ne]);var z="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ie="January February March April May June July August September October November December".split(" ");H={"%a":b=>z[b.Oa].substring(0,3),"%A":b=>z[b.Oa],"%b":b=>Ie[b.Ya].substring(0,3),"%B":b=>Ie[b.Ya],"%C":b=>A((b.Ua+1900)/100|0,2),"%d":b=>A(b.ab,2),"%e":b=>y(b.ab,2," "),"%g":b=>W(b).toString().substring(2),"%G":b=>W(b),"%H":b=>A(b.Xa,2),"%I":b=>(b=b.Xa,b==0?b=12:12<b&&(b-=12),A(b,2)),"%j":b=>{for(var q=0,re=0;re<=b.Ya-1;q+=(Ye(b.Ua+1900)?jr:Me)[re++]);return A(b.ab+q,3)},"%m":b=>A(b.Ya+1,2),"%M":b=>A(b.jb,2),"%n":()=>`
`,"%p":b=>0<=b.Xa&&12>b.Xa?"AM":"PM","%S":b=>A(b.kb,2),"%t":()=>"	","%u":b=>b.Oa||7,"%U":b=>A(Math.floor((b.Ta+7-b.Oa)/7),2),"%V":b=>{var q=Math.floor((b.Ta+7-(b.Oa+6)%7)/7);if(2>=(b.Oa+371-b.Ta-2)%7&&q++,q)q==53&&(re=(b.Oa+371-b.Ta)%7,re==4||re==3&&Ye(b.Ua)||(q=1));else{q=52;var re=(b.Oa+7-b.Ta-1)%7;(re==4||re==5&&Ye(b.Ua%400-1))&&q++}return A(q,2)},"%w":b=>b.Oa,"%W":b=>A(Math.floor((b.Ta+7-(b.Oa+6)%7)/7),2),"%y":b=>(b.Ua+1900).toString().substring(2),"%Y":b=>b.Ua+1900,"%z":b=>{b=b.ib;var q=0<=b;return b=Math.abs(b)/60,(q?"+":"-")+("0000"+(b/60*100+b%60)).slice(-4)},"%Z":b=>b.lb,"%%":()=>"%"},u=u.replace(/%%/g,"\0\0");for(ne in H)u.includes(ne)&&(u=u.replace(new RegExp(ne,"g"),H[ne](d)));return u=u.replace(/\0\0/g,"%"),ne=Nr(u),ne.length>n?0:(de.set(ne,t>>>0),ne.length-1)}for(var ot=Array(256),Ce=0;256>Ce;++Ce)ot[Ce]=String.fromCharCode(Ce);Ze=ot,Le=i.BindingError=class extends Error{constructor(t){super(t),this.name="BindingError"}},i.InternalError=class extends Error{constructor(t){super(t),this.name="InternalError"}},Object.assign(sr.prototype,{get(t){return this.Sa[t]},has(t){return this.Sa[t]!==void 0},Za(t){var n=this.bb.pop()||this.Sa.length;return this.Sa[n]=t,n},$a(t){this.Sa[t]=void 0,this.bb.push(t)}}),ye.Sa.push({value:void 0},{value:null},{value:!0},{value:!1}),ye.Va=ye.Sa.length,i.count_emval_handles=()=>{for(var t=0,n=ye.Va;n<ye.Sa.length;++n)ye.Sa[n]!==void 0&&++t;return t};var Dt={a:function(t,n,u){throw t>>>=0,new te(t).Za(n>>>0,u>>>0),ue=t,Je++,ue},v:function(){return 0},ba:function(){},N:function(){},P:function(){},H:function(){return 0},$:function(){},V:function(){},_:function(){},A:function(){},O:function(){},L:function(){},aa:function(){},M:function(){},D:function(t,n,u,d,y){n>>>=0,n=Se(n);var A=n.indexOf("u")!=-1;A&&(y=(1n<<64n)-1n),Ue(t>>>0,{name:n,fromWireType:D=>D,toWireType:function(D,C){if(typeof C!="bigint"&&typeof C!="number")throw new TypeError(`Cannot convert "${vr(C)}" to ${this.name}`);if(C<d||C>y)throw new TypeError(`Passing a number "${vr(C)}" from JS side to C/C++ side to an argument of type "${n}", which is outside the valid range [${d}, ${y}]!`);return C},argPackAdvance:8,readValueFromPointer:Xr(n,u>>>0,!A),Wa:null})},ea:function(t,n,u,d){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:function(y){return!!y},toWireType:function(y,A){return A?u:d},argPackAdvance:8,readValueFromPointer:function(y){return this.fromWireType(J[y>>>0])},Wa:null})},da:function(t,n){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:u=>{var d=he(u);return wr(u),d},toWireType:(u,d)=>Oe(d),argPackAdvance:8,readValueFromPointer:ur,Wa:null})},C:function(t,n,u){n=Se(n>>>0),Ue(t>>>0,{name:n,fromWireType:d=>d,toWireType:(d,y)=>y,argPackAdvance:8,readValueFromPointer:Jr(n,u>>>0),Wa:null})},p:function(t,n,u,d,y){if(t>>>=0,u>>>=0,n=Se(n>>>0),y===-1&&(y=4294967295),y=C=>C,d===0){var A=32-8*u;y=C=>C<<A>>>A}var D=n.includes("unsigned")?function(C,W){return W>>>0}:function(C,W){return W};Ue(t,{name:n,fromWireType:y,toWireType:D,argPackAdvance:8,readValueFromPointer:Xr(n,u,d!==0),Wa:null})},l:function(t,n,u){function d(A){return new y(de.buffer,G[A+4>>>2>>>0],G[A>>>2>>>0])}var y=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][n];u=Se(u>>>0),Ue(t>>>0,{name:u,fromWireType:d,argPackAdvance:8,readValueFromPointer:d},{gb:!0})},E:function(t,n){n=Se(n>>>0);var u=n==="std::string";Ue(t>>>0,{name:n,fromWireType:function(d){var y=G[d>>>2>>>0],A=d+4;if(u)for(var D=A,C=0;C<=y;++C){var W=A+C;if(C==y||J[W>>>0]==0){if(D=or(D,W-D),H===void 0)var H=D;else H+=String.fromCharCode(0),H+=D;D=W+1}}else{for(H=Array(y),C=0;C<y;++C)H[C]=String.fromCharCode(J[A+C>>>0]);H=H.join("")}return xe(d),H},toWireType:function(d,y){y instanceof ArrayBuffer&&(y=new Uint8Array(y));var A=typeof y=="string";if(!(A||y instanceof Uint8Array||y instanceof Uint8ClampedArray||y instanceof Int8Array))throw new Le("Cannot pass non-string to std::string");var D=u&&A?ze(y):y.length,C=dr(4+D+1),W=C+4;if(G[C>>>2>>>0]=D,u&&A)We(y,J,W,D+1);else if(A)for(A=0;A<D;++A){var H=y.charCodeAt(A);if(255<H)throw xe(W),new Le("String has UTF-16 code units that do not fit in 8 bits");J[W+A>>>0]=H}else for(A=0;A<D;++A)J[W+A>>>0]=y[A];return d!==null&&d.push(xe,C),C},argPackAdvance:8,readValueFromPointer:xr,Wa(d){xe(d)}})},x:function(t,n,u){if(n>>>=0,u>>>=0,u=Se(u),n===2)var d=k,y=Or,A=Kr,D=()=>De,C=1;else n===4&&(d=_r,y=Qr,A=It,D=()=>G,C=2);Ue(t>>>0,{name:u,fromWireType:W=>{for(var H=G[W>>>2>>>0],ne=D(),z,Ie=W+4,b=0;b<=H;++b){var q=W+4+b*n;(b==H||ne[q>>>C]==0)&&(Ie=d(Ie,q-Ie),z===void 0?z=Ie:(z+=String.fromCharCode(0),z+=Ie),Ie=q+n)}return xe(W),z},toWireType:(W,H)=>{if(typeof H!="string")throw new Le(`Cannot pass non-string to C++ string type ${u}`);var ne=A(H),z=dr(4+ne+n);return G[z>>>2]=ne>>C,y(H,z+4,ne+n),W!==null&&W.push(xe,z),z},argPackAdvance:8,readValueFromPointer:ur,Wa(W){xe(W)}})},fa:function(t,n){n=Se(n>>>0),Ue(t>>>0,{hb:!0,name:n,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},ca:()=>!0,o:function(t,n,u){n>>>=0,u>>>=0,t=he(t>>>0),n=fr(n,"emval::as");var d=[],y=Oe(d);return G[u>>>2>>>0]=y,n.toWireType(d,t)},h:function(t,n,u,d,y){u>>>=0,d>>>=0,y>>>=0,t=cr[t>>>0],n=he(n>>>0),u=lr(u);var A=[];return G[d>>>2>>>0]=Oe(A),t(n,u,A,y)},r:function(t,n,u,d){u>>>=0,d>>>=0,t=cr[t>>>0],n=he(n>>>0),u=lr(u),t(n,u,null,d)},b:wr,F:function(t,n){return n>>>=0,t=he(t>>>0),n=he(n),t==n},u:function(t){return t>>>=0,t===0?Oe(Br()):(t=lr(t),Oe(Br()[t]))},g:function(t,n){var u=Tr(t,n>>>0),d=u[0];n=d.name+"_$"+u.slice(1).map(function(ne){return ne.name}).join("_")+"$";var y=Ar[n];if(y!==void 0)return y;y=["retType"];for(var A=[d],D="",C=0;C<t-1;++C)D+=(C!==0?", ":"")+"arg"+C,y.push("argType"+C),A.push(u[1+C]);var W="return function "+Rr("methodCaller_"+n)+`(handle, name, destructors, args) {
...
`),y.push(W+`};
`),t=tt(y).apply(null,A),y=et(t),Ar[n]=y},q:function(t,n){return n>>>=0,t=he(t>>>0),n=he(n),Oe(t[n])},c:function(t){t>>>=0,4<t&&(ye.get(t).cb+=1)},G:function(t,n,u,d){u>>>=0,d>>>=0,t=he(t>>>0);var y=kr[n];return y||(y=nt(n),kr[n]=y),y(t,u,d)},s:function(){return Oe([])},k:function(t){t=he(t>>>0);for(var n=Array(t.length),u=0;u<t.length;u++)n[u]=t[u];return Oe(n)},d:function(t){return Oe(lr(t>>>0))},j:function(){return Oe({})},f:function(t){t>>>=0;for(var n=he(t);n.length;){var u=n.pop();n.pop()(u)}wr(t)},i:function(t,n,u){n>>>=0,u>>>=0,t=he(t>>>0),n=he(n),u=he(u),t[n]=u},e:function(t,n){return n>>>=0,t=fr(t>>>0,"_emval_take_value"),t=t.readValueFromPointer(n),Oe(t)},S:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),I[n>>>2>>>0]=t.getUTCSeconds(),I[n+4>>>2>>>0]=t.getUTCMinutes(),I[n+8>>>2>>>0]=t.getUTCHours(),I[n+12>>>2>>>0]=t.getUTCDate(),I[n+16>>>2>>>0]=t.getUTCMonth(),I[n+20>>>2>>>0]=t.getUTCFullYear()-1900,I[n+24>>>2>>>0]=t.getUTCDay(),I[n+28>>>2>>>0]=(t.getTime()-Date.UTC(t.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},T:function(t,n){t=-9007199254740992>t||9007199254740992<t?NaN:Number(t),n>>>=0,t=new Date(1e3*t),I[n>>>2>>>0]=t.getSeconds(),I[n+4>>>2>>>0]=t.getMinutes(),I[n+8>>>2>>>0]=t.getHours(),I[n+12>>>2>>>0]=t.getDate(),I[n+16>>>2>>>0]=t.getMonth(),I[n+20>>>2>>>0]=t.getFullYear()-1900,I[n+24>>>2>>>0]=t.getDay(),I[n+28>>>2>>>0]=(Ye(t.getFullYear())?Wr:Lr)[t.getMonth()]+t.getDate()-1|0,I[n+36>>>2>>>0]=-(60*t.getTimezoneOffset());var u=new Date(t.getFullYear(),6,1).getTimezoneOffset(),d=new Date(t.getFullYear(),0,1).getTimezoneOffset();I[n+32>>>2>>>0]=(u!=d&&t.getTimezoneOffset()==Math.min(d,u))|0},U:function(t){t>>>=0;var n=new Date(I[t+20>>>2>>>0]+1900,I[t+16>>>2>>>0],I[t+12>>>2>>>0],I[t+8>>>2>>>0],I[t+4>>>2>>>0],I[t>>>2>>>0],0),u=I[t+32>>>2>>>0],d=n.getTimezoneOffset(),y=new Date(n.getFullYear(),6,1).getTimezoneOffset(),A=new Date(n.getFullYear(),0,1).getTimezoneOffset(),D=Math.min(A,y);return 0>u?I[t+32>>>2>>>0]=+(y!=A&&D==d):0<u!=(D==d)&&(y=Math.max(A,y),n.setTime(n.getTime()+6e4*((0<u?D:y)-d))),I[t+24>>>2>>>0]=n.getDay(),I[t+28>>>2>>>0]=(Ye(n.getFullYear())?Wr:Lr)[n.getMonth()]+n.getDate()-1|0,I[t>>>2>>>0]=n.getSeconds(),I[t+4>>>2>>>0]=n.getMinutes(),I[t+8>>>2>>>0]=n.getHours(),I[t+12>>>2>>>0]=n.getDate(),I[t+16>>>2>>>0]=n.getMonth(),I[t+20>>>2>>>0]=n.getYear(),BigInt(n.getTime()/1e3)},Q:function(){return-52},R:function(){},J:function(t,n,u){function d(W){return(W=W.toTimeString().match(/\(([A-Za-z ]+)\)$/))?W[1]:"GMT"}u>>>=0;var y=new Date().getFullYear(),A=new Date(y,0,1),D=new Date(y,6,1);y=A.getTimezoneOffset();var C=D.getTimezoneOffset();G[t>>>0>>>2>>>0]=60*Math.max(y,C),I[n>>>0>>>2>>>0]=+(y!=C),t=d(A),n=d(D),t=$r(t),n=$r(n),C<y?(G[u>>>2>>>0]=t,G[u+4>>>2>>>0]=n):(G[u>>>2>>>0]=n,G[u+4>>>2>>>0]=t)},t:()=>{tr("")},B:()=>Date.now(),K:function(){return 4294901760},n:()=>performance.now(),Z:function(t,n,u){return n>>>=0,J.copyWithin(t>>>0>>>0,n>>>0,n+(u>>>0)>>>0)},I:function(t){t>>>=0;var n=J.length;if(4294901760<t)return!1;for(var u=1;4>=u;u*=2){var d=n*(1+.2/u);d=Math.min(d,t+100663296);var y=Math;d=Math.max(t,d);e:{y=(y.min.call(y,4294901760,d+(65536-d%65536)%65536)-U.buffer.byteLength+65535)/65536;try{U.grow(y),V();var A=1;break e}catch{}A=void 0}if(A)return!0}return!1},X:function(t,n){t>>>=0,n>>>=0;var u=0;return Hr().forEach((d,y)=>{var A=n+u;for(y=G[t+4*y>>>2>>>0]=A,A=0;A<d.length;++A)de[y++>>>0>>>0]=d.charCodeAt(A);de[y>>>0>>>0]=0,u+=d.length+1}),0},Y:function(t,n){t>>>=0,n>>>=0;var u=Hr();G[t>>>2>>>0]=u.length;var d=0;return u.forEach(y=>d+=y.length+1),G[n>>>2>>>0]=d,0},w:()=>52,z:function(){return 52},W:function(){return 70},y:function(t,n,u,d){n>>>=0,u>>>=0,d>>>=0;for(var y=0,A=0;A<u;A++){var D=G[n>>>2>>>0],C=G[n+4>>>2>>>0];n+=8;for(var W=0;W<C;W++){var H=J[D+W>>>0],ne=at[t];H===0||H===10?((t===1?L:Y)(yr(ne,0)),ne.length=0):ne.push(H)}y+=C}return G[d>>>2>>>0]=y,0},ga:Mr,m:function(t,n,u,d){return Mr(t>>>0,n>>>0,u>>>0,d>>>0)}},B=function(){var t={a:Dt};return me++,ar(t,function(n){B=n.instance.exports,B=it(),U=B.ha,V(),je.unshift(B.ia),me--,me==0&&(ee!==null&&(clearInterval(ee),ee=null),pe&&(n=pe,pe=null,n()))}).catch(p),{}}();i._OrtInit=(t,n)=>(i._OrtInit=B.ja)(t,n),i._OrtGetLastError=(t,n)=>(i._OrtGetLastError=B.ka)(t,n),i._OrtCreateSessionOptions=(t,n,u,d,y,A,D,C,W,H)=>(i._OrtCreateSessionOptions=B.la)(t,n,u,d,y,A,D,C,W,H),i._OrtAppendExecutionProvider=(t,n)=>(i._OrtAppendExecutionProvider=B.ma)(t,n),i._OrtAddFreeDimensionOverride=(t,n,u)=>(i._OrtAddFreeDimensionOverride=B.na)(t,n,u),i._OrtAddSessionConfigEntry=(t,n,u)=>(i._OrtAddSessionConfigEntry=B.oa)(t,n,u),i._OrtReleaseSessionOptions=t=>(i._OrtReleaseSessionOptions=B.pa)(t),i._OrtCreateSession=(t,n,u)=>(i._OrtCreateSession=B.qa)(t,n,u),i._OrtReleaseSession=t=>(i._OrtReleaseSession=B.ra)(t),i._OrtGetInputOutputCount=(t,n,u)=>(i._OrtGetInputOutputCount=B.sa)(t,n,u),i._OrtGetInputName=(t,n)=>(i._OrtGetInputName=B.ta)(t,n),i._OrtGetOutputName=(t,n)=>(i._OrtGetOutputName=B.ua)(t,n),i._OrtFree=t=>(i._OrtFree=B.va)(t),i._OrtCreateTensor=(t,n,u,d,y,A)=>(i._OrtCreateTensor=B.wa)(t,n,u,d,y,A),i._OrtGetTensorData=(t,n,u,d,y)=>(i._OrtGetTensorData=B.xa)(t,n,u,d,y),i._OrtReleaseTensor=t=>(i._OrtReleaseTensor=B.ya)(t),i._OrtCreateRunOptions=(t,n,u,d)=>(i._OrtCreateRunOptions=B.za)(t,n,u,d),i._OrtAddRunConfigEntry=(t,n,u)=>(i._OrtAddRunConfigEntry=B.Aa)(t,n,u),i._OrtReleaseRunOptions=t=>(i._OrtReleaseRunOptions=B.Ba)(t),i._OrtCreateBinding=t=>(i._OrtCreateBinding=B.Ca)(t),i._OrtBindInput=(t,n,u)=>(i._OrtBindInput=B.Da)(t,n,u),i._OrtBindOutput=(t,n,u,d)=>(i._OrtBindOutput=B.Ea)(t,n,u,d),i._OrtClearBoundOutputs=t=>(i._OrtClearBoundOutputs=B.Fa)(t),i._OrtReleaseBinding=t=>(i._OrtReleaseBinding=B.Ga)(t),i._OrtRunWithBinding=(t,n,u,d,y)=>(i._OrtRunWithBinding=B.Ha)(t,n,u,d,y),i._OrtRun=(t,n,u,d,y,A,D,C)=>(i._OrtRun=B.Ia)(t,n,u,d,y,A,D,C),i._OrtEndProfiling=t=>(i._OrtEndProfiling=B.Ja)(t);var dr=i._malloc=t=>(dr=i._malloc=B.Ka)(t),xe=i._free=t=>(xe=i._free=B.La)(t),_e=t=>(_e=B.Ma)(t);i.__embind_initialize_bindings=()=>(i.__embind_initialize_bindings=B.Na)();var Pr=()=>(Pr=B.Pa)(),ge=t=>(ge=B.Qa)(t),Te=t=>(Te=B.Ra)(t);function it(){var t=B;t=Object.assign({},t);var n=d=>()=>d()>>>0,u=d=>y=>d(y)>>>0;return t.__errno_location=n(t.__errno_location),t.Ka=u(t.Ka),t.Ma=u(t.Ma),t.Pa=n(t.Pa),t.Ra=u(t.Ra),t}i.stackAlloc=Te,i.stackSave=Pr,i.stackRestore=ge,i.UTF8ToString=or,i.stringToUTF8=(t,n,u)=>We(t,J,n,u),i.lengthBytesUTF8=ze;var Cr;pe=function t(){Cr||st(),Cr||(pe=t)};function st(){if(!(0<me)){for(;0<Q.length;)Q.shift()(i);if(!(0<me||Cr||(Cr=!0,i.calledRun=!0,K))){for(;0<je.length;)je.shift()(i);for(m(i);0<be.length;)be.shift()(i)}}}return st(),s.ready}})();typeof ha=="object"&&typeof Vt=="object"?Vt.exports=ma:typeof define=="function"&&define.amd&&define([],()=>ma)});var ya=Fr(()=>{});var va=Fr(()=>{});var ba={};Yr(ba,{cpus:()=>Mo});var Mo,wa=Z(()=>{Mo=void 0});var Ta=Fr((_a,qt)=>{"use strict";var Oa=(()=>{var o=typeof document<"u"&&document.currentScript?document.currentScript.src:void 0;return typeof __filename<"u"&&(o=o||__filename),function(s={}){function i(){return Q.buffer!=ee.buffer&&te(),ee}function m(){return Q.buffer!=ee.buffer&&te(),pe}function p(){return Q.buffer!=ee.buffer&&te(),tr}function O(){return Q.buffer!=ee.buffer&&te(),$e}function c(){return Q.buffer!=ee.buffer&&te(),Re}function g(){return Q.buffer!=ee.buffer&&te(),Xe}function _(){return Q.buffer!=ee.buffer&&te(),ar}var f=s,T,M;f.ready=new Promise((e,r)=>{T=e,M=r});var E=Object.assign({},f),F="./this.program",j=(e,r)=>{throw r},x=typeof window=="object",L=typeof importScripts=="function",Y=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",U=f.ENVIRONMENT_IS_PTHREAD||!1,K="";function de(e){return f.locateFile?f.locateFile(e,K):K+e}var J,Ee,De;if(Y){var I=(zt(),Dr(Nt)),G=(Gt(),Dr(Yt));K=L?G.dirname(K)+"/":__dirname+"/",J=(r,a)=>(r=r.startsWith("file://")?new URL(r):G.normalize(r),I.readFileSync(r,a?void 0:"utf8")),De=r=>(r=J(r,!0),r.buffer||(r=new Uint8Array(r)),r),Ee=(r,a,l,h=!0)=>{r=r.startsWith("file://")?new URL(r):G.normalize(r),I.readFile(r,h?void 0:"utf8",(v,S)=>{v?l(v):a(h?S.buffer:S)})},!f.thisProgram&&1<process.argv.length&&(F=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),j=(r,a)=>{throw process.exitCode=r,a},f.inspect=()=>"[Emscripten Module object]";let e;try{e=ya()}catch(r){throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'),r}global.Worker=e.Worker}else(x||L)&&(L?K=self.location.href:typeof document<"u"&&document.currentScript&&(K=document.currentScript.src),typeof o<"u"&&o&&(K=o),K.indexOf("blob:")!==0?K=K.substr(0,K.replace(/[?#].*/,"").lastIndexOf("/")+1):K="",Y||(J=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.send(null),r.responseText},L&&(De=e=>{var r=new XMLHttpRequest;return r.open("GET",e,!1),r.responseType="arraybuffer",r.send(null),new Uint8Array(r.response)}),Ee=(e,r,a)=>{var l=new XMLHttpRequest;l.open("GET",e,!0),l.responseType="arraybuffer",l.onload=()=>{l.status==200||l.status==0&&l.response?r(l.response):a()},l.onerror=a,l.send(null)}));Y&&typeof performance>"u"&&(global.performance=va().performance);var Qe=console.log.bind(console),er=console.error.bind(console);Y&&(Qe=(...e)=>I.writeSync(1,e.join(" ")+`
`),er=(...e)=>I.writeSync(2,e.join(" ")+`
`));var rr=Qe,ce=er;Object.assign(f,E),E=null;var V=!0;typeof WebAssembly!="object"&&He("no native wasm support detected");var Q,je,be=!1,me,ee,pe,tr,$e,Re,Xe,nr,we,ke,ar;function te(){var e=Q.buffer;f.HEAP8=ee=new Int8Array(e),f.HEAP16=tr=new Int16Array(e),f.HEAPU8=pe=new Uint8Array(e),f.HEAPU16=$e=new Uint16Array(e),f.HEAP32=Re=new Int32Array(e),f.HEAPU32=Xe=new Uint32Array(e),f.HEAPF32=nr=new Float32Array(e),f.HEAPF64=ar=new Float64Array(e),f.HEAP64=we=new BigInt64Array(e),f.HEAPU64=ke=new BigUint64Array(e)}var ue=16777216;if(5242880<=ue||He("INITIAL_MEMORY should be larger than STACK_SIZE, was "+ue+"! (STACK_SIZE=5242880)"),U)Q=f.wasmMemory;else if(Q=new WebAssembly.Memory({initial:ue/65536,maximum:65536,shared:!0}),!(Q.buffer instanceof SharedArrayBuffer))throw ce("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),Y&&ce("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");te(),ue=Q.buffer.byteLength;var Je=[],Ne=[],yr=[],or=0;function ze(){return V||0<or}var We=0,vr=null,Ze=null;function Se(){if(We--,We==0&&(vr!==null&&(clearInterval(vr),vr=null),Ze)){var e=Ze;Ze=null,e()}}function He(e){throw e="Aborted("+e+")",ce(e),be=!0,me=1,e=new WebAssembly.RuntimeError(e+". Build with -sASSERTIONS for more info."),M(e),e}function br(e){return e.startsWith("data:application/octet-stream;base64,")}var ir;ir="ort-wasm-threaded.wasm",br(ir)||(ir=de(ir));function Le(e){if(De)return De(e);throw"both async and sync fetching of the wasm failed"}function Ct(e){if(x||L){if(typeof fetch=="function"&&!e.startsWith("file://"))return fetch(e,{credentials:"same-origin"}).then(r=>{if(!r.ok)throw"failed to load wasm binary file at '"+e+"'";return r.arrayBuffer()}).catch(()=>Le(e));if(Ee)return new Promise((r,a)=>{Ee(e,l=>r(new Uint8Array(l)),a)})}return Promise.resolve().then(()=>Le(e))}function Ue(e,r,a){return Ct(e).then(l=>WebAssembly.instantiate(l,r)).then(l=>l).then(a,l=>{ce(`failed to asynchronously prepare wasm: ${l}`),He(l)})}function Xr(e,r){var a=ir;return typeof WebAssembly.instantiateStreaming!="function"||br(a)||a.startsWith("file://")||Y||typeof fetch!="function"?Ue(a,e,r):fetch(a,{credentials:"same-origin"}).then(l=>WebAssembly.instantiateStreaming(l,e).then(r,function(h){return ce(`wasm streaming compile failed: ${h}`),ce("falling back to ArrayBuffer instantiation"),Ue(a,e,r)}))}function sr(e){this.name="ExitStatus",this.message=`Program terminated with exit(${e})`,this.status=e}var ye=e=>{e.terminate(),e.onmessage=()=>{}},wr=e=>{if(k.qb.length==0){var r=de("ort-wasm-threaded.worker.js");r=new Worker(r),k.qb.push(r),k.Jb(k.qb[0])}if(r=k.qb.pop(),!r)return 6;k.nb.push(r),k.jb[e.mb]=r,r.mb=e.mb;var a={cmd:"run",start_routine:e.Mb,arg:e.Fb,pthread_ptr:e.mb};return Y&&r.unref(),r.postMessage(a,e.Sb),0},he=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Oe=(e,r,a)=>{r>>>=0;var l=r+a;for(a=r;e[a]&&!(a>=l);)++a;if(16<a-r&&e.buffer&&he)return he.decode(e.buffer instanceof SharedArrayBuffer?e.slice(r,a):e.subarray(r,a));for(l="";r<a;){var h=e[r++];if(h&128){var v=e[r++]&63;if((h&224)==192)l+=String.fromCharCode((h&31)<<6|v);else{var S=e[r++]&63;h=(h&240)==224?(h&15)<<12|v<<6|S:(h&7)<<18|v<<12|S<<6|e[r++]&63,65536>h?l+=String.fromCharCode(h):(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023))}}else l+=String.fromCharCode(h)}return l},ur=(e,r)=>(e>>>=0)?Oe(m(),e,r):"";function Jr(e){if(U)return z(0,1,e);me=e,ze()||(k.Nb(),be=!0),j(e,new sr(e))}var xr=e=>{if(me=e,U)throw Kr(e),"unwind";Jr(e)};function Zr(){Je.unshift(()=>{We++,Se()})}var k={qb:[],nb:[],Eb:[],jb:{},vb(){U?(k.receiveObjectTransfer=k.Lb,k.threadInitTLS=k.Db,k.setExitStatus=k.Cb,V=!1):Zr()},Cb:e=>{me=e},Vb:["$terminateWorker"],Nb:()=>{for(var e of k.nb)ye(e);for(e of k.qb)ye(e);k.qb=[],k.nb=[],k.jb=[]},Bb:e=>{var r=e.mb;delete k.jb[r],k.qb.push(e),k.nb.splice(k.nb.indexOf(e),1),e.mb=0,Bt(r)},Lb(){},Db(){k.Eb.forEach(e=>e())},Jb:e=>new Promise(r=>{e.onmessage=v=>{v=v.data;var S=v.cmd;if(v.targetThread&&v.targetThread!=ft()){var P=k.jb[v.targetThread];P?P.postMessage(v,v.transferList):ce(`Internal error! Worker sent a message "${S}" to target pthread ${v.targetThread}, but that thread no longer exists!`)}else S==="checkMailbox"?H():S==="spawnThread"?wr(v):S==="cleanupThread"?((v=k.jb[v.thread])||He(),k.Bb(v)):S==="killThread"?(v=v.thread,S=k.jb[v],delete k.jb[v],ye(S),Bt(v),k.nb.splice(k.nb.indexOf(S),1),S.mb=0):S==="cancelThread"?k.jb[v.thread].postMessage({cmd:"cancel"}):S==="loaded"?(e.loaded=!0,r(e)):S==="alert"?alert(`Thread ${v.threadId}: ${v.text}`):v.target==="setimmediate"?e.postMessage(v):S==="callHandler"?f[v.handler](...v.args):S&&ce(`worker sent an unknown command ${S}`)},e.onerror=v=>{throw ce(`worker sent an error! ${v.filename}:${v.lineno}: ${v.message}`),v},Y&&(e.on("message",v=>e.onmessage({data:v})),e.on("error",v=>e.onerror(v)));var a=[],l=[],h;for(h of l)f.hasOwnProperty(h)&&a.push(h);e.postMessage({cmd:"load",handlers:a,urlOrBlob:f.mainScriptUrlOrBlob||o,wasmMemory:Q,wasmModule:je})})};f.PThread=k;var Or=e=>{for(;0<e.length;)e.shift()(f)};f.establishStackSpace=()=>{var e=ft(),r=g()[e+52>>>2>>>0];e=g()[e+56>>>2>>>0],Ln(r,r-e),ct(r)};function Kr(e){if(U)return z(1,0,e);xr(e)}var _r=[],Qr;f.invokeEntryPoint=(e,r)=>{var a=_r[e];a||(e>=_r.length&&(_r.length=e+1),_r[e]=a=Qr.get(e)),e=a(r),ze()?k.Cb(e):Rt(e)};function It(e){this.sb=e-24,this.Kb=function(r){g()[this.sb+4>>>2>>>0]=r},this.xb=function(r){g()[this.sb+8>>>2>>>0]=r},this.vb=function(r,a){this.wb(),this.Kb(r),this.xb(a)},this.wb=function(){g()[this.sb+16>>>2>>>0]=0}}var fr=0,Ft=0;function lr(e,r,a,l){return U?z(2,1,e,r,a,l):cr(e,r,a,l)}function cr(e,r,a,l){if(e>>>=0,r>>>=0,a>>>=0,l>>>=0,typeof SharedArrayBuffer>"u")return ce("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var h=[];return U&&h.length===0?lr(e,r,a,l):(e={Mb:a,mb:e,Fb:l,Sb:h},U?(e.Ub="spawnThread",postMessage(e,h),0):wr(e))}function Br(e,r,a){return U?z(3,1,e,r,a):0}function et(e,r){if(U)return z(4,1,e,r)}var Tr=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);127>=l?r++:2047>=l?r+=2:55296<=l&&57343>=l?(r+=4,++a):r+=3}return r},Rr=(e,r,a,l)=>{if(a>>>=0,!(0<l))return 0;var h=a;l=a+l-1;for(var v=0;v<e.length;++v){var S=e.charCodeAt(v);if(55296<=S&&57343>=S){var P=e.charCodeAt(++v);S=65536+((S&1023)<<10)|P&1023}if(127>=S){if(a>=l)break;r[a++>>>0]=S}else{if(2047>=S){if(a+1>=l)break;r[a++>>>0]=192|S>>6}else{if(65535>=S){if(a+2>=l)break;r[a++>>>0]=224|S>>12}else{if(a+3>=l)break;r[a++>>>0]=240|S>>18,r[a++>>>0]=128|S>>12&63}r[a++>>>0]=128|S>>6&63}r[a++>>>0]=128|S&63}}return r[a>>>0]=0,a-h},Ar=(e,r,a)=>Rr(e,m(),r,a);function rt(e,r){if(U)return z(5,1,e,r)}function tt(e,r,a){if(U)return z(6,1,e,r,a)}function nt(e,r,a){return U?z(7,1,e,r,a):0}function kr(e,r){if(U)return z(8,1,e,r)}function Ye(e,r,a){if(U)return z(9,1,e,r,a)}function Wr(e,r,a,l){if(U)return z(10,1,e,r,a,l)}function Lr(e,r,a,l){if(U)return z(11,1,e,r,a,l)}function $r(e,r,a,l){if(U)return z(12,1,e,r,a,l)}function Er(e){if(U)return z(13,1,e)}function Hr(e,r){if(U)return z(14,1,e,r)}function Sr(e,r,a){if(U)return z(15,1,e,r,a)}var at=e=>{if(e===null)return"null";var r=typeof e;return r==="object"||r==="array"||r==="function"?e.toString():""+e},jr,Me=e=>{for(var r="";m()[e>>>0];)r+=jr[m()[e++>>>0]];return r},Nr={},Mr={},ot={},Ce;function Dt(e,r,a={}){var l=r.name;if(!e)throw new Ce(`type "${l}" must have a positive integer typeid pointer`);if(Mr.hasOwnProperty(e)){if(a.Hb)return;throw new Ce(`Cannot register type '${l}' twice`)}Mr[e]=r,delete ot[e],Nr.hasOwnProperty(e)&&(r=Nr[e],delete Nr[e],r.forEach(h=>h()))}function B(e,r,a={}){if(!("argPackAdvance"in r))throw new TypeError("registerType registeredInstance requires argPackAdvance");Dt(e,r,a)}var dr=(e,r,a)=>{switch(r){case 1:return a?l=>i()[l>>>0>>>0]:l=>m()[l>>>0>>>0];case 2:return a?l=>p()[l>>>1>>>0]:l=>O()[l>>>1>>>0];case 4:return a?l=>c()[l>>>2>>>0]:l=>g()[l>>>2>>>0];case 8:return a?l=>we[l>>>3]:l=>ke[l>>>3];default:throw new TypeError(`invalid integer width (${r}): ${e}`)}};function xe(){this.lb=[void 0],this.zb=[]}var _e=new xe;function Pr(e){e>>>=0,e>=_e.sb&&--_e.get(e).Ab===0&&_e.xb(e)}var ge=e=>{if(!e)throw new Ce("Cannot use deleted val. handle = "+e);return _e.get(e).value},Te=e=>{switch(e){case void 0:return 1;case null:return 2;case!0:return 3;case!1:return 4;default:return _e.wb({Ab:1,value:e})}};function it(e){return this.fromWireType(c()[e>>>2>>>0])}var Cr=(e,r)=>{switch(r){case 4:return function(a){var l=this.fromWireType;return Q.buffer!=ee.buffer&&te(),l.call(this,nr[a>>>2>>>0])};case 8:return function(a){return this.fromWireType(_()[a>>>3>>>0])};default:throw new TypeError(`invalid float width (${r}): ${e}`)}};function st(e){return this.fromWireType(g()[e>>>2>>>0])}var t=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,n=(e,r)=>{for(var a=e>>1,l=a+r/2;!(a>=l)&&O()[a>>>0];)++a;if(a<<=1,32<a-e&&t)return t.decode(m().slice(e,a));for(a="",l=0;!(l>=r/2);++l){var h=p()[e+2*l>>>1>>>0];if(h==0)break;a+=String.fromCharCode(h)}return a},u=(e,r,a)=>{if(a===void 0&&(a=2147483647),2>a)return 0;a-=2;var l=r;a=a<2*e.length?a/2:e.length;for(var h=0;h<a;++h){var v=e.charCodeAt(h);p()[r>>>1>>>0]=v,r+=2}return p()[r>>>1>>>0]=0,r-l},d=e=>2*e.length,y=(e,r)=>{for(var a=0,l="";!(a>=r/4);){var h=c()[e+4*a>>>2>>>0];if(h==0)break;++a,65536<=h?(h-=65536,l+=String.fromCharCode(55296|h>>10,56320|h&1023)):l+=String.fromCharCode(h)}return l},A=(e,r,a)=>{if(r>>>=0,a===void 0&&(a=2147483647),4>a)return 0;var l=r;a=l+a-4;for(var h=0;h<e.length;++h){var v=e.charCodeAt(h);if(55296<=v&&57343>=v){var S=e.charCodeAt(++h);v=65536+((v&1023)<<10)|S&1023}if(c()[r>>>2>>>0]=v,r+=4,r+4>a)break}return c()[r>>>2>>>0]=0,r-l},D=e=>{for(var r=0,a=0;a<e.length;++a){var l=e.charCodeAt(a);55296<=l&&57343>=l&&++a,r+=4}return r},C=e=>{if(!be)try{if(e(),!ze())try{U?Rt(me):xr(me)}catch(r){r instanceof sr||r=="unwind"||j(1,r)}}catch(r){r instanceof sr||r=="unwind"||j(1,r)}};function W(e){e>>>=0,typeof Atomics.Tb=="function"&&(Atomics.Tb(c(),e>>>2,e).value.then(H),e+=128,Atomics.store(c(),e>>>2,1))}f.__emscripten_thread_mailbox_await=W;var H=()=>{var e=ft();e&&(W(e),C(()=>Wn()))};f.checkMailbox=H;var ne=e=>{var r=kt();return e=e(),ct(r),e};function z(e,r){var a=arguments.length-2,l=arguments;return ne(()=>{for(var h=2*a,v=Wt(8*h),S=v>>>3,P=0;P<a;P++){var $=l[2+P];typeof $=="bigint"?(we[S+2*P]=1n,we[S+2*P+1]=$):(we[S+2*P]=0n,_()[S+2*P+1>>>0]=$)}return kn(e,h,v,r)})}var Ie=[],b=(e,r)=>{var a=Mr[e];if(a===void 0)throw e=Bn(e),a=Me(e),Ge(e),new Ce(r+" has unknown type "+a);return a},q={},re=e=>{var r=q[e];return r===void 0?Me(e):r},Be=[],zr=()=>typeof globalThis=="object"?globalThis:Function("return this")(),io=e=>{var r=Be.length;return Be.push(e),r},so=(e,r)=>{for(var a=Array(e),l=0;l<e;++l)a[l]=b(g()[r+4*l>>>2>>>0],"parameter "+l);return a},gn=e=>{if(e===void 0)return"_unknown";e=e.replace(/[^a-zA-Z0-9_]/g,"$");var r=e.charCodeAt(0);return 48<=r&&57>=r?`_${e}`:e},yn={};function uo(e,r){return e=gn(e),{[e]:function(){return r.apply(this,arguments)}}[e]}function fo(e){var r=Function;if(!(r instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof r} which is not a function`);var a=uo(r.name||"unknownFunctionName",function(){});return a.prototype=r.prototype,a=new a,e=r.apply(a,e),e instanceof Object?e:a}var lo=e=>{for(var r="",a=0;a<e;++a)r+=(a!==0?", ":"")+"arg"+a;var l="return function emval_allocator_"+e+`(constructor, argTypes, args) {
  var HEAPU32 = getMemory();
...
`))(b,f,Te,()=>g())},vn={},Ir=e=>e%4===0&&(e%100!==0||e%400===0),bn=[0,31,60,91,121,152,182,213,244,274,305,335],wn=[0,31,59,90,120,151,181,212,243,273,304,334];function On(e,r,a,l,h,v,S){return U?z(16,1,e,r,a,l,h,v,S):-52}function _n(e,r,a,l,h,v){if(U)return z(17,1,e,r,a,l,h,v)}var Tn=e=>{var r=Tr(e)+1,a=lt(r);return a&&Ar(e,a,r),a},Ut={},An=()=>{if(!xt){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:F||"./this.program"},r;for(r in Ut)Ut[r]===void 0?delete e[r]:e[r]=Ut[r];var a=[];for(r in e)a.push(`${r}=${e[r]}`);xt=a}return xt},xt;function En(e,r){if(U)return z(18,1,e,r);e>>>=0,r>>>=0;var a=0;return An().forEach((l,h)=>{var v=r+a;for(h=g()[e+4*h>>>2>>>0]=v,v=0;v<l.length;++v)i()[h++>>>0>>>0]=l.charCodeAt(v);i()[h>>>0>>>0]=0,a+=l.length+1}),0}function Sn(e,r){if(U)return z(19,1,e,r);e>>>=0,r>>>=0;var a=An();g()[e>>>2>>>0]=a.length;var l=0;return a.forEach(h=>l+=h.length+1),g()[r>>>2>>>0]=l,0}function Mn(e){return U?z(20,1,e):52}function Pn(e,r,a,l){return U?z(21,1,e,r,a,l):52}function Cn(e,r,a,l){return U?z(22,1,e,r,a,l):70}var co=[null,[],[]];function In(e,r,a,l){if(U)return z(23,1,e,r,a,l);r>>>=0,a>>>=0,l>>>=0;for(var h=0,v=0;v<a;v++){var S=g()[r>>>2>>>0],P=g()[r+4>>>2>>>0];r+=8;for(var $=0;$<P;$++){var N=m()[S+$>>>0],oe=co[e];N===0||N===10?((e===1?rr:ce)(Oe(oe,0)),oe.length=0):oe.push(N)}h+=P}return g()[l>>>2>>>0]=h,0}var Fn=[31,29,31,30,31,30,31,31,30,31,30,31],Dn=[31,28,31,30,31,30,31,31,30,31,30,31];function po(e){var r=Array(Tr(e)+1);return Rr(e,r,0,r.length),r}var mo=(e,r)=>{i().set(e,r>>>0)};function Un(e,r,a,l){function h(w,X,ie){for(w=typeof w=="number"?w.toString():w||"";w.length<X;)w=ie[0]+w;return w}function v(w,X){return h(w,X,"0")}function S(w,X){function ie(Hn){return 0>Hn?-1:0<Hn?1:0}var pr;return(pr=ie(w.getFullYear()-X.getFullYear()))===0&&(pr=ie(w.getMonth()-X.getMonth()))===0&&(pr=ie(w.getDate()-X.getDate())),pr}function P(w){switch(w.getDay()){case 0:return new Date(w.getFullYear()-1,11,29);case 1:return w;case 2:return new Date(w.getFullYear(),0,3);case 3:return new Date(w.getFullYear(),0,2);case 4:return new Date(w.getFullYear(),0,1);case 5:return new Date(w.getFullYear()-1,11,31);case 6:return new Date(w.getFullYear()-1,11,30)}}function $(w){var X=w.ob;for(w=new Date(new Date(w.pb+1900,0,1).getTime());0<X;){var ie=w.getMonth(),pr=(Ir(w.getFullYear())?Fn:Dn)[ie];if(X>pr-w.getDate())X-=pr-w.getDate()+1,w.setDate(1),11>ie?w.setMonth(ie+1):(w.setMonth(0),w.setFullYear(w.getFullYear()+1));else{w.setDate(w.getDate()+X);break}}return ie=new Date(w.getFullYear()+1,0,4),X=P(new Date(w.getFullYear(),0,4)),ie=P(ie),0>=S(X,w)?0>=S(ie,w)?w.getFullYear()+1:w.getFullYear():w.getFullYear()-1}e>>>=0,r>>>=0,a>>>=0,l>>>=0;var N=g()[l+40>>>2>>>0];l={Qb:c()[l>>>2>>>0],Pb:c()[l+4>>>2>>>0],tb:c()[l+8>>>2>>>0],yb:c()[l+12>>>2>>>0],ub:c()[l+16>>>2>>>0],pb:c()[l+20>>>2>>>0],kb:c()[l+24>>>2>>>0],ob:c()[l+28>>>2>>>0],Wb:c()[l+32>>>2>>>0],Ob:c()[l+36>>>2>>>0],Rb:N?ur(N):""},a=ur(a),N={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var oe in N)a=a.replace(new RegExp(oe,"g"),N[oe]);var Fe="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ve="January February March April May June July August September October November December".split(" ");N={"%a":w=>Fe[w.kb].substring(0,3),"%A":w=>Fe[w.kb],"%b":w=>Ve[w.ub].substring(0,3),"%B":w=>Ve[w.ub],"%C":w=>v((w.pb+1900)/100|0,2),"%d":w=>v(w.yb,2),"%e":w=>h(w.yb,2," "),"%g":w=>$(w).toString().substring(2),"%G":w=>$(w),"%H":w=>v(w.tb,2),"%I":w=>(w=w.tb,w==0?w=12:12<w&&(w-=12),v(w,2)),"%j":w=>{for(var X=0,ie=0;ie<=w.ub-1;X+=(Ir(w.pb+1900)?Fn:Dn)[ie++]);return v(w.yb+X,3)},"%m":w=>v(w.ub+1,2),"%M":w=>v(w.Pb,2),"%n":()=>`
`,"%p":w=>0<=w.tb&&12>w.tb?"AM":"PM","%S":w=>v(w.Qb,2),"%t":()=>"	","%u":w=>w.kb||7,"%U":w=>v(Math.floor((w.ob+7-w.kb)/7),2),"%V":w=>{var X=Math.floor((w.ob+7-(w.kb+6)%7)/7);if(2>=(w.kb+371-w.ob-2)%7&&X++,X)X==53&&(ie=(w.kb+371-w.ob)%7,ie==4||ie==3&&Ir(w.pb)||(X=1));else{X=52;var ie=(w.kb+7-w.ob-1)%7;(ie==4||ie==5&&Ir(w.pb%400-1))&&X++}return v(X,2)},"%w":w=>w.kb,"%W":w=>v(Math.floor((w.ob+7-(w.kb+6)%7)/7),2),"%y":w=>(w.pb+1900).toString().substring(2),"%Y":w=>w.pb+1900,"%z":w=>{w=w.Ob;var X=0<=w;return w=Math.abs(w)/60,(X?"+":"-")+("0000"+(w/60*100+w%60)).slice(-4)},"%Z":w=>w.Rb,"%%":()=>"%"},a=a.replace(/%%/g,"\0\0");for(oe in N)a.includes(oe)&&(a=a.replace(new RegExp(oe,"g"),N[oe](l)));return a=a.replace(/\0\0/g,"%"),oe=po(a),oe.length>r?0:(mo(oe,e),oe.length-1)}k.vb();for(var xn=Array(256),ut=0;256>ut;++ut)xn[ut]=String.fromCharCode(ut);jr=xn,Ce=f.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},f.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(xe.prototype,{get(e){return this.lb[e]},has(e){return this.lb[e]!==void 0},wb(e){var r=this.zb.pop()||this.lb.length;return this.lb[r]=e,r},xb(e){this.lb[e]=void 0,this.zb.push(e)}}),_e.lb.push({value:void 0},{value:null},{value:!0},{value:!1}),_e.sb=_e.lb.length,f.count_emval_handles=()=>{for(var e=0,r=_e.sb;r<_e.lb.length;++r)_e.lb[r]!==void 0&&++e;return e};var ho=[Jr,Kr,lr,Br,et,rt,tt,nt,kr,Ye,Wr,Lr,$r,Er,Hr,Sr,On,_n,En,Sn,Mn,Pn,Cn,In],go={b:function(e,r,a){throw e>>>=0,new It(e).vb(r>>>0,a>>>0),fr=e,Ft++,fr},ea:function(e){Rn(e>>>0,!L,1,!x,131072,!1),k.Db()},D:function(e){e>>>=0,U?postMessage({cmd:"cleanupThread",thread:e}):((e=k.jb[e])||He(),k.Bb(e))},W:cr,y:Br,ka:et,S:rt,U:tt,L:nt,ia:kr,ba:Ye,ha:Wr,F:Lr,T:$r,Q:Er,ja:Hr,R:Sr,I:function(e,r,a,l,h){e>>>=0,r>>>=0,a>>>=0,r=Me(r);var v=r.indexOf("u")!=-1;v&&(h=(1n<<64n)-1n),B(e,{name:r,fromWireType:S=>S,toWireType:function(S,P){if(typeof P!="bigint"&&typeof P!="number")throw new TypeError(`Cannot convert "${at(P)}" to ${this.name}`);if(P<l||P>h)throw new TypeError(`Passing a number "${at(P)}" from JS side to C/C++ side to an argument of type "${r}", which is outside the valid range [${l}, ${h}]!`);return P},argPackAdvance:8,readValueFromPointer:dr(r,a,!v),rb:null})},qa:function(e,r,a,l){e>>>=0,r=Me(r>>>0),B(e,{name:r,fromWireType:function(h){return!!h},toWireType:function(h,v){return v?a:l},argPackAdvance:8,readValueFromPointer:function(h){return this.fromWireType(m()[h>>>0])},rb:null})},pa:function(e,r){e>>>=0,r=Me(r>>>0),B(e,{name:r,fromWireType:a=>{var l=ge(a);return Pr(a),l},toWireType:(a,l)=>Te(l),argPackAdvance:8,readValueFromPointer:it,rb:null})},H:function(e,r,a){e>>>=0,a>>>=0,r=Me(r>>>0),B(e,{name:r,fromWireType:l=>l,toWireType:(l,h)=>h,argPackAdvance:8,readValueFromPointer:Cr(r,a),rb:null})},t:function(e,r,a,l,h){if(e>>>=0,a>>>=0,r=Me(r>>>0),h===-1&&(h=4294967295),h=P=>P,l===0){var v=32-8*a;h=P=>P<<v>>>v}var S=r.includes("unsigned")?function(P,$){return $>>>0}:function(P,$){return $};B(e,{name:r,fromWireType:h,toWireType:S,argPackAdvance:8,readValueFromPointer:dr(r,a,l!==0),rb:null})},m:function(e,r,a){function l(v){var S=g()[v>>>2>>>0];return v=g()[v+4>>>2>>>0],new h(i().buffer,v,S)}e>>>=0;var h=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][r];a=Me(a>>>0),B(e,{name:a,fromWireType:l,argPackAdvance:8,readValueFromPointer:l},{Hb:!0})},J:function(e,r){e>>>=0,r=Me(r>>>0);var a=r==="std::string";B(e,{name:r,fromWireType:function(l){var h=g()[l>>>2>>>0],v=l+4;if(a)for(var S=v,P=0;P<=h;++P){var $=v+P;if(P==h||m()[$>>>0]==0){if(S=ur(S,$-S),N===void 0)var N=S;else N+=String.fromCharCode(0),N+=S;S=$+1}}else{for(N=Array(h),P=0;P<h;++P)N[P]=String.fromCharCode(m()[v+P>>>0]);N=N.join("")}return Ge(l),N},toWireType:function(l,h){h instanceof ArrayBuffer&&(h=new Uint8Array(h));var v=typeof h=="string";if(!(v||h instanceof Uint8Array||h instanceof Uint8ClampedArray||h instanceof Int8Array))throw new Ce("Cannot pass non-string to std::string");var S=a&&v?Tr(h):h.length,P=lt(4+S+1),$=P+4;if(g()[P>>>2>>>0]=S,a&&v)Ar(h,$,S+1);else if(v)for(v=0;v<S;++v){var N=h.charCodeAt(v);if(255<N)throw Ge($),new Ce("String has UTF-16 code units that do not fit in 8 bits");m()[$+v>>>0]=N}else for(v=0;v<S;++v)m()[$+v>>>0]=h[v];return l!==null&&l.push(Ge,P),P},argPackAdvance:8,readValueFromPointer:st,rb(l){Ge(l)}})},A:function(e,r,a){if(e>>>=0,r>>>=0,a>>>=0,a=Me(a),r===2)var l=n,h=u,v=d,S=()=>O(),P=1;else r===4&&(l=y,h=A,v=D,S=()=>g(),P=2);B(e,{name:a,fromWireType:$=>{for(var N=g()[$>>>2>>>0],oe=S(),Fe,Ve=$+4,w=0;w<=N;++w){var X=$+4+w*r;(w==N||oe[X>>>P]==0)&&(Ve=l(Ve,X-Ve),Fe===void 0?Fe=Ve:(Fe+=String.fromCharCode(0),Fe+=Ve),Ve=X+r)}return Ge($),Fe},toWireType:($,N)=>{if(typeof N!="string")throw new Ce(`Cannot pass non-string to C++ string type ${a}`);var oe=v(N),Fe=lt(4+oe+r);return g()[Fe>>>2]=oe>>P,h(N,Fe+4,oe+r),$!==null&&$.push(Ge,Fe),Fe},argPackAdvance:8,readValueFromPointer:it,rb($){Ge($)}})},ra:function(e,r){e>>>=0,r=Me(r>>>0),B(e,{Ib:!0,name:r,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>!0,O:function(e,r){e>>>=0,e==r>>>0?setTimeout(()=>H()):U?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=k.jb[e])&&e.postMessage({cmd:"checkMailbox"})},X:function(e,r,a,l){r>>>=0,a/=2,Ie.length=a,l=l>>>0>>>3;for(var h=0;h<a;h++)Ie[h]=we[l+2*h]?we[l+2*h+1]:_()[l+2*h+1>>>0];return e=ho[e],k.Gb=r,r=e.apply(null,Ie),k.Gb=0,r},da:W,ma:function(e){Y&&k.jb[e>>>0].ref()},r:function(e,r,a){r>>>=0,a>>>=0,e=ge(e>>>0),r=b(r,"emval::as");var l=[],h=Te(l);return g()[a>>>2>>>0]=h,r.toWireType(l,e)},i:function(e,r,a,l,h){a>>>=0,l>>>=0,h>>>=0,e=Be[e>>>0],r=ge(r>>>0),a=re(a);var v=[];return g()[l>>>2>>>0]=Te(v),e(r,a,v,h)},u:function(e,r,a,l){a>>>=0,l>>>=0,e=Be[e>>>0],r=ge(r>>>0),a=re(a),e(r,a,null,l)},c:Pr,K:function(e,r){return r>>>=0,e=ge(e>>>0),r=ge(r),e==r},o:function(e){return e>>>=0,e===0?Te(zr()):(e=re(e),Te(zr()[e]))},h:function(e,r){var a=so(e,r>>>0),l=a[0];r=l.name+"_$"+a.slice(1).map(function(oe){return oe.name}).join("_")+"$";var h=yn[r];if(h!==void 0)return h;h=["retType"];for(var v=[l],S="",P=0;P<e-1;++P)S+=(P!==0?", ":"")+"arg"+P,h.push("argType"+P),v.push(a[1+P]);var $="return function "+gn("methodCaller_"+r)+`(handle, name, destructors, args) {
