...
`)}},Ki=e=>new aa(e),er=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let o=r-1-n,u=e[o]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(o)}return a},ke=e=>!0});var dd,Yi,cd,pd,dt,Zi,Xi,tr=j(()=>{"use strict";_e();Ve();we();dd=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Yi=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,cd=(e,t)=>U.sortBasedOnPerm(e,Yi(e.length,t)),pd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let o=0;o<t;++o)n.push(r.indicesSet("a",e[o],`i[${o}]`));return n.push("return a;}"),n.join(`
`)},dt=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Yi(a,t),o=ke(a),u=cd(e.dims,n),l=o?u.length:u,i=o?a:e.dims,c=K("output",r,l),m=z("a",r,i),f=h=>`
  ...
  ${h.mainStart()}
    ...
    ${c.setByOffset("global_idx",m.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:_=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:i},programUniforms:[{type:"uint32",data:c}]})}},gt=(e,t,r,a)=>{let n=e.inputs.length===1?r:sa(e.inputs,r),o=n.axes;o.length===0&&!n.noopWithEmptyAxes&&(o=e.inputs[0].dims.map((w,b)=>b));let u=U.normalizeAxes(o,e.inputs[0].dims.length),l=u,i=e.inputs[0],c=$d(l,e.inputs[0].dims.length);c.length>0&&(i=e.compute(dt(e.inputs[0],c),{inputs:[0],outputs:[-1]})[0],l=yd(l.length,i.dims.length));let[m,f]=bd(i.dims,l),h=m;n.keepDims&&(h=wd(m,u)),e.compute(_d(t,{hint:n.cacheKey,inputDependencies:["type"]},[i],a,e.inputs[0].dataType,h,f),{inputs:[i]})},Qi=(e,t)=>{gt(e,"ReduceMeanShared",t,"mean")},Ji=(e,t)=>{gt(e,"ReduceL1Shared",t,"l1")},eo=(e,t)=>{gt(e,"ReduceL2Shared",t,"l2")},to=(e,t)=>{gt(e,"ReduceLogSumExpShared",t,"logSumExp")},ro=(e,t)=>{gt(e,"ReduceMaxShared",t,"max")},no=(e,t)=>{gt(e,"ReduceMinShared",t,"min")},ao=(e,t)=>{gt(e,"ReduceProdShared",t,"prod")},io=(e,t)=>{gt(e,"ReduceSumShared",t,"sum")},oo=(e,t)=>{gt(e,"ReduceSumSquareShared",t,"sumSquare")},so=(e,t)=>{gt(e,"ReduceLogSumShared",t,"logSum")}});var yt,xd,fn,sa,bt,Sd,Id,Cd,Ed,Ad,Td,Od,kd,Rd,Pd,wt,lo,co,po,mo,fo,ho,go,yo,bo,wo,mn=j(()=>{"use strict";_e();Ve();we();uo();yt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},xd=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],fn=(e,t,r,a,n,o,u=!1,l=!1)=>{let i=[],c=r[0].dims,m=c.length,f=U.normalizeAxes(n,m),h=!l&&f.length===0;c.forEach((I,$)=>{h||f.indexOf($)>=0?u&&i.push(1):i.push(I)});let w=i.length,b=U.size(i);return{name:e,shaderCache:t,getShaderSource:I=>{let $=[],S=z("_A",r[0].dataType,m),T=K("output",o,w),E=a(S,T,f),M=E[2];for(let A=0,N=0;A<m;A++)h||f.indexOf(A)>=0?(u&&N++,M=`for(var j${A}: u32 = 0; j${A} < ${c[A]}; j${A}++) {
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${u}`,inputDependencies:c?["rank","type","type","type","type"]:void 0},getShaderSource:S,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c?[{type:"uint32",data:i},...q(o)]:[{type:"uint32",data:i}]})}},Vd=e=>ge(e),Io=(e,t)=>{let{inputs:r,outputCount:a}=e,n=Vd({...t,outputCount:a});if(Ae.webgpu.validateInputContent&&Wd(r,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Nd(r,n))}});var Hd,Ld,Eo,Ao=j(()=>{"use strict";_e();we();Hd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ld=e=>{let t=e[0].dims,r=e[0].dims[2],a=U.size(t)/4,n=e[0].dataType,o=z("input",n,t,4),u=z("bias",n,[r],4),l=z("residual",n,t,4),i=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:m=>`
  ...
  ${m.mainStart()}
    ...
    ${i.setByOffset("global_idx","value")}
  }`}},Eo=e=>{Hd(e.inputs),e.compute(Ld(e.inputs))}});var Gd,Te,To,Oo,ko,Ro,Po,Bo,Do,Mo,zo,Fd,Uo,Wo,No,Vo,gn,Ho,yn,Lo,Go,Fo,qo,jo,Ko,Yo,Zo,Xo,Qo,Jo,es,ts,rs,ns,as,is,da=j(()=>{"use strict";Be();_e();Ve();we();Gd=(e,t,r,a,n,o)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let i=z("inputData",r,[u],4),c=K("outputData",a,[u],4);return`
  ...
  }`},Te=(e,t,r,a,n,o=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Gd(u,U.size(e.dims),e.dataType,o,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:o}],dispatchGroup:{x:Math.ceil(U.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(U.size(e.dims)/4)}]})}),To=e=>{e.compute(Te(e.inputs[0],"Abs","abs"))},Oo=e=>{e.compute(Te(e.inputs[0],"Acos","acos"))},ko=e=>{e.compute(Te(e.inputs[0],"Acosh","acosh"))},Ro=e=>{e.compute(Te(e.inputs[0],"Asin","asin"))},Po=e=>{e.compute(Te(e.inputs[0],"Asinh","asinh"))},Bo=e=>{e.compute(Te(e.inputs[0],"Atan","atan"))},Do=e=>{e.compute(Te(e.inputs[0],"Atanh","atanh"))},Mo=e=>ge(e),zo=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Te(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Fd=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:dn,r=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:cn;return ge({min:t,max:r})},Uo=(e,t)=>{let r=e.inputs.length===1?t:Fd(e.inputs),a=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"Clip",n=>`clamp(${n}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${a}> = vec4(${a}(${r.min}));
    const clip_max_: vec4<${a}> = vec4(${a}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Wo=e=>{e.compute(Te(e.inputs[0],"Ceil","ceil"))},No=e=>{e.compute(Te(e.inputs[0],"Cos","cos"))},Vo=e=>{e.compute(Te(e.inputs[0],"Cosh","cosh"))},gn=e=>ge(e),Ho=(e,t)=>{let r=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"Elu",a=>`elu_vf32(${a})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Lo=e=>{let t=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,yn(`vec4<${t}>`,t)))},Go=e=>{e.compute(Te(e.inputs[0],"Exp","exp"))},Fo=e=>{e.compute(Te(e.inputs[0],"Floor","floor"))},qo=e=>{let t=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,yn(`vec4<${t}>`,t)))},jo=(e,t)=>{let r=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"LeakyRelu",a=>`select(leaky_relu_alpha_ * ${a}, ${a}, ${a} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Ko=e=>{e.compute(Te(e.inputs[0],"Not",t=>`!${t}`))},Yo=e=>{e.compute(Te(e.inputs[0],"Neg",t=>`-${t}`))},Zo=e=>{e.compute(Te(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Xo=e=>{let t=ht(e.inputs[0].dataType);e.compute(Te(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Qo=e=>{e.compute(Te(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Jo=e=>{e.compute(Te(e.inputs[0],"Sin","sin"))},es=e=>{e.compute(Te(e.inputs[0],"Sinh","sinh"))},ts=e=>{e.compute(Te(e.inputs[0],"Sqrt","sqrt"))},rs=e=>{e.compute(Te(e.inputs[0],"Tan","tan"))},ns=e=>{e.compute(Te(e.inputs[0],"Tanh","tanh"))},as=(e,t)=>{let r=ht(e.inputs[0].dataType);return e.compute(Te(e.inputs[0],"ThresholdedRelu",a=>`select(vec4<${r}>(0.0), ${a}, ${a} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},is=e=>{e.compute(Te(e.inputs[0],"Log","log"))}});var jd,Kd,os,ss=j(()=>{"use strict";_e();we();da();jd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Kd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=z("input",e[0].dataType,e[0].dims,4),a=z("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),o=U.size(t)/4,u=Ne(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:i=>`
  ...
  ${i.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${M}
      }`},Zd=(e,t,r,a,n,o,u=r.dataType)=>{let l=!U.areEqual(r.dims,a.dims),i=r.dims,c=U.size(r.dims),m=!1,f=!1,h=[l];if(l){let b=ft.calcShape(r.dims,a.dims,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");i=b,c=U.size(i);let _=U.size(r.dims)===1,I=U.size(a.dims)===1,$=r.dims.length>0&&r.dims[r.dims.length-1]%4===0,S=a.dims.length>0&&a.dims[a.dims.length-1]%4===0;h.push(_),h.push(I),h.push($),h.push(S);let T=1;for(let E=1;E<i.length;E++){let M=r.dims[r.dims.length-E]??1,A=a.dims[a.dims.length-E]??1;if(M===A)T*=M;else break}T%4===0?(f=!0,m=!0):(_||I||$||S)&&(m=!0)}else m=!0;h.push(m);let w=ke(r.dims.length)&&ke(a.dims.length)&&ke(i.length);return{name:e,shaderCache:{hint:t+h.map(b=>b.toString()).join("_"),inputDependencies:w?["rank","rank"]:["dims","dims"]},getShaderSource:b=>Yd(b,r.dims,a.dims,i,m,l,f,n,r.dataType,a.dataType,u,w,o),getRunData:()=>({outputs:[{dims:i,dataType:u}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:w?[{type:"uint32",data:Math.ceil(U.size(i)/4)},...q(r.dims),...q(a.dims),...q(i)]:[{type:"uint32",data:Math.ceil(U.size(i)/4)}]})}},vt=(e,t,r,a,n,o)=>{e.compute(Zd(t,n??"",e.inputs[0],e.inputs[1],r,a,o))},us=e=>{vt(e,"Add",(t,r)=>`${t}+${r}`)},ls=e=>{vt(e,"Div",(t,r)=>`${t}/${r}`)},ds=e=>{vt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},cs=e=>{vt(e,"Mul",(t,r)=>`${t}*${r}`)},ps=e=>{let t=z("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;vt(e,"Pow",{scalar:(a,n)=>`pow_custom(${a},${n})`,vector:(a,n)=>`pow_vector_custom(${a},${n})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ms=e=>{vt(e,"Sub",(t,r)=>`${t}-${r}`)},fs=e=>{vt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},hs=e=>{vt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},gs=e=>{vt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},ys=e=>{vt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Qd,Jd,ec,tc,ws,vs,$s=j(()=>{"use strict";_e();Ve();we();Qd=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},Jd=(e,t)=>`
...
`});var rc,nc,Ir,_s,ac,Cr,ic,_n,Er=j(()=>{"use strict";_e();we();Ot();vn();rc=(e,t)=>e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${M}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${Y}>`:Y}) {
        ...
        ${oc(i,W,L,J,u,t,B[0],B[1],B[2],Y)}
            ${b?Ir(S,$,Y,void 0,!i,N):Cr(S,$,Y,void 0,!i,N,!1,void 0,l)}`}}});var pa,Is=j(()=>{"use strict";_e();we();fa();Ot();pa=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l=u[0]/t.group,i=t.format==="NHWC",c=ma(o,u,t.dilations,t.pads,t.strides,i),m=U.size(c),f=K("output",e[0].dataType,c),{activationFunction:h,applyActivation:w}=$t(t,f.type.value),b=z("x",e[0].dataType,o),_=z("w",e[1].dataType,u),I=[b,_];a&&I.push(z("b",e[2].dataType,e[2].dims));let $=S=>`
...
`}return fe};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activationCacheKey}_${m}_${f}_${h}_${n}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:S}),getShaderSource:T}},sc=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Cs=e=>{sc(e.inputs);let t=ft.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],a=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&a<8?e.compute(ha(e.inputs,{activation:"",activationCacheKey:""},t)):e.compute(_n(e.inputs,{activation:"",activationCacheKey:""},t))}});var ma,Es,uc,As,ya,lc,dc,ba,fa=j(()=>{"use strict";_e();Ve();Ss();Er();Is();Ot();ga();tr();ma=(e,t,r,a,n,o)=>{let u=e[0],l=e.slice(o?1:2,o?3:4),i=l.length,c=t[0],f=t.slice(2).map((b,_)=>b+(b-1)*(r[_]-1)),w=l.map((b,_)=>b+a[_]+a[_+i]).map((b,_)=>Math.floor((b-f[_]+n[_])/n[_]));return w.splice(0,0,u),w.splice(o?3:1,0,c),w},Es=[2,3,1,0],uc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},As=(e,t)=>{let r=e.kernelShape.slice();for(let o=2;o<t[1].dims.length;++o)r[o-2]===0&&(r[o-2]=t[1].dims[o]);let a=e.pads.slice();Ht.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},ya=e=>{let t=bn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,o=e.group,u=e.kernel_shape,l=e.pads,i=e.strides,c=e.w_is_const();return ge({autoPad:a,format:r,dilations:n,group:o,kernelShape:u,pads:l,strides:i,wIsConst:c,...t})},lc=(e,t,r)=>{let a=As(r,t);if(r.group!==1){e.compute(pa(t,a));return}let n=r.format==="NHWC",o=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],i=t[0].dims[n?3:1],c=t[1].dims[2],m=t[1].dims[3],f=ma(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),h=f[n?1:2],w=f[n?2:3],b=f[n?3:1],_=n&&c===u&&m===l&&r.pads[0]===0&&r.pads[1]===0;if(_||c===1&&m===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let A=f[0],N,W,L,J=[];if(n){let pe=e.kernelCustomData.wT??e.compute(dt(t[1],Es),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=pe),_){let ee=u*l*i;N=t[0].reshape([1,A,ee]),W=pe.reshape([1,ee,b]),L=[1,A,b]}else N=t[0].reshape([A,u*l,i]),W=pe.reshape([1,i,b]),L=[A,h*w,b];J.push(N),J.push(W)}else N=t[0].reshape([A,i,u*l]),W=t[1].reshape([1,b,i]),L=[A,b,h*w],J.push(W),J.push(N);o&&J.push(t[2]);let B=L[2],Y=J[0].dims[J[0].dims.length-1];B<8&&Y<8?e.compute(ha(J,a,f,L,n),{inputs:J}):e.compute(_n(J,a,f,L,n),{inputs:J});return}let I=!0,$=e.kernelCustomData.wT??e.compute(dt(t[1],Es),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=$);let S=[t[0],$];o&&S.push(t[2]);let T=n?h*w:b,E=n?b:h*w,M=c*m*i;e.compute(xs(S,a,f,T,E,M,o,I),{inputs:S})},dc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],o=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),i=As({...t,pads:n,strides:o,dilations:u,kernelShape:l},a);e.compute(pa(a,i,c=>r?[c[0],c[2],c[3]]:[]))},ba=(e,t)=>{uc(e.inputs,t),e.inputs[0].dims.length===3?dc(e,t):lc(e,e.inputs,t)}});var cc,Ts,Os=j(()=>{"use strict";Tt();we();Ot();vn();ca();Er();cc=(e,t=!1,r,a=4)=>{let n=Fe(a,"f32"),o=S=>{switch(S){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dimAOuter && col < uniforms.dimBOuter) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${a}] = value;
        ...
        ${Y}
        ${cc(i,u,t,E)}
        ${b?Ir(S,$,"f32",void 0,!i,M):Cr(S,$,"f32",void 0,!i,M,!1,void 0,l)}`}}});var pc,wa,ks=j(()=>{"use strict";Tt();_e();we();pc=(e,t,r,a,n,o,u=!1,l)=>{let i=r.format==="NHWC",c=i?1:2,m=i?2:3,f=i?3:1,h=U.size(a),w=u?2:1,b=r.group,_=t[1].dims,I=_[0]/b,$=_[1],S=`
  ...
  ${u?W:L}}`},wa=(e,t,r)=>{let a=e.length>2,n=t.outputShape,o=U.size(n),u=[Math.ceil(o/64),1,1];Re("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${u}`);let l=Ne(e[0].dataType);return{name:"ConvTranspose2D",shaderCache:{hint:t.cacheKey},getRunData:()=>({dispatchGroup:{x:u[0],y:u[1],z:u[2]},outputs:[{dims:r?r(n):n,dataType:e[0].dataType}]}),getShaderSource:i=>pc(i,e,t,n,a,u[1]===1&&u[2]===1,!1,l)}}});var mc,fc,hc,Rs,Ps,gc,yc,bc,wc,Bs,Ds=j(()=>{"use strict";Ve();Os();ks();Ot();tr();mc=(e,t,r,a,n,o)=>(e-1)*t+r+(a-1)*n+1-o,fc=(e,t,r,a,n)=>{let o=Math.floor(e/2);t==="SAME_UPPER"?(r[a]=o,r[n]=e-o):t==="SAME_LOWER"&&(r[a]=e-o,r[n]=o)},hc=(e,t,r,a,n,o,u,l,i,c)=>{let m=e.length-2,f=c.length===0;if(i.length===0)for(let b=0;b<m;++b)i.push(0);let h=e[0],w=t[l?3:1]*n;for(let b=0,_=e.length-m-(l?1:0);b<m;++b,++_){let I=e[_],$=f?I*u[b]:c[b],S=mc(I,u[b],o[b],t[_],r[b],$);fc(S,a,o,b,b+m),f&&c.push(u[b]*(I-1)+i[b]+(t[_]-1)*r[b]+1-o[b]-o[b+m])}c.splice(0,0,h),c.splice(l?3:1,0,w)},Rs=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((h,w)=>h*w,1)===0){r.length=0;for(let h=2;h<t[1].dims.length;++h)r.push(t[1].dims[h])}let a=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(a?3:1,0,t[1].dims[1]);let n=e.pads.slice(),o=e.outputShape.slice(),u=e.outputPadding.slice(),l=t[0].dims,i=e.dilations.slice();if(i.reduce((h,w)=>h+w,0)===0){let h=t[0].dims.length-2;i=new Array(h).fill(1)}let c=e.strides.slice();if(c.reduce((h,w)=>h+w,0)===0){let h=t[0].dims.length-2;c=new Array(h).fill(1)}hc(l,r,i,e.autoPad,e.group,n,c,a,u,o);let m=Object.assign({},e),f=e.cacheKey+[r.join("n,"),n.join(","),c.join(","),u.join(","),o.join(","),i.join(",")].join("_");return Object.assign(m,{kernelShape:r,pads:n,outputPadding:u,outputShape:o,dilations:i,strides:c,cacheKey:f}),m},Ps=e=>{let t=bn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,o=e.group,u=e.kernelShape,l=e.pads,i=e.strides,c=e.wIsConst(),m=e.outputPadding,f=e.outputShape;return ge({autoPad:a,format:r,dilations:n,group:o,kernelShape:u,outputPadding:m,outputShape:f,pads:l,strides:i,wIsConst:c,...t})},gc=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[0];if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.reduce((m,f)=>m+f,0)>0&&t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.reduce((m,f)=>m+f,0)>0&&t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.reduce((m,f)=>m+f,0)>0&&t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.outputPadding.length!==o&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${o}D`);if(t.kernelShape.reduce((m,f)=>m+f,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},yc=[2,3,1,0],bc=(e,t,r)=>{let a=Rs(r,t),n=r.format==="NHWC",o=a.outputShape,u=o[n?3:1],l=t[0].dims[n?3:1];if(a.group!==1||u===1&&l===1){e.compute(wa(t,a));return}let i=o[n?1:2],c=o[n?2:3],m=t[1].dims[2],f=t[1].dims[3],h=n?i*c:u,w=n?u:i*c,b=m*f*l,_=!0,I=e.kernelCustomData.wT??e.compute(dt(t[1],yc),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let $=[t[0],I],S=t.length===3;S&&(!n&&t[2].dims.length===1?$.push(t[2].reshape([t[2].dims[0],1,1])):$.push(t[2])),e.compute(Ts($,a,o,h,w,b,S,_),{inputs:$})},wc=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];a.length===3&&a.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let o=t.dilations;(o.length===0||o[0]===0)&&(o=[1]);let u=t.strides;(u.length===0||u[0]===0)&&(u=[1]);let l=t.pads;l.length===0&&(l=[0,0]),l=[0,l[0],0,l[1]],u=[1].concat(u),o=[1].concat(o),n=[1].concat(n);let i=Rs({...t,pads:l,strides:u,dilations:o,kernelShape:n},a);e.compute(wa(a,i,c=>r?[c[0],c[2],c[3]]:[c[0],c[1],c[3]]))},Bs=(e,t)=>{gc(e.inputs,t),e.inputs[0].dims.length===3?wc(e,t):bc(e,e.inputs,t)}});var vc,Ms,zs,Us=j(()=>{"use strict";Be();_e();Ve();we();vc=(e,t,r,a)=>{let n=U.size(t),o=t.length,u=z("input",e,o),l=K("output",e,o),i=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),c=U.normalizeAxis(i,o),m=f=>{let h=` i32(${u.indicesGet("inputIndices","uniforms.axis")}) `,w=de("uniforms.input_shape","uniforms.axis",o),b=a.reverse?h+(a.exclusive?" + 1":""):"0",_=a.reverse?w:h+(a.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:a.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:"uint32",data:n},{type:"int32",data:c},...q(t),...q(t)]}),getShaderSource:m}},Ms=(e,t)=>{let r=e.inputs[0].dims,a=e.inputs[0].dataType,n=e.inputs[1];e.compute(vc(a,r,n,t),{inputs:[0]})},zs=e=>{let t=e.exclusive===1,r=e.reverse===1;return ge({exclusive:t,reverse:r})}});var va,xn,Ws,$c,_c,$a,_a,Ns,xc,Vs,Hs,Ls=j(()=>{"use strict";_e();Ve();we();va="[a-zA-Z]|\\.\\.\\.",xn="("+va+")+",Ws="^"+xn+"$",$c="("+xn+",)*"+xn,_c="^"+$c+"$",$a=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let a=this.symbolToIndices.get(t);a===void 0?a=[r]:a.push(r),this.symbolToIndices.set(t,a)}},_a=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[a,n]=r.includes("->")?r.split("->",2):[r,""];if(!a.match(RegExp(_c)))throw new Error("Invalid LHS term");if(a.split(",").forEach((l,i)=>{let c=t[i].dims.slice();if(!l.match(RegExp(Ws)))throw new Error("Invalid LHS term");let m=this.processTerm(l,!0,c,i);this.lhs.push(m)}),n==="")n+=[...this.symbolToInfo.entries()].filter(([l,i])=>i.count===1||l==="...").map(([l])=>l).join("");else if(!n.match(RegExp(xn)))throw new Error("Invalid RHS");n.match(RegExp(va,"g"))?.forEach(l=>{if(l==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let i=this.symbolToInfo.get(l);if(i===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(i.dimValue)}}),this.rhs=this.processTerm(n,!1,this.outputDims)}addSymbol(t,r,a){let n=this.symbolToInfo.get(t);if(n!==void 0){if(n.dimValue!==r&&n.count!==1)throw new Error("Dimension mismatch");n.count++,n.inputIndices.push(a)}else n={count:1,dimValue:r,inputIndices:[a]};this.symbolToInfo.set(t,n)}processTerm(t,r,a,n=-1){let o=a.length,u=!1,l=[],i=0;if(!t.match(RegExp(Ws))&&!r&&t!=="")throw new Error("Invalid LHS term");let c=t.match(RegExp(va,"g")),m=new $a(n);return c?.forEach((f,h)=>{if(f==="..."){if(u)throw new Error("Only one ellipsis is allowed per input term");u=!0;let w=o-c.length+1;if(w<0)throw new Error("Ellipsis out of bounds");if(l=a.slice(i,i+w),this.hasEllipsis){if(this.ellipsisDims.length!==l.length||this.ellipsisDims.toString()!==l.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=l;else throw new Error("Ellipsis must be specified in the LHS");for(let b=0;b<l.length;b++){let _=String.fromCharCode("0".charCodeAt(0)+b);m.addSymbol(_,h+b),this.addSymbol(_,a[i++],n)}}else m.addSymbol(f,h+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(f,a[i++],n)}),m}},Ns=e=>e+"_max",xc=(e,t,r,a,n)=>{let u=t.map((w,b)=>e[b]?w.length:w).map((w,b)=>z(`input${b}`,r,w)),l=U.size(n),i=ke(n.length),c=i?n.length:n,m=K("output",r,c),f=[...a.symbolToInfo.keys()].filter(w=>!a.rhs.symbolToIndices.has(w)),h=w=>{let b=[],_="var prod = 1.0;",I="var sum = 0.0;",$="sum += prod;",S=[],T=[],E=[],M=[],A=a.symbolToInfo.size===a.rhs.symbolToIndices.size;a.symbolToInfo.forEach((W,L)=>{if(a.rhs.symbolToIndices.has(L)){let J=a.rhs.symbolToIndices.get(L)?.[0];J!==void 0&&a.lhs.forEach((B,Y)=>{if(W.inputIndices.includes(Y)){let pe=B.symbolToIndices.get(L);if(pe===void 0)throw new Error("Invalid symbol error");pe.forEach(ee=>{b.push(`${u[Y].indicesSet(`input${Y}Indices`,ee,m.indicesGet("outputIndices",J))}`)})}})}else a.lhs.forEach((J,B)=>{if(W.inputIndices.includes(B)){let Y=J.symbolToIndices.get(L);if(Y===void 0)throw new Error("Invalid symbol error");Y.forEach(pe=>{S.push(`${u[B].indicesSet(`input${B}Indices`,pe,`${L}`)}`)}),M.push(`prod *= ${u[B].getByIndices(`input${B}Indices`)};`)}}),T.push(`for(var ${L}: u32 = 0; ${L} < uniforms.${Ns(L)}; ${L}++) {`),E.push("}")});let N=A?[...b,`let sum = ${u.map((W,L)=>W.getByIndices(`input${L}Indices`)).join(" * ")};`]:[...b,I,...T,...S,_,...M,$,...E];return`
            ${w.registerUniforms(f.map(W=>({name:`${Ns(W)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...u,m)}
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:a.equation,inputDependencies:e.map(w=>w?"rank":"dims")},getRunData:()=>{let w=f.filter(_=>a.symbolToInfo.has(_)).map(_=>({type:"uint32",data:a.symbolToInfo.get(_)?.dimValue||0}));w.push({type:"uint32",data:l});let b=t.filter((_,I)=>e[I]).map((_,I)=>[...q(_)]).reduce((_,I)=>_.concat(I),w);return i&&b.push(...q(n)),{outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:b}},getShaderSource:h}},Vs=(e,t)=>{let r=new _a(e.inputs,t.equation),a=e.inputs.map((u,l)=>ke(u.dims.length)),n=r.outputDims,o=e.inputs.map((u,l)=>u.dims);e.compute(xc(a,o,e.inputs[0].dataType,r,n))},Hs=e=>{let t=e.equation.replace(/\s+/g,"");return ge({equation:t})}});var Sc,Gs,Ic,Cc,Fs,qs=j(()=>{"use strict";Be();_e();we();Sc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Gs=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},Ic=(e,t)=>e.length>t.length?Gs(e,t):Gs(t,e),Cc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=Ic(t,r),n=e[0].dataType,o=n===9?4:1,u=Math.ceil(U.size(a)/o),l=ke(t.length),i=ke(a.length),c=f=>{let h=l?t.length:t,w=i?a.length:a,b=z("input",n,h,o),_=K("output",n,w,o),I;if(n===9){let $=(S,T,E="")=>`
    ...
    ${I}`},m=[{type:"uint32",data:u}];return l&&m.push(...q(t)),i&&m.push(...q(a)),{name:"Expand",shaderCache:{hint:`${a.length}`,inputDependencies:[l?"rank":"dims"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m})}},Fs=e=>{Sc(e.inputs),e.compute(Cc(e.inputs),{inputs:[0]})}});var Ec,Ac,js,Ks,Ys=j(()=>{"use strict";Be();_e();Ve();we();Ec=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Ac=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,o=U.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(o,1,...a);let l=r[o],i=e[0].dataType===9?4:1,c=Math.ceil(U.size(u)/i),m=ke(e[0].dims.length),f=m?e[0].dims.length:e[0].dims,h=ke(e[1].dims.length),w=h?e[1].dims.length:e[1].dims,b=ke(u.length),_=b?u.length:u,I=[{type:"uint32",data:c},{type:"int32",data:l},{type:"uint32",data:o}];m&&I.push(...q(e[0].dims)),h&&I.push(...q(e[1].dims)),b&&I.push(...q(u));let $=[];$.push(m?"rank":"dims"),$.push(h?"rank":"dims");let S=T=>{let E=z("data",e[0].dataType,f,i),M=z("inputIndices",e[1].dataType,w),A=K("output",e[0].dataType,_,i),N=L=>{let J=a.length,B=`var indicesIndices${L}  = ${M.type.indices}(0);`;for(let Y=0;Y<J;Y++)B+=`${J>1?`indicesIndices${L}[${Y}]`:`indicesIndices${L}`} = ${u.length>1?`outputIndices${L}[uniforms.axis + ${Y}]`:`outputIndices${L}`};`;B+=`
      ...
      ${T.mainStart()}
        ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${W}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:$},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:I}),getShaderSource:S}},js=e=>ge({axis:e.axis}),Ks=(e,t)=>{let r=e.inputs;Ec(r),e.compute(Ac(e.inputs,t))}});var Tc,Oc,Zs,Xs,Qs=j(()=>{"use strict";_e();Ve();we();Tc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${i}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:m}),getShaderSource:w},{inputs:[t[0],h]})},ru=(e,t)=>{t.format==="NHWC"?Dc(e,e.inputs,t):e.compute(Pc(e.inputs,t))}});var Mc,zc,au,iu=j(()=>{"use strict";Be();_e();we();Mc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},zc=(e,t,r)=>{let a=e[0].dims,n=e[1],o=e[2],u=a,l=U.normalizeAxis(t.axis,a.length),i=U.sizeToDimension(a,l),c=U.sizeFromDimension(a,l),m=U.size(n.dims),f=o?U.size(o.dims):0;if(m!==c||o&&f!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:l,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}),getShaderSource:m},{inputs:[t,r],outputs:[-1]})[0]},xa=(e,t,r,a,n,o,u,l)=>{let i=o;if(u){if(a===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return i=Wc(e,o,u,t,a,r*n,l),i=i.reshape([t,a,r,n]),e.compute(dt(i,ou.perm),{inputs:[i],outputs:[-1]})[0]}else return o.dims.length===3&&(i=o.reshape([t,a,r,n])),e.compute(dt(i,ou.perm),{inputs:[i],outputs:[-1]})[0]},uu=(e,t)=>{let r=Uc(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let a=e.inputs[1]&&e.inputs[2]&&e.inputs[1].dims.length===4&&e.inputs[2].dims.length===4,n=xa(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],e.inputs[3],0);if(a)return hn(e,n,e.inputs[1],e.inputs[2],e.inputs[4],void 0,void 0,void 0,e.inputs[5],r,t);let o=xa(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,e.inputs[1],e.inputs[3],r.hiddenSize),u=xa(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,e.inputs[2],e.inputs[3],2*r.hiddenSize);hn(e,n,o,u,e.inputs[4],void 0,e.inputs[6],e.inputs[7],e.inputs[5],r,t)}});var Nc,Vc,Hc,Lc,Gc,Fc,qc,jc,du,cu=j(()=>{"use strict";Be();_e();we();Nc=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1)throw new Error("Input type must be float.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Vc=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
      ...
      `},Hc=(e,t,r)=>{let a="";for(let n=t-1;n>=0;--n)a+=`
          ...
          `},Fc=(e,t,r)=>{switch(r.mode){case 0:return Vc(e,t,r.pads.length);case 1:return Hc(e,t,r.pads.length);case 2:return Lc(e,t,r.pads.length);case 3:return Gc(e,t,r.pads.length);default:throw new Error("Invalid mode")}},qc=(e,t)=>{let r=U.padShape(e[0].dims.slice(),t.pads),a=e[0].dims,o=[{type:"uint32",data:U.size(r)},{type:"uint32",data:t.pads}];if(t.mode===0){let i=et(e[0].dataType);o.push({type:i,data:t.value})}o.push(...q(e[0].dims),...q(r));let u=["rank"],l=i=>{let c=K("output",e[0].dataType,r.length),m=z("x",e[0].dataType,a.length),f=m.type.value,h=Fc(c,a.length,t),w=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&w.push({name:"constant_value",type:f}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},hu=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Kc=e=>`${hu(e)};${e.countIncludePad}`,Yc=e=>`${hu(e)};${e.storageOrder};${e.dilations}`,gu=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),yu=(e,t,r,a)=>{let[n,o]=pu(t,a,r),u=z("x",t.dataType,t.dims.length),l=u.type.value,i="value += x_val;",c="";n.countIncludePad?c+=`value /= ${l}(uniforms.kernelSize);`:c+=`value /= ${l}(i32(uniforms.kernelSize) - pad);`;let[m,f,h,w,b]=mu(o,n);m.push(...q(t.dims),...q(o));let _=["rank"];return{name:e,shaderCache:{hint:`${a.cacheKey};${h};${w};${b}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(U.size(o)/64)},programUniforms:m}),getShaderSource:I=>fu(I,u,t.dims.length,o.length,n,i,c,0,f,h,w,b)}},bu=e=>{let t=e.count_include_pad!==0,r=gu(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let a={countIncludePad:t,...r,cacheKey:""};return{...a,cacheKey:Kc(a)}},wu=(e,t)=>{Sn(e.inputs),e.compute(yu("AveragePool",e.inputs[0],!1,t))},vu={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},$u=e=>{let t=e.format;return{format:t,...vu,cacheKey:t}},_u=(e,t)=>{Sn(e.inputs),e.compute(yu("GlobalAveragePool",e.inputs[0],!0,t))},xu=(e,t,r,a)=>{let[n,o]=pu(t,a,r),u=`
      value = max(x_val, value);
    `,l="",i=z("x",t.dataType,t.dims.length),c=["rank"],[m,f,h,w,b]=mu(o,n);return m.push(...q(t.dims),...q(o)),{name:e,shaderCache:{hint:`${a.cacheKey};${h};${w};${b}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(U.size(o)/64)},programUniforms:m}),getShaderSource:_=>fu(_,i,t.dims.length,o.length,n,u,l,-1e5,f,h,w,b)}},Su=(e,t)=>{Sn(e.inputs),e.compute(xu("MaxPool",e.inputs[0],!1,t))},Iu=e=>{let t=e.storage_order,r=e.dilations,a=gu(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...a,cacheKey:""};return{...n,cacheKey:Yc(n)}},Cu=e=>{let t=e.format;return{format:t,...vu,cacheKey:t}},Eu=(e,t)=>{Sn(e.inputs),e.compute(xu("GlobalMaxPool",e.inputs[0],!0,t))}});var Xc,Qc,Tu,Ou=j(()=>{"use strict";ot();Be();we();Xc=(e,t,r)=>{let a=e===t,n=e<t&&r<0,o=e>t&&r>0;if(a||n||o)throw new Error("Range these inputs' contents are invalid.")},Qc=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),o=[n],u=n,l=et(a),i=[{type:"uint32",data:u},{type:l,data:e},{type:l,data:r},...q(o)],c=m=>{let f=K("output",a,o.length),h=f.type.value,w=[{name:"outputSize",type:"u32"},{name:"start",type:h},{name:"delta",type:h}];return`
        ${m.registerUniforms(w).declareVariables(f)}
        ${m.mainStart()}
        ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${h}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:c,getRunData:()=>({outputs:[{dims:o,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:i})}},Tu=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Ae.webgpu.validateInputContent&&Xc(t,r,a),e.compute(Qc(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var Jc,ep,tp,rp,np,ap,ip,op,sp,up,lp,ku,dp,cp,pp,mp,fp,Ru,Pu,Bu=j(()=>{"use strict";_e();Ve();we();Jc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${i.length}_${u.length}_${o.length}`,inputDependencies:["rank"]},getShaderSource:I,getRunData:()=>({outputs:[m],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:_})}},Wu=(e,t)=>{yp(e.inputs,t);let r=bp(e.inputs,t);e.compute(vp(e.inputs,r),{inputs:[0]})},Nu=e=>{let t=e.starts,r=e.ends,a=e.axes;return ge({starts:t,ends:r,axes:a})}});var $p,_p,Hu,Lu,Gu=j(()=>{"use strict";_e();Ve();we();$p=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},_p=(e,t)=>{let r=e.dims,a=U.size(r),n=64,o=t.axis;if(o<0&&(o=r.length+o),o<r.length-1)throw new Error("softmax only supports last axis for now.");let u=r[o],l=a/u,i=He(u),c=u/i,m=(I,$)=>$===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:$===2?`max(${I}.x, ${I}.y)`:$===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,f=z("x",e.dataType,e.dims,i),h=K("result",e.dataType,e.dims,i),w=f.type.value,b=Ne(e.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,_=I=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${i}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:c}]}),getShaderSource:_}},Hu=(e,t)=>{$p(e.inputs),e.compute(_p(e.inputs[0],t))},Lu=e=>ge({axis:e.axis})});var xp,Sp,Ip,Cp,Ep,Fu,qu,ju=j(()=>{"use strict";_e();Ve();we();xp=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Sp=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),ge({numOutputs:a,axis:t.axis,splitSizes:r})},Ip=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:w,getRunData:()=>({outputs:c,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:h})}},Fu=(e,t)=>{xp(e.inputs);let r=e.inputs.length===1?t:Sp(e.inputs,t);e.compute(Ep(e.inputs,r),{inputs:[0]})},qu=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return ge({axis:t,numOutputs:a,splitSizes:r})}});var Ku,Ap,Tp,Op,Yu,Zu=j(()=>{"use strict";Be();_e();we();Ku=e=>Array.from(e.getBigInt64Array(),Number),Ap=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Ku(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Tp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},Op=e=>{let t=e[0].dims,r=Ku(e[1]),a=Tp(t,r),n=U.size(a),o=e[0].dataType,u=z("input",o,t.length),l=K("output",o,a.length),i=c=>`
