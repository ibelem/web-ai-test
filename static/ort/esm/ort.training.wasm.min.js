...
`))(Nt,s,Me,()=>p())},hn={},mt=e=>e%4===0&&(e%100!==0||e%400===0),gn=[0,31,60,91,121,152,182,213,244,274,305,335],yn=[0,31,59,90,120,151,181,212,243,273,304,334];function bn(e,t,o,c,g,w,A){return I?ee(16,1,e,t,o,c,g,w,A):-52}function wn(e,t,o,c,g,w){if(I)return ee(17,1,e,t,o,c,g,w)}var vn=e=>{var t=le(e)+1,o=Yt(t);return o&&pt(e,o,t),o},Ar={},On=()=>{if(!Sr){var e={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:S||"./this.program"},t;for(t in Ar)Ar[t]===void 0?delete e[t]:e[t]=Ar[t];var o=[];for(t in e)o.push(`${t}=${e[t]}`);Sr=o}return Sr},Sr;function Tn(e,t){if(I)return ee(18,1,e,t);e>>>=0,t>>>=0;var o=0;return On().forEach((c,g)=>{var w=t+o;for(g=p()[e+4*g>>>2>>>0]=w,w=0;w<c.length;++w)r()[g++>>>0>>>0]=c.charCodeAt(w);r()[g>>>0>>>0]=0,o+=c.length+1}),0}function _n(e,t){if(I)return ee(19,1,e,t);e>>>=0,t>>>=0;var o=On();p()[e>>>2>>>0]=o.length;var c=0;return o.forEach(g=>c+=g.length+1),p()[t>>>2>>>0]=c,0}function En(e){return I?ee(20,1,e):52}function An(e,t,o,c){return I?ee(21,1,e,t,o,c):52}function Sn(e,t,o,c){return I?ee(22,1,e,t,o,c):70}var To=[null,[],[]];function Mn(e,t,o,c){if(I)return ee(23,1,e,t,o,c);t>>>=0,o>>>=0,c>>>=0;for(var g=0,w=0;w<o;w++){var A=p()[t>>>2>>>0],M=p()[t+4>>>2>>>0];t+=8;for(var H=0;H<M;H++){var W=l()[A+H>>>0],ne=To[e];W===0||W===10?((e===1?Je:ue)(Et(ne,0)),ne.length=0):ne.push(W)}g+=M}return p()[c>>>2>>>0]=g,0}var Cn=[31,29,31,30,31,30,31,31,30,31,30,31],Pn=[31,28,31,30,31,30,31,31,30,31,30,31];function _o(e){var t=Array(le(e)+1);return St(e,t,0,t.length),t}var Eo=(e,t)=>{r().set(e,t>>>0)};function In(e,t,o,c){function g(v,Y,ae){for(v=typeof v=="number"?v.toString():v||"";v.length<Y;)v=ae[0]+v;return v}function w(v,Y){return g(v,Y,"0")}function A(v,Y){function ae(Ln){return 0>Ln?-1:0<Ln?1:0}var et;return(et=ae(v.getFullYear()-Y.getFullYear()))===0&&(et=ae(v.getMonth()-Y.getMonth()))===0&&(et=ae(v.getDate()-Y.getDate())),et}function M(v){switch(v.getDay()){case 0:return new Date(v.getFullYear()-1,11,29);case 1:return v;case 2:return new Date(v.getFullYear(),0,3);case 3:return new Date(v.getFullYear(),0,2);case 4:return new Date(v.getFullYear(),0,1);case 5:return new Date(v.getFullYear()-1,11,31);case 6:return new Date(v.getFullYear()-1,11,30)}}function H(v){var Y=v.ob;for(v=new Date(new Date(v.pb+1900,0,1).getTime());0<Y;){var ae=v.getMonth(),et=(mt(v.getFullYear())?Cn:Pn)[ae];if(Y>et-v.getDate())Y-=et-v.getDate()+1,v.setDate(1),11>ae?v.setMonth(ae+1):(v.setMonth(0),v.setFullYear(v.getFullYear()+1));else{v.setDate(v.getDate()+Y);break}}return ae=new Date(v.getFullYear()+1,0,4),Y=M(new Date(v.getFullYear(),0,4)),ae=M(ae),0>=A(Y,v)?0>=A(ae,v)?v.getFullYear()+1:v.getFullYear():v.getFullYear()-1}e>>>=0,t>>>=0,o>>>=0,c>>>=0;var W=p()[c+40>>>2>>>0];c={Qb:f()[c>>>2>>>0],Pb:f()[c+4>>>2>>>0],tb:f()[c+8>>>2>>>0],yb:f()[c+12>>>2>>>0],ub:f()[c+16>>>2>>>0],pb:f()[c+20>>>2>>>0],kb:f()[c+24>>>2>>>0],ob:f()[c+28>>>2>>>0],Wb:f()[c+32>>>2>>>0],Ob:f()[c+36>>>2>>>0],Rb:W?Ze(W):""},o=Ze(o),W={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ne in W)o=o.replace(new RegExp(ne,"g"),W[ne]);var Ae="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Ne="January February March April May June July August September October November December".split(" ");W={"%a":v=>Ae[v.kb].substring(0,3),"%A":v=>Ae[v.kb],"%b":v=>Ne[v.ub].substring(0,3),"%B":v=>Ne[v.ub],"%C":v=>w((v.pb+1900)/100|0,2),"%d":v=>w(v.yb,2),"%e":v=>g(v.yb,2," "),"%g":v=>H(v).toString().substring(2),"%G":v=>H(v),"%H":v=>w(v.tb,2),"%I":v=>(v=v.tb,v==0?v=12:12<v&&(v-=12),w(v,2)),"%j":v=>{for(var Y=0,ae=0;ae<=v.ub-1;Y+=(mt(v.pb+1900)?Cn:Pn)[ae++]);return w(v.yb+Y,3)},"%m":v=>w(v.ub+1,2),"%M":v=>w(v.Pb,2),"%n":()=>`
`,"%p":v=>0<=v.tb&&12>v.tb?"AM":"PM","%S":v=>w(v.Qb,2),"%t":()=>"	","%u":v=>v.kb||7,"%U":v=>w(Math.floor((v.ob+7-v.kb)/7),2),"%V":v=>{var Y=Math.floor((v.ob+7-(v.kb+6)%7)/7);if(2>=(v.kb+371-v.ob-2)%7&&Y++,Y)Y==53&&(ae=(v.kb+371-v.ob)%7,ae==4||ae==3&&mt(v.pb)||(Y=1));else{Y=52;var ae=(v.kb+7-v.ob-1)%7;(ae==4||ae==5&&mt(v.pb%400-1))&&Y++}return w(Y,2)},"%w":v=>v.kb,"%W":v=>w(Math.floor((v.ob+7-(v.kb+6)%7)/7),2),"%y":v=>(v.pb+1900).toString().substring(2),"%Y":v=>v.pb+1900,"%z":v=>{v=v.Ob;var Y=0<=v;return v=Math.abs(v)/60,(Y?"+":"-")+("0000"+(v/60*100+v%60)).slice(-4)},"%Z":v=>v.Rb,"%%":()=>"%"},o=o.replace(/%%/g,"\0\0");for(ne in W)o.includes(ne)&&(o=o.replace(new RegExp(ne,"g"),W[ne](c)));return o=o.replace(/\0\0/g,"%"),ne=_o(o),ne.length>t?0:(Eo(ne,e),ne.length-1)}U.vb();for(var Rn=Array(256),jt=0;256>jt;++jt)Rn[jt]=String.fromCharCode(jt);sn=Rn,Ve=s.BindingError=class extends Error{constructor(e){super(e),this.name="BindingError"}},s.InternalError=class extends Error{constructor(e){super(e),this.name="InternalError"}},Object.assign(fn.prototype,{get(e){return this.lb[e]},has(e){return this.lb[e]!==void 0},wb(e){var t=this.zb.pop()||this.lb.length;return this.lb[t]=e,t},xb(e){this.lb[e]=void 0,this.zb.push(e)}}),Se.lb.push({value:void 0},{value:null},{value:!0},{value:!1}),Se.sb=Se.lb.length,s.count_emval_handles=()=>{for(var e=0,t=Se.sb;t<Se.lb.length;++t)Se.lb[t]!==void 0&&++e;return e};var Ao=[At,i,z,be,de,T,V,Z,Be,Mt,Qr,en,tn,rn,nn,an,bn,wn,Tn,_n,En,An,Sn,Mn],So={b:function(e,t,o){throw e>>>=0,new O(e).vb(t>>>0,o>>>0),C=e,x++,C},ea:function(e){Fn(e>>>0,!L,1,!P,131072,!1),U.Db()},E:function(e){e>>>=0,I?postMessage({cmd:"cleanupThread",thread:e}):((e=U.jb[e])||Le(),U.Bb(e))},W:fe,y:be,ka:de,S:T,U:V,L:Z,ia:Be,ba:Mt,ha:Qr,G:en,T:tn,Q:rn,ja:nn,R:an,J:function(e,t,o,c,g){e>>>=0,t>>>=0,o>>>=0,t=Pe(t);var w=t.indexOf("u")!=-1;w&&(g=(1n<<64n)-1n),He(e,{name:t,fromWireType:A=>A,toWireType:function(A,M){if(typeof M!="bigint"&&typeof M!="number")throw new TypeError(`Cannot convert "${on(M)}" to ${this.name}`);if(M<c||M>g)throw new TypeError(`Passing a number "${on(M)}" from JS side to C/C++ side to an argument of type "${t}", which is outside the valid range [${c}, ${g}]!`);return M},argPackAdvance:8,readValueFromPointer:un(t,o,!w),rb:null})},qa:function(e,t,o,c){e>>>=0,t=Pe(t>>>0),He(e,{name:t,fromWireType:function(g){return!!g},toWireType:function(g,w){return w?o:c},argPackAdvance:8,readValueFromPointer:function(g){return this.fromWireType(l()[g>>>0])},rb:null})},pa:function(e,t){e>>>=0,t=Pe(t>>>0),He(e,{name:t,fromWireType:o=>{var c=Te(o);return Tr(o),c},toWireType:(o,c)=>Me(c),argPackAdvance:8,readValueFromPointer:ln,rb:null})},I:function(e,t,o){e>>>=0,o>>>=0,t=Pe(t>>>0),He(e,{name:t,fromWireType:c=>c,toWireType:(c,g)=>g,argPackAdvance:8,readValueFromPointer:oo(t,o),rb:null})},u:function(e,t,o,c,g){if(e>>>=0,o>>>=0,t=Pe(t>>>0),g===-1&&(g=4294967295),g=M=>M,c===0){var w=32-8*o;g=M=>M<<w>>>w}var A=t.includes("unsigned")?function(M,H){return H>>>0}:function(M,H){return H};He(e,{name:t,fromWireType:g,toWireType:A,argPackAdvance:8,readValueFromPointer:un(t,o,c!==0),rb:null})},m:function(e,t,o){function c(w){var A=p()[w>>>2>>>0];return w=p()[w+4>>>2>>>0],new g(r().buffer,w,A)}e>>>=0;var g=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][t];o=Pe(o>>>0),He(e,{name:o,fromWireType:c,argPackAdvance:8,readValueFromPointer:c},{Hb:!0})},K:function(e,t){e>>>=0,t=Pe(t>>>0);var o=t==="std::string";He(e,{name:t,fromWireType:function(c){var g=p()[c>>>2>>>0],w=c+4;if(o)for(var A=w,M=0;M<=g;++M){var H=w+M;if(M==g||l()[H>>>0]==0){if(A=Ze(A,H-A),W===void 0)var W=A;else W+=String.fromCharCode(0),W+=A;A=H+1}}else{for(W=Array(g),M=0;M<g;++M)W[M]=String.fromCharCode(l()[w+M>>>0]);W=W.join("")}return We(c),W},toWireType:function(c,g){g instanceof ArrayBuffer&&(g=new Uint8Array(g));var w=typeof g=="string";if(!(w||g instanceof Uint8Array||g instanceof Uint8ClampedArray||g instanceof Int8Array))throw new Ve("Cannot pass non-string to std::string");var A=o&&w?le(g):g.length,M=Yt(4+A+1),H=M+4;if(p()[M>>>2>>>0]=A,o&&w)pt(g,H,A+1);else if(w)for(w=0;w<A;++w){var W=g.charCodeAt(w);if(255<W)throw We(H),new Ve("String has UTF-16 code units that do not fit in 8 bits");l()[H+w>>>0]=W}else for(w=0;w<A;++w)l()[H+w>>>0]=g[w];return c!==null&&c.push(We,M),M},argPackAdvance:8,readValueFromPointer:io,rb(c){We(c)}})},A:function(e,t,o){if(e>>>=0,t>>>=0,o>>>=0,o=Pe(o),t===2)var c=so,g=uo,w=fo,A=()=>m(),M=1;else t===4&&(c=lo,g=co,w=po,A=()=>p(),M=2);He(e,{name:o,fromWireType:H=>{for(var W=p()[H>>>2>>>0],ne=A(),Ae,Ne=H+4,v=0;v<=W;++v){var Y=H+4+v*t;(v==W||ne[Y>>>M]==0)&&(Ne=c(Ne,Y-Ne),Ae===void 0?Ae=Ne:(Ae+=String.fromCharCode(0),Ae+=Ne),Ne=Y+t)}return We(H),Ae},toWireType:(H,W)=>{if(typeof W!="string")throw new Ve(`Cannot pass non-string to C++ string type ${o}`);var ne=w(W),Ae=Yt(4+ne+t);return p()[Ae>>>2]=ne>>M,g(W,Ae+4,ne+t),H!==null&&H.push(We,Ae),Ae},argPackAdvance:8,readValueFromPointer:ln,rb(H){We(H)}})},ra:function(e,t){e>>>=0,t=Pe(t>>>0),He(e,{Ib:!0,name:t,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},na:()=>!0,O:function(e,t){e>>>=0,e==t>>>0?setTimeout(()=>Wt()):I?postMessage({targetThread:e,cmd:"checkMailbox"}):(e=U.jb[e])&&e.postMessage({cmd:"checkMailbox"})},X:function(e,t,o,c){t>>>=0,o/=2,Er.length=o,c=c>>>0>>>3;for(var g=0;g<o;g++)Er[g]=ge[c+2*g]?ge[c+2*g+1]:y()[c+2*g+1>>>0];return e=Ao[e],U.Gb=t,t=e.apply(null,Er),U.Gb=0,t},da:_r,ma:function(e){F&&U.jb[e>>>0].ref()},r:function(e,t,o){t>>>=0,o>>>=0,e=Te(e>>>0),t=Nt(t,"emval::as");var c=[],g=Me(c);return p()[o>>>2>>>0]=g,t.toWireType(c,e)},i:function(e,t,o,c,g){o>>>=0,c>>>=0,g>>>=0,e=$t[e>>>0],t=Te(t>>>0),o=zt(o);var w=[];return p()[c>>>2>>>0]=Me(w),e(t,o,w,g)},s:function(e,t,o,c){o>>>=0,c>>>=0,e=$t[e>>>0],t=Te(t>>>0),o=zt(o),e(t,o,null,c)},c:Tr,B:function(e,t){return t>>>=0,e=Te(e>>>0),t=Te(t),e==t},o:function(e){return e>>>=0,e===0?Me(dn()):(e=zt(e),Me(dn()[e]))},g:function(e,t){var o=bo(e,t>>>0),c=o[0];t=c.name+"_$"+o.slice(1).map(function(ne){return ne.name}).join("_")+"$";var g=mn[t];if(g!==void 0)return g;g=["retType"];for(var w=[c],A="",M=0;M<e-1;++M)A+=(M!==0?", ":"")+"arg"+M,g.push("argType"+M),w.push(o[1+M]);var H="return function "+pn("methodCaller_"+t)+`(handle, name, destructors, args) {
