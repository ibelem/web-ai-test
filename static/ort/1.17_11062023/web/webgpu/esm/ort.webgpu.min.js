...
`)}},Ko=e=>new Jn(e),Zn=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let s=r-1-n,u=e[s]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(s)}return a},Yo=e=>e<=4});var td,Xo,rd,nd,At,Jo,Qo,xr=L(()=>{"use strict";ge();Pe();ve();td=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Xo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,rd=(e,t)=>z.sortBasedOnPerm(e,Xo(e.length,t)),nd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)n.push(r.indicesSet("a",e[s],`i[${s}]`));return n.push("return a;}"),n.join(`
`)},At=(e,t)=>{let r=e.dataType,a=e.dims.length,n=Xo(a,t),s=Yo(a),u=rd(e.dims,n),l=s?u.length:u,o=s?a:e.dims,p=X("output",r,l),m=F("a",r,o),b=g=>`
  ...
  ${g.mainStart()}
    ...
    ${p.setByOffset("global_idx",m.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:w=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:o},programUniforms:[{type:"uint32",data:p}]})}},ot=(e,t,r,a)=>{let n=e.inputs.length===1?r:ea(e.inputs,r),s=n.axes;s.length===0&&!n.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((v,$)=>$));let u=z.normalizeAxes(s,e.inputs[0].dims.length),l=u,o=e.inputs[0],p=pd(l,e.inputs[0].dims.length);p.length>0&&(o=e.compute(At(e.inputs[0],p),{inputs:[0],outputs:[-1]})[0],l=ud(l.length,o.dims.length));let[m,b]=ld(o.dims,l),g=m;n.keepDims&&(g=dd(m,u)),e.compute(fd(t,{hint:n.cacheKey,inputDependencies:["type"]},[o],a,e.inputs[0].dataType,g,b),{inputs:[o]})},Zo=(e,t)=>{ot(e,"ReduceMeanShared",t,"mean")},ei=(e,t)=>{ot(e,"ReduceL1Shared",t,"l1")},ti=(e,t)=>{ot(e,"ReduceL2Shared",t,"l2")},ri=(e,t)=>{ot(e,"ReduceLogSumExpShared",t,"logSumExp")},ni=(e,t)=>{ot(e,"ReduceMaxShared",t,"max")},ai=(e,t)=>{ot(e,"ReduceMinShared",t,"min")},oi=(e,t)=>{ot(e,"ReduceProdShared",t,"prod")},ii=(e,t)=>{ot(e,"ReduceSumShared",t,"sum")},si=(e,t)=>{ot(e,"ReduceSumSquareShared",t,"sumSquare")},ui=(e,t)=>{ot(e,"ReduceLogSumShared",t,"logSum")}});var it,md,on,ea,st,hd,gd,yd,bd,wd,vd,$d,xd,Sd,Cd,ut,di,ci,pi,fi,mi,hi,gi,yi,bi,wi,et,an=L(()=>{"use strict";ge();Pe();ve();li();it=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},md=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],on=(e,t,r,a,n,s,u=!1,l=!1)=>{let o=[],p=r[0].dims,m=z.normalizeAxes(n,r[0].dims.length),b=!l&&m.length===0;p.forEach((W,H)=>{b||m.indexOf(H)>=0?u&&o.push(1):o.push(W)});let g=[],v=F("_A",r[0].dataType,p),$=X("output",s,o),w=a(v,$,m),C=`inputOffset = ${v.indicesToOffset("inputIndices")};`,I=`let ${C};`,R=`var ${C};`,M=w[1]===""?"":R,P=(w[1]===""?I:C)+`
...
`)}`,`var value = ${a.getByOffset("inputOffset")};`,`value = min(value, ${a.getByOffset("inputOffset")});`,""]})},xd=(e,t)=>{it(e.inputs),st(e,"ReduceProd",t,(a,n)=>[`var value = ${n.type.storage}(1);`,"",`value *= ${a.getByOffset("inputOffset")};`,""])},Sd=(e,t)=>{it(e.inputs),st(e,"ReduceSum",t,(a,n)=>[`var value = ${n.type.storage}(0);`,"",`value += ${a.getByOffset("inputOffset")};`,""])},Cd=(e,t)=>{it(e.inputs),st(e,"ReduceSumSquare",t,(a,n)=>[`var t = ${n.type.value}(0); var value = ${n.type.value}(0);`,"",`t = ${a.getByOffset("inputOffset")}; value += t * t;`,""])},ut=(e,t,r)=>{if(t.length===0)return!!r;let a=1,n=1;for(let s=0;s<t.length;s++)t.indexOf(s)===-1?a*=e[s]:n*=e[s];return n<32&&a>1024},di=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?vd(e,t):Zo(e,t)},ci=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?gd(e,t):ei(e,t)},pi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?yd(e,t):ti(e,t)},fi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?bd(e,t):ri(e,t)},mi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?wd(e,t):ni(e,t)},hi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?$d(e,t):ai(e,t)},gi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?xd(e,t):oi(e,t)},yi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sd(e,t):ii(e,t)},bi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cd(e,t):si(e,t)},wi=(e,t)=>{ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?hd(e,t):ui(e,t)},et=e=>se(e)});var vi,$i,xi,Si,ta,Ci=L(()=>{"use strict";De();Pe();an();vi=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},$i=(e,t)=>se({axis:t.axis,keepDims:t.keepDims,selectLastIndex:t.selectLastIndex}),xi=(e,t)=>{vi(e.inputs);let r=(n,s,u)=>{let l=[];for(let o=0;o<n.rank;o++)(u.indexOf(o)>=0||u.length===0)&&l.push(`inputIndices[${o}] = 0;`);return[`${l.join(`
...
var bestIndex : i32 = 0;`,`if (${n.getByOffset("inputOffset")} ${t.selectLastIndex>0?"<=":"<"} value) {
       ...
       }`,"",s.setByOffset("global_idx","bestIndex")]},a=e.inputs.length===1?t:$i(e.inputs,t);e.compute(on("ArgMin",{hint:a.cacheKey},[e.inputs[0]],r,[a.axis],7,a.keepDims),{inputs:[0]})},Si=(e,t)=>{vi(e.inputs);let r=(n,s,u)=>{let l=[];for(let o=0;o<n.rank;o++)(u.indexOf(o)>=0||u.length===0)&&l.push(`inputIndices[${o}] = 0;`);return[`${l.join(`
`)}`,`var value = ${n.getByOffset("inputOffset")};
var bestIndex : i32 = 0;`,`if (${n.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${n.getByOffset("inputOffset")};
         bestIndex = i32(lastIndex);
       }`,"",s.setByOffset("global_idx","bestIndex")]},a=e.inputs.length===1?t:$i(e.inputs,t);e.compute(on("argMax",{hint:a.cacheKey},[e.inputs[0]],r,[a.axis],7,a.keepDims),{inputs:[0]})},ta=e=>se(e)});var Id,Ad,Ii,Ai=L(()=>{"use strict";ge();ve();Id=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ad=e=>{let t=e[0].dims,r=e[0].dims[2],a=z.size(t)/4,n=e[0].dataType,s=F("input",n,t,4),u=F("bias",n,[r],4),l=F("residual",n,t,4),o=X("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:m=>`
  ...
  }`}},Ii=e=>{Id(e.inputs),e.compute(Ad(e.inputs))}});var Ed,$e,Ei,_i,Oi,Ti,Ri,Pi,ki,Mi,Bi,ra,_d,Di,zi,Wi,Ni,sn,Vi,un,Ui,Gi,Fi,Li,Hi,ji,qi,Ki,Yi,Xi,Ji,Qi,Zi,es,ts,rs,ns,na=L(()=>{"use strict";De();ge();Pe();ve();Ed=(e,t,r,a,n,s)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let o=F("inputData",r,[u],4),p=X("outputData",a,[u],4);return`
  ...
  }`},$e=(e,t,r,a,n,s=e.dataType)=>({name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:u=>Ed(u,z.size(e.dims),e.dataType,s,r,a),getRunData:u=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(z.size(u[0].dims)/64/4)},programUniforms:[{type:"uint32",data:Math.ceil(z.size(e.dims)/4)}]})}),Ei=e=>{e.compute($e(e.inputs[0],"Abs","abs"))},_i=e=>{e.compute($e(e.inputs[0],"Acos","acos"))},Oi=e=>{e.compute($e(e.inputs[0],"Acosh","acosh"))},Ti=e=>{e.compute($e(e.inputs[0],"Asin","asin"))},Ri=e=>{e.compute($e(e.inputs[0],"Asinh","asinh"))},Pi=e=>{e.compute($e(e.inputs[0],"Atan","atan"))},ki=e=>{e.compute($e(e.inputs[0],"Atanh","atanh"))},Mi=e=>se(e),Bi=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($e(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},ra=(e,t)=>{let r=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Clip",a=>`clamp(${a}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${r}> = vec4(${r}(${t.min}));
    const clip_max_: vec4<${r}> = vec4(${r}(${t.max}));
`,t.cacheKey),{inputs:[0]})},_d=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:rn,r=e.length>=3?e[2].getFloat32Array()[0]:nn;return se({min:t,max:r})},Di=e=>{let t=_d(e.inputs);ra(e,t)},zi=e=>{e.compute($e(e.inputs[0],"Ceil","ceil"))},Wi=e=>{e.compute($e(e.inputs[0],"Cos","cos"))},Ni=e=>{e.compute($e(e.inputs[0],"Cosh","cosh"))},sn=e=>se(e),Vi=(e,t)=>{e.compute($e(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,Ui=e=>{let t=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,un(`vec4<${t}>`,t)))},Gi=e=>{e.compute($e(e.inputs[0],"Exp","exp"))},Fi=e=>{e.compute($e(e.inputs[0],"Floor","floor"))},Li=e=>{let t=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,un(`vec4<${t}>`,t)))},Hi=(e,t)=>{e.compute($e(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},ji=e=>{e.compute($e(e.inputs[0],"Not",t=>`!${t}`))},qi=e=>{e.compute($e(e.inputs[0],"Neg",t=>`-${t}`))},Ki=e=>{e.compute($e(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Yi=e=>{e.compute($e(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},Xi=e=>{e.compute($e(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Ji=e=>{e.compute($e(e.inputs[0],"Sin","sin"))},Qi=e=>{e.compute($e(e.inputs[0],"Sinh","sinh"))},Zi=e=>{e.compute($e(e.inputs[0],"Sqrt","sqrt"))},es=e=>{e.compute($e(e.inputs[0],"Tan","tan"))},ts=e=>{e.compute($e(e.inputs[0],"Tanh","tanh"))},rs=(e,t)=>(e.compute($e(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),ns=e=>{e.compute($e(e.inputs[0],"Log","log"))}});var Td,Rd,as,os=L(()=>{"use strict";ge();ve();na();Td=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Rd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=F("input",e[0].dataType,e[0].dims,4),a=F("bias",e[0].dataType,[e[0].dims[2]],4),n=X("output",e[0].dataType,t,4),s=z.size(t)/4;return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${M}
      }`},kd=(e,t,r,a,n,s,u=r.dataType)=>{let l=!z.areEqual(r.dims,a.dims),o=r.dims,p=z.size(r.dims),m=!1;if(l){let b=at.calcShape(r.dims,a.dims,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");o=b,p=z.size(o);let g=z.size(r.dims)===1,v=z.size(a.dims)===1,$=1;for(let w=1;w<o.length;w++){let C=r.dims[r.dims.length-w]??1,I=a.dims[a.dims.length-w]??1;if(C===I)$*=C;else break}($%4===0||g||v)&&(m=!0)}else m=!0;return{name:e,shaderCache:{hint:t},getShaderSource:b=>Pd(b,r.dims,a.dims,o,m,l,n,r.dataType,a.dataType,u,s),getRunData:()=>({outputs:[{dims:o,dataType:u}],dispatchGroup:{x:Math.ceil(p/64/4)}})}},lt=(e,t,r,a,n,s)=>{e.compute(kd(t,n??"",e.inputs[0],e.inputs[1],r,a,s))},is=e=>{lt(e,"Add",(t,r)=>`${t}+${r}`)},ss=e=>{lt(e,"Div",(t,r)=>`${t}/${r}`)},us=e=>{lt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},ls=e=>{lt(e,"Mul",(t,r)=>`${t}*${r}`)},ds=e=>{let t=F("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;lt(e,"Pow",{scalar:(a,n)=>`pow_custom(${a},${n})`,vector:(a,n)=>`pow_vector_custom(${a},${n})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},cs=e=>{lt(e,"Sub",(t,r)=>`${t}-${r}`)},ps=e=>{lt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},fs=e=>{lt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},ms=e=>{lt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},hs=e=>{lt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Bd,Dd,zd,Wd,ys,bs,ws=L(()=>{"use strict";ge();Pe();ve();Bd=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},Dd=e=>`
...
`)},Wd=(e,t)=>{let r=e[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");let a=t<0?r.length+t:t,n=r.slice(0);for(let v=1;v<e.length;v++){let $=e[v].dims.slice();for(let w=0;w<r.length;w++)if(w===a)n[a]+=$[w];else if(r[w]!==$[w])throw new Error("non concat dimensions must match")}let s=z.size(n),u=new Array(e.length),l=new Array(e.length),o=e[0].dataType,p=0;for(let v=0;v<e.length;++v)p+=e[v].dims[a],u[v]=p,l[v]=F(`input${v}`,o,e[v].dims);let m=X("output",o,n),b=m.indicesGet("indices",a),g=v=>`
  ...
  ${v.mainStart()}
    ...
    ${zd(l,m)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:g}},ys=(e,t)=>{Bd(e.inputs),e.compute(Wd(e.inputs,t.axis))},bs=e=>se({axis:e.axis})});var ze,ln,dn,cn=L(()=>{"use strict";ze=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},ln=(e,t=!1,r=!1,a=3)=>"",dn=(e,t)=>`
...
bIndices[${M-2}] = u32(row);
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${T}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${$?`vec4<${q}>`:q}) {
        ...
        ${Fd(o,H,K,le,u,t.activation.toLowerCase(),!1,D[0],D[1],D[2],q)}
            ${$?Cr(R,I,q,void 0,!o,W):Ir(R,I,q,void 0,!o,W,!1,void 0,l)}`}}});var oa,Ss=L(()=>{"use strict";ge();ve();sa();Sr();oa=(e,t,r)=>{let a=e.length>2,n=a?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,l=u[0]/t.group,{activationFunction:o,applyActivation:p}=fn(t),m=t.format==="NHWC",b=ia(s,u,t.dilations,t.pads,t.strides,m),g=z.size(b),v=X("output",e[0].dataType,b),$=F("x",e[0].dataType,s),w=F("w",e[1].dataType,u),C=[$,w];a&&C.push(F("b",e[2].dataType,e[2].dims));let I=R=>`
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(b):b,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)}}),getShaderSource:I}}});var ia,Cs,Ld,Is,ua,Hd,jd,la,sa=L(()=>{"use strict";ge();Pe();xs();Ar();Ss();Sr();xr();ia=(e,t,r,a,n,s)=>{let u=e[0],l=e.slice(s?1:2,s?3:4),o=l.length,p=t[0],b=t.slice(2).map(($,w)=>$+($-1)*(r[w]-1)),v=l.map(($,w)=>$+a[w]+a[w+o]).map(($,w)=>Math.floor(($-b[w]+n[w])/n[w]));return v.splice(0,0,u),v.splice(s?3:1,0,p),v},Cs=[2,3,1,0],Ld=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[1]*t.group;if(r!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Is=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let a=e.pads.slice();Wt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,a,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:a,cacheKey:e.cacheKey}),n},ua=e=>{let t=mn(e),r=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,s=e.group,u=e.kernel_shape,l=e.pads,o=e.strides,p=e.w_is_const();return se({autoPad:a,format:r,dilations:n,group:s,kernelShape:u,pads:l,strides:o,wIsConst:p,...t})},Hd=(e,t,r)=>{let a=Is(r,t);if(r.group!==1){e.compute(oa(t,a));return}let n=r.format==="NHWC",s=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],o=t[0].dims[n?3:1],p=t[1].dims[2],m=t[1].dims[3],b=ia(t[0].dims,t[1].dims,r.dilations,a.pads,r.strides,n),g=b[n?1:2],v=b[n?2:3],$=b[n?3:1],w=n&&p===u&&m===l&&r.pads[0]===0&&r.pads[1]===0;if(w||p===1&&m===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let T=b[0],W,H,K,le=[];if(n){let D=e.kernelCustomData.wT??e.compute(At(t[1],Cs),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=D),w){let q=u*l*o;W=t[0].reshape([1,T,q]),H=D.reshape([1,q,$]),K=[1,T,$]}else W=t[0].reshape([T,u*l,o]),H=D.reshape([1,o,$]),K=[T,g*v,$];le.push(W),le.push(H)}else W=t[0].reshape([T,o,u*l]),H=t[1].reshape([1,$,o]),K=[T,$,g*v],le.push(H),le.push(W);s&&le.push(t[2]),e.compute(hn(le,a,b,K,n),{inputs:le});return}let C=!0,I=e.kernelCustomData.wT??e.compute(At(t[1],Cs),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let R=[t[0],I];s&&R.push(t[2]);let M=n?g*v:$,P=n?$:g*v,B=p*m*o;e.compute($s(R,a,b,M,P,B,s,C),{inputs:R})},jd=(e,t)=>{let r=t.format==="NHWC",a=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),o=Is({...t,pads:n,strides:s,dilations:u,kernelShape:l},a);e.compute(oa(a,o,p=>r?[p[0],p[2],p[3]]:[]))},la=(e,t)=>{Ld(e.inputs,t),e.inputs[0].dims.length===3?jd(e,t):Hd(e,e.inputs,t)}});var qd,As,Es=L(()=>{"use strict";Ct();ge();cn();aa();Ar();qd=(e,t=!1,r,a=!1,n=4)=>{let s=ze(n,"f32"),u=I=>{switch(I){case 1:return"return W[getIndexFromCoords4D(coord, wShape)];";case 4:return`
...
`)}
        ...
        ${$?Cr(R,I,"f32",void 0,!o,B):Ir(R,I,"f32",void 0,!o,B,!1,void 0,l)}`}}});var Kd,da,_s=L(()=>{"use strict";Ct();ge();ve();Kd=(e,t,r,a,n,s,u=!1,l)=>{let o=r.format==="NHWC",p=o?1:2,m=o?2:3,b=o?3:1,g=z.size(a),v=u?2:1,$=r.group,w=t[1].dims,C=w[0]/$,I=w[1],R=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:R}},Ms=(e,t)=>{let r=new fa(e.inputs,t.equation);e.compute(ac(e.inputs,r))},Bs=e=>{let t=e.equation.replace(/\s+/g,"");return se({equation:t})}});var oc,zs,ic,sc,Ws,Ns=L(()=>{"use strict";ge();ve();oc=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;a<r.length&&n<t.length;++a,++n)if(r[a]!==t[n]&&r[a]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},zs=(e,t)=>{let r=e.length-t.length,a=[];for(let n=0;n<r;++n)a.push(e[n]);for(let n=0;n<t.length;++n)a.push(t[n]===1?e[n+r]:t[n]);return a},ic=(e,t)=>e.length>t.length?zs(e,t):zs(t,e),sc=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),a=ic(t,r),n=z.size(a),s=e[0].dataType,u=F("input",s,t),l=X("output",s,a),o=p=>`
  ...
  ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
    ...
    ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
  }`;return{name:"Expand",shaderCache:{hint:`${a}`},getShaderSource:o,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}})}},Ws=e=>{oc(e.inputs),e.compute(sc(e.inputs),{inputs:[0]})}});var uc,lc,Vs,Us,Gs=L(()=>{"use strict";ge();Pe();ve();uc=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},lc=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,s=z.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(s,1,...a);let l=r[s],o=z.size(u),p=F("data",e[0].dataType,e[0].dims),m=F("inputIndices",e[1].dataType,e[1].dims),b=X("output",e[0].dataType,u),g=()=>{let $=a.length,w=`var indicesIndices  = ${m.type.indices}(0);`;for(let C=0;C<$;C++)w+=`${$>1?`indicesIndices[${C}]`:"indicesIndices"} = ${u.length>1?`outputIndices[${s+C}]`:"outputIndices"};`;w+=`
      ...
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:v}},Vs=e=>se({axis:e.axis}),Us=(e,t)=>{let r=e.inputs;uc(r),e.compute(lc(e.inputs,t))}});var dc,cc,Fs,Ls,Hs=L(()=>{"use strict";ge();Pe();ve();dc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:$}},js=(e,t)=>{pc(e.inputs),e.compute(mc(e.inputs,t))},qs=e=>se(e)});var hc,gc,yc,bc,Ys,Xs,Js=L(()=>{"use strict";De();ge();Pe();ve();hc={name:"InstanceNormalization"},gc=(e,t)=>{let r=e[0].dims,a=r,n=2,s=z.sizeToDimension(r,n),u=z.sizeFromDimension(r,n),l=r[1],o=F("x",e[0].dataType,[r[0],r[1],u]),p=F("scale",e[1].dataType,e[1].dims),m=F("bias",e[2].dataType,e[2].dims),b=X("output",e[0].dataType,[r[0],r[1],u]),g=[o,p,m,b],v=o.type.value,$=64,w=C=>`
  ...
  }`;return{...hc,shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:s}}),getShaderSource:w}},yc=(e,t,r,a,n,s,u,l)=>{let o=yt(u),p=F("input",t.dataType,t.dims,o),m=F("scale",r.dataType,r.dims,o),b=F("bias",a.dataType,a.dims,o),g=64,v=o===1?"vec2f":`mat2x${o}f`,$=o===1?"f32":`vec${o}f`,w=(B,T)=>`${v}(${B}, ${T})`,C=n*u/o,I=Math.ceil(s/g),R=B=>`
  const H: u32 = ${s};
  const C: u32 = ${u/o};
  ...
  }`;return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:JSON.stringify({components:o,n,h:s,c:u,epsilon:l})},getRunData:()=>({outputs:[{dims:[n,u,2],dataType:1}],dispatchGroup:{x:Math.ceil(C/64)}}),getShaderSource:P},{inputs:[M,r,a],outputs:[-1]})[0]},bc=(e,t,r)=>{let a=t[0].dims,n=a,s=a[0],u=a[a.length-1],l=z.sizeFromDimension(a,1)/u,o=yt(u),p=z.size(n)/o,m=F("input",t[0].dataType,t[0].dims,o),b=X("output",t[0].dataType,n,o),g=ke(t[0].dataType),v=o===1?"vec2f":`mat2x${o}f`,$=o===1?g:`vec${o}<${g}>`,w=yc(e,t[0],t[1],t[2],s,l,u,r.epsilon),C=I=>`
  const H: u32 = ${l};
  const C: u32 = ${u/o};
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:C},{inputs:[t[0],w]})},Ys=e=>se({epsilon:e.epsilon,format:e.format}),Xs=(e,t)=>{t.format==="NHWC"?bc(e,e.inputs,t):e.compute(gc(e.inputs,t))}});var wc,vc,Qs,Zs,eu=L(()=>{"use strict";De();ge();Pe();ve();wc=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},vc=(e,t,r)=>{let a=e[0].dims,n=e[1],s=e[2],u=a,l=z.normalizeAxis(t.axis,a.length),o=z.sizeToDimension(a,l),p=z.sizeFromDimension(a,l),m=z.size(n.dims),b=s?z.size(s.dims):0;if(m!==p||s&&b!==p)throw new Error(`Size of X.shape()[axis:] == ${p}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${m} and bias size of ${b}`);let g=[];for(let P=0;P<a.length;++P)P<l?g.push(a[P]):g.push(1);let v=yt(p),$=ke(e[0].dataType),w=[F("x",e[0].dataType,e[0].dims,v),F("scale",n.dataType,n.dims,v)];s&&w.push(F("bias",s.dataType,s.dims,v)),w.push(X("output",e[0].dataType,u,v));let C=r>1,I=r>2;C&&w.push(X("meanDataOutput",1,g)),I&&w.push(X("invStdOutput",1,g));let R=P=>`
  ...
  ${P.mainStart()}
    ...
    for (var h: u32 = 0u; h < normSizeVectorized; h++) {
      let value = ${Nt($,v,"x[h + offset]")};
      meanVector += value;
      meanSquareVector += value * value;
    }
    let mean = ${It("meanVector",v)} / normSize;
    let meanSquare = sqrt(${It("meanSquareVector",v)} 
      / normSize - mean * mean + epsilon);

    for (var j: u32 = 0; j < normSizeVectorized; j++) {
      let f32input = ${Nt($,v,"x[j + offset]")};
      let f32scale = ${Nt($,v,"scale[j]")};
    ...
    ${I?"invStdOutput[global_idx] = 1 / meanSquare":""};
      ...
      `},Cc=(e,t,r,a,n)=>{let s=r.length,u="";for(let l=s-1;l>=0;--l)u+=`
          ...
          `},Ec=(e,t,r,a,n,s)=>{switch(n.mode){case 0:return Sc(e,t,r,a,n.pads,s,n.value);case 1:return Cc(e,t,r,a,n.pads);case 2:return Ic(e,t,r,a,n.pads);case 3:return Ac(e,t,r,a,n.pads);default:throw new Error("Invalid mode")}},_c=(e,t,r,a)=>{let n=t[0].dims,s=z.padShape(n.slice(),r.pads),u=z.size(s),l=z.computeStrides(n),o=X("output",t[0].dataType,s),p=F("x",t[0].dataType,n),m=Ec(o,s,n,l,r,a);return`
          ...
          }`},Oc=(e,t)=>{let r=z.padShape(e[0].dims.slice(),t.pads);return{name:"Pad",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(z.size(r)/64)}}),getShaderSource:a=>_c(a,e,t,"f32")}},Tc=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),a=e.length>=3&&e[2].data?e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let l=e[3].getBigInt64Array();for(let o=0;o<l.length;o++)s[Number(l[o])]=Number(r[o]),s[Number(l[o])+n]=Number(r[o+l.length])}else r.forEach((l,o)=>s[Number(o)]=Number(l));let u=[];return s.forEach(l=>u.push(l)),se({mode:t.mode,value:a,pads:u})}else return t},nu=(e,t)=>{xc(e.inputs);let r=Tc(e.inputs,t);e.compute(Oc(e.inputs,r),{inputs:[0]})},au=e=>{let t=e.mode,r=e.value,a=e.pads;return se({mode:t,value:r,pads:a})}});var yn,iu,su,uu,lu,du,cu,pu,fu,mu,hu,gu,yu,bu,wu,vu=L(()=>{"use strict";ge();Pe();ve();yn=e=>{if(!e||e.length!==1)throw new Error("Pool ops requires 1 input.");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("Pool ops supports 1-D or 2-D inputs only for now.")},iu=(e,t,r)=>{let a=t.format==="NHWC",n=e.dims.slice();a&&n.splice(1,0,n.pop());let s=Object.hasOwnProperty.call(t,"dilations"),u=t.kernelShape.slice(),l=t.strides.slice(),o=s?t.dilations.slice():[],p=t.pads.slice();Wt.adjustPoolAttributes(r,n,u,l,o,p);let m=Wt.computePoolOutputShape(r,n,l,o,u,p,t.autoPad),b=Object.assign({},t);s?Object.assign(b,{kernelShape:u,strides:l,pads:p,dilations:o,cacheKey:t.cacheKey}):Object.assign(b,{kernelShape:u,strides:l,pads:p,cacheKey:t.cacheKey});let g=m.slice();return g.push(g.splice(1,1)[0]),[b,a?g:m]},su=(e,t,r,a,n,s,u,l)=>{let o=n.format==="NHWC",p=r,m=t.type.value,b=p.length,g=z.size(a),v=X("output",t.type.tensor,a);if(n.kernelShape.length<=2){let $=n.kernelShape[n.kernelShape.length-1],w=n.strides[n.strides.length-1],C=n.pads[n.pads.length/2-1],I=n.pads[n.pads.length-1],R=b-(o?2:1),M="",P="",B="";if(C+I!==0?M=`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},uu=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),lu=(e,t,r,a)=>{let[n,s]=iu(t,a,r),u=z.size(n.kernelShape),l=F("x",t.dataType,t.dims),o=l.type.value,p="value += x_val;",m="";return n.countIncludePad?m+=`value /= ${o}(${u});`:m+=`value /= ${o}(${u} - pad);`,{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(s)/64)}}),getShaderSource:b=>su(b,l,t.dims,s,n,p,m,"0.0")}},du=e=>{let t=e.count_include_pad!==0,r=uu(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");return se({countIncludePad:t,...r})},cu=(e,t)=>{yn(e.inputs),e.compute(lu("AveragePool",e.inputs[0],!1,t))},pu={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},fu=e=>{let t=e.format;return{format:t,...pu,cacheKey:t}},mu=(e,t)=>{yn(e.inputs),e.compute(lu("GlobalAveragePool",e.inputs[0],!0,t))},hu=(e,t,r,a)=>{let[n,s]=iu(t,a,r),u=`
      value = max(x_val, value);
    `,l="",o=F("x",t.dataType,t.dims);return{name:e,shaderCache:{hint:a.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(s)/64)}}),getShaderSource:p=>su(p,o,t.dims,s,n,u,l,"-1e5")}},gu=(e,t)=>{yn(e.inputs),e.compute(hu("MaxPool",e.inputs[0],!1,t))},yu=e=>{let t=e.storage_order,r=e.dilations,a=uu(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return se({storageOrder:t,dilations:r,...a})},bu=e=>{let t=e.format;return{format:t,...pu,cacheKey:t}},wu=(e,t)=>{yn(e.inputs),e.compute(hu("GlobalMaxPool",e.inputs[0],!0,t))}});var Pc,kc,$u,xu=L(()=>{"use strict";St();De();ve();Pc=(e,t,r)=>{let a=e===t,n=e<t&&r<0,s=e>t&&r>0;if(a||n||s)throw new Error("Range these inputs' contents are invalid.")},kc=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),s=[n],u=n,l=X("output",a,s),o=l.type.storage,p=m=>`
        ${m.declareVariables(l)}
        ${m.mainStart()}
        ${m.guardAgainstOutOfBoundsWorkgroupSizes(u)}
        output[global_idx] = ${o}(${e}) + ${o}(global_idx) * ${o}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(m=>m.toString()).join("_")},getShaderSource:p,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)}})}},$u=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Ce.webgpu.validateInputContent&&Pc(t,r,a),e.compute(kc(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var Mc,Bc,Dc,zc,Wc,Nc,Vc,Uc,Gc,Fc,Lc,Hc,jc,qc,Kc,Su,Cu,Iu=L(()=>{"use strict";ge();Pe();ve();Mc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},Bc=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let a=new Array(r).fill(1);return t.forEach((n,s)=>a[n]=e[s]),a},Dc=(e,t,r,a,n,s)=>{let[u,l,o]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],p=e[0].dims.length;if(u>0&&e.length>u&&e[u].dims.length>0)e[u].getFloat32Array().forEach(m=>s.push(m));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length>0){if(e[l].getFloat32Array().forEach(m=>a.push(m)),a.length!==0&&a.length!==p&&r>=18&&a.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");Mc(a,t),t.axes.length>0&&Bc(a,t.axes,p).forEach((m,b)=>a[b]=m)}if(o>0&&e.length>o&&(e[o].getBigInt64Array().forEach(m=>n.push(Number(m))),n.length!==p||r>=18&&n.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(a.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof a<"u"&&typeof n<"u"&&a.length>0&&n.length>p)throw new Error("Resize requires only of scales or sizes to be specified")},zc=e=>"fn getOriginalCoordinateFromResizedCoordinate(xResized: f32, xScale: f32, lengthResized: f32,    lengthOriginal: f32, roiStart: f32, roiEnd: f32) -> f32 { "+(()=>{switch(e){case"asymmetric":return"return xResized / xScale;";case"pytorch_half_pixel":return"if (lengthResized > 1) {                     return (xResized + 0.5) / xScale - 0.5;                   } else {                     return 0.0;                   }";case"tf_half_pixel_for_nn":return"return (xResized + 0.5) / xScale;";case"align_corners":return"if (lengthResized == 1) {                     return 0.0;                   } else {                     return xResized * (lengthOriginal - 1) / (lengthResized - 1);                   }";case"tf_crop_and_resize":return"if (lengthResized > 1) {                     return roiStart * (lengthOriginal - 1) +                           (xResized * (roiEnd - roiStart) * (lengthOriginal - 1)) / (lengthResized - 1);                   } else {                     return 0.5 * (roiStart + roiEnd) * f32(lengthOriginal - 1);                   }";case"half_pixel_symmetric":return["const outputWidth = xScale * lengthResized;","const adjustment = lengthResized / outputWidth;","const center = lengthOriginal / 2;","const offset = center * (1 - adjustment);","return offset + ((xResized + 0.5) / xScale) - 0.5;"].join(`
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Wc=(e,t)=>"fn getNearestPixelFromOriginal(xOriginal: f32, isDownSample: bool) -> f32 {"+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",Nc=(e,t,r)=>{let a=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?a:e.slice();return t.length>0?(t.forEach((s,u)=>{a[s]=n[u],a[u+r]=n[t.length+u]}),a):n},Vc=(e,t,r,a)=>{let n=[];if(r.length>0)if(a.length>0){if(e.forEach(s=>n.push(s)),Math.max(...a)>e.length)throw new Error("axes is out of bound");a.forEach((s,u)=>n[s]=r[u])}else r.forEach(s=>n.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((s,u)=>Math.round(s*t[u]))}return n},Uc=(e,t,r,a)=>{let n=(()=>{switch(a.keepAspectRatioPolicy){case"not_larger":return a.axes.length>0?Math.min(...a.axes.map(u=>r[u]),Number.MAX_VALUE):Math.min(...r,Number.MAX_VALUE);case"not_smaller":return a.axes.length>0?Math.max(...a.axes.map(u=>r[u]),Number.MIN_VALUE):Math.max(...r,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${a.keepAspectRatioPolicy} is not supported`)}})();r.fill(1,0,r.length);let s=e.slice();return a.axes.length>0?(a.axes.forEach(u=>r[u]=n),a.axes.forEach(u=>s[u]=Math.round(e[u]*r[u]))):(r.fill(n,0,r.length),s.forEach((u,l)=>s[l]=Math.round(u*r[l]))),s},Gc=(e,t,r,a,n)=>`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> f32 {
    ...
    `},qc=(e,t,r,a,n,s)=>{let u=e.dims,l=Nc(s,t.axes,u.length),o=Vc(u,a,n,t.axes),p=a.slice();a.length===0&&(p=u.map((C,I)=>C===0?1:o[I]/C),t.keepAspectRatioPolicy!=="stretch"&&(o=Uc(u,o,p,t)));let m=X("output",e.dataType,o),b=F("input",e.dataType,u),g=z.size(o),v=u.length===o.length&&u.every((C,I)=>C===o[I]),$=t.coordinateTransformMode==="tf_crop_and_resize",w=C=>`
      ...
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${r}|${p.length>0?p:""}|${n.length>0?n:""}`},getShaderSource:w,getRunData:()=>({outputs:[{dims:o,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(g/64)}})}},Kc=e=>{let t=e.customDataBuffer;return new Uint32Array(t,t.byteOffset,1)[0]},Su=(e,t)=>{let r=[],a=[],n=[],s=Kc(e);Dc(e.inputs,t,s,r,a,n),e.compute(qc(e.inputs[0],t,s,r,a,n),{inputs:[0]})},Cu=e=>{let t=e.antialias,r=e.axes,a=e.coordinateTransformMode,n=e.cubicCoeffA,s=e.excludeOutside!==0,u=e.extrapolationValue,l=e.keepAspectRatioPolicy,o=e.mode,p=e.nearestMode===""?"simple":e.nearestMode;return se({antialias:t,axes:r,coordinateTransformMode:a,cubicCoeffA:n,excludeOutside:s,extrapolationValue:u,keepAspectRatioPolicy:l,mode:o,nearestMode:p})}});var Yc,Xc,Au,Eu,_u=L(()=>{"use strict";De();ge();Pe();ve();Yc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],a=e[2];if(t.dataType!==r.dataType||t.dataType!==a.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let n=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==n)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(a.dims.length!==1)throw new Error("Gamma must be 1D");if(a.dims[a.dims.length-1]!==n)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let u=e[3];if(u.dims.length!==1)throw new Error("Beta must be 1D");if(u.dims[u.dims.length-1]!==n)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let u=e[4];if(u.dims.length!==1)throw new Error("Bias must be 1D");if(u.dims[u.dims.length-1]!==n)throw new Error("Bias must have the same hidden size as input")}},Xc=(e,t,r,a)=>{let n=e[0].dims,s=z.size(n),u=n,l=s,o=n.slice(-1)[0],p=a?n.slice(0,-1).concat(1):[],m=e.length>3,b=e.length>4,g=a&&r>1,v=a&&r>2,$=r>3,w=yt(o),C=[F("x",e[0].dataType,e[0].dims,w),F("skip",e[1].dataType,e[1].dims,w),F("gamma",e[2].dataType,e[2].dims,w)];m&&C.push(F("beta",e[3].dataType,e[3].dims,w)),b&&C.push(F("bias",e[4].dataType,e[4].dims,w)),C.push(X("output",e[0].dataType,u,w)),g&&C.push(X("meanOutput",1,p)),v&&C.push(X("invStdOutput",1,p)),$&&C.push(X("inputSkipBiasSum",e[0].dataType,u,w));let I=ke(e[0].dataType),R=P=>`
      ...
      ${P.mainStart()}
        ...
        for (var i: u32 = 0; i < hiddenSizeVectorized; i++) {
          ...
          let f32Value = ${Nt(I,w,"value")};
          sum += f32Value;
          squareSum += f32Value * f32Value;
        }
        let mean = ${It("sum",w)} / hiddenSize;
        let variance = sqrt(${It("squareSum",w)} / hiddenSize - mean * mean + epsilon);
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${t.cacheKey}|${e[4]?.dims??""}`},getShaderSource:$,getRunData:()=>({outputs:[m],dispatchGroup:{x:Math.ceil(a/64)}})}},Tu=(e,t)=>{Jc(e.inputs,t);let r=Qc(e.inputs,t);e.compute(ep(e.inputs,r),{inputs:[0]})},Ru=e=>{let t=e.starts,r=e.ends,a=e.axes;return se({starts:t,ends:r,axes:a})}});var tp,rp,ku,Mu,Bu=L(()=>{"use strict";ge();Pe();ve();tp=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},rp=(e,t)=>{let r=ke(e.dataType),a=e.dims,n=z.size(a),s=64,u=t.axis;if(u<0&&(u=a.length+u),u<a.length-1)throw new Error("softmax only supports last axis for now.");let l=a[u],o=n/l,p=yt(l),m=l/p,b=p===1?r:`vec${p}<${r}>`,g=(w,C)=>C===4?`max(max(${w}.x, ${w}.y), max(${w}.z, ${w}.w))`:C===2?`max(${w}.x, ${w}.y)`:C===3?`max(max(${w}.x, ${w}.y), ${w}.z)`:w,v=r==="f32"?`var threadMax = ${b}(-3.402823e+38f);`:`var threadMax = ${b}(-65504.0h);`;return{name:"Softmax",getRunData:()=>({outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:o}}),getShaderSource:w=>`
      ...
      fn main(@builtin(local_invocation_id) local_id : vec3<u32>, @builtin(global_invocation_id) global_id : vec3u) {
        ...
        if (lindex == 0) {
          rowSumShared = ${b}(${It("threadShared[0]",p)});
        }
        workgroupBarrier();
      ...
      }`}},ku=(e,t)=>{tp(e.inputs),e.compute(rp(e.inputs[0],t))},Mu=e=>se({axis:e.axis})});var np,ap,op,ip,sp,Du,zu,Wu=L(()=>{"use strict";ge();Pe();ve();np=e=>{if(!e||e.length<1)throw new Error("too few inputs")},ap=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),se({numOutputs:a,axis:t.axis,splitSizes:r})},op=e=>`
...
`)}
  ...
  ${C.mainStart()}
    ...
    writeBufferData(outputNumber, indices, global_idx);
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:w,getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(a/64)}})}},Du=(e,t)=>{np(e.inputs);let r=e.inputs.length===1?t:ap(e.inputs,t);e.compute(sp(e.inputs,r),{inputs:[0]})},zu=e=>{let t=e.axis,r=e.splitSizes,a=e.numOutputs<0?r.length:e.numOutputs;if(a!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return se({axis:t,numOutputs:a,splitSizes:r})}});var Nu,up,lp,dp,Vu,Uu=L(()=>{"use strict";De();ge();ve();Nu=e=>Array.from(e.getBigInt64Array(),Number),up=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Nu(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},lp=(e,t)=>{let r=[];for(let a=0;a<e.length;++a)r.push(e[a]*t[a]);return r},dp=e=>{let t=e[0].dims,r=Nu(e[1]),a=lp(t,r),n=z.size(a),s=e[0].dataType,u=F("input",s,t),l=X("output",s,a),o=p=>`
      const inputShape = ${u.indices(...t)};
      ${p.declareVariables(u,l)}
      ${p.mainStart()}
      ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
      ...
      ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
    }`;return{name:"Tile",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:o}},Vu=e=>{up(e.inputs),e.compute(dp(e.inputs),{inputs:[0]})}});var cp,pp,Gu,Fu=L(()=>{"use strict";De();ge();ve();cp=(e,t,r,a,n)=>{let s=z.size(r),u=Math.ceil(s/4),l=X("outputData",n,r,4),o=F("aData",t[1].dataType,t[1].dims,4),p=F("bData",t[2].dataType,t[2].dims,4),m=F("cData",t[0].dataType,t[0].dims,4),b,g=(v,$,w)=>`select(${$}, ${v}, ${w})`;if(!a)b=l.setByOffset("global_idx",g(o.getByOffset("global_idx"),p.getByOffset("global_idx"),m.getByOffset("global_idx")));else{let v=($,w,C="")=>{let I=`aData[indexA${w}][componentA${w}]`,R=`bData[indexB${w}][componentB${w}]`,M=`bool(cData[indexC${w}] & ${4278190080>>>(3-w)*8}u)`;return`
