...
`)}},Lo=e=>new Vn(e),Hn=(e,t)=>{let r=e.length,o=[];for(let n=0;n<r;n++){let s=r-1-n,u=e[s]||1;(t[t.length-1-n]||1)>1&&u===1&&o.unshift(s)}return o},Ho=e=>e<=4});var st,Ul,Yr,Vl,ut,Fo,jo,qo,Ko,Yo,Xo,Jo,Qo,Zo,ei,et,Fn=L(()=>{"use strict";he();Pe();ve();st=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Ul=e=>["","",`var value = ${e.getByOffset("inputOffset")};`,""],Yr=(e,t,r,o,n,s,u=!1,l=!1)=>{let a=[],p=r[0].dims,h=z.normalizeAxes(n,r[0].dims.length),b=!l&&h.length===0;p.forEach((W,V)=>{b||h.indexOf(V)>=0?u&&a.push(1):a.push(W)});let g=[],v=H("_A",r[0].dataType,p),$=Q("output",s,a),w=o(v,$,h),S=`inputOffset = ${v.indicesToOffset("inputIndices")};`,I=`let ${S};`,T=`var ${S};`,B=w[1]===""?"":T,P=(w[1]===""?I:S)+`
...
`)}
        }`,getRunData:()=>({outputs:[{dims:a,dataType:s}],dispatchGroup:{x:Math.ceil(M/64)}})}},Vl=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),ie({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},ut=(e,t,r,o)=>{let n=e.inputs,s=n.length===1?r:Vl(n,r);e.compute(Yr(t,{hint:s.cacheKey},[n[0]],s.noopWithEmptyAxes&&s.axes.length===0?Ul:o,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},Fo=(e,t)=>{st(e.inputs),ut(e,"ReduceLogSum",t,(o,n)=>[`var value = ${n.type.storage}(0);`,"",`value += ${o.getByOffset("inputOffset")};`,"value = log(value);"])},jo=(e,t)=>{st(e.inputs),ut(e,"ReduceL1",t,(o,n)=>[`var value = ${n.type.storage}(0);`,"",`value += abs(${o.getByOffset("inputOffset")});`,""])},qo=(e,t)=>{st(e.inputs),ut(e,"ReduceL2",t,(o,n)=>[`var t = ${n.type.value}(0); var value = ${n.type.value}(0);`,"",`t = ${o.getByOffset("inputOffset")}; value += (t * t);`,"value = sqrt(value);"])},Ko=(e,t)=>{st(e.inputs),ut(e,"ReduceLogSumExp",t,(o,n)=>[`var value = ${n.type.storage}(0);`,"",`value += exp(${o.getByOffset("inputOffset")});`,"value = log(value);"])},Yo=(e,t)=>{st(e.inputs),ut(e,"ReduceMax",t,(o,n,s)=>{let u=[];for(let l=0;l<o.rank;l++)(s.indexOf(l)>=0||s.length===0)&&u.push(o.indicesSet("inputIndices",l,0));return[`${u.join(`
`)}`,`var value = ${o.getByOffset("inputOffset")};`,`value = max(value, ${o.getByOffset("inputOffset")});`,""]})},Xo=(e,t)=>{st(e.inputs),ut(e,"ReduceMean",t,(o,n,s)=>{let u=1;for(let l=0;l<o.rank;l++)(s.indexOf(l)>=0||s.length===0)&&(u*=e.inputs[0].dims[l]);return["var sum = f32(0);","",`sum += f32(${o.getByOffset("inputOffset")});`,`let value = ${n.type.value}(sum / ${u});`]})},Jo=(e,t)=>{st(e.inputs),ut(e,"ReduceMin",t,(o,n,s)=>{let u=[];for(let l=0;l<o.rank;l++)(s.indexOf(l)>=0||s.length===0)&&u.push(`inputIndices[${l}] = 0;`);return[`${u.join(`
`)}`,`var value = ${o.getByOffset("inputOffset")};`,`value = min(value, ${o.getByOffset("inputOffset")});`,""]})},Qo=(e,t)=>{st(e.inputs),ut(e,"ReduceProd",t,(o,n)=>[`var value = ${n.type.storage}(1);`,"",`value *= ${o.getByOffset("inputOffset")};`,""])},Zo=(e,t)=>{st(e.inputs),ut(e,"ReduceSum",t,(o,n)=>[`var value = ${n.type.storage}(0);`,"",`value += ${o.getByOffset("inputOffset")};`,""])},ei=(e,t)=>{st(e.inputs),ut(e,"ReduceSumSquare",t,(o,n)=>[`var t = ${n.type.value}(0); var value = ${n.type.value}(0);`,"",`t = ${o.getByOffset("inputOffset")}; value += t * t;`,""])},et=e=>ie(e)});var ti,ri,ni,ai,jn,oi=L(()=>{"use strict";De();Pe();Fn();ti=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},ri=(e,t)=>ie({axis:t.axis,keepDims:t.keepDims,selectLastIndex:t.selectLastIndex}),ni=(e,t)=>{ti(e.inputs);let r=(n,s,u)=>{let l=[];for(let a=0;a<n.rank;a++)(u.indexOf(a)>=0||u.length===0)&&l.push(`inputIndices[${a}] = 0;`);return[`${l.join(`
...
var bestIndex : i32 = 0;`,`if (${n.getByOffset("inputOffset")} ${t.selectLastIndex>0?"<=":"<"} value) {
       ...
       }`,"",s.setByOffset("global_idx","bestIndex")]},o=e.inputs.length===1?t:ri(e.inputs,t);e.compute(Yr("ArgMin",{hint:o.cacheKey},[e.inputs[0]],r,[o.axis],7,o.keepDims),{inputs:[0]})},ai=(e,t)=>{ti(e.inputs);let r=(n,s,u)=>{let l=[];for(let a=0;a<n.rank;a++)(u.indexOf(a)>=0||u.length===0)&&l.push(`inputIndices[${a}] = 0;`);return[`${l.join(`
`)}`,`var value = ${n.getByOffset("inputOffset")};
var bestIndex : i32 = 0;`,`if (${n.getByOffset("inputOffset")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${n.getByOffset("inputOffset")};
         bestIndex = i32(lastIndex);
       }`,"",s.setByOffset("global_idx","bestIndex")]},o=e.inputs.length===1?t:ri(e.inputs,t);e.compute(Yr("argMax",{hint:o.cacheKey},[e.inputs[0]],r,[o.axis],7,o.keepDims),{inputs:[0]})},jn=e=>ie(e)});var Ll,Hl,ii,si=L(()=>{"use strict";he();ve();Ll=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Hl=e=>{let t=e[0].dims,r=e[0].dims[2],o=z.size(t)/4,n=e[0].dataType,s=H("input",n,t,4),u=H("bias",n,[r],4),l=H("residual",n,t,4),a=Q("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:h=>`
  ...
  }`}},ii=e=>{Ll(e.inputs),e.compute(Hl(e.inputs))}});var Fl,$e,ui,li,di,ci,pi,fi,mi,hi,gi,qn,jl,yi,bi,wi,vi,Xr,$i,Jr,xi,Si,Ci,Ii,Ai,_i,Ei,Oi,Ti,Ri,Pi,ki,Bi,Mi,Di,zi,Wi,Kn=L(()=>{"use strict";De();he();Pe();ve();Fl=(e,t,r,o,n,s)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let a=H("inputData",r,[u],4),p=Q("outputData",o,[u],4);return`
  ...
  }`},$e=(e,t,r,o,n,s=e.dataType)=>({name:t,shaderCache:{hint:n},getShaderSource:u=>Fl(u,z.size(e.dims),e.dataType,s,r,o),getRunData:u=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(z.size(u[0].dims)/64/4)}})}),ui=e=>{e.compute($e(e.inputs[0],"Abs","abs"))},li=e=>{e.compute($e(e.inputs[0],"Acos","acos"))},di=e=>{e.compute($e(e.inputs[0],"Acosh","acosh"))},ci=e=>{e.compute($e(e.inputs[0],"Asin","asin"))},pi=e=>{e.compute($e(e.inputs[0],"Asinh","asinh"))},fi=e=>{e.compute($e(e.inputs[0],"Atan","atan"))},mi=e=>{e.compute($e(e.inputs[0],"Atanh","atanh"))},hi=e=>ie(e),gi=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($e(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},qn=(e,t)=>{let r=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Clip",o=>`clamp(${o}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${r}> = vec4(${r}(${t.min}));
    const clip_max_: vec4<${r}> = vec4(${r}(${t.max}));
`,t.cacheKey),{inputs:[0]})},jl=e=>{let t=e.length>=2?e[1].getFloat32Array()[0]:qr,r=e.length>=3?e[2].getFloat32Array()[0]:Kr;return ie({min:t,max:r})},yi=e=>{let t=jl(e.inputs);qn(e,t)},bi=e=>{e.compute($e(e.inputs[0],"Ceil","ceil"))},wi=e=>{e.compute($e(e.inputs[0],"Cos","cos"))},vi=e=>{e.compute($e(e.inputs[0],"Cosh","cosh"))},Xr=e=>ie(e),$i=(e,t)=>{e.compute($e(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
fn erf_vf32(v: ${e}) -> ${e} {
...
}`,xi=e=>{let t=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Jr(`vec4<${t}>`,t)))},Si=e=>{e.compute($e(e.inputs[0],"Exp","exp"))},Ci=e=>{e.compute($e(e.inputs[0],"Floor","floor"))},Ii=e=>{let t=ke(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Jr(`vec4<${t}>`,t)))},Ai=(e,t)=>{e.compute($e(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<f32>(0.0))`,`const leaky_relu_alpha_: f32 = f32(${t.alpha});`,t.cacheKey))},_i=e=>{e.compute($e(e.inputs[0],"Not",t=>`!${t}`))},Ei=e=>{e.compute($e(e.inputs[0],"Neg",t=>`-${t}`))},Oi=e=>{e.compute($e(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ti=e=>{e.compute($e(e.inputs[0],"Relu",t=>`select(vec4<f32>(0.0), ${t}, ${t} > vec4<f32>(0.0))`))},Ri=e=>{e.compute($e(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Pi=e=>{e.compute($e(e.inputs[0],"Sin","sin"))},ki=e=>{e.compute($e(e.inputs[0],"Sinh","sinh"))},Bi=e=>{e.compute($e(e.inputs[0],"Sqrt","sqrt"))},Mi=e=>{e.compute($e(e.inputs[0],"Tan","tan"))},Di=e=>{e.compute($e(e.inputs[0],"Tanh","tanh"))},zi=(e,t)=>(e.compute($e(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<f32>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_: vec4<f32> = vec4<f32>(${t.alpha});`,t.cacheKey)),0),Wi=e=>{e.compute($e(e.inputs[0],"Log","log"))}});var Kl,Yl,Ni,Gi=L(()=>{"use strict";he();ve();Kn();Kl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Yl=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=H("input",e[0].dataType,e[0].dims,4),o=H("bias",e[0].dataType,[e[0].dims[2]],4),n=Q("output",e[0].dataType,t,4),s=z.size(t)/4;return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:l=>`
  ...
  ${l.mainStart()}
    ...
    ${n.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${B}
      }`},Jl=(e,t,r,o,n,s,u=r.dataType)=>{let l=!z.areEqual(r.dims,o.dims),a=r.dims,p=z.size(r.dims),h=!1;if(l){let b=it.calcShape(r.dims,o.dims,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");a=b,p=z.size(a);let g=z.size(r.dims)===1,v=z.size(o.dims)===1,$=1;for(let w=1;w<a.length;w++){let S=r.dims[r.dims.length-w]??1,I=o.dims[o.dims.length-w]??1;if(S===I)$*=S;else break}($%4===0||g||v)&&(h=!0)}else h=!0;return{name:e,shaderCache:{hint:t},getShaderSource:b=>Xl(b,r.dims,o.dims,a,h,l,n,r.dataType,o.dataType,u,s),getRunData:()=>({outputs:[{dims:a,dataType:u}],dispatchGroup:{x:Math.ceil(p/64/4)}})}},lt=(e,t,r,o,n,s)=>{e.compute(Jl(t,n??"",e.inputs[0],e.inputs[1],r,o,s))},Ui=e=>{lt(e,"Add",(t,r)=>`${t}+${r}`)},Vi=e=>{lt(e,"Div",(t,r)=>`${t}/${r}`)},Li=e=>{lt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Hi=e=>{lt(e,"Mul",(t,r)=>`${t}*${r}`)},Fi=e=>{let t=H("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;lt(e,"Pow",{scalar:(o,n)=>`pow_custom(${o},${n})`,vector:(o,n)=>`pow_vector_custom(${o},${n})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ji=e=>{lt(e,"Sub",(t,r)=>`${t}-${r}`)},qi=e=>{lt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},Ki=e=>{lt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Yi=e=>{lt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},Xi=e=>{lt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Zl,ed,td,rd,Qi,Zi,es=L(()=>{"use strict";he();Pe();ve();Zl=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let o of e){if(o.dataType!==t)throw new Error("input tensors should be one type");if(o.dims.length!==r)throw new Error("input tensors should have the same shape")}},ed=e=>`
...
`)},rd=(e,t)=>{let r=e[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");let o=t<0?r.length+t:t,n=r.slice(0);for(let v=1;v<e.length;v++){let $=e[v].dims.slice();for(let w=0;w<r.length;w++)if(w===o)n[o]+=$[w];else if(r[w]!==$[w])throw new Error("non concat dimensions must match")}let s=z.size(n),u=new Array(e.length),l=new Array(e.length),a=e[0].dataType,p=0;for(let v=0;v<e.length;++v)p+=e[v].dims[o],u[v]=p,l[v]=H(`input${v}`,a,e[v].dims);let h=Q("output",a,n),b=h.indicesGet("indices",o),g=v=>`
  ...
  ${v.mainStart()}
    ...
    ${td(l,h)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:g}},Qi=(e,t)=>{Zl(e.inputs),e.compute(rd(e.inputs,t.axis))},Zi=e=>ie({axis:e.axis})});var ze,Qr,Zr,en=L(()=>{"use strict";ze=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Qr=(e,t=!1,r=!1,o=3)=>"",Zr=(e,t)=>`
...
bIndices[${B-2}] = u32(row);
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${R}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${$?`vec4<${K}>`:K}) {
        ...
        ${sd(a,V,Y,le,u,t.activation.toLowerCase(),!1,D[0],D[1],D[2],K)}
            ${$?fr(T,I,K,void 0,!a,W):mr(T,I,K,void 0,!a,W,!1,void 0,l)}`}}});var Xn,as=L(()=>{"use strict";he();ve();Qn();pr();Xn=(e,t,r)=>{let o=e.length>2,n=o?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,l=u[0]/t.group,{activationFunction:a,applyActivation:p}=rn(t),h=t.format==="NHWC",b=Jn(s,u,t.dilations,t.pads,t.strides,h),g=z.size(b),v=Q("output",e[0].dataType,b),$=H("x",e[0].dataType,s),w=H("w",e[1].dataType,u),S=[$,w];o&&S.push(H("b",e[2].dataType,e[2].dims));let I=T=>`
  ...
  }`;return{name:"GroupedConv",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r?r(b):b,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)}}),getShaderSource:I}}});var ud,os,ld,dd,Vt,is,ss,on=L(()=>{"use strict";he();Pe();ve();ud=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},os=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,ld=(e,t)=>z.sortBasedOnPerm(e,os(e.length,t)),dd=(e,t,r,o)=>{let n=[];n.push(`fn perm(i: ${o.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)n.push(r.indicesSet("a",e[s],`i[${s}]`));return n.push("return a;}"),n.join(`
`)},Vt=(e,t)=>{let r=e.dataType,o=e.dims.length,n=os(o,t),s=Ho(o),u=ld(e.dims,n),l=s?u.length:u,a=s?o:e.dims,p=Q("output",r,l),h=H("a",r,a),b=g=>`
  ...
  }`;return{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:s?["rank"]:["dims"]},getRunData:g=>{let v=z.size(u);return{outputs:[{dims:u,dataType:g[0].dataType}],dispatchGroup:{x:Math.ceil(v/64)},programUniforms:s?[{type:"uint32",data:v},...Ln(g[0].dims),...Ln(u)]:[{type:"uint32",data:v}]}},getShaderSource:b}},is=(e,t)=>{ud(e.inputs),e.compute(Vt(e.inputs[0],t.perm))},ss=e=>ie({perm:e.perm})});var Jn,us,cd,ls,Zn,pd,fd,ea,Qn=L(()=>{"use strict";he();Pe();ns();hr();as();pr();on();Jn=(e,t,r,o,n,s)=>{let u=e[0],l=e.slice(s?1:2,s?3:4),a=l.length,p=t[0],b=t.slice(2).map(($,w)=>$+($-1)*(r[w]-1)),v=l.map(($,w)=>$+o[w]+o[w+a]).map(($,w)=>Math.floor(($-b[w]+n[w])/n[w]));return v.splice(0,0,u),v.splice(s?3:1,0,p),v},us=[2,3,1,0],cd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],o=e[1].dims[1]*t.group;if(r!==o)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let n=e[0].dims.length-2;if(t.dilations.length!==n)throw new Error(`dilations should be ${n}D`);if(t.strides.length!==n)throw new Error(`strides should be ${n}D`);if(t.pads.length!==n*2)throw new Error(`pads should be ${n*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},ls=(e,t)=>{let r=e.kernelShape.slice();for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let o=e.pads.slice();Et.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,o,e.format==="NHWC",e.autoPad);let n=Object.assign({},e);return Object.assign(n,{kernelShape:r,pads:o,cacheKey:e.cacheKey}),n},Zn=e=>{let t=nn(e),r=e.format,o=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],n=e.dilations,s=e.group,u=e.kernel_shape,l=e.pads,a=e.strides,p=e.w_is_const();return ie({autoPad:o,format:r,dilations:n,group:s,kernelShape:u,pads:l,strides:a,wIsConst:p,...t})},pd=(e,t,r)=>{let o=ls(r,t);if(r.group!==1){e.compute(Xn(t,o));return}let n=r.format==="NHWC",s=t.length===3,u=t[0].dims[n?1:2],l=t[0].dims[n?2:3],a=t[0].dims[n?3:1],p=t[1].dims[2],h=t[1].dims[3],b=Jn(t[0].dims,t[1].dims,r.dilations,o.pads,r.strides,n),g=b[n?1:2],v=b[n?2:3],$=b[n?3:1],w=n&&p===u&&h===l&&r.pads[0]===0&&r.pads[1]===0;if(w||p===1&&h===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let R=b[0],W,V,Y,le=[];if(n){let D=e.kernelCustomData.wT??e.compute(Vt(t[1],us),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=D),w){let K=u*l*a;W=t[0].reshape([1,R,K]),V=D.reshape([1,K,$]),Y=[1,R,$]}else W=t[0].reshape([R,u*l,a]),V=D.reshape([1,a,$]),Y=[R,g*v,$];le.push(W),le.push(V)}else W=t[0].reshape([R,a,u*l]),V=t[1].reshape([1,$,a]),Y=[R,$,g*v],le.push(V),le.push(W);s&&le.push(t[2]),e.compute(an(le,o,b,Y,n),{inputs:le});return}let S=!0,I=e.kernelCustomData.wT??e.compute(Vt(t[1],us),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let T=[t[0],I];s&&T.push(t[2]);let B=n?g*v:$,P=n?$:g*v,M=p*h*a;e.compute(rs(T,o,b,B,P,M,s,S),{inputs:T})},fd=(e,t)=>{let r=t.format==="NHWC",o=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&o.push(e.inputs[2]);let n=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),u=[1].concat(t.dilations),l=[1].concat(t.kernelShape),a=ls({...t,pads:n,strides:s,dilations:u,kernelShape:l},o);e.compute(Xn(o,a,p=>r?[p[0],p[2],p[3]]:[]))},ea=(e,t)=>{cd(e.inputs,t),e.inputs[0].dims.length===3?fd(e,t):pd(e,e.inputs,t)}});var md,ds,cs=L(()=>{"use strict";wt();he();en();Yn();hr();md=(e,t=!1,r,o=!1,n=4)=>{let s=ze(n,"f32"),u=I=>{switch(I){case 1:return"return W[getIndexFromCoords4D(coord, wShape)];";case 4:return`
...
`)}
        ...
        ${$?fr(T,I,"f32",void 0,!a,M):mr(T,I,"f32",void 0,!a,M,!1,void 0,l)}`}}});var hd,ta,ps=L(()=>{"use strict";wt();he();ve();hd=(e,t,r,o,n,s,u=!1,l)=>{let a=r.format==="NHWC",p=a?1:2,h=a?2:3,b=a?3:1,g=z.size(o),v=u?2:1,$=r.group,w=t[1].dims,S=w[0]/$,I=w[1],T=`
...
`)};
      ...
      }`;return{name:"Einsum",shaderCache:{hint:t.equation},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:T}},bs=(e,t)=>{let r=new aa(e.inputs,t.equation);e.compute(Id(e.inputs,r))},ws=e=>{let t=e.equation.replace(/\s+/g,"");return ie({equation:t})}});var Ad,$s,_d,Ed,xs,Ss=L(()=>{"use strict";he();ve();Ad=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;o<r.length&&n<t.length;++o,++n)if(r[o]!==t[n]&&r[o]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},$s=(e,t)=>{let r=e.length-t.length,o=[];for(let n=0;n<r;++n)o.push(e[n]);for(let n=0;n<t.length;++n)o.push(t[n]===1?e[n+r]:t[n]);return o},_d=(e,t)=>e.length>t.length?$s(e,t):$s(t,e),Ed=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=_d(t,r),n=z.size(o),s=e[0].dataType,u=H("input",s,t),l=Q("output",s,o),a=p=>`
  ...
  ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
    ...
    ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
  }`;return{name:"Expand",shaderCache:{hint:`${o}`},getShaderSource:a,getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}})}},xs=e=>{Ad(e.inputs),e.compute(Ed(e.inputs),{inputs:[0]})}});var Od,Td,Cs,Is,As=L(()=>{"use strict";he();Pe();ve();Od=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Td=(e,t)=>{let r=e[0].dims,o=e[1].dims,n=r.length,s=z.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(s,1,...o);let l=r[s],a=z.size(u),p=H("data",e[0].dataType,e[0].dims),h=H("inputIndices",e[1].dataType,e[1].dims),b=Q("output",e[0].dataType,u),g=()=>{let $=o.length,w=`var indicesIndices  = ${h.type.indices}(0);`;for(let S=0;S<$;S++)w+=`${$>1?`indicesIndices[${S}]`:"indicesIndices"} = ${u.length>1?`outputIndices[${s+S}]`:"outputIndices"};`;w+=`
      ...
      }`;return{name:"Gather",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:v}},Cs=e=>ie({axis:e.axis}),Is=(e,t)=>{let r=e.inputs;Od(r),e.compute(Td(e.inputs,t))}});var Rd,Pd,_s,Es,Os=L(()=>{"use strict";he();Pe();ve();Rd=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`)}
  ...
  }`;return{name:"Gemm",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:$}},Ts=(e,t)=>{kd(e.inputs),e.compute(Md(e.inputs,t))},Rs=e=>ie(e)});var Dd,zd,Wd,Nd,ks,Bs,Ms=L(()=>{"use strict";De();he();Pe();ve();Dd={name:"InstanceNormalization"},zd=(e,t)=>{let r=e[0].dims,o=r,n=2,s=z.sizeToDimension(r,n),u=z.sizeFromDimension(r,n),l=r[1],a=H("x",e[0].dataType,[r[0],r[1],u]),p=H("scale",e[1].dataType,e[1].dims),h=H("bias",e[2].dataType,e[2].dims),b=Q("output",e[0].dataType,[r[0],r[1],u]),g=[a,p,h,b],v=a.type.value,$=64,w=S=>`
  ...
  }`;return{...Dd,shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:s}}),getShaderSource:w}},Wd=(e,t,r,o,n,s,u,l)=>{let a=pt(u),p=H("input",t.dataType,t.dims,a),h=H("scale",r.dataType,r.dims,a),b=H("bias",o.dataType,o.dims,a),g=64,v=a===1?"vec2f":`mat2x${a}f`,$=a===1?"f32":`vec${a}f`,w=(M,R)=>`${v}(${M}, ${R})`,S=n*u/a,I=Math.ceil(s/g),T=M=>`
  const H: u32 = ${s};
  const C: u32 = ${u/a};
  ...
  }`;e.compute({name:"InstanceNormalization",shaderCache:{hint:`${r.cacheKey}`},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)}}),getShaderSource:S},{inputs:[t[0],w]})},ks=e=>ie({epsilon:e.epsilon,format:e.format}),Bs=(e,t)=>{t.format==="NHWC"?Nd(e,e.inputs,t):e.compute(zd(e.inputs,t))}});var Gd,Ud,Ds,zs,Ws=L(()=>{"use strict";De();he();Pe();ve();Gd=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Ud=(e,t,r)=>{let o=e[0].dims,n=e[1],s=e[2],u=o,l=z.normalizeAxis(t.axis,o.length),a=z.sizeToDimension(o,l),p=z.sizeFromDimension(o,l),h=z.size(n.dims),b=s?z.size(s.dims):0;if(h!==p||s&&b!==p)throw new Error(`Size of X.shape()[axis:] == ${p}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${h} and bias size of ${b}`);let g=[];for(let P=0;P<o.length;++P)P<l?g.push(o[P]):g.push(1);let v=pt(p),$=ke(e[0].dataType),w=[H("x",e[0].dataType,e[0].dims,v),H("scale",n.dataType,n.dims,v)];s&&w.push(H("bias",s.dataType,s.dims,v)),w.push(Q("output",e[0].dataType,u,v));let S=r>1,I=r>2;S&&w.push(Q("meanDataOutput",1,g)),I&&w.push(Q("invStdOutput",1,g));let T=P=>`
  ...
  ${P.mainStart()}
    ...
    for (var h: u32 = 0u; h < normSizeVectorized; h++) {
      let value = ${Ot($,v,"x[h + offset]")};
      meanVector += value;
      meanSquareVector += value * value;
    }
    let mean = ${vt("meanVector",v)} / normSize;
    let meanSquare = sqrt(${vt("meanSquareVector",v)} 
      / normSize - mean * mean + epsilon);

    for (var j: u32 = 0; j < normSizeVectorized; j++) {
      let f32input = ${Ot($,v,"x[j + offset]")};
      let f32scale = ${Ot($,v,"scale[j]")};
    ...
    ${I?"invStdOutput[global_idx] = 1 / meanSquare":""};
  }`,B=[{dims:u,dataType:e[0].dataType}];return S&&B.push({dims:g,dataType:1}),I&&B.push({dims:g,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${t.cacheKey}|${r}|${e.length}`},getRunData:()=>({outputs:B,dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:T}},Ds=e=>ie({axis:e.axis,epsilon:e.epsilon}),zs=(e,t)=>{Gd(e.inputs),e.compute(Ud(e.inputs,t,e.outputCount))}});var Vd,Ns,Gs=L(()=>{"use strict";he();hr();Vd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Ns=e=>{Vd(e.inputs);let t=it.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");e.compute(an(e.inputs,{activation:"",activationCacheKey:""},t))}});var Ld,Hd,Fd,jd,qd,Kd,Yd,Xd,Jd,Us,Vs,Ls=L(()=>{"use strict";De();he();Pe();ve();Ld=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1)throw new Error("Input type must be float.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Hd=(e,t,r,o,n,s,u)=>{let l=r.length,a="";for(let p=l-1;p>=0;--p)a+=`
      ...
      `},Fd=(e,t,r,o,n)=>{let s=r.length,u="";for(let l=s-1;l>=0;--l)u+=`
          ...
          `},Kd=(e,t,r,o,n,s)=>{switch(n.mode){case 0:return Hd(e,t,r,o,n.pads,s,n.value);case 1:return Fd(e,t,r,o,n.pads);case 2:return jd(e,t,r,o,n.pads);case 3:return qd(e,t,r,o,n.pads);default:throw new Error("Invalid mode")}},Yd=(e,t,r,o)=>{let n=t[0].dims,s=z.padShape(n.slice(),r.pads),u=z.size(s),l=z.computeStrides(n),a=Q("output",t[0].dataType,s),p=H("x",t[0].dataType,n),h=Kd(a,s,n,l,r,o);return`
          ...
          }`},Xd=(e,t)=>{let r=z.padShape(e[0].dims.slice(),t.pads);return{name:"Pad",shaderCache:{hint:t.cacheKey},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(z.size(r)/64)}}),getShaderSource:o=>Yd(o,e,t,"f32")}},Jd=(e,t)=>{if(e.length>1){let r=e[1].getBigInt64Array(),o=e.length>=3&&e[2].data?e[2].getFloat32Array()[0]:0,n=e[0].dims.length,s=new Int32Array(2*n).fill(0);if(e.length>=4){let l=e[3].getBigInt64Array();for(let a=0;a<l.length;a++)s[Number(l[a])]=Number(r[a]),s[Number(l[a])+n]=Number(r[a+l.length])}else r.forEach((l,a)=>s[Number(a)]=Number(l));let u=[];return s.forEach(l=>u.push(l)),ie({mode:t.mode,value:o,pads:u})}else return t},Us=(e,t)=>{Ld(e.inputs);let r=Jd(e.inputs,t);e.compute(Xd(e.inputs,r),{inputs:[0]})},Vs=e=>{let t=e.mode,r=e.value,o=e.pads;return ie({mode:t,value:r,pads:o})}});var un,Hs,Fs,js,qs,Ks,Ys,Xs,Js,Qs,Zs,eu,tu,ru,nu,au=L(()=>{"use strict";he();Pe();ve();un=e=>{if(!e||e.length!==1)throw new Error("Pool ops requires 1 input.");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("Pool ops supports 1-D or 2-D inputs only for now.")},Hs=(e,t,r)=>{let o=t.format==="NHWC",n=e.dims.slice();o&&n.splice(1,0,n.pop());let s=Object.hasOwnProperty.call(t,"dilations"),u=t.kernelShape.slice(),l=t.strides.slice(),a=s?t.dilations.slice():[],p=t.pads.slice();Et.adjustPoolAttributes(r,n,u,l,a,p);let h=Et.computePoolOutputShape(r,n,l,a,u,p,t.autoPad),b=Object.assign({},t);s?Object.assign(b,{kernelShape:u,strides:l,pads:p,dilations:a,cacheKey:t.cacheKey}):Object.assign(b,{kernelShape:u,strides:l,pads:p,cacheKey:t.cacheKey});let g=h.slice();return g.push(g.splice(1,1)[0]),[b,o?g:h]},Fs=(e,t,r,o,n,s,u,l)=>{let a=n.format==="NHWC",p=r,h=t.type.value,b=p.length,g=z.size(o),v=Q("output",t.type.tensor,o);if(n.kernelShape.length<=2){let $=n.kernelShape[n.kernelShape.length-1],w=n.strides[n.strides.length-1],S=n.pads[n.pads.length/2-1],I=n.pads[n.pads.length-1],T=b-(a?2:1),B="",P="",M="";if(S+I!==0?B=`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},js=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),qs=(e,t,r,o)=>{let[n,s]=Hs(t,o,r),u=z.size(n.kernelShape),l=H("x",t.dataType,t.dims),a=l.type.value,p="value += x_val;",h="";return n.countIncludePad?h+=`value /= ${a}(${u});`:h+=`value /= ${a}(${u} - pad);`,{name:e,shaderCache:{hint:o.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(s)/64)}}),getShaderSource:b=>Fs(b,l,t.dims,s,n,p,h,"0.0")}},Ks=e=>{let t=e.count_include_pad!==0,r=js(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");return ie({countIncludePad:t,...r})},Ys=(e,t)=>{un(e.inputs),e.compute(qs("AveragePool",e.inputs[0],!1,t))},Xs={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},Js=e=>{let t=e.format;return{format:t,...Xs,cacheKey:t}},Qs=(e,t)=>{un(e.inputs),e.compute(qs("GlobalAveragePool",e.inputs[0],!0,t))},Zs=(e,t,r,o)=>{let[n,s]=Hs(t,o,r),u=`
      value = max(x_val, value);
    `,l="",a=H("x",t.dataType,t.dims);return{name:e,shaderCache:{hint:o.cacheKey},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(z.size(s)/64)}}),getShaderSource:p=>Fs(p,a,t.dims,s,n,u,l,"-1e5")}},eu=(e,t)=>{un(e.inputs),e.compute(Zs("MaxPool",e.inputs[0],!1,t))},tu=e=>{let t=e.storage_order,r=e.dilations,o=js(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(o.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");return ie({storageOrder:t,dilations:r,...o})},ru=e=>{let t=e.format;return{format:t,...Xs,cacheKey:t}},nu=(e,t)=>{un(e.inputs),e.compute(Zs("GlobalMaxPool",e.inputs[0],!0,t))}});var Zd,ec,ou,iu=L(()=>{"use strict";bt();De();ve();Zd=(e,t,r)=>{let o=e===t,n=e<t&&r<0,s=e>t&&r>0;if(o||n||s)throw new Error("Range these inputs' contents are invalid.")},ec=(e,t,r,o)=>{let n=Math.abs(Math.ceil((t-e)/r)),s=[n],u=n,l=Q("output",o,s),a=l.type.storage,p=h=>`
        ${h.declareVariables(l)}
        ${h.mainStart()}
        ${h.guardAgainstOutOfBoundsWorkgroupSizes(u)}
        output[global_idx] = ${a}(${e}) + ${a}(global_idx) * ${a}(${r});
      }`;return{name:"Range",shaderCache:{hint:[e,t,r].map(h=>h.toString()).join("_")},getShaderSource:p,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:Math.ceil(u/64)}})}},ou=e=>{let t=0,r=0,o=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],o=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],o=e.inputs[2].getFloat32Array()[0]),Ie.webgpu.validateInputContent&&Zd(t,r,o),e.compute(ec(t,r,o,e.inputs[0].dataType),{inputs:[]})}});var tc,rc,nc,ac,oc,ic,sc,uc,lc,dc,cc,pc,fc,mc,hc,su,uu,lu=L(()=>{"use strict";he();Pe();ve();tc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for linear mode")}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},rc=(e,t,r)=>{t.every(n=>n>=0&&n<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let o=new Array(r).fill(1);return t.forEach((n,s)=>o[n]=e[s]),o},nc=(e,t,r,o,n,s)=>{let[u,l,a]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],p=e[0].dims.length;if(u>0&&e.length>u&&e[u].dims.length>0)e[u].getFloat32Array().forEach(h=>s.push(h));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(l>0&&e.length>l&&e[l].dims.length>0){if(e[l].getFloat32Array().forEach(h=>o.push(h)),o.length!==0&&o.length!==p&&r>=18&&o.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");tc(o,t),t.axes.length>0&&rc(o,t.axes,p).forEach((h,b)=>o[b]=h)}if(a>0&&e.length>a&&(e[a].getBigInt64Array().forEach(h=>n.push(Number(h))),n.length!==p||r>=18&&n.length===t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(o.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(n.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof o<"u"&&typeof n<"u"&&o.length>0&&n.length>p)throw new Error("Resize requires only of scales or sizes to be specified")},ac=e=>"fn getOriginalCoordinateFromResizedCoordinate(xResized: f32, xScale: f32, lengthResized: f32,    lengthOriginal: f32, roiStart: f32, roiEnd: f32) -> f32 { "+(()=>{switch(e){case"asymmetric":return"return xResized / xScale;";case"pytorch_half_pixel":return"if (lengthResized > 1) {                     return (xResized + 0.5) / xScale - 0.5;                   } else {                     return 0.0;                   }";case"tf_half_pixel_for_nn":return"return (xResized + 0.5) / xScale;";case"align_corners":return"if (lengthResized == 1) {                     return 0.0;                   } else {                     return xResized * (lengthOriginal - 1) / (lengthResized - 1);                   }";case"tf_crop_and_resize":return"if (lengthResized > 1) {                     return roiStart * (lengthOriginal - 1) +                           (xResized * (roiEnd - roiStart) * (lengthOriginal - 1)) / (lengthResized - 1);                   } else {                     return 0.5 * (roiStart + roiEnd) * f32(lengthOriginal - 1);                   }";case"half_pixel_symmetric":return["const outputWidth = xScale * lengthResized;","const adjustment = lengthResized / outputWidth;","const center = lengthOriginal / 2;","const offset = center * (1 - adjustment);","return offset + ((xResized + 0.5) / xScale) - 0.5;"].join(`
`);case"half_pixel":return"return ((xResized + 0.5) / xScale) - 0.5;";default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",oc=(e,t)=>"fn getNearestPixelFromOriginal(xOriginal: f32, isDownSample: bool) -> f32 {"+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",ic=(e,t,r)=>{let o=new Array(r).fill(0).concat(new Array(r).fill(1)),n=e.length===0?o:e.slice();return t.length>0?(t.forEach((s,u)=>{o[s]=n[u],o[u+r]=n[t.length+u]}),o):n},sc=(e,t,r,o)=>{let n=[];if(r.length>0)if(o.length>0){if(e.forEach(s=>n.push(s)),Math.max(...o)>e.length)throw new Error("axes is out of bound");o.forEach((s,u)=>n[s]=r[u])}else r.forEach(s=>n.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");n=e.map((s,u)=>Math.round(s*t[u]))}return n},uc=(e,t,r,o)=>{let n=(()=>{switch(o.keepAspectRatioPolicy){case"not_larger":return o.axes.length>0?Math.min(...o.axes.map(u=>r[u]),Number.MAX_VALUE):Math.min(...r,Number.MAX_VALUE);case"not_smaller":return o.axes.length>0?Math.max(...o.axes.map(u=>r[u]),Number.MIN_VALUE):Math.max(...r,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${o.keepAspectRatioPolicy} is not supported`)}})();r.fill(1,0,r.length);let s=e.slice();return o.axes.length>0?(o.axes.forEach(u=>r[u]=n),o.axes.forEach(u=>s[u]=Math.round(e[u]*r[u]))):(r.fill(n,0,r.length),s.forEach((u,l)=>s[l]=Math.round(u*r[l]))),s},lc=(e,t,r,o,n)=>`
  ...
  fn bicubicInterpolation(outputIndices: ${t.type.indices}) -> f32 {
    ...
    `},mc=(e,t,r,o,n,s)=>{let u=e.dims,l=ic(s,t.axes,u.length),a=sc(u,o,n,t.axes),p=o.slice();o.length===0&&(p=u.map((S,I)=>S===0?1:a[I]/S),t.keepAspectRatioPolicy!=="stretch"&&(a=uc(u,a,p,t)));let h=Q("output",e.dataType,a),b=H("input",e.dataType,u),g=z.size(a),v=u.length===a.length&&u.every((S,I)=>S===a[I]),$=t.coordinateTransformMode==="tf_crop_and_resize",w=S=>`
      ...
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${r}|${p.length>0?p:""}|${n.length>0?n:""}`},getShaderSource:w,getRunData:()=>({outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(g/64)}})}},hc=e=>{let t=e.customDataBuffer;return new Uint32Array(t,t.byteOffset,1)[0]},su=(e,t)=>{let r=[],o=[],n=[],s=hc(e);nc(e.inputs,t,s,r,o,n),e.compute(mc(e.inputs[0],t,s,r,o,n),{inputs:[0]})},uu=e=>{let t=e.antialias,r=e.axes,o=e.coordinateTransformMode,n=e.cubicCoeffA,s=e.excludeOutside!==0,u=e.extrapolationValue,l=e.keepAspectRatioPolicy,a=e.mode,p=e.nearestMode===""?"simple":e.nearestMode;return ie({antialias:t,axes:r,coordinateTransformMode:o,cubicCoeffA:n,excludeOutside:s,extrapolationValue:u,keepAspectRatioPolicy:l,mode:a,nearestMode:p})}});var gc,yc,du,cu,pu=L(()=>{"use strict";De();he();Pe();ve();gc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],o=e[2];if(t.dataType!==r.dataType||t.dataType!==o.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let n=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==n)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(o.dims.length!==1)throw new Error("Gamma must be 1D");if(o.dims[o.dims.length-1]!==n)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let u=e[3];if(u.dims.length!==1)throw new Error("Beta must be 1D");if(u.dims[u.dims.length-1]!==n)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let u=e[4];if(u.dims.length!==1)throw new Error("Bias must be 1D");if(u.dims[u.dims.length-1]!==n)throw new Error("Bias must have the same hidden size as input")}},yc=(e,t,r,o)=>{let n=e[0].dims,s=z.size(n),u=n,l=s,a=n.slice(-1)[0],p=o?n.slice(0,-1).concat(1):[],h=e.length>3,b=e.length>4,g=o&&r>1,v=o&&r>2,$=r>3,w=pt(a),S=[H("x",e[0].dataType,e[0].dims,w),H("skip",e[1].dataType,e[1].dims,w),H("gamma",e[2].dataType,e[2].dims,w)];h&&S.push(H("beta",e[3].dataType,e[3].dims,w)),b&&S.push(H("bias",e[4].dataType,e[4].dims,w)),S.push(Q("output",e[0].dataType,u,w)),g&&S.push(Q("meanOutput",1,p)),v&&S.push(Q("invStdOutput",1,p)),$&&S.push(Q("inputSkipBiasSum",e[0].dataType,u,w));let I=ke(e[0].dataType),T=P=>`
      ...
      ${P.mainStart()}
        ...
        for (var i: u32 = 0; i < hiddenSizeVectorized; i++) {
          ...
          let f32Value = ${Ot(I,w,"value")};
          sum += f32Value;
          squareSum += f32Value * f32Value;
        }
        let mean = ${vt("sum",w)} / hiddenSize;
        let variance = sqrt(${vt("squareSum",w)} / hiddenSize - mean * mean + epsilon);
      ...
      }`,B=[{dims:u,dataType:e[0].dataType}];return r>1&&B.push({dims:p,dataType:1}),r>2&&B.push({dims:p,dataType:1}),r>3&&B.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:t.cacheKey},getShaderSource:T,getRunData:()=>({outputs:B,dispatchGroup:{x:Math.ceil(l/a/64)}})}},du=(e,t)=>{gc(e.inputs);let o=[0];e.outputCount>1&&o.push(-3),e.outputCount>2&&o.push(-3),e.outputCount>3&&o.push(3),e.compute(yc(e.inputs,t,e.outputCount,!1),{outputs:o})},cu=e=>{let t=e.epsilon;return ie({epsilon:t})}});var bc,ln,wc,fu,vc,$c,mu,hu,gu=L(()=>{"use strict";De();he();Pe();ve();bc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,o)=>{if(e[o+1].dataType!==6&&e[o+1].dataType!==7)throw new Error(`Input ${o} must be an array of int32 or int64`)})},ln=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(o=>r.push(Number(o)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(o=>r.push(Number(o)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},wc=(e,t)=>{if(e.length>1){let r=ln(e,1),o=ln(e,2),n=ln(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),ie({starts:r,ends:o,axes:n})}else return t},fu=(e,t,r,o,n)=>{let s=e;return e<0&&(s+=r[o[t]]),n[t]<0?Math.max(0,Math.min(s,r[o[t]]-1)):Math.max(0,Math.min(s,r[o[t]]))},vc=(e,t,r,o)=>`fn calculateInputIndices(outputIndices: ${t.type.indices}) -> ${e.type.indices} {
          var inputIndices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${t.cacheKey}|${e[4]?.dims??""}`},getShaderSource:$,getRunData:()=>({outputs:[h],dispatchGroup:{x:Math.ceil(o/64)}})}},mu=(e,t)=>{bc(e.inputs,t);let r=wc(e.inputs,t);e.compute($c(e.inputs,r),{inputs:[0]})},hu=e=>{let t=e.starts,r=e.ends,o=e.axes;return ie({starts:t,ends:r,axes:o})}});var xc,Sc,yu,bu,wu=L(()=>{"use strict";he();Pe();ve();xc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Sc=(e,t)=>{let r=ke(e.dataType),o=e.dims,n=z.size(o),s=64,u=t.axis;if(u<0&&(u=o.length+u),u<o.length-1)throw new Error("softmax only supports last axis for now.");let l=o[u],a=n/l,p=pt(l),h=l/p,b=p===1?r:`vec${p}<${r}>`,g=(w,S)=>S===4?`max(max(${w}.x, ${w}.y), max(${w}.z, ${w}.w))`:S===2?`max(${w}.x, ${w}.y)`:S===3?`max(max(${w}.x, ${w}.y), ${w}.z)`:w,v=r==="f32"?`var threadMax = ${b}(-3.402823e+38f);`:`var threadMax = ${b}(-65504.0h);`;return{name:"Softmax",getRunData:()=>({outputs:[{dims:o,dataType:e.dataType}],dispatchGroup:{x:a}}),getShaderSource:w=>`
      ...
      fn main(@builtin(local_invocation_id) local_id : vec3<u32>, @builtin(global_invocation_id) global_id : vec3u) {
        ...
        if (lindex == 0) {
          rowSumShared = ${b}(${vt("threadShared[0]",p)});
        }
        workgroupBarrier();
      ...
      }`}},yu=(e,t)=>{xc(e.inputs),e.compute(Sc(e.inputs[0],t))},bu=e=>ie({axis:e.axis})});var Cc,Ic,Ac,_c,Ec,vu,$u,xu=L(()=>{"use strict";he();Pe();ve();Cc=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Ic=(e,t)=>{let r=[],o=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),o=r.length),ie({numOutputs:o,axis:t.axis,splitSizes:r})},Ac=e=>`
...
`)}
  ...
  ${S.mainStart()}
    ...
    writeBufferData(outputNumber, indices, global_idx);
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey},getShaderSource:w,getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(o/64)}})}},vu=(e,t)=>{Cc(e.inputs);let r=e.inputs.length===1?t:Ic(e.inputs,t);e.compute(Ec(e.inputs,r),{inputs:[0]})},$u=e=>{let t=e.axis,r=e.splitSizes,o=e.numOutputs<0?r.length:e.numOutputs;if(o!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return ie({axis:t,numOutputs:o,splitSizes:r})}});var Su,Oc,Tc,Rc,Cu,Iu=L(()=>{"use strict";De();he();ve();Su=e=>Array.from(e.getBigInt64Array(),Number),Oc=e=>{if(!e||e.length!==2)throw new Error("Tile requires 2 inputs.");if(e[0].dataType!==1&&e[0].dataType!==6&&e[0].dataType!==12)throw new Error("Tile only support float, int32, and uint32 data types");if(e[1].dataType!==7)throw new Error("Tile `repeats` input should be of int64 data type");if(e[1].dims.length!==1)throw new Error("Tile `repeats` input should be 1-D");if(Su(e[1]).length!==e[0].dims.length)throw new Error("Tile `repeats` input should have same number of elements as rank of input data tensor")},Tc=(e,t)=>{let r=[];for(let o=0;o<e.length;++o)r.push(e[o]*t[o]);return r},Rc=e=>{let t=e[0].dims,r=Su(e[1]),o=Tc(t,r),n=z.size(o),s=e[0].dataType,u=H("input",s,t),l=Q("output",s,o),a=p=>`
      const inputShape = ${u.indices(...t)};
      ${p.declareVariables(u,l)}
      ${p.mainStart()}
      ${p.guardAgainstOutOfBoundsWorkgroupSizes(n)}
      ...
      ${l.setByOffset("global_idx",u.getByIndices("inputIndices"))}
    }`;return{name:"Tile",shaderCache:{hint:`${r}`},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:a}},Cu=e=>{Oc(e.inputs),e.compute(Rc(e.inputs),{inputs:[0]})}});var Pc,kc,Au,_u=L(()=>{"use strict";De();he();ve();Pc=(e,t,r,o,n)=>{let s=z.size(r),u=Math.ceil(s/4),l=Q("outputData",n,r,4),a=H("aData",t[1].dataType,t[1].dims,4),p=H("bData",t[2].dataType,t[2].dims,4),h=H("cData",t[0].dataType,t[0].dims,4),b,g=(v,$,w)=>`select(${$}, ${v}, ${w})`;if(!o)b=l.setByOffset("global_idx",g(a.getByOffset("global_idx"),p.getByOffset("global_idx"),h.getByOffset("global_idx")));else{let v=($,w,S="")=>{let I=`aData[indexA${w}][componentA${w}]`,T=`bData[indexB${w}][componentB${w}]`,B=`bool(cData[indexC${w}] & ${4278190080>>>(3-w)*8}u)`;return`
